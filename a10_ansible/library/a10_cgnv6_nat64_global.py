...
def get_argspec():
    ...
    rv.update(dict(
        ...
        tcp=dict(type='dict',mss_clamp=dict(type='dict',mss_clamp_type=dict(type='str',choices=['fixed','none','subtract']),mss_value=dict(type='int',),mss_subtract=dict(type='int',),min=dict(type='int',)),reset_on_error=dict(type='dict',outbound=dict(type='str',choices=['disable']))),
