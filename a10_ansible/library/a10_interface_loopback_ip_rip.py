...
description:
    - RIP
short_description: Configures A10 interface.loopback.ip.rip
...
def get_argspec():
    ...
    rv.update(dict(
        receive_cfg=dict(type='dict',receive=dict(type='bool',),version=dict(type='str',choices=['1','2','1-2'])),
        uuid=dict(type='str',),
        ...
        send_cfg=dict(type='dict',version=dict(type='str',choices=['1','2','1-compatible','1-2']),send=dict(type='bool',)),
