...
options:
    ...
    stats:
        ...
        suboptions:
            ...
            vport_curr_conn_overflow:
                description:
                - "Virtual Server Port Real Curr Conn Overflow"
            ...
            l2_dsr:
                description:
                - "L2 DSR received"
            sg_curr_conn_overflow:
                description:
                - "Service Group Curr Conn Overflow"
            bw_watermark_drop:
                description:
                - "BW-Watermark drop"
            ...
            l7_cps_exceed:
                description:
                - "L7 CPS exceed drop"
            vserver_curr_conn_overflow:
                description:
                - "Virtual Server Real Curr Conn Overflow"
            outrst_ack_attack:
                description:
            ...
            udp_no_slb:
                description:
                - "UDP no SLB"
            sgm_curr_conn_overflow:
                description:
                - "Service Group Member Curr Conn Overflow"
            port_preserve_succ:
                description:
