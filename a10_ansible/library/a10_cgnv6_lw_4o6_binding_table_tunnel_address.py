...
description:
    - None
short_description: Configures A10 cgnv6.lw.4o6.binding.table.tunnel-address
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        nat_address_list=dict(type='list',ipv4_nat_addr=dict(type='str',required=True,),user_tag=dict(type='str',),port_range_list=dict(type='list',port_start=dict(type='int',required=True,),port_end=dict(type='int',required=True,),tunnel_endpoint_address=dict(type='str',)))
    ))
