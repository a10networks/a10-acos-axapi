...
options:
    ...
    protocol-anomaly-filtering:
        description:
            - 'disable': Disable Anomaly Filtering; choices:['disable']
    
    mandatory-ie-filtering:
        description:
            - 'disable': Disable  Mandatory Information Element Filtering; choices:['disable']
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        mandatory_ie_filtering=dict(
            type='enum' , choices=['disable']
        ),
        maximum_message_length=dict(
            type='str' 
        ),
        name=dict(
            type='str' , required=True
        ),
        protocol_anomaly_filtering=dict(
            type='enum' , choices=['disable']
        ),
        tunnel_timeout=dict(
            type='str' 
