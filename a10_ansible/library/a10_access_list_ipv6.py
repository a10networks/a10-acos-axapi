...
DOCUMENTATION = r'''
module: a10_access_list_ipv6
description:
    - Display IPv6 ACLs
short_description: Configures A10 access.list.ipv6
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/access-list/ipv6"
