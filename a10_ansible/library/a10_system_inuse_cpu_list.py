...
short_description: Configures A10 system.inuse-cpu-list
...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',system_inuse_cpu_list=dict(type='list',status=dict(type='str',),HT_CPU=dict(type='str',),CPU_Num=dict(type='str',),CPU_ID=dict(type='str',),NUMA_NODE=dict(type='str',))),
        uuid=dict(type='str',)
    ))
