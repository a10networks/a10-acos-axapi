...
options:
    ...
    protocol:
        description:
            - 'tcp': Set TCP connection rate limit; 'udp': Set UDP packet rate limit; choices:['tcp', 'udp']
    ...
    limit-period:
        description:
            - '100': 100 ms; '1000': 1000 ms; choices:['100', '1000']
...
def create(module, result):
    payload = build_json("src-ip", module)
    try:
