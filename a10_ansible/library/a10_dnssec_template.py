...
options:
    ...
    algorithm:
        description:
            - 'RSASHA1': RSASHA1 algorithm; 'RSASHA256': RSASHA256 algorithm; 'RSASHA512': RSASHA512 algorithm; choices:['RSASHA1', 'RSASHA256', 'RSASHA512']
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        algorithm=dict(
            type='enum' , choices=['RSASHA1', 'RSASHA256', 'RSASHA512']
        ),
        combinations_limit=dict(
            type='str' 
        ),
        dnskey_ttl_k=dict(
            type='str' 
        ...
        return_nsec_on_failure=dict(
            type='str' 
        ),
        signature_validity_period_k=dict(
            type='str' 
        ),
        signature_validity_period_v=dict(
            type='str' 
        ),
        user_tag=dict(
            type='str' 
