...
options:
    ...
    type:
        description:
            - 'ac': Make class-list type Aho-Corasick; 'dns': Make class-list type DNS; 'ipv4': Make class-list type IPv4; 'ipv6': Make class-list type IPv6; 'string': Make class-list type String; 'string-case-insensitive': Make class-list type String-case-insensitive. Case insensitive is applied to key string; choices:['ac', 'dns', 'ipv4', 'ipv6', 'string', 'string-case-insensitive']
...
AVAILABLE_PROPERTIES = {"ac_list","dns","file","ipv4_list","ipv6_list","name","str_list","type","user_tag","uuid",}
