...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',sensor_list=dict(type='list',sensor_type=dict(type='str',),sensor_status=dict(type='str',),sensor_name=dict(type='str',),sensor_value=dict(type='str',))),
        uuid=dict(type='str',)
    ))
