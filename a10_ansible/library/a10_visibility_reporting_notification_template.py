...
DOCUMENTATION = """
module: a10_notification-template
description:
    - 
...
options:
    ...
    protocol:
        description:
            - 'http': Use http protocol; 'https': Use https protocol(default);  (http protocol)choices:['http', 'https']
...
def create(module, result):
    payload = build_json("notification-template", module)
    try:
