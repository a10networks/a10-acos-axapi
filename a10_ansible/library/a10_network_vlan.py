...
def get_argspec():
    ...
    rv.update(dict(
        ...
        untagged_eth_list=dict(type='list',untagged_ethernet_start=dict(type='str',),untagged_ethernet_end=dict(type='str',)),
        ...
        tagged_eth_list=dict(type='list',tagged_ethernet_start=dict(type='str',),tagged_ethernet_end=dict(type='str',)),
