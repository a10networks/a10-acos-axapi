...
AVAILABLE_PROPERTIES = ["accounting_interim_update","accounting_on","accounting_start","accounting_stop","attribute","attribute_name","custom_attribute_name","disable_reply","encrypted","listen_port","remote","sampling_enable","secret","secret_string","stats","uuid","vrid",]
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        stats=dict(type='dict',secret_not_configured_dropped=dict(type='str',),radius_request_dropped=dict(type='str',),imsi_received=dict(type='str',),invalid_key=dict(type='str',),request_bad_secret_dropped=dict(type='str',),ha_standby_dropped=dict(type='str',),custom_received=dict(type='str',),radius_request_received=dict(type='str',),imei_received=dict(type='str',),request_no_key_vap_dropped=dict(type='str',),radius_table_full=dict(type='str',),msisdn_received=dict(type='str',),request_ignored=dict(type='str',),ipv6_prefix_length_mismatch=dict(type='str',),request_malformed_dropped=dict(type='str',)),
