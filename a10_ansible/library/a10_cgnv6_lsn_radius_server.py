...
def get_argspec():
    ...
    rv.update(dict(
        ...
        remote=dict(type='dict',ip_list=dict(type='list',ip_list_name=dict(type='str',),ip_list_secret=dict(type='bool',),ip_list_secret_string=dict(type='str',),ip_list_encrypted=dict(type='str',))),
        secret=dict(type='bool',),
        secret_string=dict(type='str',),
        encrypted=dict(type='str',),
        vrid=dict(type='int',),
        attribute=dict(type='list',attribute_value=dict(type='str',choices=['inside-ipv6-prefix','inside-ip','inside-ipv6','imei','imsi','msisdn','custom1','custom2','custom3']),prefix_length=dict(type='str',choices=['32','48','64','80','96','112']),prefix_vendor=dict(type='int',),prefix_number=dict(type='int',),name=dict(type='str',),value=dict(type='str',choices=['hexadecimal']),custom_vendor=dict(type='int',),custom_number=dict(type='int',),vendor=dict(type='int',),number=dict(type='int',)),
