...
def get_argspec():
    ...
    rv.update(dict(
        ...
        stats=dict(type='dict',sync_rx_nat_create_sby=dict(type='str',),sync_rx_type_invalid=dict(type='str',),sync_rx_ext_lsn_acl=dict(type='str',),sync_rx_ddos_drop_counter=dict(type='str',),sync_rx_conn_exists=dict(type='str',),sync_get_buff_failed_port=dict(type='str',),sync_tx_smp_radius_table_counter=dict(type='str',),sync_tx_total_info_counter=dict(type='str',),sync_rx_nat_alloc_sby=dict(type='str',),query_tx_min_packed=dict(type='str',),sync_rx_ext_bit_process_error=dict(type='str',),sync_rx_ext_nat_mac=dict(type='str',),sync_rx_lsn_fullcone=dict(type='str',),query_pkt_tx_counter=dict(type='str',),sync_rx_ext_nat_alg_tcp_info=dict(type='str',),sync_rx_estab_counter=dict(type='str',),sync_rx_unk_counter=dict(type='str',),sync_tx_create_counter=dict(type='str',),sync_rx_zone_failure_counter=dict(type='str',),sync_persist_rx_len_invalid=dict(type='str',),sync_rx_create_counter=dict(type='str',),sync_pkt_rcv_counter=dict(type='str',),sync_rx_len_invalid=dict(type='str',),sync_tx_update_seqnos_counter=dict(type='str',),sync_rx_persist_create_counter=dict(type='str',),sync_persist_rx_no_such_sg_group=dict(type='str',),sync_rx_ext_rtsp=dict(type='str',),sync_rx_update_seqnos_counter=dict(type='str',),sync_rx_conn_get_failed=dict(type='str',),sync_tx_persist_del_counter=dict(type='str',),sync_query_dcmsg_counter=dict(type='str',),sync_pkt_invalid_idx_counter=dict(type='str',),sync_tx_persist_update_age_counter=dict(type='str',),sync_persist_rx_vporttype_not_supported=dict(type='str',),sync_tx_update_sctp_conn_addr=dict(type='str',),sync_rx_ext_fw_http_logging=dict(type='str',),sync_rx_dcmsg_counter=dict(type='str',),sync_rx_del_no_such_session=dict(type='str',),sync_rx_ftp_control=dict(type='str',),sync_tx_persist_create_counter=dict(type='str',),sync_rx_smp_radius_table_counter=dict(type='str',),sync_rx_no_such_sg_node=dict(type='str',),sync_rx_proto_not_supported=dict(type='str',),sync_tx_get_buff_failed=dict(type='str',),sync_tx_estab_counter=dict(type='str',),sync_rx_create_ext_bit_counter=dict(type='str',),sync_tx_update_age_counter=dict(type='str',),sync_rx_lsn_create_sby=dict(type='str',),sync_get_buff_failed_rt=dict(type='str',),sync_tx_create_ext_bit_counter=dict(type='str',),sync_tx_max_packed=dict(type='str',),sync_rx_persist_update_age_counter=dict(type='str',),sync_rx_sfw=dict(type='str',),sync_rx_bad_protocol_counter=dict(type='str',),sync_rx_seq_deltas=dict(type='str',),sync_rx_ext_dcfw_rule_id=dict(type='str',),sync_rx_total_info_counter=dict(type='str',),query_pkt_invalid_idx_counter=dict(type='str',),sync_rx_create_static_sby=dict(type='str',),sync_rx_persist_del_counter=dict(type='str',),sync_rx_update_age_counter=dict(type='str',),query_tx_max_packed=dict(type='str',),sync_persist_rx_ext_bit_process_error=dict(type='str',),query_pkt_rcv_counter=dict(type='str',),sync_rx_zero_info_counter=dict(type='str',),sync_pkt_tx_counter=dict(type='str',),sync_rx_ext_sip_alg=dict(type='str',),sync_rx_no_vgrp_counter=dict(type='str',),sync_rx_reserve_ha=dict(type='str',),sync_rx_ext_pptp=dict(type='str',),sync_persist_rx_type_invalid=dict(type='str',),sync_rx_insert_tuple=dict(type='str',),sync_rx_no_such_nat_pool=dict(type='str',),sync_tx_del_counter=dict(type='str',),sync_tx_lsn_fullcone=dict(type='str',),sync_rx_apptype_not_supported=dict(type='str',),query_rx_zero_info_counter=dict(type='str',),sync_persist_rx_no_such_rport=dict(type='str',),sync_rx_by_inactive_peer_counter=dict(type='str',),sync_persist_rx_no_such_vport=dict(type='str',),query_tx_get_buff_failed=dict(type='str',),sync_rx_ext_h323_alg=dict(type='str',),sync_persist_rx_cannot_process_mandatory=dict(type='str',),sync_rx_ext_dcfw_log=dict(type='str',),sync_rx_invalid_sync_packet_counter=dict(type='str',),sync_persist_rx_proto_not_supported=dict(type='str',),sync_persist_rx_conn_get_failed=dict(type='str',),sync_rx_ext_lsn_ac_idle_timeout=dict(type='str',),sync_err_lsn_fullcone=dict(type='str',),sync_tx_min_packed=dict(type='str',),query_rx_unk_counter=dict(type='str',),sync_rx_update_sctp_conn_addr=dict(type='str',),sync_persist_rx_no_sg_group_info=dict(type='str',),sync_rx_no_such_vport=dict(type='str',),sync_rx_no_such_rport=dict(type='str',),sync_rx_ext_dcfw_rule_idle_timeout=dict(type='str',),sync_rx_del_counter=dict(type='str',),query_rx_full_info_counter=dict(type='str',),sync_rx_cannot_process_mandatory=dict(type='str',),sync_rx_no_dst_for_vport_inline=dict(type='str',)),
        uuid=dict(type='str',)
    ))
