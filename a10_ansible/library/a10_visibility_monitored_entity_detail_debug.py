...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',all_keys=dict(type='bool',),mon_entity_list=dict(type='list',uuid=dict(type='str',),l4_port=dict(type='int',),entity_key=dict(type='str',),ipv4_addr=dict(type='str',),ipv6_addr=dict(type='str',),entity_metric_list=dict(type='list',std_dev=dict(type='str',),min=dict(type='str',),max=dict(type='str',),metric_name=dict(type='str',),current=dict(type='str',),threshold=dict(type='str',),anomaly=dict(type='str',),mean=dict(type='str',)),mode=dict(type='str',),l4_proto=dict(type='str',),flat_oid=dict(type='int',),sec_entity_list=dict(type='list',uuid=dict(type='str',),l4_port=dict(type='int',),entity_key=dict(type='str',),ipv4_addr=dict(type='str',),ipv6_addr=dict(type='str',),entity_metric_list=dict(type='list',std_dev=dict(type='str',),min=dict(type='str',),max=dict(type='str',),metric_name=dict(type='str',),current=dict(type='str',),threshold=dict(type='str',),anomaly=dict(type='str',),mean=dict(type='str',)),mode=dict(type='str',),l4_proto=dict(type='str',),flat_oid=dict(type='int',),ha_state=dict(type='str',)),ha_state=dict(type='str',)),primary_keys=dict(type='bool',)),
        uuid=dict(type='str',)
    ))
...
def new_url(module):
    ...
    url_base = "/axapi/v3/visibility/monitored-entity/detail/debug"
