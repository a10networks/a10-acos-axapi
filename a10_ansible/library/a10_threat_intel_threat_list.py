...
options:
    ...
    type:
        description:
            - 'webroot': Configure Webroot threat categories; choices:['webroot']
...
AVAILABLE_PROPERTIES = {"all_categories","botnets","dos_attacks","mobile_threats","name","phishing","proxy","reputation","sampling_enable","scanners","spam_sources","tor_proxy","type","user_tag","uuid","web_attacks","windows_exploits",}
