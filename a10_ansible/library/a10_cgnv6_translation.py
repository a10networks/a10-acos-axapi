...
def get_argspec():
    ...
    rv.update(dict(
        ...
        uuid=dict(type='str',),
        service_timeout_list=dict(type='list',service_type=dict(type='str',required=True,choices=['tcp','udp']),port=dict(type='int',required=True,),port_end=dict(type='int',),timeout_val=dict(type='int',),fast=dict(type='bool',),uuid=dict(type='str',))
    ))
