...
def get_argspec():
    ...
    rv.update(dict(
        ...
        host_switching=dict(type='list',host_switching_type=dict(type='str',choices=['contains','ends-with','equals','starts-with','regex-match','host-hits-enable']),host_match_string=dict(type='str',),host_service_group=dict(type='str',)),
        ...
        redirect_rewrite=dict(type='dict',match_list=dict(type='list',redirect_match=dict(type='str',),rewrite_to=dict(type='str',)),redirect_secure=dict(type='bool',),redirect_secure_port=dict(type='int',)),
        ...
        response_content_replace_list=dict(type='list',response_content_replace=dict(type='str',),response_new_string=dict(type='str',)),
        response_header_erase_list=dict(type='list',response_header_erase=dict(type='str',)),
        response_header_insert_list=dict(type='list',response_header_insert=dict(type='str',),response_header_insert_type=dict(type='str',choices=['insert-if-not-exist','insert-always'])),
        ...
        url_switching=dict(type='list',url_switching_type=dict(type='str',choices=['contains','ends-with','equals','starts-with','regex-match','url-case-insensitive','url-hits-enable']),url_match_string=dict(type='str',),url_service_group=dict(type='str',)),
