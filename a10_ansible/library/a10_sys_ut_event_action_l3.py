...
DOCUMENTATION = """
module: a10_sys_ut_event_action_l3
description:
    - L3 packet paramters
short_description: Configures A10 sys.ut.event.action.l3
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        value=dict(type='int',),
        ip_list=dict(type='list',ve=dict(type='str',),virtual_server=dict(type='str',),src_dst=dict(type='str',required=True,choices=['dest','src']),nat_pool=dict(type='str',),trunk=dict(type='str',),ipv6_address=dict(type='str',),ethernet=dict(type='str',),ipv4_address=dict(type='str',),uuid=dict(type='str',)),
        ttl=dict(type='int',),
        ...
        for k, v in payload["l3"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["l3"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["l3"][k] = v
