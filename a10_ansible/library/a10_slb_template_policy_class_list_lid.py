...
def get_argspec():
    ...
    rv.update(dict(
        ...
        response_code_rate_limit=dict(type='list',code_range_start=dict(type='int',),code_range_end=dict(type='int',),threshold=dict(type='int',),period=dict(type='int',)),
        dns64=dict(type='dict',disable=dict(type='bool',),exclusive_answer=dict(type='bool',),prefix=dict(type='str',)),
        uuid=dict(type='str',),
