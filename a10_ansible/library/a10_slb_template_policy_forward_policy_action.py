...
options:
    ...
    action1:
        description:
            - 'forward-to-internet': Forward request to Internet; 'forward-to-service-group': Forward request to service group; 'forward-to-proxy': Forward request to HTTP proxy server; 'drop': Drop request; choices:['forward-to-internet', 'forward-to-service-group', 'forward-to-proxy', 'drop']
    ...
    http-status-code:
        description:
            - '301': Moved permanently; '302': Found; choices:['301', '302']
