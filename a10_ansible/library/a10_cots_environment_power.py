...
DOCUMENTATION = """
module: a10_cots_environment_power
description:
    - Field cots_environment_power
short_description: Configures A10 cots_environment_power
...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',sensor_list=dict(type='list',sensor_name=dict(type='str',))),
        uuid=dict(type='str',)
    ))
...
def new_url(module):
    ...
    url_base = "/axapi/v3/system/cots_environment_power"
