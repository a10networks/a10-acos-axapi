...
short_description: Configures A10 file.class-list
...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict', file_list=dict(type='list', file=dict(type='str', ),ntype=dict(type='str', ),location=dict(type='str', ),user_tag=dict(type='str', ))),
