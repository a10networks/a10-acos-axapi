...
short_description: Configures A10 gslb.zone.service.dns.a.record.dns-a-record-ipv4
        ...
        for k, v in payload["dns-a-record-ipv4"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["dns-a-record-ipv4"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["dns-a-record-ipv4"][k] = v
