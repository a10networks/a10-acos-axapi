...
short_description: Configures A10 ntp-status
...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',server=dict(type='list',status=dict(type='str',),ntp_server=dict(type='str',),auth=dict(type='str',),is_preferred=dict(type='str',),mode=dict(type='str',))),
        uuid=dict(type='str',)
    ))
