...
AVAILABLE_PROPERTIES = ["action","bypass_ip_cfg","cylance","fail_close","include_protocol_in_uri","logging","min_payload_size","name","preview","server_ssl","service_group","service_url","source_ip","tcp_proxy","user_tag","uuid",]
