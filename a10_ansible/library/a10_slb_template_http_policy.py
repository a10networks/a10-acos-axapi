...
def get_argspec():
    ...
    rv.update(dict(
        ...
        http_policy_match=dict(type='list',ntype=dict(type='str',choices=['cookie','host','url']),match_type=dict(type='str',choices=['contains','ends-with','equals','starts-with']),match_string=dict(type='str',),service_group=dict(type='str',),template=dict(type='str',choices=['waf']),template_name=dict(type='str',)),
