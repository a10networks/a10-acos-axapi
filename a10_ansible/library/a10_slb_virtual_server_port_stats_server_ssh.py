...
short_description: Configures A10 slb.virtual-server.port.stats.server.ssh
...
def get_argspec():
    ...
    rv.update(dict(
        stats=dict(type='dict',server_ssh=dict(type='dict',forwarding_errors=dict(type='str',),successful_handshakes=dict(type='str',),failed_handshakes=dict(type='str',))),
...
def new_url(module):
    ...
    url_base = "/axapi/v3/slb/virtual-server/{virtual_server_name}/port/{port_number}+{protocol}/stats?server-ssh=true"
