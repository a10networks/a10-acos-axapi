...
DOCUMENTATION = """
module: a10_scaleout_service_config
description:
    - Configure scaleout templates for SLB, CGN and VRRP
short_description: Configures A10 scaleout.service-config
...
def new_url(module):
    ...
    url_base = "/axapi/v3/scaleout/{scaleout_cluster_id}/service-config"
        ...
        for k, v in payload["service-config"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["service-config"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["service-config"][k] = v
