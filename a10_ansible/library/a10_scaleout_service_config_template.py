...
DOCUMENTATION = """
module: a10_scaleout_service_config_template
description:
    - Scaleout template
short_description: Configures A10 scaleout.service.config.template
...
def new_url(module):
    ...
    url_base = "/axapi/v3/scaleout/{scaleout_cluster_id}/service-config/template/{name}"
