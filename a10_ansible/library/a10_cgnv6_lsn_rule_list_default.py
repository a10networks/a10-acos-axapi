...
short_description: Configures A10 cgnv6.lsn.rule.list.default
        ...
        for k, v in payload["default"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["default"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["default"][k] = v
...
def present(module, result, existing_config):
    payload = build_json("default", module)
