...
def get_argspec():
    ...
    rv.update(dict(
        ...
        avp_list=dict(type='list',avp=dict(type='int',),int32=dict(type='int',),int64=dict(type='int',),string=dict(type='str',),mandatory=dict(type='bool',)),
        uuid=dict(type='str',),
        user_tag=dict(type='str',),
        origin_host=dict(type='dict',origin_host_name=dict(type='str',),uuid=dict(type='str',))
    ))
