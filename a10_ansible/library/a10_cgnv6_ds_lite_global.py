...
AVAILABLE_PROPERTIES = ["icmp","inside","ip_checksum_error","l4_checksum_error","sampling_enable","stats","tcp","uuid",]
...
def get_argspec():
    ...
    rv.update(dict(
        stats=dict(type='dict',data_session_freed=dict(type='str',),total_udp_overloaded=dict(type='str',),endpoint_indep_filter_match=dict(type='str',),udp_fullcone_freed=dict(type='str',),nat_pool_unusable=dict(type='str',),nat_port_unavailable_udp=dict(type='str',),lid_pass_through=dict(type='str',),total_icmp_freed=dict(type='str',),hairpin=dict(type='str',),tcp_fullcone_created=dict(type='str',),nat_port_unavailable_icmp=dict(type='str',),udp_fullcone_created=dict(type='str',),extended_quota_matched=dict(type='str',),icmp_user_quota_exceeded=dict(type='str',),ha_nat_pool_unusable=dict(type='str',),port_overloading_smp_free_udp=dict(type='str',),total_tcp_allocated=dict(type='str',),tcp_user_quota_exceeded=dict(type='str',),port_overloading_smp_inserted_tcp=dict(type='str',),eif_limit_exceeded=dict(type='str',),port_overloading_smp_inserted_udp=dict(type='str',),udp_user_quota_exceeded=dict(type='str',),ha_nat_pool_batch_type_mismatch=dict(type='str',),user_quota_failure=dict(type='str',),user_quota_put_in_del_q=dict(type='str',),total_udp_freed=dict(type='str',),nat_port_unavailable_tcp=dict(type='str',),total_tcp_overloaded=dict(type='str',),fullcone_failure=dict(type='str',),user_quota_created=dict(type='str',),data_sesn_user_quota_exceeded=dict(type='str',),lid_drop=dict(type='str',),data_sesn_rate_user_quota_exceeded=dict(type='str',),truncated_packet=dict(type='str',),fullcone_self_hairpinning_drop=dict(type='str',),nat_mismatch_drop=dict(type='str',),class_list_permit_drop=dict(type='str',),new_user_resource_unavailable=dict(type='str',),extended_quota_exceeded=dict(type='str',),total_udp_allocated=dict(type='str',),data_session_created=dict(type='str',),port_overloading_smp_free_tcp=dict(type='str',),endpoint_indep_map_match=dict(type='str',),tcp_fullcone_freed=dict(type='str',),no_radius_profile_match=dict(type='str',),total_icmp_allocated=dict(type='str',),no_class_list_match=dict(type='str',),inbound_filtered=dict(type='str',),total_tcp_freed=dict(type='str',)),
        uuid=dict(type='str',),
