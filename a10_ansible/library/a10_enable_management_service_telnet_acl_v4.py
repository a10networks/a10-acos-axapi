...
short_description: Configures A10 enable-management.service.telnet.acl-v4
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        acl_id=dict(type='int',required=True,),
        ...
        for k, v in payload["acl-v4"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["acl-v4"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["acl-v4"][k] = v
