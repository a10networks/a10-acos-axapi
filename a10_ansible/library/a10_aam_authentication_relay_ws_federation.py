...
options:
    ...
    application-server:
        description:
            - 'sharepoint': Microsoft SharePoint; 'exchange-owa': Microsoft Exchange OWA; choices:['sharepoint', 'exchange-owa']
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        application_server=dict(
            type='enum' , choices=['sharepoint', 'exchange-owa']
        ),
        authentication_uri=dict(
            type='str' 
        ),
        name=dict(
