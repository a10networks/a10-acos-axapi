...
short_description: Configures A10 slb.http-proxy
...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',debug_fields=dict(type='bool',),http_proxy_cpu_list=dict(type='list',new_svrconn=dict(type='int',),req_timeout_retry=dict(type='int',),connecting_rst=dict(type='int',),req_sz_32k=dict(type='int',),total_proxy=dict(type='int',),req_get=dict(type='int',),fwdreqdata_fail=dict(type='int',),aflex_switching_enqueue=dict(type='int',),invalid_header=dict(type='int',),response_501=dict(type='int',),negative_resp_remain=dict(type='int',),response_503=dict(type='int',),response_502=dict(type='int',),response_505=dict(type='int',),response_504=dict(type='int',),response_507=dict(type='int',),response_506=dict(type='int',),response_509=dict(type='int',),response_508=dict(type='int',),rsp_sz_8k=dict(type='int',),compress_no_content_type=dict(type='int',),pkts_retrans_rst=dict(type='int',),req_put=dict(type='int',),response_2xx=dict(type='int',),req_over_limit=dict(type='int',),req_sz_gt_256k=dict(type='int',),svr_prem_close=dict(type='int',),parsereq_fail=dict(type='int',),decompression_after=dict(type='int',),response_101=dict(type='int',),connecting_rst_ofo=dict(type='int',),response_102=dict(type='int',),compress_resp_already_compressed=dict(type='int',),req_post=dict(type='int',),req_over_5s=dict(type='int',),rsp_chunk=dict(type='int',),decompression_before=dict(type='int',),lb_switching_ok=dict(type='int',),req_ofo=dict(type='int',),req_200m=dict(type='int',),huge_cookie_header=dict(type='int',),chunk_sz_1k=dict(type='int',),pkts_retrans_push=dict(type='int',),header_delete=dict(type='int',),response_510=dict(type='int',),response_6xx=dict(type='int',),req_timeout_close=dict(type='int',),response_500=dict(type='int',),req_succ=dict(type='int',),aflex_lb_reselect=dict(type='int',),rsp_sz_32k=dict(type='int',),req_100u=dict(type='int',),req_http10_keepalive=dict(type='int',),req_100m=dict(type='int',),response_3xx=dict(type='int',),rsp_sz_gt_256k=dict(type='int',),connecting_ack=dict(type='int',),connecting_fin_ofo=dict(type='int',),rsp_sz_2k=dict(type='int',),chunk_sz_2k=dict(type='int',),compression_after=dict(type='int',),response_http11=dict(type='int',),response_408=dict(type='int',),client_rst=dict(type='int',),client_rst_connected=dict(type='int',),chunk_sz_512=dict(type='int',),response_400=dict(type='int',),response_401=dict(type='int',),compression_before=dict(type='int',),response_403=dict(type='int',),response_404=dict(type='int',),response_405=dict(type='int',),response_406=dict(type='int',),response_407=dict(type='int',),l4_switching=dict(type='int',),req_sz_256k=dict(type='int',),noproxy=dict(type='int',),chunk_sz_gt_4k=dict(type='int',),ws_handshake_resp=dict(type='int',),asm_setcookie_header_fail=dict(type='int',),req_trace=dict(type='int',),req=dict(type='int',),client_req_unexp_flag=dict(type='int',),fwdreq_fail_persist=dict(type='int',),url_switching_ok=dict(type='int',),cookie_switching_enqueue=dict(type='int',),rsp_sz_64k=dict(type='int',),large_cookie=dict(type='int',),asm_setcookie_fail=dict(type='int',),rsp_content_len=dict(type='int',),client_rst_request=dict(type='int',),host_switching_enqueue=dict(type='int',),rsp_sz_1k=dict(type='int',),aflex_retry=dict(type='int',),response_306=dict(type='int',),connecting_fin_retrans=dict(type='int',),wrong_resp_header=dict(type='int',),compress_rsp=dict(type='int',),curr_proxy=dict(type='int',),req_20u=dict(type='int',),response_418=dict(type='int',),response_413=dict(type='int',),response_412=dict(type='int',),response_411=dict(type='int',),response_410=dict(type='int',),response_http2=dict(type='int',),insert_client_ip=dict(type='int',),response_415=dict(type='int',),host_switching_ok=dict(type='int',),response_504_ax=dict(type='int',),pkts_ofo=dict(type='int',),skip_insert_client_port=dict(type='int',),req_1m=dict(type='int',),compress_del_accept_enc=dict(type='int',),compress_resp_lt_min=dict(type='int',),compress_content_type_excluded=dict(type='int',),skip_insert_client_ip=dict(type='int',),server_rst_connected=dict(type='int',),client_rst_connecting=dict(type='int',),fwdreq_fail_tuple=dict(type='int',),req_1s=dict(type='int',),server_resel_failed=dict(type='int',),ws_server_packets=dict(type='int',),req_delete=dict(type='int',),req_500m=dict(type='int',),too_many_headers=dict(type='int',),rsp_sz_4k=dict(type='int',),response_426=dict(type='int',),response_424=dict(type='int',),response_425=dict(type='int',),response_422=dict(type='int',),response_1xx=dict(type='int',),url_switching=dict(type='int',),asm_cookie_fail=dict(type='int',),url_switching_enqueue=dict(type='int',),req_500u=dict(type='int',),response_unknown=dict(type='int',),cache_rsp=dict(type='int',),req_2s=dict(type='int',),response_5xx=dict(type='int',),response_305=dict(type='int',),response_304=dict(type='int',),response_303=dict(type='int',),req_rate_over_limit=dict(type='int',),response_301=dict(type='int',),response_300=dict(type='int',),response_417=dict(type='int',),pconn_connected=dict(type='int',),response_416=dict(type='int',),fwdreq_fail_server=dict(type='int',),ws_client_packets=dict(type='int',),fwdreq_fail_route=dict(type='int',),response_4xx=dict(type='int',),response_414=dict(type='int',),parse_cookie_fail=dict(type='int',),req_track=dict(type='int',),req_2m=dict(type='int',),response_307=dict(type='int',),connect_req=dict(type='int',),server_rst=dict(type='int',),req_10u=dict(type='int',),header_insert=dict(type='int',),response_http10=dict(type='int',),notuple=dict(type='int',),req_sz_2k=dict(type='int',),negative_req_remain=dict(type='int',),rsp_sz_256k=dict(type='int',),aflex_lb_reselect_ok=dict(type='int',),l4_switching_ok=dict(type='int',),snat_fail=dict(type='int',),asm_cookie_header_fail=dict(type='int',),server_rst_request=dict(type='int',),req_10m=dict(type='int',),req_50u=dict(type='int',),pkts_retrans_fin=dict(type='int',),response_409=dict(type='int',),req_unknown=dict(type='int',),fwdreq_fail=dict(type='int',),req_options=dict(type='int',),lb_switching_enqueue=dict(type='int',),lb_switching=dict(type='int',),req_50m=dict(type='int',),cookie_switching=dict(type='int',),aflex_switching=dict(type='int',),fwdreq_fail_rport=dict(type='int',),server_rst_response=dict(type='int',),svrsel_fail=dict(type='int',),req_sz_8k=dict(type='int',),retry_503=dict(type='int',),huge_cookie=dict(type='int',),req_http2=dict(type='int',),large_cookie_header=dict(type='int',),req_retran=dict(type='int',),pkts_retrans_ack_finwait=dict(type='int',),aflex_switching_ok=dict(type='int',),header_name_too_long=dict(type='int',),chunk_bad=dict(type='int',),compress_resp_no_cl_or_ce=dict(type='int',),close_on_ddos=dict(type='int',),response_402=dict(type='int',),pkts_retrans=dict(type='int',),req_200u=dict(type='int',),response_423=dict(type='int',),response_206=dict(type='int',),chunk_sz_4k=dict(type='int',),response_204=dict(type='int',),response_205=dict(type='int',),response_202=dict(type='int',),response_203=dict(type='int',),response_200=dict(type='int',),response_201=dict(type='int',),cookie_switching_ok=dict(type='int',),rsp_sz_16k=dict(type='int',),req_http10=dict(type='int',),req_http11=dict(type='int',),req_connect=dict(type='int',),parse_setcookie_fail=dict(type='int',),non_http_bypass=dict(type='int',),response_449=dict(type='int',),req_sz_4k=dict(type='int',),insert_client_port=dict(type='int',),client_rst_response=dict(type='int',),server_resel=dict(type='int',),stale_sess=dict(type='int',),req_sz_16k=dict(type='int',),pconn_connecting=dict(type='int',),response_302=dict(type='int',),req_sz_64k=dict(type='int',),line_too_long=dict(type='int',),compress_ratio_too_high=dict(type='int',),fwdreq_fail_buff=dict(type='int',),response_100=dict(type='int',),host_switching=dict(type='int',),response_450=dict(type='int',),connecting_rst_retrans=dict(type='int',),server_rst_connecting=dict(type='int',),req_5m=dict(type='int',),pconn_connecting_failed=dict(type='int',),req_sz_1k=dict(type='int',),ws_handshake_req=dict(type='int',),req_head=dict(type='int',),req_20m=dict(type='int',),req_5s=dict(type='int',),connecting_fin=dict(type='int',),response_207=dict(type='int',),l4_switching_enqueue=dict(type='int',),req_enter_ssli=dict(type='int',)),cpu_count=dict(type='int',)),
        sampling_enable=dict(type='list',counters1=dict(type='str',choices=['all','num','curr_proxy','total_proxy','req','req_succ','noproxy','client_rst','server_rst','notuple','parsereq_fail','svrsel_fail','fwdreq_fail','fwdreq_fail_buff','fwdreq_fail_rport','fwdreq_fail_route','fwdreq_fail_persist','fwdreq_fail_server','fwdreq_fail_tuple','fwdreqdata_fail','req_retran','req_ofo','server_resel','svr_prem_close','new_svrconn','snat_fail','tcpoutrst','full_proxy','full_proxy_post','full_proxy_pipeline','full_proxy_fpga_err','req_over_limit','req_rate_over_limit','l4_switching','cookie_switching','aflex_switching','http_policy_switching','url_switching','host_switching','lb_switching','l4_switching_ok','cookie_switching_ok','aflex_switching_ok','http_policy_switching_ok','url_switching_ok','host_switching_ok','lb_switching_ok','l4_switching_enqueue','cookie_switching_enqueue','aflex_switching_enqueue','http_policy_switching_enqueue','url_switching_enqueue','host_switching_enqueue','lb_switching_enqueue','retry_503','aflex_retry','aflex_lb_reselect','aflex_lb_reselect_ok','client_rst_request','client_rst_connecting','client_rst_connected','client_rst_response','server_rst_request','server_rst_connecting','server_rst_connected','server_rst_response','invalid_header','too_many_headers','line_too_long','header_name_too_long','wrong_resp_header','header_insert','header_delete','insert_client_ip','negative_req_remain','negative_resp_remain','large_cookie','large_cookie_header','huge_cookie','huge_cookie_header','parse_cookie_fail','parse_setcookie_fail','asm_cookie_fail','asm_cookie_header_fail','asm_setcookie_fail','asm_setcookie_header_fail','client_req_unexp_flag','connecting_fin','connecting_fin_retrans','connecting_fin_ofo','connecting_rst','connecting_rst_retrans','connecting_rst_ofo','connecting_ack','pkts_ofo','pkts_retrans','pkts_retrans_ack_finwait','pkts_retrans_fin','pkts_retrans_rst','pkts_retrans_push','stale_sess','server_resel_failed','compression_before','compression_after','response_1xx','response_100','response_101','response_102','response_2xx','response_200','response_201','response_202','response_203','response_204','response_205','response_206','response_207','response_3xx','response_300','response_301','response_302','response_303','response_304','response_305','response_306','response_307','response_4xx','response_400','response_401','response_402','response_403','response_404','response_405','response_406','response_407','response_408','response_409','response_410','response_411','response_412','response_413','response_414','response_415','response_416','response_417','response_418','response_422','response_423','response_424','response_425','response_426','response_449','response_450','response_5xx','response_500','response_501','response_502','response_503','response_504','response_505','response_506','response_507','response_508','response_509','response_510','response_6xx','response_unknown','req_http10','req_http11','response_http10','response_http11','req_get','req_head','req_put','req_post','req_trace','req_options','req_connect','req_delete','req_unknown','req_content_len','rsp_content_len','rsp_chunk','req_chunk','compress_rsp','compress_del_accept_enc','compress_resp_already_compressed','compress_content_type_excluded','compress_no_content_type','compress_resp_lt_min','compress_resp_no_cl_or_ce','compress_ratio_too_high','cache_rsp','close_on_ddos','req_http10_keepalive','req_sz_1k','req_sz_2k','req_sz_4k']),counters2=dict(type='str',choices=['req_sz_8k','req_sz_16k','req_sz_32k','req_sz_64k','req_sz_256k','req_sz_gt_256k','rsp_sz_1k','rsp_sz_2k','rsp_sz_4k','rsp_sz_8k','rsp_sz_16k','rsp_sz_32k','rsp_sz_64k','rsp_sz_256k','rsp_sz_gt_256k','chunk_sz_512','chunk_sz_1k','chunk_sz_2k','chunk_sz_4k','chunk_sz_gt_4k','pconn_connecting','pconn_connected','pconn_connecting_failed','chunk_bad','req_10u','req_20u','req_50u','req_100u','req_200u','req_500u','req_1m','req_2m','req_5m','req_10m','req_20m','req_50m','req_100m','req_200m','req_500m','req_1s','req_2s','req_5s','req_over_5s','insert_client_port','req_track','connect_req','req_enter_ssli','non_http_bypass','decompression_before','decompression_after','req_http2','response_http2','req_timeout_retry','req_timeout_close'])),
        stats=dict(type='dict',new_svrconn=dict(type='str',),svrsel_fail=dict(type='str',),cache_rsp=dict(type='str',),total_proxy=dict(type='str',),fwdreqdata_fail=dict(type='str',),compression_after=dict(type='str',),req_http2=dict(type='str',),client_rst=dict(type='str',),req_retran=dict(type='str',),compression_before=dict(type='str',),close_on_ddos=dict(type='str',),req_over_limit=dict(type='str',),noproxy=dict(type='str',),req_rate_over_limit=dict(type='str',),parsereq_fail=dict(type='str',),req=dict(type='str',),decompression_after=dict(type='str',),connect_req=dict(type='str',),server_rst=dict(type='str',),decompression_before=dict(type='str',),notuple=dict(type='str',),curr_proxy=dict(type='str',),server_resel=dict(type='str',),req_ofo=dict(type='str',),snat_fail=dict(type='str',),response_http2=dict(type='str',),svr_prem_close=dict(type='str',),fwdreq_fail=dict(type='str',),req_succ=dict(type='str',),req_enter_ssli=dict(type='str',)),
        uuid=dict(type='str',)
    ))
        ...
        for k, v in payload["http-proxy"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["http-proxy"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["http-proxy"][k] = v
...
def present(module, result, existing_config):
    payload = build_json("http-proxy", module)
