...
DOCUMENTATION = """
module: a10_visibility_reporting_notification_template_authentication
description:
    - Configure authentication information
short_description: Configures A10 visibility.reporting.notification.template.authentication
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(
        notification_template_name=dict(type='str', required=True),
    ))
