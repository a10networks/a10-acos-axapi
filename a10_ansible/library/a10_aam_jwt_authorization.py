...
def get_argspec():
    ...
    rv.update(dict(
        ...
        log_level=dict(type='str',choices=['0','1','2','3']),
        sampling_enable=dict(type='list',counters1=dict(type='str',choices=['all','jwt-request','jwt-authorize-success','jwt-authorize-failure','jwt-missing-token','jwt-missing-claim','jwt-token-expired','jwt-signature-failure','jwt-other-error'])),
        user_tag=dict(type='str',),
        jwt_exp_default=dict(type='int',),
        verification_cert=dict(type='str',),
        jwt_forwarding=dict(type='bool',),
        exp_claim_requried=dict(type='bool',),
        uuid=dict(type='str',)
    ))
