...
short_description: Configures A10 cgnv6.nat46.stateless.static-dest-mapping
    ...
    if existing_config:
        for k, v in payload["static-dest-mapping"].items():
            if v.lower() == "true":
                ...
                v = 0
            if existing_config["static-dest-mapping"][k] != v:
                if result["changed"] != True:
                    result["changed"] = True
                existing_config["static-dest-mapping"][k] = v
