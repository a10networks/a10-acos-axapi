...
def get_argspec():
    ...
    rv.update(dict(
        ...
        client_domain_switching=dict(type='list',switching_type=dict(type='str',choices=['contains','ends-with','starts-with']),match_string=dict(type='str',),service_group=dict(type='str',)),
        uuid=dict(type='str',),
