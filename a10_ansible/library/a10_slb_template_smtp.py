...
options:
    ...
    client-starttls-type:
        description:
            - 'optional': STARTTLS is optional requirement; 'enforced': Must issue STARTTLS command before mail transaction; choices:['optional', 'enforced']
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        client_domain_switching=dict(
            type='str' 
        ),
        client_starttls_type=dict(
            type='enum' , choices=['optional', 'enforced']
        ),
        command_disable=dict(
            type='str' 
        ),
        name=dict(
        ...
        server_starttls_type=dict(
            type='enum' , choices=['optional', 'enforced']
        ),
        service_ready_msg=dict(
            type='str' 
        ),
        user_tag=dict(
            type='str' 
