...
def get_argspec():
    ...
    rv.update(dict(
        filter_cfg=dict(type='dict',source_addr=dict(type='str',),dport2=dict(type='int',),dest_mask=dict(type='str',),session_type=dict(type='str',choices=['ipv6','sip']),source_port=dict(type='int',),source_mask=dict(type='str',),dest_addr=dict(type='str',)),
        set=dict(type='bool',),
