...
def get_argspec():
    ...
    rv.update(dict(
        ...
        class_list=dict(type='dict',name=dict(type='str',),uuid=dict(type='str',),lid_list=dict(type='list',lidnum=dict(type='int',required=True,),conn_rate_limit=dict(type='int',),per=dict(type='int',),over_limit_action=dict(type='bool',),action_value=dict(type='str',choices=['dns-cache-disable','dns-cache-enable','forward']),lockout=dict(type='int',),log=dict(type='bool',),log_interval=dict(type='int',),dns=dict(type='dict',cache_action=dict(type='str',choices=['cache-disable','cache-enable']),ttl=dict(type='int',),weight=dict(type='int',),honor_server_response_ttl=dict(type='bool',)),uuid=dict(type='str',),user_tag=dict(type='str',)))
    ))
