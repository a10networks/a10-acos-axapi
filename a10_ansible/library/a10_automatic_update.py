...
def get_argspec():
    ...
    rv.update(dict(
        info=dict(type='dict',sampling_enable=dict(type='list',counters1=dict(type='str',choices=['all','dummy']))),
        reset=dict(type='dict',feature_name=dict(type='str',choices=['app-fw'])),
        uuid=dict(type='str',),
        use_mgmt_port=dict(type='bool',),
        checknow=dict(type='dict',sampling_enable=dict(type='list',counters1=dict(type='str',choices=['all','dummy']))),
