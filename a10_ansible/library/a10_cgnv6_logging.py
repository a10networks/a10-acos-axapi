...
def get_argspec():
    ...
    rv.update(dict(
        ...
        nat_resource_exhausted=dict(type='dict',level=dict(type='str',choices=['warning','critical','notice']),uuid=dict(type='str',)),
        nat_quota_exceeded=dict(type='dict',level=dict(type='str',choices=['warning','critical','notice']),uuid=dict(type='str',))
    ))
