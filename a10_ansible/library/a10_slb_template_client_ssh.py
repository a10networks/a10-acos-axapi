...
short_description: Configures A10 slb.template.client-ssh
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        forward_proxy_hostkey=dict(type='str',),
        ...
        for k, v in payload["client-ssh"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["client-ssh"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["client-ssh"][k] = v
