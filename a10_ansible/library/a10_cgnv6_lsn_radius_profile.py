...
def get_argspec():
    ...
    rv.update(dict(
        ...
        radius=dict(type='list',attribute=dict(type='str',choices=['custom1','custom2','custom3','imei','imsi','msisdn','default']),starts_with=dict(type='str',),starts_with_lsn_lid=dict(type='int',),exact_value=dict(type='str',),exact_value_lsn_lid=dict(type='int',),default_lsn_lid=dict(type='int',)),
        uuid=dict(type='str',),
