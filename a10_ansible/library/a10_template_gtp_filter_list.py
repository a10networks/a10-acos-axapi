...
options:
    ...
    str_list:
        ...
        suboptions:
            ...
            selection_mode:
                description:
                - "'mobilestation'= Mobile station-provided APN, subscription not verified; 'network'= Network-provided APN, subscription not verified; 'verified'= MS or Network-provided APN, subscription verified; "
            imsi_selection:
                description:
