...
short_description: Configures A10 tacacs-server.host.tacacs-hostname
    ...
    if existing_config:
        for k, v in payload["tacacs-hostname"].items():
            if v.lower() == "true":
                ...
                v = 0
            if existing_config["tacacs-hostname"][k] != v:
                if result["changed"] != True:
                    result["changed"] = True
                existing_config["tacacs-hostname"][k] = v
