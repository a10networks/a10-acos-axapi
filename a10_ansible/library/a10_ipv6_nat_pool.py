...
description:
    - IPv6 pool name
short_description: Configures A10 ipv6.nat.pool
...
AVAILABLE_PROPERTIES = ["end_address","gateway","ip_rr","netmask","oper","pool_name","sampling_enable","scaleout_device_id","start_address","stats","uuid","vrid",]
