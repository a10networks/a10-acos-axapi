...
options:
    ...
    method:
        description:
            - 'append': Append if there is already a header (default); 'replace': Replace if there is already a header; choices:['append', 'replace']
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        header_name_client_ip=dict(
            type='str' 
        ),
        header_name_msisdn=dict(
            type='str' 
        ),
        include_tunnel_ip=dict(
            type='str' 
        ),
        method=dict(
            type='enum' , choices=['append', 'replace']
        ),
        name=dict(
        ...
        request_insert_client_ip=dict(
            type='str' 
        ),
        request_insert_msisdn=dict(
            type='str' 
        ),
        retry=dict(
            type='str' 
