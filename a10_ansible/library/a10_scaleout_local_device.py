...
DOCUMENTATION = """
module: a10_scaleout_local_device
description:
    - Local device configuration
short_description: Configures A10 scaleout.local-device
...
AVAILABLE_PROPERTIES = ["id","priority","uuid",]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/scaleout/{scaleout_cluster_id}/local-device"
