...
short_description: Configures A10 system.apps-global
        ...
        for k, v in payload["apps-global"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["apps-global"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["apps-global"][k] = v
...
def present(module, result, existing_config):
    payload = build_json("apps-global", module)
