...
def get_argspec():
    ...
    rv.update(dict(
        ...
        stats=dict(type='dict',msg_dropped_no_active_member=dict(type='str',),msg_dropped_local_log_ratelimit=dict(type='str',),msg_dropped_no_template=dict(type='str',),msg_dropped_too_long=dict(type='str',),msg_dropped_other=dict(type='str',),msg_dropped_format_not_defined=dict(type='str',),msg_dropped_remote_log_ratelimit=dict(type='str',),msg_sent=dict(type='str',),msg_sent_logdb=dict(type='str',),msg_dropped_send_failed=dict(type='str',),msg_dropped_route_fail=dict(type='str',),msg_dropped_selector=dict(type='str',),msg_dropped_malloc_failure=dict(type='str',),msg_dropped_craft_fail=dict(type='str',)),
        uuid=dict(type='str',)
    ))
