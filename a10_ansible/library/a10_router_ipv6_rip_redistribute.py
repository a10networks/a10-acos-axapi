...
short_description: Configures A10 router.ipv6.rip.redistribute
...
options:
    ...
    redist_list:
        ...
        suboptions:
            ...
            ntype:
                description:
                - "'bgp'= Border Gateway Protocol (BGP); 'connected'= Connected; 'floating-ip'= Floating IP; 'ip-nat-list'= IP NAT list; 'ip-nat'= IP NAT; 'isis'= ISO IS-IS; 'lw4o6'= LW4O6 Prefix; 'nat-map'= NAT MAP Prefix; 'nat64'= NAT64 Prefix; 'ospf'= Open Shortest Path First (OSPF); 'static'= Static routes; "
    uuid:
        description:
        - "uuid of the object"
        required: False
