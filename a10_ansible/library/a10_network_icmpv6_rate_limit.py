...
short_description: Configures A10 network.icmpv6-rate-limit
        ...
        for k, v in payload["icmpv6-rate-limit"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["icmpv6-rate-limit"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["icmpv6-rate-limit"][k] = v
...
def present(module, result, existing_config):
    payload = build_json("icmpv6-rate-limit", module)
