...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',bios_version=dict(type='str',),cpu_cores=dict(type='int',),l23_asic=dict(type='str',),bios_release_date=dict(type='str',),fpga_summary=dict(type='str',),memory=dict(type='str',),storage=dict(type='str',),bypass_pr=dict(type='int',),compression_cards=dict(type='dict',aha363=dict(type='int',),unknown_compression=dict(type='int',),gzip_devices=dict(type='int',)),bypass_list=dict(type='list',bypass_name=dict(type='str',)),fpga_date=dict(type='str',),ipmi=dict(type='str',),platform_description=dict(type='str',),ssl_cards=dict(type='dict',unknown_ssl_cards=dict(type='int',),hsm=dict(type='int',),ssl_devices=dict(type='int',),nitroxpx=dict(type='int',),nitrox5=dict(type='int',),nitrox3=dict(type='int',),nitrox2=dict(type='int',),nitrox1=dict(type='int',)),serial=dict(type='str',),cpu=dict(type='str',),cpu_stepping=dict(type='int',),ports=dict(type='str',)),
        uuid=dict(type='str',)
    ))
