...
DOCUMENTATION = """
module: a10_file_policy
description:
    - WAF Policy file information and management commands
short_description: Configures A10 file.policy
...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict',file_list=dict(type='list',file=dict(type='str',),template=dict(type='str',),learning=dict(type='str',),syntax=dict(type='str',))),
