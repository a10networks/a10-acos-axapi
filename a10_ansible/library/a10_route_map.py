...
def get_argspec():
    ...
    rv.update(dict(
        set=dict(type='dict',extcommunity=dict(type='dict',rt=dict(type='dict',value=dict(type='str',)),soo=dict(type='dict',value=dict(type='str',))),origin=dict(type='dict',egp=dict(type='bool',),incomplete=dict(type='bool',),igp=dict(type='bool',)),originator_id=dict(type='dict',originator_ip=dict(type='str',)),weight=dict(type='dict',weight_val=dict(type='int',)),level=dict(type='dict',value=dict(type='str',choices=['level-1','level-1-2','level-2'])),ip=dict(type='dict',next_hop=dict(type='dict',address=dict(type='str',))),metric=dict(type='dict',value=dict(type='str',)),as_path=dict(type='dict',num=dict(type='int',),num2=dict(type='int',),prepend=dict(type='str',)),comm_list=dict(type='dict',name=dict(type='str',),v_std=dict(type='int',),v_exp_delete=dict(type='bool',),v_exp=dict(type='int',),name_delete=dict(type='bool',),delete=dict(type='bool',)),atomic_aggregate=dict(type='bool',),community=dict(type='str',),local_preference=dict(type='dict',val=dict(type='int',)),tag=dict(type='dict',value=dict(type='int',)),aggregator=dict(type='dict',aggregator_as=dict(type='dict',ip=dict(type='str',),asn=dict(type='int',))),dampening_cfg=dict(type='dict',dampening_max_supress=dict(type='int',),dampening=dict(type='bool',),dampening_penalty=dict(type='int',),dampening_half_time=dict(type='int',),dampening_supress=dict(type='int',),dampening_reuse=dict(type='int',)),ipv6=dict(type='dict',next_hop_1=dict(type='dict',local=dict(type='dict',address=dict(type='str',)),address=dict(type='str',))),metric_type=dict(type='dict',value=dict(type='str',choices=['external','internal','type-1','type-2'])),uuid=dict(type='str',)),
        uuid=dict(type='str',),
        sequence=dict(type='int',required=True,),
        user_tag=dict(type='str',),
        tag=dict(type='str',required=True,),
        action=dict(type='str',required=True,choices=['permit','deny']),
        match=dict(type='dict',extcommunity=dict(type='dict',extcommunity_l_std_cfg=dict(type='dict',exact_match=dict(type='bool',),l_std=dict(type='int',)),extcommunity_l_name=dict(type='dict',exact_match=dict(type='bool',),name=dict(type='str',)),extcommunity_l_ext_cfg=dict(type='dict',exact_match=dict(type='bool',),l_ext=dict(type='int',))),origin=dict(type='dict',egp=dict(type='bool',),incomplete=dict(type='bool',),igp=dict(type='bool',)),group=dict(type='dict',group_id=dict(type='int',),ha_state=dict(type='str',choices=['active','standby'])),uuid=dict(type='str',),ip=dict(type='dict',peer=dict(type='dict',acl1=dict(type='int',),acl2=dict(type='int',),name=dict(type='str',)),next_hop=dict(type='dict',acl1=dict(type='int',),acl2=dict(type='int',),name=dict(type='str',),prefix_list_1=dict(type='dict',name=dict(type='str',))),address=dict(type='dict',acl1=dict(type='int',),acl2=dict(type='int',),prefix_list=dict(type='dict',name=dict(type='str',)),name=dict(type='str',))),metric=dict(type='dict',value=dict(type='int',)),as_path=dict(type='dict',name=dict(type='str',)),community=dict(type='dict',l_std_cfg=dict(type='dict',exact_match=dict(type='bool',),l_std=dict(type='int',)),name_cfg=dict(type='dict',exact_match=dict(type='bool',),name=dict(type='str',)),l_ext_cfg=dict(type='dict',exact_match=dict(type='bool',),l_ext=dict(type='int',))),local_preference=dict(type='dict',val=dict(type='int',)),route_type=dict(type='dict',external=dict(type='dict',value=dict(type='str',choices=['type-1','type-2']))),tag=dict(type='dict',value=dict(type='int',)),ipv6=dict(type='dict',next_hop_1=dict(type='dict',prefix_list_name=dict(type='str',),v6_addr=dict(type='str',),next_hop_acl_name=dict(type='str',)),peer_1=dict(type='dict',acl1=dict(type='int',),acl2=dict(type='int',),name=dict(type='str',)),address_1=dict(type='dict',name=dict(type='str',),prefix_list_2=dict(type='dict',name=dict(type='str',)))),interface=dict(type='dict',ethernet=dict(type='str',),loopback=dict(type='int',),ve=dict(type='int',),trunk=dict(type='int',)))
    ))
