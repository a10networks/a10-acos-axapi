...
options:
    ...
    action:
        description:
            - 'permit': Route map permits set operations; 'deny': Route map denies set operations; choices:['permit', 'deny']
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        action=dict(
            type='enum' , required=True, choices=['permit', 'deny']
        ),
        match=dict(
            type='str' 
        ),
