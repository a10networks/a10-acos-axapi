...
options:
    ...
    service-type:
        description:
            - 'tcp': TCP Protocol; 'udp': UDP Protocol; choices:['tcp', 'udp']
    ...
    timeout-type:
        description:
            - 'age': Expiration time; 'fast': Use Fast aging; choices:['age', 'fast']
