...
options:
    ...
    forward-traffic:
        description:
            - 'forward-all-traffic': Forward all traffic between bridge members; 'forward-ip-traffic': Forward only IP traffic between bridge members (default); choices:['forward-all-traffic', 'forward-ip-traffic']
