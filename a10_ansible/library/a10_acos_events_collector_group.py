...
options:
    ...
    format:
        description:
        - "'syslog'= log message format is syslog; 'cef'= log message format is cef; 'leef'= log message format is leef; "
        required: False
    rate:
        description:
    ...
    sampling_enable:
        ...
        suboptions:
            counters1:
                description:
                - "'all'= all; 'msgs_sent'= Number of log messages sent; 'msgs_rate_limited'= Number of rate limted log messages; 'msgs_dropped'= Number of messages droppped for other reasons; "
    log_server_list:
        description:
