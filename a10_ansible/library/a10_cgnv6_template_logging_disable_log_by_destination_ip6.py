...
short_description: Configures A10 cgnv6.template.logging.disable.log.by.destination.ip6
        ...
        for k, v in payload["ip6"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["ip6"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["ip6"][k] = v
