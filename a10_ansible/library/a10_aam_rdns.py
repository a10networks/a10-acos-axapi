...
description:
    - Field rdns
short_description: Configures A10 aam.rdns
...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict', entry_list=dict(type='list', domain=dict(type='str', ), address=dict(type='str', ), ntype=dict(type='str', ), ttl=dict(type='int', ))),
        uuid=dict(type='str', )
    ))
