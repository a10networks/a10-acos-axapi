...
short_description: Configures A10 router.isis.redistribute
...
options:
    ...
    redist_list:
        ...
        suboptions:
            ...
            ntype:
                description:
                - "'bgp'= Border Gateway Protocol (BGP); 'connected'= Connected; 'floating-ip'= Floating IP; 'ip-nat-list'= IP NAT list; 'ip-nat'= IP NAT; 'lw4o6'= LW4O6 Prefix; 'nat-map'= NAT MAP Prefix; 'ospf'= Open Shortest Path First (OSPF); 'rip'= Routing Information Protocol (RIP); 'static'= Static routes; "
            metric_type:
                description:
                - "'external'= Set IS-IS External metric type; 'internal'= Set IS-IS Internal metric type; "
            level:
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        redist_list=dict(type='list',metric=dict(type='int',),route_map=dict(type='str',),ntype=dict(type='str',choices=['bgp','connected','floating-ip','ip-nat-list','ip-nat','lw4o6','nat-map','ospf','rip','static']),metric_type=dict(type='str',choices=['external','internal']),level=dict(type='str',choices=['level-1','level-1-2','level-2'])),
