...
short_description: Configures A10 cgnv6.map.encapsulation.domain.basic.mapping.rule.prefix-rule
        ...
        for k, v in payload["prefix-rule"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["prefix-rule"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["prefix-rule"][k] = v
