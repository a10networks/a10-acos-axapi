...
short_description: Configures A10 multi-ctrl-cpu
        ...
        for k, v in payload["multi-ctrl-cpu"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["multi-ctrl-cpu"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["multi-ctrl-cpu"][k] = v
...
def present(module, result, existing_config):
    payload = build_json("multi-ctrl-cpu", module)
