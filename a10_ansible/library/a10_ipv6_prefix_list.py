...
short_description: Configures A10 ipv6.prefix-list
...
options:
    ...
    rules:
        ...
        suboptions:
            ...
            any:
                description:
                - "Any prefix match. Same as '==0/0 le le 128'"
    name:
        description:
        ...
        for k, v in payload["prefix-list"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["prefix-list"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["prefix-list"][k] = v
