...
short_description: Configures A10 cgnv6.fixed.nat.inside.iplist
...
AVAILABLE_PROPERTIES = ["dest_rule_list","dynamic_pool_size","inside_ip_list","method","nat_end_address","nat_ip_list","nat_netmask","nat_start_address","offset","ports_per_user","respond_to_user_mac","session_quota","usable_nat_ports","uuid","vrid",]
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        inside_ip_list=dict(type='str',required=True,),
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/fixed-nat/inside/iplist/{inside-ip-list}"

    f_dict = {}
    f_dict["inside-ip-list"] = module.params["inside_ip_list"]
