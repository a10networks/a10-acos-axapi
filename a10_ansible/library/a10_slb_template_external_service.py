...
options:
    ...
    failure-action:
        description:
            - 'continue': Continue; 'drop': Drop; 'reset': Reset; choices:['continue', 'drop', 'reset']
    ...
    type:
        description:
            - 'skyfire-icap': Skyfire ICAP service; 'url-filter': URL filtering service; choices:['skyfire-icap', 'url-filter']
