...
def get_argspec():
    ...
    rv.update(dict(
        ...
        dns=dict(type='dict',cache_action=dict(type='str',choices=['cache-disable','cache-enable']),ttl=dict(type='int',),weight=dict(type='int',),honor_server_response_ttl=dict(type='bool',)),
        uuid=dict(type='str',),
