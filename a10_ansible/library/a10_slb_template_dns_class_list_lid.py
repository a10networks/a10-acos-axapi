...
description:
    - Limit ID
short_description: Configures A10 slb.template.dns.class-list.lid
...
def get_argspec():
    ...
    rv.update(dict(
        ...
        dns=dict(type='dict',cache_action=dict(type='str',choices=['cache-disable','cache-enable']),honor_server_response_ttl=dict(type='bool',),weight=dict(type='int',),ttl=dict(type='int',)),
