...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_pop3_vport_tmpl_trigger_stats_rate
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/pop3-vport-tmpl/{pop3_vport_tmpl_name}/trigger-stats-rate"
