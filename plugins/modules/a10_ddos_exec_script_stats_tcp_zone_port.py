...
DOCUMENTATION = r'''
module: a10_ddos_exec_script_stats_tcp_zone_port
description:
    - Statistics for the object exec-script
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/exec-script/stats?tcp-zone-port=true"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["exec-script"]["stats"] if info != "NotFound" else info
