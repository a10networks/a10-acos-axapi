...
def get_argspec():
    ...
    rv.update({'toggle': {'type': 'str', 'choices': ['enable', 'disable']},
        'logging_action': {'type': 'str', 'choices': ['enable', 'disable']},
        'enable_action': {'type': 'str', 'choices': ['local', 'remote', 'both']},
        'packets_per_second': {'type': 'dict', 'ip': {'type': 'int', }, 'action': {'type': 'dict', 'action_type': {'type': 'str', 'choices': ['log', 'drop', 'redistribute-route']}, 'route_map': {'type': 'str', }, 'expiration': {'type': 'int', }, 'timer_multiply_max': {'type': 'int', }, 'remove_wait_timer': {'type': 'int', }}, 'tcp': {'type': 'int', }, 'tcp_action': {'type': 'dict', 'tcp_action_type': {'type': 'str', 'choices': ['log', 'drop']}, 'tcp_expiration': {'type': 'int', }}, 'udp': {'type': 'int', }, 'udp_action': {'type': 'dict', 'udp_action_type': {'type': 'str', 'choices': ['log', 'drop']}, 'udp_expiration': {'type': 'int', }}, 'other': {'type': 'int', }, 'other_action': {'type': 'dict', 'other_action_type': {'type': 'str', 'choices': ['log', 'drop']}, 'other_expiration': {'type': 'int', }}, 'include_existing_session': {'type': 'bool', }},
        'syn_cookie': {'type': 'dict', 'syn_cookie_enable': {'type': 'bool', }, 'syn_cookie_on_threshold': {'type': 'int', }, 'syn_cookie_on_timeout': {'type': 'int', }},
