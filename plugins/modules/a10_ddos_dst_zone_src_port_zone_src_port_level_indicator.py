...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_zone_src_port_level_indicator
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(level_num=dict(type='str', required=True), protocol=dict(type='str', required=True), zone_src_port_port_num=dict(type='str', required=True), zone_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port/{zone_src_port_port_num}+{protocol}/level/{level_num}/indicator/{type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port/{zone_src_port_port_num}+{protocol}/level/{level_num}/indicator"
