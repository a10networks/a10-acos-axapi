...
def get_argspec():
    ...
    rv.update({'background': {'type': 'dict', 'bgfile': {'type': 'str', }, 'bgstyle': {'type': 'str', 'choices': ['tile', 'stretch', 'fit']}, 'bgcolor_name': {'type': 'str', 'choices': ['aqua', 'black', 'blue', 'fuchsia', 'gray', 'green', 'lime', 'maroon', 'navy', 'olive', 'orange', 'purple', 'red', 'silver', 'teal', 'white', 'yellow']}, 'bgcolor_value': {'type': 'str', }},
        ...
        'enable_CAPTCHA': {'type': 'bool', },
        'captcha_type': {'type': 'str', 'choices': ['reCAPTCHAv2-checkbox', 'reCAPTCHAv2-invisible', 'reCAPTCHAv3']},
        'site_key_string': {'type': 'str', },
        'encrypted': {'type': 'str', },
        'reCAPTCHA_cfg': {'type': 'dict', 'reCAPTCHA_theme': {'type': 'str', 'choices': ['light', 'dark']}, 'reCAPTCHA_size': {'type': 'str', 'choices': ['normal', 'compact']}, 'reCAPTCHA_badge': {'type': 'str', 'choices': ['bottom-left', 'bottom-right']}, 'reCAPTCHA_action': {'type': 'str', }},
