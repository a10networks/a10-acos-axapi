...
def present(module, result, existing_config):
    payload = utils.build_json("identity-provider", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "identity-provider"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "identity-provider-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["identity-provider"][
