...
AVAILABLE_PROPERTIES = ["cgnv6", "cgnv6_ds_lite", "cgnv6_ds_lite_lsn_lid", "cgnv6_lsn_lid", "cgnv6_policy", "deny_log", "forward", "inspect_payload", "ipsec", "listen_on_port", "permit_limit_policy", "permit_log", "permit_respond_to_user_mac", "reset_log", "reset_respond_to_user_mac", "ntype", "uuid", "vpn_ipsec_name", ]
...
def get_argspec():
    ...
    rv.update({'ntype': {'type': 'str', 'choices': ['permit', 'deny', 'reset']},
        'permit_log': {'type': 'bool', },
        'reset_log': {'type': 'bool', },
        'deny_log': {'type': 'bool', },
        ...
        'permit_limit_policy': {'type': 'int', },
        'permit_respond_to_user_mac': {'type': 'bool', },
        'reset_respond_to_user_mac': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/rule-set/{rule_set_name}/rule/{name}/action-group"
