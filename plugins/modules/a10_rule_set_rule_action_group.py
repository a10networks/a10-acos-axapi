...
AVAILABLE_PROPERTIES = [
    ...
    "permit_respond_to_user_mac", "reset_fw_log", "reset_log", "reset_log_template_type", "reset_respond_to_user_mac", "set_dscp", "skip_urpf_check", "syn_cookie", "syn_cookie_enable", "tcp", "threshold_val", "ntype", "uuid", "vpn_ipsec_group_name", "vpn_ipsec_name",
    ]
