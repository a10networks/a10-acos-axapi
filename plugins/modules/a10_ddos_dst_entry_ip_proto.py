...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_ip_proto
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/ip-proto/{port_num}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/ip-proto"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ip-proto"]["oper"] if info != "NotFound" else info
