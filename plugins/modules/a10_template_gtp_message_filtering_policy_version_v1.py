...
def get_argspec():
    ...
    rv.update({'enable_disable_action': {'type': 'str', 'required': True, 'choices': ['enable', 'disable']},
        ...
        'initiate_pdp': {'type': 'str', 'choices': ['enable', 'disable']},
        'pdu_notification': {'type': 'str', 'choices': ['enable', 'disable']},
        'ms_info_change': {'type': 'str', 'choices': ['enable', 'disable']},
        'gtp_pdu': {'type': 'str', 'choices': ['enable', 'disable']},
        'mbms_session': {'type': 'str', 'choices': ['enable', 'disable']},
        'mbms_notification': {'type': 'str', 'choices': ['enable', 'disable']},
        'mbms_registration': {'type': 'str', 'choices': ['enable', 'disable']},
        'mbms_deregistration': {'type': 'str', 'choices': ['enable', 'disable']},
        'create_mbms': {'type': 'str', 'choices': ['enable', 'disable']},
        'delete_mbms': {'type': 'str', 'choices': ['enable', 'disable']},
        'update_mbms': {'type': 'str', 'choices': ['enable', 'disable']},
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/template/gtp/message-filtering-policy/{message_filtering_policy_name}/version-v1"
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["version-v1"].items():
        v = 1 if str(v).lower() == "true" else v
        v = 0 if str(v).lower() == "false" else v

        if config_changes["version-v1"].get(k) != v:
            change_results["changed"] = True
            config_changes["version-v1"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("version-v1", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["version-v1"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["version-v1-list"] if info != "NotFound" else info
