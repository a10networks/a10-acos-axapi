...
def existing_url(module):
    ...
    if '/' in module.params["message_filtering_policy_name"]:
        f_dict["message_filtering_policy_name"] = module.params[
            "message_filtering_policy_name"].replace("/", "%2F")
    else:
        f_dict["message_filtering_policy_name"] = module.params[
            "message_filtering_policy_name"]
...
def present(module, result, existing_config):
    payload = utils.build_json("version-v1", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "version-v1"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "version-v1-list"] if info != "NotFound" else info
