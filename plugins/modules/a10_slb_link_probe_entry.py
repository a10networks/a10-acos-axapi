        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'total_ready_to_free', 'total_freed',
                    'err_entry_create_failed', 'err_entry_create_oom',
                    'err_entry_insert_failed', 'err_tmpl_probe_create_failed',
                    'err_tmpl_probe_create_oom', 'total_http_probes_sent',
                    'total_http_response_received', 'total_http_response_good',
                    'total_http_response_bad', 'total_tcp_err',
                    'err_smart_nat_alloc', 'err_smart_nat_port_alloc',
                    'err_l4_sess_alloc', 'err_probe_tcp_conn_send',
                    'probe_tcp_conn_sent'
                ]
            }
        },
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "entry"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "entry-list"] if info != "NotFound" else info
