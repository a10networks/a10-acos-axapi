...
AVAILABLE_PROPERTIES = [
    "age", "apply_policy_on_overflow", "deny", "drop_frag_pkt", "dynamic_entry_overflow_policy_list", "enable_class_list_overflow", "enable_top_k", "enable_top_k_destination", "esp_inspect", "faster_de_escalation", "glid_cfg", "level_list", "manual_mode_enable", "manual_mode_list", "max_dynamic_entry_count", "oper", "port_ind",
    "progression_tracking", "protocol_num", "set_counter_base_val", "src_based_policy_list", "topk_destinations", "topk_dst_num_records", "topk_num_records", "topk_sources", "unlimited_dynamic_entry_count", "uuid",
    ]
