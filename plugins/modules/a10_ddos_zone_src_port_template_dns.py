...
DOCUMENTATION = r'''
module: a10_ddos_zone_src_port_template_dns
description:
...
AVAILABLE_PROPERTIES = ["name", "query_resolution_check", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-src-port-template/dns/{name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-src-port-template/dns"
