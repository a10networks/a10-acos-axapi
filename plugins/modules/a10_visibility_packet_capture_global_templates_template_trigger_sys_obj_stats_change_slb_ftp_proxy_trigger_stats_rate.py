...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_ftp_proxy_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["auth_fail", "bad_sequence", "cant_find_eprt", "cant_find_port", "cl_est_err", "cl_request_err", "data_conn_start_err", "data_send_fail", "data_serv_connected_err", "data_serv_connecting_err", "data_server_conn_fail", "ds_fail", "duration", "insert_tuple_fail", "invalid_start_line", "line_too_long", "no_route", "rsv_persist_conn_fail", "ser_connecting_err", "server_response_err", "smp_create_fail", "smp_v4_fail", "smp_v6_fail", "snat_fail", "svrsel_fail", "threshold_exceeded_by", "unsupported_command", "unsupported_pbsz_value", "unsupported_prot_value", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'svrsel_fail': {'type': 'bool', },
        'no_route': {'type': 'bool', },
        'snat_fail': {'type': 'bool', },
        'line_too_long': {'type': 'bool', },
        'invalid_start_line': {'type': 'bool', },
        'smp_create_fail': {'type': 'bool', },
        'data_server_conn_fail': {'type': 'bool', },
        'data_send_fail': {'type': 'bool', },
        'unsupported_pbsz_value': {'type': 'bool', },
        'unsupported_prot_value': {'type': 'bool', },
        'unsupported_command': {'type': 'bool', },
        'bad_sequence': {'type': 'bool', },
        'rsv_persist_conn_fail': {'type': 'bool', },
        'smp_v6_fail': {'type': 'bool', },
        'smp_v4_fail': {'type': 'bool', },
        'insert_tuple_fail': {'type': 'bool', },
        'cl_est_err': {'type': 'bool', },
        'ser_connecting_err': {'type': 'bool', },
        'server_response_err': {'type': 'bool', },
        'cl_request_err': {'type': 'bool', },
        'data_conn_start_err': {'type': 'bool', },
        'data_serv_connecting_err': {'type': 'bool', },
        'data_serv_connected_err': {'type': 'bool', },
        'auth_fail': {'type': 'bool', },
        'ds_fail': {'type': 'bool', },
        'cant_find_port': {'type': 'bool', },
        'cant_find_eprt': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-ftp-proxy/trigger-stats-rate"
