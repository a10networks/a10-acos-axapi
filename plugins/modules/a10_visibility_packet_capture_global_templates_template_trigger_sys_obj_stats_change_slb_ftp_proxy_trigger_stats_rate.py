...
AVAILABLE_PROPERTIES = [
    "auth_fail", "bad_sequence", "cant_find_eprt", "cant_find_port", "cl_est_err", "cl_request_err", "data_conn_start_err", "data_send_fail", "data_serv_connected_err", "data_serv_connecting_err", "data_server_conn_fail", "ds_fail", "duration", "insert_tuple_fail", "invalid_start_line",
    "line_too_long", "no_route", "rsv_persist_conn_fail", "ser_connecting_err", "server_response_err", "smp_create_fail", "smp_v4_fail", "smp_v6_fail", "snat_fail", "svrsel_fail", "threshold_exceeded_by", "unsupported_command", "unsupported_pbsz_value", "unsupported_prot_value", "uuid",
    ]
