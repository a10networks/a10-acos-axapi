...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'icmp-unknown-type', 'icmp-no-port-info', 'icmp-no-session-drop', 'icmpv6-unknown-type', 'icmpv6-no-port-info', 'icmpv6-no-session-drop', 'icmp-to-icmp', 'icmp-to-icmpv6', 'icmpv6-to-icmp', 'icmpv6-to-icmpv6', 'icmp-bad-type', 'icmpv6-bad-type', '64-known-drop', '64-unknown-drop', '64-midpoint-hop', '46-known-drop', '46-unknown-drop', '46-no-prefix-for-ipv4', '46-bad-encap-ip-header-len', 'icmp-to-icmp-err', 'icmp-to-icmpv6-err', 'icmpv6-to-icmp-err', 'icmpv6-to-icmpv6-err', 'encap-cross-cpu-no-match', 'encap-cross-cpu-preprocess-err', 'icmp-to-icmp-unknown-l4', 'icmp-to-icmpv6-unknown-l4', 'icmpv6-to-icmp-unknown-l4', 'icmpv6-to-icmpv6-unknown-l4', 'static-nat', 'echo-to-pool-reply', 'echo-to-pool-drop', 'error-to-pool-drop', 'echo-to-pool-reply-v6', 'echo-to-pool-drop-v6', 'error-to-pool-drop-v6', 'error-ip-mismatch']}},
        'stats': {'type': 'dict', 'icmp_unknown_type': {'type': 'str', }, 'icmp_no_port_info': {'type': 'str', }, 'icmp_no_session_drop': {'type': 'str', }, 'icmpv6_unknown_type': {'type': 'str', }, 'icmpv6_no_port_info': {'type': 'str', }, 'icmpv6_no_session_drop': {'type': 'str', }, 'icmp_to_icmp': {'type': 'str', }, 'icmp_to_icmpv6': {'type': 'str', }, 'icmpv6_to_icmp': {'type': 'str', }, 'icmpv6_to_icmpv6': {'type': 'str', }, 'icmp_bad_type': {'type': 'str', }, 'icmpv6_bad_type': {'type': 'str', }, '64_known_drop': {'type': 'str', }, '64_unknown_drop': {'type': 'str', }, '64_midpoint_hop': {'type': 'str', }, '46_known_drop': {'type': 'str', }, '46_unknown_drop': {'type': 'str', }, '46_no_prefix_for_ipv4': {'type': 'str', }, 'icmp_to_icmp_err': {'type': 'str', }, 'icmp_to_icmpv6_err': {'type': 'str', }, 'icmpv6_to_icmp_err': {'type': 'str', }, 'icmpv6_to_icmpv6_err': {'type': 'str', }}
    })
    return rv
