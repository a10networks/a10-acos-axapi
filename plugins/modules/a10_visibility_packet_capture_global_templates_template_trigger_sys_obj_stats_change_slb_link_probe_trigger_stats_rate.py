...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_link_probe_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "err_entry_create_failed", "err_entry_create_oom", "err_entry_insert_failed", "err_l4_sess_alloc", "err_probe_tcp_conn_send", "err_smart_nat_alloc", "err_smart_nat_port_alloc", "err_tmpl_probe_create_failed", "err_tmpl_probe_create_oom", "threshold_exceeded_by", "total_http_response_bad", "total_tcp_err", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'err_entry_create_failed': {'type': 'bool', },
        'err_entry_create_oom': {'type': 'bool', },
        'err_entry_insert_failed': {'type': 'bool', },
        'err_tmpl_probe_create_failed': {'type': 'bool', },
        'err_tmpl_probe_create_oom': {'type': 'bool', },
        'total_http_response_bad': {'type': 'bool', },
        'total_tcp_err': {'type': 'bool', },
        'err_smart_nat_alloc': {'type': 'bool', },
        'err_smart_nat_port_alloc': {'type': 'bool', },
        'err_l4_sess_alloc': {'type': 'bool', },
        'err_probe_tcp_conn_send': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-link-probe/trigger-stats-rate"
