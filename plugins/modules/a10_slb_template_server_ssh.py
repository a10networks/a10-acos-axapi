...
def present(module, result, existing_config):
    payload = utils.build_json("server-ssh", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "server-ssh"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "server-ssh-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["server-ssh"][
