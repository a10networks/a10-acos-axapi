...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', }, 'oper': {'type': 'dict', 'ocsp_list': {'type': 'list', 'subject': {'type': 'str', }, 'issuer': {'type': 'str', }, 'validity': {'type': 'str', }, 'certificate_status': {'type': 'str', }}, 'total_ocsps': {'type': 'int', }}})
    return rv
