...
AVAILABLE_PROPERTIES = ["base", "cn_value", "dn_value", "domain", "domain_cfg", "group", "ipv6_addr", "ipv6_addr_cfg", "port_cfg", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'ipv6_addr': {'type': 'str', 'required': True, },
        'domain': {'type': 'str', },
        'ipv6_addr_cfg': {'type': 'dict', 'port': {'type': 'int', }, 'ssl': {'type': 'bool', }, 'timeout': {'type': 'int', }},
        'cn_value': {'type': 'str', },
        'group': {'type': 'str', },
        'base': {'type': 'str', },
        'dn_value': {'type': 'str', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ldap-server/host/ipv6/{ipv6_addr}"
