...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_zone_src_port_stats_udp_zone_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port/{zone_src_port_port_num}+{protocol}/stats?udp-zone-port=true"
