...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'enqueue', 'enqueue-full', 'enqueue-error', 'dequeue', 'dequeue-error', 'raw-log', 'raw-log-error', 'log-summarized', 'l1-log-summarized', 'l2-log-summarized', 'log-summarized-error', 'aam-db', 'ep-db', 'fi-db', 'fw-db', 'aam-top-user-db', 'ep-top-user-db', 'ep-top-src-db', 'ep-top-dst-db', 'ep-top-domain-db', 'ep-top-web-category-db', 'ep-top-host-db', 'fi-top-src-db', 'fi-top-dst-db', 'fi-top-filename-db', 'fi-top-file-ext-db', 'fi-top-url-db', 'fw-top-app-db', 'fw-top-src-db', 'fw-top-app-src-db', 'fw-top-category-db', 'db-erro', 'query', 'response', 'query-error']}},
        'stats': {'type': 'dict', 'enqueue': {'type': 'str', }, 'enqueue_full': {'type': 'str', }, 'enqueue_error': {'type': 'str', }, 'dequeue': {'type': 'str', }, 'dequeue_error': {'type': 'str', }, 'raw_log': {'type': 'str', }, 'raw_log_error': {'type': 'str', }, 'log_summarized': {'type': 'str', }, 'l1_log_summarized': {'type': 'str', }, 'l2_log_summarized': {'type': 'str', }, 'log_summarized_error': {'type': 'str', }, 'aam_db': {'type': 'str', }, 'ep_db': {'type': 'str', }, 'fi_db': {'type': 'str', }, 'fw_db': {'type': 'str', }, 'aam_top_user_db': {'type': 'str', }, 'ep_top_user_db': {'type': 'str', }, 'ep_top_src_db': {'type': 'str', }, 'ep_top_dst_db': {'type': 'str', }, 'ep_top_domain_db': {'type': 'str', }, 'ep_top_web_category_db': {'type': 'str', }, 'ep_top_host_db': {'type': 'str', }, 'fi_top_src_db': {'type': 'str', }, 'fi_top_dst_db': {'type': 'str', }, 'fi_top_filename_db': {'type': 'str', }, 'fi_top_file_ext_db': {'type': 'str', }, 'fi_top_url_db': {'type': 'str', }, 'fw_top_app_db': {'type': 'str', }, 'fw_top_src_db': {'type': 'str', }, 'fw_top_app_src_db': {'type': 'str', }, 'fw_top_category_db': {'type': 'str', }, 'db_erro': {'type': 'str', }, 'query': {'type': 'str', }, 'response': {'type': 'str', }, 'query_error': {'type': 'str', }}
    })
    return rv
