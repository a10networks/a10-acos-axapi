...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_ds_lite_global_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["fullcone_failure", "nat_port_unavailable_icmp", "nat_port_unavailable_tcp", "nat_port_unavailable_udp", "user_quota_failure", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'user_quota_failure': {'type': 'bool', }, 'nat_port_unavailable_tcp': {'type': 'bool', }, 'nat_port_unavailable_udp': {'type': 'bool', }, 'nat_port_unavailable_icmp': {'type': 'bool', }, 'fullcone_failure': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-ds-lite-global/trigger-stats-inc"
