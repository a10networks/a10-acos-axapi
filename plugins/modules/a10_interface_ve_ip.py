...
AVAILABLE_PROPERTIES = ["address_list", "allow_promiscuous_vip", "client", "dhcp", "dmz", "generate_membership_query", "helper_address_list", "inside", "max_resp_time", "ospf", "outside", "query_interval", "rip", "router", "server", "slb_partition_redirect", "syn_cookie", "ttl_ignore", "unnumbered", "uuid", ]
