...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_level
description:
...
AVAILABLE_PROPERTIES = [
    "apply_extracted_filters", "clear_sources_upon_deescalation", "close_sessions_for_all_sources", "close_sessions_for_unauth_sources", "glid_action", "indicator_list", "level_num", "src_default_glid", "src_escalation_score", "src_violation_actions", "start_pattern_recognition", "start_signature_extraction", "user_tag", "uuid",
    "zone_escalation_score", "zone_template", "zone_violation_actions",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service/{zone_service_port_num}+{protocol}/level/{level_num}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service/{zone_service_port_num}+{protocol}/level"
