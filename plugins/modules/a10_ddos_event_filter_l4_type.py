...
DOCUMENTATION = r'''
module: a10_ddos_event_filter_l4_type
description:
    - DDOS L4 type event
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["out_of_seq", "protocol", "retrans_syn_cfg", "tcp_auth", "udp_auth", "user_tag", "uuid", "zero_window", ]
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(event_filter_filter_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/event-filter/{event_filter_filter_name}/l4-type/{protocol}"
    ...
    if '/' in module.params["event_filter_filter_name"]:
        f_dict["event_filter_filter_name"] = module.params["event_filter_filter_name"].replace("/", "%2F")
    else:
        f_dict["event_filter_filter_name"] = module.params["event_filter_filter_name"]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/event-filter/{event_filter_filter_name}/l4-type"
