...
DOCUMENTATION = r'''
module: a10_aam_authentication_captcha_instance
description:
    - CAPTCHA Profile
...
AVAILABLE_PROPERTIES = ["client_ip_param_name", "encrypted", "method", "name", "resp_error_code_field_name", "resp_result_field_name", "secret_key", "secret_key_param_name", "secret_key_string", "send_client_ip", "stats", "timeout", "token_param_name", "url", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'secret_key': {'type': 'bool', },
        'secret_key_string': {'type': 'str', },
        'encrypted': {'type': 'str', },
        'url': {'type': 'str', },
        'method': {'type': 'str', 'choices': ['POST', 'GET']},
        'timeout': {'type': 'int', },
        'secret_key_param_name': {'type': 'str', },
        'token_param_name': {'type': 'str', },
        'resp_result_field_name': {'type': 'str', },
        'resp_error_code_field_name': {'type': 'str', },
        'send_client_ip': {'type': 'bool', },
        'client_ip_param_name': {'type': 'str', },
        'uuid': {'type': 'str', },
        'stats': {'type': 'dict', 'request': {'type': 'str', }, 'verify_succ': {'type': 'str', }, 'parse_fail': {'type': 'str', }, 'json_fail': {'type': 'str', }, 'attr_fail': {'type': 'str', }, 'timeout_error': {'type': 'str', }, 'other_error': {'type': 'str', }, 'name': {'type': 'str', 'required': True, }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/aam/authentication/captcha/instance/{name}"
