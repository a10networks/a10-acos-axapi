...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_system_tcp_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["attemptfails", "noroute", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'attemptfails': {'type': 'bool', }, 'noroute': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/system-tcp/trigger-stats-inc"
