...
def get_argspec():
    ...
    rv.update({'all': {'type': 'bool', }, 'zone': {'type': 'bool', }, 'site': {'type': 'bool', }, 'group': {'type': 'bool', }, 'service_ip': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    return rv
...
def present(module, result, existing_config):
    payload = utils.build_json("gslb", module.params, AVAILABLE_PROPERTIES)
