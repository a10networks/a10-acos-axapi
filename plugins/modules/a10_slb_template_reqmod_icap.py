...
AVAILABLE_PROPERTIES = [
    "action", "allowed_http_methods", "bypass_ip_cfg", "disable_http_server_reset", "fail_close", "failure_action", "include_protocol_in_uri", "log_only_allowed_method", "logging", "min_payload_size", "name", "preview", "server_ssl", "service_group", "service_url",
    "shared_partition_persist_source_ip_template", "shared_partition_tcp_proxy_template", "source_ip", "tcp_proxy", "template_persist_source_ip_shared", "template_tcp_proxy_shared", "timeout", "user_tag", "uuid", "x_auth_url",
    ]
