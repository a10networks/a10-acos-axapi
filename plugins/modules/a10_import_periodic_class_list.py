...
AVAILABLE_PROPERTIES = ["class_list", "encrypted", "password", "period", "remote_file", "use_mgmt_port", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'class_list': {'type': 'str', 'required': True, }, 'user_tag': {'type': 'str', }, 'use_mgmt_port': {'type': 'bool', }, 'remote_file': {'type': 'str', }, 'period': {'type': 'int', }, 'password': {'type': 'str', }, 'encrypted': {'type': 'str', }, 'uuid': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    f_dict = {}
    if '/' in str(module.params["class_list"]):
        f_dict["class_list"] = module.params["class_list"].replace("/", "%2F")
    else:
