    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'query', 'query-bad-pkt', 'query-chg',
                    'query-parallel', 'query-passive', 'resp', 'resp-bad-pkt',
                    'resp-bad-qr', 'resp-chg', 'resp-err', 'resp-empty',
                    'resp-local', 'adjust', 'cache', 'drop'
                ]
            }
        },
        'stats': {
