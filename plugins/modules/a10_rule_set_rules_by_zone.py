...
def existing_url(module):
    ...
    if '/' in module.params["rule_set_name"]:
        f_dict["rule_set_name"] = module.params["rule_set_name"].replace(
            "/", "%2F")
    else:
...
def present(module, result, existing_config):
    payload = utils.build_json("rules-by-zone", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "rules-by-zone"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "rules-by-zone-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["rules-by-zone"][
