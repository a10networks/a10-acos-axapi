...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_lsn_alg_sip_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["method_unknown", "parse_error", "tcp_out_of_order_drop", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'method_unknown': {'type': 'bool', }, 'parse_error': {'type': 'bool', }, 'tcp_out_of_order_drop': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-lsn-alg-sip/trigger-stats-inc"
