...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_logging_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["conn_tcp_dropped", "log_dropped", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'log_dropped': {'type': 'bool', }, 'conn_tcp_dropped': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-logging/trigger-stats-inc"
