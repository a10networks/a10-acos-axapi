...
AVAILABLE_PROPERTIES = ["action", "dst_file", "file", "file_handle", "oper", "size", "uuid", "verify_xml_signature", ]
...
def get(module):
    ...
    if file_info:
        ...
        file_list = file_info["auth-saml-idp"]["oper"].get("file-list", [])
...
def present(module, result, existing_config):
    payload = build_json("auth-saml-idp", module)
