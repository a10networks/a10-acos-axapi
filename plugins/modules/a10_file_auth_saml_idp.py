...
def present(module, result, existing_config):
    payload = utils.build_json("auth-saml-idp", module.params,
                               AVAILABLE_PROPERTIES)
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(
            module.client, "auth-saml-idp", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "auth-saml-idp"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "auth-saml-idp-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["auth-saml-idp"][
