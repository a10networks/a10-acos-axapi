...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_system_hardware_accelerate_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "hw_fwd_flow_error_count", "hw_fwd_flow_seq_mismatch", "hw_fwd_flow_singlebit_errors", "hw_fwd_flow_tag_mismatch", "hw_fwd_flow_unalign_count", "hw_fwd_flow_underflow_count", "hw_fwd_prog_errors", "threshold_exceeded_by", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/system-hardware-accelerate/trigger-stats-rate"
