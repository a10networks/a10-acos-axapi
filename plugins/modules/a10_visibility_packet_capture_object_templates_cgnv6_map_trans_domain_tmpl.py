...
def present(module, result, existing_config):
    payload = utils.build_json("cgnv6-map-trans-domain-tmpl", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "cgnv6-map-trans-domain-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "cgnv6-map-trans-domain-tmpl-list"] if info != "NotFound" else info
