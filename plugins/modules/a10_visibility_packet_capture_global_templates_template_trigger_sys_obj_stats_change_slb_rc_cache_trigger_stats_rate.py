...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_rc_cache_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["content_toobig", "content_toosmall", "duration", "entry_create_failures", "rv_failure", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'rv_failure': {'type': 'bool', }, 'content_toobig': {'type': 'bool', }, 'content_toosmall': {'type': 'bool', }, 'entry_create_failures': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-rc-cache/trigger-stats-rate"
