...
DOCUMENTATION = r'''
module: a10_ddos_template_tcp_progression_tracking_mitigation_time_window_tracking
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/template/tcp/{tcp_name}/progression-tracking/mitigation/time-window-tracking"
