...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_lsn_alg_rtsp_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["no_session_mem", "port_allocation_failure", "stream_creation_failure", "unknown_client_port_from_server", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'stream_creation_failure': {'type': 'bool', }, 'port_allocation_failure': {'type': 'bool', }, 'unknown_client_port_from_server': {'type': 'bool', }, 'no_session_mem': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-lsn-alg-rtsp/trigger-stats-inc"
