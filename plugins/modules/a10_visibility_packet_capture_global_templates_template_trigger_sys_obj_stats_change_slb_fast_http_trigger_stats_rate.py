...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_fast_http_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "full_proxy_fpga_err", "fwdreq_fail", "fwdreqdata_fail", "parsereq_fail", "req_over_limit", "req_rate_over_limit", "snat_fail", "svrsel_fail", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'parsereq_fail': {'type': 'bool', },
        'svrsel_fail': {'type': 'bool', },
        'fwdreq_fail': {'type': 'bool', },
        'fwdreqdata_fail': {'type': 'bool', },
        'snat_fail': {'type': 'bool', },
        'full_proxy_fpga_err': {'type': 'bool', },
        'req_over_limit': {'type': 'bool', },
        'req_rate_over_limit': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-fast-http/trigger-stats-rate"
