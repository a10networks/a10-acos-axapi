...
def get_argspec():
    ...
    rv.update({'snmp': {'type': 'bool', },
        'snmp_port': {'type': 'int', },
        'community': {'type': 'str', },
        'oid': {'type': 'dict', 'mib': {'type': 'str', 'choices': ['sysDescr', 'sysUpTime', 'sysName']}, 'asn': {'type': 'str', }},
        'operation': {'type': 'dict', 'oper_type': {'type': 'str', 'choices': ['getnext', 'get']}},
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
