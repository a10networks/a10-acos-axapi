...
def present(module, result, existing_config):
    payload = utils.build_json("imap-proxy", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "imap-proxy"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "imap-proxy-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["imap-proxy"][
