...
AVAILABLE_PROPERTIES = ["action", "file_url", "name", "oper", "source_ip_address", "ntype", "use_mgmt_port", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'file_content': {'type': 'str', },'ntype': {'type': 'str', },
        'name': {'type': 'str', },
        ...
        'action': {'type': 'str', },
        'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'file_list': {'type': 'list', 'name': {'type': 'str', }, 'status': {'type': 'str', }, 'ntype': {'type': 'str', }, 'timestamp': {'type': 'str', }, 'size': {'type': 'str', }}}
    })
    return rv
...
def present(module, result, existing_config):
    payload = utils.build_json("data-file", module.params, AVAILABLE_PROPERTIES)
