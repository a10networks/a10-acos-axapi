...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_switch_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["lacp_tx_intf_err_drop", "unnumbered_nat_error", "unnumbered_unsupported_drop", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'lacp_tx_intf_err_drop': {'type': 'bool', }, 'unnumbered_nat_error': {'type': 'bool', }, 'unnumbered_unsupported_drop': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-switch/trigger-stats-inc"
