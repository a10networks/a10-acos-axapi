...
DOCUMENTATION = r'''
module: a10_slb_common_global_dns_cache_class_list_lid
description:
    - Limit ID
author: A10 Networks
options:
    ...
    over_limit_action:
        description:
        - "'ignore'= Ignore the limit and proceed; 'drop'= Drop the query when it exceeds
          limit;"
        type: str
        required: False
    lockout:
...
AVAILABLE_PROPERTIES = ["conn_rate_limit", "dns", "lidnum", "lockout", "log", "log_interval", "over_limit_action", "per", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/slb/common/global-dns-cache/class-list/lid/{lidnum}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/slb/common/global-dns-cache/class-list/lid"
