...
AVAILABLE_PROPERTIES = ["all", "gslb", "lldp", "lsn", "network", "routing", "scaleout", "slb", "slb_change", "snmp", "ssl", "system", "uuid", "vcs", "vrrp_a", ]
...
def get_argspec():
    ...
    rv.update({'all': {'type': 'bool', },
        ...
        'scaleout': {'type': 'dict', 'infrastructure': {'type': 'dict', 'all': {'type': 'bool', }, 'test_send_all_traps': {'type': 'bool', }, 'uuid': {'type': 'str', }, 'cluster': {'type': 'dict', 'single_node_mode': {'type': 'bool', }, 'election': {'type': 'bool', }, 'master_calling_re_election': {'type': 'bool', }, 'node_status': {'type': 'bool', }, 'uuid': {'type': 'str', }}, 'service_node': {'type': 'dict', 'local_device_disabled': {'type': 'bool', }, 'service_master': {'type': 'bool', }, 'traffic_map_update': {'type': 'bool', }, 'uuid': {'type': 'str', }}, 'master_node': {'type': 'dict', 'traffic_map_distribution': {'type': 'bool', }, 'vserver_traffic_map_update': {'type': 'bool', }, 'uuid': {'type': 'str', }}}},
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["traps"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["traps-list"] if info != "NotFound" else info
