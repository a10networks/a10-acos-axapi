...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'token_cached': {'type': 'int', }, 'token_cache_hit': {'type': 'int', }, 'max_token_cache': {'type': 'int', }, 'cache_list': {'type': 'list', 'cache_id': {'type': 'int', }, 'issuer': {'type': 'str', }, 'subject': {'type': 'str', }, 'audience': {'type': 'str', }, 'client_ip': {'type': 'str', }, 'ttl': {'type': 'int', }}, 'audience': {'type': 'str', }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/aam/authorization/jwt/cache"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["cache"]["oper"] if info != "NotFound" else info
