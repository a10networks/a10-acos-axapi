...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'dns64': {'type': 'dict', 'enable': {'type': 'bool', }, 'answer_only_disable': {'type': 'bool', }, 'auth_data': {'type': 'bool', }, 'cache': {'type': 'bool', }, 'change_query': {'type': 'bool', }, 'compress_disable': {'type': 'bool', }, 'deep_check_qr': {'type': 'bool', }, 'deep_check_rr_disable': {'type': 'bool', }, 'drop_cname_disable': {'type': 'bool', }, 'edns_append': {'type': 'bool', }, 'fast_append': {'type': 'bool', }, 'ignore_rcode3_disable': {'type': 'bool', }, 'max_qr_length': {'type': 'int', }, 'parallel_query': {'type': 'bool', }, 'passive_query_disable': {'type': 'bool', }, 'retry': {'type': 'int', }, 'single_response_disable': {'type': 'bool', }, 'timeout': {'type': 'int', }, 'trans_ptr': {'type': 'bool', }, 'trans_ptr_query': {'type': 'bool', }, 'ttl': {'type': 'int', }, 'uuid': {'type': 'str', }}
    })
    return rv
