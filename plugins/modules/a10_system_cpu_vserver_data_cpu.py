...
def present(module, result, existing_config):
    payload = utils.build_json("vserver-data-cpu", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "vserver-data-cpu"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "vserver-data-cpu-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["vserver-data-cpu"][
