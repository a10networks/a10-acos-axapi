...
options:
    ...
    idle_timeout:
        description:
        - "Idle Timeout (interval of 60 seconds), default 120 seconds (idle timeout in
          second, default 120)"
        type: int
        required: False
    ...
    receive_buffer:
        description:
        - "Receive buffer size in byte, default 200000 (Receive buffer size, default
          200000)"
        type: int
        required: False
    server_retry:
...
AVAILABLE_PROPERTIES = ["burst_len", "connection_id_length", "idle_timeout", "initial_wnd", "key_update_to_client", "key_update_to_server", "name", "receive_buffer", "server_retry", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/slb/template/quic/{name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/slb/template/quic"
