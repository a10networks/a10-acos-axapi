...
def get_argspec():
    ...
    rv.update({'identity_provider_limit': {'type': 'int', },
        'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'idp_limit_current': {'type': 'int', }, 'idp_limit_default': {'type': 'int', }, 'idp_limit_minimum': {'type': 'int', }, 'idp_limit_maximum': {'type': 'int', }}
    })
    return rv
