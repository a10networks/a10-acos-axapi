...
def get_argspec():
    ...
    rv.update({'tcp_idle_timeout': {'type': 'int', },
        ...
        'port_cfg': {'type': 'list', 'tcp_port': {'type': 'int', }, 'tcp_idle_timeout': {'type': 'int', }, 'half_open_idle_timeout': {'type': 'int', }, 'half_close_idle_timeout': {'type': 'int', }, 'force_delete_timeout': {'type': 'int', }, 'force_delete_timeout_100ms': {'type': 'int', }},
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
        session_aging_name=dict(type='str', required=True),
    ))
    return rv
...
def existing_url(module):
    ...
    f_dict = {}
    if '/' in module.params["session_aging_name"]:
        f_dict["session_aging_name"] = module.params["session_aging_name"].replace("/","%2F")
    else:
