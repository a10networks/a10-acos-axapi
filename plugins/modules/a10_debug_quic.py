...
AVAILABLE_PROPERTIES = ["dummy", "level", "tls", "tls_level", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'dummy': {'type': 'bool', }, 'level': {'type': 'int', }, 'tls': {'type': 'bool', }, 'tls_level': {'type': 'int', }, 'uuid': {'type': 'str', }})
    return rv
