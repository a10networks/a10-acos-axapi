...
DOCUMENTATION = r'''
module: a10_ddos_network_object_ipv6
description:
...
AVAILABLE_PROPERTIES = ["prefix_anomaly_threshold", "sampling_enable", "src_port_list", "stats", "subnet_ipv6_addr", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object/{network_object_object_name}/ipv6/{subnet_ipv6_addr}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object/{network_object_object_name}/ipv6"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["ipv6"]["stats"] if info != "NotFound" else info
