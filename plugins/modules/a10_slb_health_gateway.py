...
def present(module, result, existing_config):
    payload = utils.build_json("health-gateway", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "health-gateway"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "health-gateway-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["health-gateway"][
