...
DOCUMENTATION = r'''
module: a10_ddos_detection_settings_standalone_settings_netflow
description:
    - Configure Netflow parameters for flow based detection
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/detection/settings/standalone-settings/netflow"
