...
def get_argspec():
    ...
    rv.update({'file_path': {'type': 'str', },'file': {'type': 'str', },
        ...
        'dst_file': {'type': 'str', },
        'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'file_list': {'type': 'list', 'file': {'type': 'str', }, 'parent': {'type': 'str', }}}
    })
    return rv
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(
            module.client, "dnssec-dnskey", file_url,
            module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["dnssec-dnskey"]["oper"] if info != "NotFound" else info
