...
AVAILABLE_PROPERTIES = ["aflex_table_entry_aging_interval", "aflex_table_entry_sync", "after_disable", "allow_in_gateway_mode", "auto_nat_no_ip_refresh", "auto_translate_port", "buff_thresh", "buff_thresh_hw_buff", "buff_thresh_relieve_thresh", "buff_thresh_sys_buff_high", "buff_thresh_sys_buff_low", "compress_block_size", "conn_rate_limit", "ddos_pkt_count_thresh", "ddos_pkt_size_thresh", "ddos_protection", "disable_adaptive_resource_check", "disable_persist_scoring", "disable_port_masking", "disable_server_auto_reselect", "dns_cache_age", "dns_cache_age_min_threshold", "dns_cache_enable", "dns_cache_entry_size", "dns_response_rate_limiting", "dns_vip_stateless", "drop_icmp_to_vip_when_vip_down", "dsr_health_check_enable", "ecmp_hash", "enable_l7_req_acct", "entity", "exclude_destination", "extended_stats", "fast_path_disable", "gateway_health_check", "graceful_shutdown", "graceful_shutdown_enable", "health_check_to_all_vip", "honor_server_response_ttl", "http_fast_enable", "hw_compression", "hw_syn_rr", "interval", "ipv4_offset", "l2l3_trunk_lb_disable", "log_for_reset_unknown_conn", "low_latency", "max_buff_queued_per_conn", "max_http_header_count", "max_local_rate", "max_remote_rate", "msl_time", "mss_table", "N5_new", "N5_old", "no_auto_up_on_aflex", "one_server_conn_hm_rate", "oper", "override_port", "per_thr_percent", "ping_sweep_detection", "pkt_rate_for_reset_unknown_conn", "player_id_check_enable", "port_scan_detection", "QAT", "range", "range_end", "range_start", "rate_limit_logging", "recursive_ns_cache", "reset_stale_session", "resolve_port_conflict", "response_type", "scale_out", "scale_out_traffic_map", "service_group_on_no_dest_nat_vports", "show_slb_server_legacy_cmd", "show_slb_service_group_legacy_cmd", "show_slb_virtual_server_legacy_cmd", "snat_gwy_for_l3", "snat_on_vip", "snat_preserve", "software", "software_tls13", "sort_res", "ssli_cert_not_ready_inspect_limit", "ssli_cert_not_ready_inspect_timeout", "ssli_sni_hash_enable", "stateless_sg_multi_binding", "stats_data_disable", "substitute_source_mac", "timeout", "traffic_map_type", "ttl_threshold", "use_default_sess_count", "use_mss_tab", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'port_scan_detection': {'type': 'str', 'choices': ['enable', 'disable']},
        ...
        'auto_translate_port': {'type': 'bool', },
        'range': {'type': 'int', },
        'range_start': {'type': 'int', },
        'range_end': {'type': 'int', },
        'use_default_sess_count': {'type': 'bool', },
        'per_thr_percent': {'type': 'int', },
        'dsr_health_check_enable': {'type': 'bool', },
        'one_server_conn_hm_rate': {'type': 'int', },
        'aflex_table_entry_aging_interval': {'type': 'int', },
        'override_port': {'type': 'bool', },
        'health_check_to_all_vip': {'type': 'bool', },
        ...
        'ddos_pkt_size_thresh': {'type': 'int', },
        'ddos_pkt_count_thresh': {'type': 'int', },
        ...
        'scale_out': {'type': 'bool', },
        'scale_out_traffic_map': {'type': 'bool', },
        'show_slb_server_legacy_cmd': {'type': 'bool', },
        'show_slb_service_group_legacy_cmd': {'type': 'bool', },
        'show_slb_virtual_server_legacy_cmd': {'type': 'bool', },
        'traffic_map_type': {'type': 'str', 'choices': ['vport', 'global']},
        'sort_res': {'type': 'bool', },
        ...
        'ssli_cert_not_ready_inspect_timeout': {'type': 'int', },
        'ssli_cert_not_ready_inspect_limit': {'type': 'int', },
        'software': {'type': 'bool', },
        'software_tls13': {'type': 'bool', },
        'QAT': {'type': 'bool', },
        'N5_new': {'type': 'bool', },
        'N5_old': {'type': 'bool', },
        ...
        'uuid': {'type': 'str', },
        'aflex_table_entry_sync': {'type': 'dict', 'aflex_table_entry_sync_enable': {'type': 'bool', }, 'aflex_table_entry_sync_max_key_len': {'type': 'int', }, 'aflex_table_entry_sync_max_value_len': {'type': 'int', }, 'aflex_table_entry_sync_min_lifetime': {'type': 'int', }, 'uuid': {'type': 'str', }},
