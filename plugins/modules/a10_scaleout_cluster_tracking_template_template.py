...
DOCUMENTATION = r'''
module: a10_scaleout_cluster_tracking_template_template
description:
...
def get_argspec():
    ...
    rv.update({'template': {'type': 'str', 'required': True, },
        'threshold_cfg': {'type': 'list', 'threshold': {'type': 'int', }, 'action': {'type': 'str', 'choices': ['down', 'exit-cluster']}},
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', }
    })
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/scaleout/cluster/{cluster_id}/tracking-template/template/{template}"
