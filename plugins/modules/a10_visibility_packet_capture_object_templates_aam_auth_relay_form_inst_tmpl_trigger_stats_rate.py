...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_aam_auth_relay_form_inst_tmpl_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["bad_req", "duration", "error", "invalid_cred", "invalid_srv_rsp", "not_fnd", "other_error", "post_fail", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'invalid_srv_rsp': {'type': 'bool', },
        'post_fail': {'type': 'bool', },
        'invalid_cred': {'type': 'bool', },
        'bad_req': {'type': 'bool', },
        'not_fnd': {'type': 'bool', },
        'error': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-relay-form-inst-tmpl/{aam_auth_relay_form_inst_tmpl_name}/trigger-stats-rate"
