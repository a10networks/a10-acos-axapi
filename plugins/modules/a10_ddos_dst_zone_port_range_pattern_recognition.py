...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_range_pattern_recognition
description:
...
AVAILABLE_PROPERTIES = ["algorithm", "app_payload_offset", "capture_traffic", "filter_inactive_threshold", "filter_threshold", "mode", "oper", "sensitivity", "triggered_by", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/pattern-recognition"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["pattern-recognition"]["oper"] if info != "NotFound" else info
