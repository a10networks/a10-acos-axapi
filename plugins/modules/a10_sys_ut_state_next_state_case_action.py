...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(case_number=dict(type='str', required=True), state_name=dict(type='str', required=True), ))
    return rv
...
def new_url(module):
    ...
    url_base = "/axapi/v3/sys-ut/state/{state_name}/next-state/{name}/case/{case_number}/action"
