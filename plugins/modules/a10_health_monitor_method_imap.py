...
description:
    - IMAP type
short_description: Configures A10 health.monitor.method.imap
...
options:
    ...
    monitor_name:
        description:
        - Key to identify parent object    imap_cram_md5:
        description:
    ...
    if existing_config:
        for k, v in payload["imap"].items():
            if isinstance(v, str):
                ...
                if existing_config["imap"][k] != v:
                    if result["changed"] is not True:
                        result["changed"] = True
                    existing_config["imap"][k] = v
