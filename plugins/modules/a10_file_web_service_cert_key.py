...
def get_argspec():
    ...
    rv.update({'file_content': {'type': 'str', },'file_handle': {'type': 'str', }
    })
    return rv
...
def get(module):
    ...
    if file_info:
        ...
        file_list = file_info["web-service-cert-key"]["oper"].get("file-list", [])
...
def present(module, result, existing_config):
    payload = build_json("web-service-cert-key", module)
