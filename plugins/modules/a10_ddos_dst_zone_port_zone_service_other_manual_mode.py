...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_other_manual_mode
description:
...
AVAILABLE_PROPERTIES = ["close_sessions_for_all_sources", "close_sessions_for_unauth_sources", "config", "glid_action", "src_default_glid", "user_tag", "uuid", "zone_template", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/manual-mode/{config}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/manual-mode"
