...
DOCUMENTATION = r'''
module: a10_acos_events_log_parameterization_message_selector_rule
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/acos-events/log-parameterization/message-selector/rule/{index}"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result[
                    "acos_info"] = info["rule"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "rule-list"] if info != "NotFound" else info
