...
AVAILABLE_PROPERTIES = ["so_pkts_l2redirect_dest_mac_zero_drop", "so_pkts_l2redirect_interface_not_up", "so_pkts_l2redirect_invalid_redirect_inf", "so_pkts_l2redirect_port_retrieval_error", "so_pkts_l2redirect_vlan_retrieval_error", "so_pkts_l3_redirect_chassis_dest_mac_er", "so_pkts_l3_redirect_encap_error_drop", "so_pkts_l3_redirect_fragmentation_error", "so_pkts_l3_redirect_inner_mac_zero_drop", "so_pkts_l3_redirect_invalid_dev_dir", "so_pkts_l3_redirect_table_error", "so_pkts_l3_redirect_table_no_entry_foun", "so_pkts_slb_nat_release_fail", "so_pkts_slb_nat_reserve_fail", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'so_pkts_slb_nat_reserve_fail': {'type': 'bool', },
        'so_pkts_slb_nat_release_fail': {'type': 'bool', },
        'so_pkts_l2redirect_dest_mac_zero_drop': {'type': 'bool', },
        'so_pkts_l2redirect_interface_not_up': {'type': 'bool', },
        'so_pkts_l2redirect_invalid_redirect_inf': {'type': 'bool', },
        'so_pkts_l3_redirect_encap_error_drop': {'type': 'bool', },
        'so_pkts_l3_redirect_inner_mac_zero_drop': {'type': 'bool', },
        'so_pkts_l3_redirect_table_error': {'type': 'bool', },
        'so_pkts_l3_redirect_fragmentation_error': {'type': 'bool', },
        'so_pkts_l3_redirect_table_no_entry_foun': {'type': 'bool', },
        'so_pkts_l3_redirect_invalid_dev_dir': {'type': 'bool', },
        'so_pkts_l3_redirect_chassis_dest_mac_er': {'type': 'bool', },
        'so_pkts_l2redirect_vlan_retrieval_error': {'type': 'bool', },
        'so_pkts_l2redirect_port_retrieval_error': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/so-counters/trigger-stats-inc"
