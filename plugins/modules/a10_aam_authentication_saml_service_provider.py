...
AVAILABLE_PROPERTIES = ["acs_uri_bypass", "adfs_ws_federation", "artifact_resolution_service", "assertion_consuming_service", "bad_request_redirect_url", "certificate", "entity_id", "metadata_export_service", "name", "packet_capture_template", "require_assertion_signed", "saml_request_signed", "sampling_enable", "service_url", "signature_algorithm", "single_logout_service", "soap_tls_certificate_validate", "SP_initiated_single_logout_service", "stats", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'SP_initiated_single_logout_service': {'type': 'list', 'SP_SLO_location': {'type': 'str', }, 'asynchronous': {'type': 'bool', }},
        ...
        'bad_request_redirect_url': {'type': 'str', },
        'acs_uri_bypass': {'type': 'bool', },
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'sp-metadata-export-req', 'sp-metadata-export-success', 'login-auth-req', 'login-auth-resp', 'acs-req', 'acs-success', 'acs-authz-fail', 'acs-error', 'slo-req', 'slo-success', 'slo-error', 'sp-slo-req', 'glo-slo-success', 'loc-slo-success', 'par-slo-success', 'other-error']}},
        'packet_capture_template': {'type': 'str', },
        'stats': {'type': 'dict', 'sp_metadata_export_req': {'type': 'str', }, 'sp_metadata_export_success': {'type': 'str', }, 'login_auth_req': {'type': 'str', }, 'login_auth_resp': {'type': 'str', }, 'acs_req': {'type': 'str', }, 'acs_success': {'type': 'str', }, 'acs_authz_fail': {'type': 'str', }, 'acs_error': {'type': 'str', }, 'slo_req': {'type': 'str', }, 'slo_success': {'type': 'str', }, 'slo_error': {'type': 'str', }, 'sp_slo_req': {'type': 'str', }, 'glo_slo_success': {'type': 'str', }, 'loc_slo_success': {'type': 'str', }, 'par_slo_success': {'type': 'str', }, 'other_error': {'type': 'str', }, 'name': {'type': 'str', 'required': True, }}
    })
    return rv
