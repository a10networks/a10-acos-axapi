...
def present(module, result, existing_config):
    payload = utils.build_json("trigger-sys-obj-stats-severity", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "trigger-sys-obj-stats-severity"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "trigger-sys-obj-stats-severity-list"] if info != "NotFound" else info
