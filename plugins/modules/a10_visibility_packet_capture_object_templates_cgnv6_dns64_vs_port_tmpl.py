...
def present(module, result, existing_config):
    payload = utils.build_json("cgnv6-dns64-vs-port-tmpl", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "cgnv6-dns64-vs-port-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "cgnv6-dns64-vs-port-tmpl-list"] if info != "NotFound" else info
