...
DOCUMENTATION = r'''
module: a10_ip_nat_pool_group_member
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ip/nat/pool-group/{pool_group_pool_group_name}/member/{pool_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ip/nat/pool-group/{pool_group_pool_group_name}/member"
