...
def present(module, result, existing_config):
    payload = utils.build_json("resource-accounting", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "resource-accounting"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "resource-accounting-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["resource-accounting"][
