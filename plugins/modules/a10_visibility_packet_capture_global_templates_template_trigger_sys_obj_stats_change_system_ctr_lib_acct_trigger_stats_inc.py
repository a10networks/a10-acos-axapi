...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_system_ctr_lib_acct_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["total_nodes_free_failed", "total_nodes_unlink_failed", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'total_nodes_free_failed': {'type': 'bool', }, 'total_nodes_unlink_failed': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/system-ctr-lib-acct/trigger-stats-inc"
