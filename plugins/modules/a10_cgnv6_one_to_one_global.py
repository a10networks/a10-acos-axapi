    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'total-map-allocated', 'total-map-freed',
                    'map-alloc-failure', 'map-dbl-free', 'alloc-map-race',
                    'map-not-found', 'ha-map-mismatch',
                    'ha-select-addr-failure', 'ha-alloc-map-conflicts'
                ]
            }
        },
        'stats': {
