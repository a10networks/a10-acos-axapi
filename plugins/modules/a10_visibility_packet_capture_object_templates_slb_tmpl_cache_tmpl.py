...
def present(module, result, existing_config):
    payload = utils.build_json("slb-tmpl-cache-tmpl", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "slb-tmpl-cache-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "slb-tmpl-cache-tmpl-list"] if info != "NotFound" else info
