...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_auth_captcha_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["attr_fail", "duration", "job_start_error", "json_fail", "other_error", "polling_control_error", "request_dropped", "response_error", "response_failure", "response_timeout", "threshold_exceeded_by", "timeout_error", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-auth-captcha/trigger-stats-rate"
