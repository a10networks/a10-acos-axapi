...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_aflow_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["error_resume_conn", "pause_conn_fail", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'pause_conn_fail': {'type': 'bool', }, 'error_resume_conn': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-aflow/trigger-stats-inc"
