...
DOCUMENTATION = r'''
module: a10_import_ips_profile
description:
    - Modify/Enable/Disable IPS signatures
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["overwrite", "password", "profile_filename", "remote_file", "use_mgmt_port", ]
...
def get_argspec():
    ...
    rv.update({'profile_filename': {'type': 'str', }, 'overwrite': {'type': 'bool', }, 'use_mgmt_port': {'type': 'bool', }, 'remote_file': {'type': 'str', }, 'password': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/import/ips/profile"
