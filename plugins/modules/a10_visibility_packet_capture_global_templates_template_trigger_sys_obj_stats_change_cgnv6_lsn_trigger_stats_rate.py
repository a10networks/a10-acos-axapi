...
AVAILABLE_PROPERTIES = [
    "adc_port_allocation_failed", "data_sesn_user_quota_exceeded", "duration", "fullcone_ext_mem_alloc_failure", "fullcone_ext_mem_alloc_init_faulure", "fullcone_failure", "fullcone_self_hairpinning_drop", "h323_alg_alloc_single_port_failure", "h323_alg_create_rtcp_fullcone_failure",
    ...
    "threshold_exceeded_by", "user_quota_failure", "user_quota_unusable", "user_quota_unusable_drop", "uuid",
    ]
