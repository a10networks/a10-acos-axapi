...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_lsn_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = [
    "adc_port_allocation_failed", "data_sesn_user_quota_exceeded", "duration", "fullcone_ext_mem_alloc_failure", "fullcone_ext_mem_alloc_init_faulure", "fullcone_failure", "fullcone_self_hairpinning_drop", "h323_alg_alloc_single_port_failure", "h323_alg_create_rtcp_fullcone_failure", "h323_alg_create_rtp_fullcone_failure",
    ...
    "sip_alg_alloc_rtp_rtcp_port_failure", "sip_alg_alloc_single_port_failure", "sip_alg_create_rtcp_fullcone_failure", "sip_alg_create_rtp_fullcone_failure", "sip_alg_create_single_fullcone_failure", "sip_alg_quota_inc_failure", "threshold_exceeded_by", "user_quota_failure", "user_quota_unusable", "user_quota_unusable_drop", "uuid",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-lsn/trigger-stats-rate"
