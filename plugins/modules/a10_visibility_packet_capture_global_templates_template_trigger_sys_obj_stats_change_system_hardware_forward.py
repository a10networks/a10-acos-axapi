    ...
    trigger_stats_inc:
        ...
        suboptions:
            ...
            hw_fwd_flow_drop_count:
                description:
                - "Enable automatic packet-capture for hardware forward flow drop count"
                type: bool
...
def get_argspec():
    ...
    rv.update({'dummy': {'type': 'bool', },
        'uuid': {'type': 'str', },
        'trigger_stats_inc': {'type': 'dict', 'hw_fwd_prog_errors': {'type': 'bool', }, 'hw_fwd_flow_singlebit_errors': {'type': 'bool', }, 'hw_fwd_flow_tag_mismatch': {'type': 'bool', }, 'hw_fwd_flow_seq_mismatch': {'type': 'bool', }, 'hw_fwd_flow_drop_count': {'type': 'bool', }, 'hw_fwd_flow_error_count': {'type': 'bool', }, 'hw_fwd_flow_unalign_count': {'type': 'bool', }, 'hw_fwd_flow_underflow_count': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        'trigger_stats_rate': {'type': 'dict', 'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'hw_fwd_prog_errors': {'type': 'bool', }, 'hw_fwd_flow_singlebit_errors': {'type': 'bool', }, 'hw_fwd_flow_tag_mismatch': {'type': 'bool', }, 'hw_fwd_flow_seq_mismatch': {'type': 'bool', }, 'hw_fwd_flow_drop_count': {'type': 'bool', }, 'hw_fwd_flow_error_count': {'type': 'bool', }, 'hw_fwd_flow_unalign_count': {'type': 'bool', }, 'hw_fwd_flow_underflow_count': {'type': 'bool', }, 'uuid': {'type': 'str', }}
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/system-hardware-forward"
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["system-hardware-forward"].items():
        v = 1 if str(v).lower() == "true" else v
        v = 0 if str(v).lower() == "false" else v

        if config_changes["system-hardware-forward"].get(k) != v:
            change_results["changed"] = True
            config_changes["system-hardware-forward"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("system-hardware-forward", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["system-hardware-forward"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["system-hardware-forward-list"] if info != "NotFound" else info
