...
def present(module, result, existing_config):
    payload = utils.build_json("system-hardware-forward", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "system-hardware-forward"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "system-hardware-forward-list"] if info != "NotFound" else info
