...
DOCUMENTATION = r'''
module: a10_ddos_zone_template_udp
description:
...
options:
    ...
    spoof_detect_min_delay:
        description:
        - "Optional minimum delay between UDP retransmits for authentication to pass, unit
    ...
    spoof_detect_fail_action:
        description:
        - "'drop'= Drop packets (Default); 'blacklist-src'= Blacklist-src for spoof-detect
          fail;"
        type: str
        required: False
    ...
    ntp_monlist_cfg:
        ...
        suboptions:
            ...
            ntp_monlist_action:
                description:
                - "'drop'= Drop packets for ntp-monlist (Default); 'blacklist-src'= Blacklist-src
          for ntp-monlist; 'ignore'= Ignore ntp-monlist;"
                type: str
    max_payload_size_cfg:
        ...
        suboptions:
            ...
            max_payload_size_action:
                description:
                - "'drop'= Drop packets for max-payload-size exceed (Default); 'blacklist-src'=
          Blacklist-src for max-payload-size exceed; 'ignore'= Do nothing for max-
          payload-size exceed;"
                type: str
    min_payload_size_cfg:
        ...
        suboptions:
            ...
            min_payload_size_action:
                description:
                - "'drop'= Drop packets for min-payload-size (Default); 'blacklist-src'=
          Blacklist-src for min-payload-size; 'ignore'= Do nothing for min-payload-size
          exceed;"
                type: str
    uuid:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/udp/{name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/udp"
