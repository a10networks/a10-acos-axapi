...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_number_dynamic_entry_overflow_policy
description:
...
def get_argspec():
    ...
    rv.update({'dummy_name': {'type': 'str', 'required': True, 'choices': ['configuration']}, 'glid': {'type': 'str', }, 'action': {'type': 'str', 'choices': ['bypass', 'deny']}, 'zone_template': {'type': 'dict', 'ip_proto': {'type': 'str', }}, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/dynamic-entry-overflow-policy/{dummy_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/dynamic-entry-overflow-policy"
