...
def present(module, result, existing_config):
    payload = utils.build_json("ike-sa-clients", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "ike-sa-clients"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "ike-sa-clients-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["ike-sa-clients"][
