...
def present(module, result, existing_config):
    payload = utils.build_json("icmp-rate", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "icmp-rate"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "icmp-rate-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["icmp-rate"][
