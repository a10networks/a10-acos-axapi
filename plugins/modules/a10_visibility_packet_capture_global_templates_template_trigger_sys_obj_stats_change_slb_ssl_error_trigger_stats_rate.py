...
AVAILABLE_PROPERTIES = [
    "app_data_in_handshake", "attempt_to_reuse_sess_in_diff_context", "bad_alert_record", "bad_authentication_type", "bad_change_cipher_spec", "bad_checksum", "bad_data_returned_by_callback", "bad_decompression", "bad_dh_g_length", "bad_dh_p_length", "bad_dh_pub_key_length", "bad_digest_length", "bad_dsa_signature", "bad_ecc_cert", "bad_ecdsa_sig",
    "bad_ecpoint", "bad_handshake_length", "bad_hello_request", "bad_length", "bad_mac_decode", "bad_message_type", "bad_packet_length", "bad_protocol_version_counter", "bad_response_argument", "bad_rsa_decrypt", "bad_rsa_e_length", "bad_rsa_encrypt", "bad_rsa_modulus_length", "bad_rsa_signature", "bad_signature", "bad_ssl_filetype",
    "bad_ssl_session_id_length", "bad_state", "bad_write_retry", "bio_not_set", "block_cipher_pad_is_wrong", "bn_lib", "ca_dn_length_mismatch", "ca_dn_too_long", "ccs_received_early", "cert_length_mismatch", "certificate_verify_failed", "challenge_is_different", "cipher_code_wrong_length", "cipher_or_hash_unavailable", "cipher_table_src_error",
    "clienthello_tlsext", "compressed_length_too_long", "compression_failure", "compression_library_error", "connection_id_is_different", "connection_type_not_set", "cookie_mismatch", "data_between_ccs_and_finished", "data_length_too_long", "decryption_failed", "decryption_failed_or_bad_record_mac", "dh_public_value_length_is_wrong",
    "digest_check_failed", "duration", "encrypted_length_too_long", "error_generating_tmp_rsa_key", "error_in_received_cipher_list", "excessive_message_size", "extra_data_in_message", "got_a_fin_before_a_ccs", "http_request", "https_proxy_request", "illegal_padding", "inappropriate_fallback", "invalid_challenge_length", "invalid_command",
    "invalid_purpose", "invalid_status_response", "invalid_trust", "key_arg_too_long", "krb5", "krb5_client_cc_principal", "krb5_client_get_cred", "krb5_client_init", "krb5_client_mk_req", "krb5_server_bad_ticket", "krb5_server_init", "krb5_server_rd_req", "krb5_server_tkt_expired", "krb5_server_tkt_not_yet_valid", "krb5_server_tkt_skew",
    "length_mismatch", "length_too_short", "library_bug", "library_has_no_ciphers", "mast_key_too_long", "message_too_long", "missing_dh_dsa_cert", "missing_dh_key", "missing_dh_rsa_cert", "missing_dsa_signing_cert", "missing_export_tmp_dh_key", "missing_export_tmp_rsa_key", "missing_rsa_certificate", "missing_rsa_encrypting_cert",
    "missing_rsa_signing_cert", "missing_tmp_dh_key", "missing_tmp_rsa_key", "missing_tmp_rsa_pkey", "missing_verify_message", "multiple_sgc_restarts", "no_certificate_assigned", "no_certificate_returned", "no_certificate_set", "no_certificate_specified", "no_certificates_returned", "no_cipher_list", "no_cipher_match", "no_ciphers_available",
    "no_ciphers_passed", "no_ciphers_specified", "no_client_cert_received", "no_compression_specified", "no_method_specified", "no_private_key_assigned", "no_privatekey", "no_protocols_available", "no_publickey", "no_required_digest", "no_shared_cipher", "no_verify_callback", "non_sslv2_initial_packet", "null_ssl_ctx", "null_ssl_method_passed",
    "old_session_cipher_not_returned", "packet_length_too_long", "parse_tlsext", "path_too_long", "peer_did_not_return_a_certificate", "peer_error", "peer_error_certificate", "peer_error_no_certificate", "peer_error_no_cipher", "peer_error_unsupported_certificate_type", "pre_mac_length_too_long", "problems_mapping_cipher_functions",
    "protocol_is_shutdown", "public_key_encrypt_error", "public_key_is_not_rsa", "public_key_not_rsa", "read_bio_not_set", "read_wrong_packet_type", "record_length_mismatch", "record_too_large", "record_too_small", "required_cipher_missing", "reuse_cert_length_not_zero", "reuse_cert_type_not_zero", "reuse_cipher_list_not_zero",
    "scsv_received_when_renegotiating", "serverhello_tlsext", "session_id_context_uninitialized", "short_read", "signature_for_non_signing_certificate", "ssl_ctx_has_no_default_ssl_version", "ssl_handshake_failure", "ssl_library_has_no_ciphers", "ssl_session_id_callback_failed", "ssl_session_id_conflict", "ssl_session_id_context_too_long",
    "ssl_session_id_has_bad_length", "ssl_session_id_is_different", "ssl2_connection_id_too_long", "ssl23_doing_session_id_reuse", "ssl3_ext_invalid_servername", "ssl3_ext_invalid_servername_type", "ssl3_session_id_too_long", "ssl3_session_id_too_short", "sslv3_alert_bad_certificate", "sslv3_alert_bad_record_mac", "sslv3_alert_certificate_expired",
    "sslv3_alert_certificate_revoked", "sslv3_alert_certificate_unknown", "sslv3_alert_decompression_failure", "sslv3_alert_handshake_failure", "sslv3_alert_illegal_parameter", "sslv3_alert_no_certificate", "sslv3_alert_peer_error_cert", "sslv3_alert_peer_error_no_cert", "sslv3_alert_peer_error_no_cipher", "sslv3_alert_peer_error_unsupp_cert_type",
    "sslv3_alert_unexpected_msg", "sslv3_alert_unknown_remote_err_type", "sslv3_alert_unspported_cert", "threshold_exceeded_by", "tls_client_cert_req_with_anon_cipher", "tls_invalid_ecpointformat_list", "tls_peer_did_not_respond_with_cert_list", "tls_rsa_encrypted_value_length_is_wrong", "tlsv1_alert_access_denied", "tlsv1_alert_decode_error",
    "tlsv1_alert_decrypt_error", "tlsv1_alert_decryption_failed", "tlsv1_alert_export_restriction", "tlsv1_alert_insufficient_security", "tlsv1_alert_internal_error", "tlsv1_alert_no_renegotiation", "tlsv1_alert_protocol_version", "tlsv1_alert_record_overflow", "tlsv1_alert_unknown_ca", "tlsv1_alert_user_cancelled",
    "tried_to_use_unsupported_cipher", "unable_to_decode_dh_certs", "unable_to_extract_public_key", "unable_to_find_dh_parameters", "unable_to_find_public_key_parameters", "unable_to_find_ssl_method", "unable_to_load_ssl2_md5_routines", "unable_to_load_ssl3_md5_routines", "unable_to_load_ssl3_sha1_routines", "unexpected_message",
    "unexpected_record", "uninitialized", "unknown_alert_type", "unknown_certificate_type", "unknown_cipher_returned", "unknown_cipher_type", "unknown_key_exchange_type", "unknown_pkey_type", "unknown_protocol", "unknown_remote_error_type", "unknown_ssl_version", "unknown_state", "unsupported_cipher", "unsupported_compression_algorithm",
    "unsupported_digest_type", "unsupported_elliptic_curve", "unsupported_option", "unsupported_protocol", "unsupported_ssl_version", "unsupported_status_type", "uuid", "write_bio_not_set", "wrong_cipher_returned", "wrong_counter_of_key_bits", "wrong_message_type", "wrong_signature_length", "wrong_signature_size", "wrong_ssl_version",
    "wrong_version_counter", "x509_lib", "x509_verification_setup_problems",
    ]
