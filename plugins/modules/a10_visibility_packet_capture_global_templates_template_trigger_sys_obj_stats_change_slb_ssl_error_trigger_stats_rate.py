...
AVAILABLE_PROPERTIES = [
    ...
    "connection_type_not_set", "cookie_mismatch", "data_between_ccs_and_finished", "data_length_too_long", "decryption_failed", "decryption_failed_or_bad_record_mac", "dh_public_value_length_is_wrong", "digest_check_failed", "duration", "encrypted_length_too_long", "error_generating_tmp_rsa_key",
    ...
    "sslv3_alert_unspported_cert", "threshold_exceeded_by", "tls_client_cert_req_with_anon_cipher", "tls_invalid_ecpointformat_list", "tls_peer_did_not_respond_with_cert_list", "tls_rsa_encrypted_value_length_is_wrong", "tlsv1_alert_access_denied", "tlsv1_alert_decode_error",
    "tlsv1_alert_decrypt_error", "tlsv1_alert_decryption_failed", "tlsv1_alert_export_restriction", "tlsv1_alert_insufficient_security", "tlsv1_alert_internal_error", "tlsv1_alert_no_renegotiation", "tlsv1_alert_protocol_version", "tlsv1_alert_record_overflow", "tlsv1_alert_unknown_ca",
    "tlsv1_alert_user_cancelled", "tried_to_use_unsupported_cipher", "unable_to_decode_dh_certs", "unable_to_extract_public_key", "unable_to_find_dh_parameters", "unable_to_find_public_key_parameters", "unable_to_find_ssl_method", "unable_to_load_ssl2_md5_routines",
    "unable_to_load_ssl3_md5_routines", "unable_to_load_ssl3_sha1_routines", "unexpected_message", "unexpected_record", "uninitialized", "unknown_alert_type", "unknown_certificate_type", "unknown_cipher_returned", "unknown_cipher_type", "unknown_key_exchange_type", "unknown_pkey_type",
    "unknown_protocol", "unknown_remote_error_type", "unknown_ssl_version", "unknown_state", "unsupported_cipher", "unsupported_compression_algorithm", "unsupported_digest_type", "unsupported_elliptic_curve", "unsupported_option", "unsupported_protocol", "unsupported_ssl_version",
    "unsupported_status_type", "uuid", "write_bio_not_set", "wrong_cipher_returned", "wrong_counter_of_key_bits", "wrong_message_type", "wrong_signature_length", "wrong_signature_size", "wrong_ssl_version", "wrong_version_counter", "x509_lib", "x509_verification_setup_problems",
    ]
