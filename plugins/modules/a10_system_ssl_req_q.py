...
def present(module, result, existing_config):
    payload = utils.build_json("ssl-req-q", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "ssl-req-q"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "ssl-req-q-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["ssl-req-q"][
