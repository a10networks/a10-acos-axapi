...
DOCUMENTATION = r'''
module: a10_ddos_dns_cache_domain_group
description:
    - DNS Cache Settings
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["domain_list_policy_list", "name", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dns-cache/{dns_cache_name}/domain-group"
