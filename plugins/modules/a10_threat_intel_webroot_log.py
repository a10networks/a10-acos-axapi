...
def present(module, result, existing_config):
    payload = utils.build_json("webroot-log", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "webroot-log"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "webroot-log-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["webroot-log"][
