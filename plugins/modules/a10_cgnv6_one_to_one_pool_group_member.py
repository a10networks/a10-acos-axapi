...
DOCUMENTATION = r'''
module: a10_cgnv6_one_to_one_pool_group_member
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(pool_group_pool_group_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/one-to-one/pool-group/{pool_group_pool_group_name}/member/{pool_name}"
    ...
    if '/' in module.params["pool_group_pool_group_name"]:
        f_dict["pool_group_pool_group_name"] = module.params["pool_group_pool_group_name"].replace("/", "%2F")
    else:
...
def new_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/one-to-one/pool-group/{pool_group_pool_group_name}/member"
