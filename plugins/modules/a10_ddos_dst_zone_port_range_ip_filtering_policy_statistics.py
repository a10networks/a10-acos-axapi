...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_range_ip_filtering_policy_statistics
description:
    - IP Filter
author: A10 Networks
options:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/ip-filtering-policy-statistics"
