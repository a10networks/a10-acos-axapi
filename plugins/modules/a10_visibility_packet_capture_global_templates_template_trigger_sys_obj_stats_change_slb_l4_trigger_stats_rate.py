...
AVAILABLE_PROPERTIES = [
    "bw_rate_limit_exceed", "concurrent_conn_exceed", "conn_rate_limit_drop", "conn_rate_limit_reset", "connlimit_drop", "dns_policy_drop", "duration", "l4_cps_exceed", "l7_cps_exceed", "nat_cps_exceed", "no_resourse_drop", "smart_nat_id_mismatch", "snat_fail", "snat_icmp_error_process", "snat_icmp_no_match", "snat_no_fwd_route",
    "snat_no_rev_route", "ssl_cps_exceed", "ssl_tpt_exceed", "svr_syn_handshake_fail", "svrselfail", "synattack", "syncookiescheckfailed", "syncookiessentfailed", "threshold_exceeded_by", "uuid",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-l4/trigger-stats-rate"
