...
DOCUMENTATION = r'''
module: a10_ddos_zone_profile_port
description:
...
options:
    ...
    port_protocol:
        description:
        - "'dns-tcp'= dns-tcp; 'dns-udp'= dns-udp; 'sip-tcp'= sip-tcp; 'sip-udp'= sip-udp;
          'http'= http; 'tcp'= tcp; 'udp'= udp; 'ssl-l4'= ssl-l4; 'quic'= quic;"
        type: str
        required: True
    uuid:
        description:
...
AVAILABLE_PROPERTIES = ["indicator_list", "port_num", "port_protocol", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    rv.update({
        ...
        'port_protocol': {
            'type': 'str',
            'required': True,
            'choices': ['dns-tcp', 'dns-udp', 'sip-tcp', 'sip-udp', 'http', 'tcp', 'udp', 'ssl-l4', 'quic']
            },
        'uuid': {
            'type': 'str',
            },
    ...
    # Parent keys
    rv.update(dict(zone_profile_profile_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port/{port_num}+{port_protocol}"
    ...
    if '/' in str(module.params["port_protocol"]):
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port/"

    f_dict = {}
    f_dict["port_num"] = ""
    f_dict["port_protocol"] = ""
    f_dict["zone_profile_profile_name"] = module.params["zone_profile_profile_name"]
