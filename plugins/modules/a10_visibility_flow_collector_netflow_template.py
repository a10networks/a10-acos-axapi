...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'templates-added-to-delq', 'templates-removed-from-delq']}},
        'detail': {'type': 'dict', 'uuid': {'type': 'str', }},
        'oper': {'type': 'dict', 'nf_template_list': {'type': 'list', 'exporter_address': {'type': 'str', }, 'observation_domain_id': {'type': 'int', }, 'template_id': {'type': 'int', }, 'nflow_version': {'type': 'int', }, 'field_count': {'type': 'int', }, 'seconds_to_expire': {'type': 'int', }, 'partition_id': {'type': 'int', }}, 'detail': {'type': 'dict', 'oper': {'type': 'dict', 'nf_template_list': {'type': 'list', 'exporter_address': {'type': 'str', }, 'observation_domain_id': {'type': 'int', }, 'template_id': {'type': 'int', }, 'nflow_version': {'type': 'int', }, 'field_count': {'type': 'int', }, 'seconds_to_expire': {'type': 'int', }, 'partition_id': {'type': 'int', }, 'template_field_list': {'type': 'list', 'id': {'type': 'int', }, 'length': {'type': 'int', }, 'enterprise_field': {'type': 'str', }, 'variable_length': {'type': 'str', }}}}}},
        'stats': {'type': 'dict', 'templates_added_to_delq': {'type': 'str', }, 'templates_removed_from_delq': {'type': 'str', }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/flow-collector/netflow/template"
