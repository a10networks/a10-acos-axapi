...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["sys-ut"].items():
        ...
        if config_changes["sys-ut"].get(k) != v:
            change_results["changed"] = True
            config_changes["sys-ut"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("sys-ut", module.params, AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "sys-ut"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "sys-ut-list"] if info != "NotFound" else info
