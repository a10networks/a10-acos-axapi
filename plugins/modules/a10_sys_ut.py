...
AVAILABLE_PROPERTIES = ["action", "common", "event_list", "run_test", "secondary_name", "state_list", "template_list", "test_name", "uuid", ]
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["sys-ut"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["sys-ut-list"] if info != "NotFound" else info
