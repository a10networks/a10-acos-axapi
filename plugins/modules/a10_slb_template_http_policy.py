...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'http_policy_match': {'type': 'list', 'ntype': {'type': 'str', 'choices': ['cookie', 'host', 'url']}, 'match_type': {'type': 'str', 'choices': ['contains', 'ends-with', 'equals', 'starts-with']}, 'match_string': {'type': 'str', }, 'service_group': {'type': 'str', }, 'template': {'type': 'str', 'choices': ['waf']}, 'template_name': {'type': 'str', }},
