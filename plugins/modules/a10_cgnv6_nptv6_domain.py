...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'inside_prefix': {'type': 'str', },
        'outside_prefix': {'type': 'str', },
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'outbound-packets', 'inbound-packets', 'hairpin-packets', 'address-not-valid-for-translation', 'inbound-packets-no-map', 'packets-dest-unreachable']}},
        'stats': {'type': 'dict', 'outbound_packets': {'type': 'str', }, 'inbound_packets': {'type': 'str', }, 'hairpin_packets': {'type': 'str', }, 'address_not_valid_for_translation': {'type': 'str', }, 'inbound_packets_no_map': {'type': 'str', }, 'packets_dest_unreachable': {'type': 'str', }, 'name': {'type': 'str', 'required': True, }}
    })
    return rv
