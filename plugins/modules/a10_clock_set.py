...
def get_argspec():
    ...
    rv.update({'time_cfg': {'type': 'dict', 'time': {'type': 'str', }, 'month': {'type': 'str', 'choices': ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']}, 'day_of_month_2': {'type': 'int', }, 'month_2': {'type': 'str', 'choices': ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December']}, 'day_of_month': {'type': 'int', }, 'year': {'type': 'int', }}
    })
    return rv
