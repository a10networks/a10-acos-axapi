...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_persist
description:
    - Configure triggers for slb.persist object
...
def get_argspec():
    ...
    rv.update({'dummy': {'type': 'bool', },
        'uuid': {'type': 'str', },
        'trigger_stats_inc': {'type': 'dict', 'hash_tbl_trylock_fail': {'type': 'bool', }, 'hash_tbl_create_fail': {'type': 'bool', }, 'hash_tbl_rst_updown': {'type': 'bool', }, 'hash_tbl_rst_adddel': {'type': 'bool', }, 'url_hash_fail': {'type': 'bool', }, 'header_hash_fail': {'type': 'bool', }, 'src_ip_fail': {'type': 'bool', }, 'src_ip_new_sess_cache_fail': {'type': 'bool', }, 'src_ip_new_sess_sel_fail': {'type': 'bool', }, 'src_ip_hash_fail': {'type': 'bool', }, 'dst_ip_fail': {'type': 'bool', }, 'dst_ip_new_sess_cache_fail': {'type': 'bool', }, 'dst_ip_new_sess_sel_fail': {'type': 'bool', }, 'dst_ip_hash_fail': {'type': 'bool', }, 'cssl_sid_not_found': {'type': 'bool', }, 'cssl_sid_not_match': {'type': 'bool', }, 'sssl_sid_not_found': {'type': 'bool', }, 'sssl_sid_not_match': {'type': 'bool', }, 'ssl_sid_persist_fail': {'type': 'bool', }, 'ssl_sid_session_fail': {'type': 'bool', }, 'cookie_persist_fail': {'type': 'bool', }, 'cookie_not_found': {'type': 'bool', }, 'cookie_invalid': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        'trigger_stats_rate': {'type': 'dict', 'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'hash_tbl_trylock_fail': {'type': 'bool', }, 'hash_tbl_create_fail': {'type': 'bool', }, 'hash_tbl_rst_updown': {'type': 'bool', }, 'hash_tbl_rst_adddel': {'type': 'bool', }, 'url_hash_fail': {'type': 'bool', }, 'header_hash_fail': {'type': 'bool', }, 'src_ip_fail': {'type': 'bool', }, 'src_ip_new_sess_cache_fail': {'type': 'bool', }, 'src_ip_new_sess_sel_fail': {'type': 'bool', }, 'src_ip_hash_fail': {'type': 'bool', }, 'dst_ip_fail': {'type': 'bool', }, 'dst_ip_new_sess_cache_fail': {'type': 'bool', }, 'dst_ip_new_sess_sel_fail': {'type': 'bool', }, 'dst_ip_hash_fail': {'type': 'bool', }, 'cssl_sid_not_found': {'type': 'bool', }, 'cssl_sid_not_match': {'type': 'bool', }, 'sssl_sid_not_found': {'type': 'bool', }, 'sssl_sid_not_match': {'type': 'bool', }, 'ssl_sid_persist_fail': {'type': 'bool', }, 'ssl_sid_session_fail': {'type': 'bool', }, 'cookie_persist_fail': {'type': 'bool', }, 'cookie_not_found': {'type': 'bool', }, 'cookie_invalid': {'type': 'bool', }, 'uuid': {'type': 'str', }}
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-persist"
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["slb-persist"].items():
        v = 1 if str(v).lower() == "true" else v
        v = 0 if str(v).lower() == "false" else v

        if config_changes["slb-persist"].get(k) != v:
            change_results["changed"] = True
            config_changes["slb-persist"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("slb-persist", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["slb-persist"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["slb-persist-list"] if info != "NotFound" else info
