...
DOCUMENTATION = r'''
module: a10_system_udp
description:
    - System udp global config
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["skip_checksum_when_zero", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'skip_checksum_when_zero': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    return rv
