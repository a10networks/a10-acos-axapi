...
def get_argspec():
    ...
    rv.update({'no_client_conn_reuse': {'type': 'bool', },
        ...
        'uuid': {'type': 'str', },
        'action_list': {'type': 'list', 'name': {'type': 'str', 'required': True, }, 'action1': {'type': 'str', 'choices': ['forward-to-internet', 'forward-to-service-group', 'forward-to-proxy', 'drop']}, 'fake_sg': {'type': 'str', }, 'real_sg': {'type': 'str', }, 'forward_snat': {'type': 'str', }, 'fall_back': {'type': 'str', }, 'fall_back_snat': {'type': 'str', }, 'log': {'type': 'bool', }, 'drop_response_code': {'type': 'int', }, 'drop_message': {'type': 'str', }, 'drop_redirect_url': {'type': 'str', }, 'http_status_code': {'type': 'str', 'choices': ['301', '302']}, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }, 'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'hits']}}},
...
def present(module, result, existing_config):
    payload = utils.build_json("forward-policy", module.params, AVAILABLE_PROPERTIES)
