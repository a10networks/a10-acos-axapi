...
AVAILABLE_PROPERTIES = ["acos_event_log", "action_list", "dual_stack_action_list", "enable_adv_match", "filtering", "forward_http_connect_to_icap", "local_logging", "no_client_conn_reuse", "reqmod_icap", "require_web_category", "san_filtering", "source_list", "uuid", ]
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["forward-policy"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["forward-policy-list"] if info != "NotFound" else info
