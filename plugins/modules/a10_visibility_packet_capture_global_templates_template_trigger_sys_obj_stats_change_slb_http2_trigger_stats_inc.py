...
AVAILABLE_PROPERTIES = [
    ...
    "cant_allocate_window_frame", "closed_state_unexpected_frame", "compression_error", "connect_error", "continuation_before_headers", "data_no_stream", "data_queue_alloc_error", "deflate_alloc_fail", "enhance_your_calm", "err_rcvd_total", "err_sent_cancel", "err_sent_compression_err",
    ...
    "proxy_alloc_error", "refused_stream", "reserved_local_state_unexpected_frame", "reserved_remote_state_unexpected_frame", "settings_timeout", "split_buff_fail", "streams_gt_max_concur_streams", "trailers_no_end_stream", "uuid", "wrong_stream_state", "zero_window_size_on_stream",
    ]
