...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_mqtt_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["client_id_null", "conn_null", "duration", "insertion_failed", "parse_connect_fail", "parse_publish_fail", "parse_subscribe_fail", "parse_unsubscribe_fail", "session_exist", "threshold_exceeded_by", "tuple_already_linked", "tuple_not_linked", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'parse_connect_fail': {'type': 'bool', },
        'parse_publish_fail': {'type': 'bool', },
        'parse_subscribe_fail': {'type': 'bool', },
        'parse_unsubscribe_fail': {'type': 'bool', },
        'tuple_not_linked': {'type': 'bool', },
        'tuple_already_linked': {'type': 'bool', },
        'conn_null': {'type': 'bool', },
        'client_id_null': {'type': 'bool', },
        'session_exist': {'type': 'bool', },
        'insertion_failed': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-mqtt/trigger-stats-rate"
