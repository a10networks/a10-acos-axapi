...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'dh_short_key_action': {'type': 'str', 'choices': ['none', 'prepend', 'regenerate']},
        'key': {'type': 'str', },
        'passphrase': {'type': 'str', },
        'encrypted': {'type': 'str', },
