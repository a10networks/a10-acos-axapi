...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_l4_type_stats_other_ipproto
description:
    - Statistics for the object l4-type
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/l4-type/{l4_type_protocol}/stats?other-ipproto=true"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["l4-type"]["stats"] if info != "NotFound" else info
