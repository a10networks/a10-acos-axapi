...
def get_argspec():
    ...
    rv.update({'user_quota_prefix_length': {'type': 'int', },
        ...
        'force_non_zero_ipv4_id': {'type': 'bool', },
        'all': {'type': 'bool', },
