...
def get_argspec():
    ...
    rv.update({'dns': {'type': 'bool', },
        'dns_ip_key': {'type': 'bool', },
        'dns_ipv4_addr': {'type': 'str', },
        'dns_ipv6_addr': {'type': 'str', },
        'dns_ipv4_port': {'type': 'int', },
        'dns_ipv4_expect': {'type': 'dict', 'dns_ipv4_response': {'type': 'str', }, 'dns_ipv4_fqdn': {'type': 'str', }},
        'dns_ipv4_recurse': {'type': 'str', 'choices': ['enabled', 'disabled']},
        'dns_ipv4_tcp': {'type': 'bool', },
        'dns_ipv6_port': {'type': 'int', },
        'dns_ipv6_expect': {'type': 'dict', 'dns_ipv6_response': {'type': 'str', }, 'dns_ipv6_fqdn': {'type': 'str', }},
        'dns_ipv6_recurse': {'type': 'str', 'choices': ['enabled', 'disabled']},
        'dns_ipv6_tcp': {'type': 'bool', },
        'dns_domain': {'type': 'str', },
        'dns_domain_port': {'type': 'int', },
        'dns_domain_type': {'type': 'str', 'choices': ['A', 'CNAME', 'SOA', 'PTR', 'MX', 'TXT', 'AAAA']},
        'dns_domain_expect': {'type': 'dict', 'dns_domain_response': {'type': 'str', }, 'dns_domain_fqdn': {'type': 'str', }, 'dns_domain_ipv4': {'type': 'str', }, 'dns_domain_ipv6': {'type': 'str', }},
        'dns_domain_recurse': {'type': 'str', 'choices': ['enabled', 'disabled']},
        'dns_domain_tcp': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
