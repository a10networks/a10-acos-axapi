...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_other_stats_tcp_zone_port
description:
    - Statistics for the object zone-service-other
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/stats?tcp-zone-port=true"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["zone-service-other"]["stats"] if info != "NotFound" else info
