...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'current_open', 'current_active', 'nbind', 'nunbind', 'nestab', 'ntermi', 'ntermi_err', 'delay_unbind', 'long_resp', 'miss_resp', 'unbound_data_rcv', 'pause_conn', 'pause_conn_fail', 'resume_conn', 'not_remove_from_rport']}},
        'oper': {'type': 'dict', 'connection_reuse_cpu_list': {'type': 'list', 'current_open': {'type': 'int', }, 'current_active': {'type': 'int', }, 'nbind': {'type': 'int', }, 'nunbind': {'type': 'int', }, 'nestab': {'type': 'int', }, 'ntermi': {'type': 'int', }, 'ntermi_err': {'type': 'int', }, 'delay_unbind': {'type': 'int', }, 'long_resp': {'type': 'int', }, 'miss_resp': {'type': 'int', }, 'unbound_data_rcv': {'type': 'int', }, 'pause_conn': {'type': 'int', }, 'pause_conn_fail': {'type': 'int', }, 'resume_conn': {'type': 'int', }, 'not_remove_from_rport': {'type': 'int', }}, 'cpu_count': {'type': 'int', }},
        'stats': {'type': 'dict', 'current_open': {'type': 'str', }, 'current_active': {'type': 'str', }, 'nbind': {'type': 'str', }, 'nunbind': {'type': 'str', }, 'nestab': {'type': 'str', }, 'ntermi': {'type': 'str', }, 'ntermi_err': {'type': 'str', }, 'delay_unbind': {'type': 'str', }, 'long_resp': {'type': 'str', }, 'miss_resp': {'type': 'str', }, 'unbound_data_rcv': {'type': 'str', }, 'pause_conn': {'type': 'str', }, 'pause_conn_fail': {'type': 'str', }, 'resume_conn': {'type': 'str', }, 'not_remove_from_rport': {'type': 'str', }}
    })
    return rv
