...
def get_argspec():
    ...
    # Parent keys
    rv.update(
        dict(gtp_network_element_topn_tmpl_name=dict(type='str',
                                                     required=True), ))
    return rv
...
def existing_url(module):
    ...
    if '/' in module.params["gtp_network_element_topn_tmpl_name"]:
        f_dict["gtp_network_element_topn_tmpl_name"] = module.params[
            "gtp_network_element_topn_tmpl_name"].replace("/", "%2F")
    else:
        f_dict["gtp_network_element_topn_tmpl_name"] = module.params[
            "gtp_network_element_topn_tmpl_name"]
