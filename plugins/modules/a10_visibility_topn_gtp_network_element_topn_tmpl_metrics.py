...
AVAILABLE_PROPERTIES = [
    ...
    "drop_vld_invalid_flow_label_v0", "drop_vld_invalid_pkt_len_piggyback", "drop_vld_invalid_teid", "drop_vld_mandatory_information_element", "drop_vld_message_length", "drop_vld_out_of_order_ie", "drop_vld_out_of_state", "drop_vld_out_of_state_ie", "drop_vld_protocol_flag_unset", "drop_vld_reserved_field_set",
    "drop_vld_reserved_information_element", "drop_vld_sanity_failed_piggyback", "drop_vld_sequence_num_correlation", "drop_vld_tunnel_id_flag", "drop_vld_unsupported_message_type", "drop_vld_version_not_supported", "drop_vld_gtp_bearer_count_exceed", "gtp_c_handover_in_progress_with_conn", "gtp_path_management_message", "gtp_u_tunnel_created",
    ...
    "gtp_v2_c_tunnel_half_open", "rl_message_monitor", "u_downlink_bytes", "u_downlink_pkts", "u_uplink_bytes", "u_uplink_pkts", "uplink_bytes", "uplink_pkts", "uuid",
    ]
