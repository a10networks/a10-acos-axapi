...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_l7session_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["conn_not_exist", "data_cb_failed", "duration", "err_cb_failed", "err_event", "hps_fwdreq_fail", "server_conn_failed", "server_select_fail", "threshold_exceeded_by", "uuid", "wbuf_cb_failed", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'conn_not_exist': {'type': 'bool', },
        'wbuf_cb_failed': {'type': 'bool', },
        'err_event': {'type': 'bool', },
        'err_cb_failed': {'type': 'bool', },
        'server_conn_failed': {'type': 'bool', },
        'server_select_fail': {'type': 'bool', },
        'data_cb_failed': {'type': 'bool', },
        'hps_fwdreq_fail': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-l7session/trigger-stats-rate"
