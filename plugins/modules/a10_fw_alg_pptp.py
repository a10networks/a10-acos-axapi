        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'call-reply-pns-call-id-mismatch', 'gre-session-created',
                    'gre-session-freed', 'call-req-retransmit', 'call-req-new',
                    'call-req-ext-alloc-failure', 'call-reply-call-id-unknown',
                    'call-reply-retransmit',
