...
DOCUMENTATION = r'''
module: a10_ddos_dst_default_l4_type
description:
    - DDOS L4 type
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["deny", "disable_syn_auth", "drop_frag_pkt", "drop_on_no_port_match", "glid", "max_rexmit_syn_per_flow", "protocol", "stateful", "syn_auth", "syn_cookie", "tcp_reset_client", "tcp_reset_server", "tunnel_decap", "tunnel_rate_limit", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/default/{default_address_type}/l4-type/{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/default/{default_address_type}/l4-type"
