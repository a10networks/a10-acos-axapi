...
def present(module, result, existing_config):
    payload = utils.build_json("gtp-apn-prefix-topn-tmpl", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "gtp-apn-prefix-topn-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "gtp-apn-prefix-topn-tmpl-list"] if info != "NotFound" else info
