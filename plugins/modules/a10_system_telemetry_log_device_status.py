...
def present(module, result, existing_config):
    payload = utils.build_json("device-status", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "device-status"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "device-status-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["device-status"][
