...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_zone_src_port_other
description:
...
AVAILABLE_PROPERTIES = ["default_action_list", "deny", "glid_cfg", "level_list", "oper", "port_ind", "port_other", "protocol", "set_counter_base_val", "uuid", "zone_template", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port_other/{port-other}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port-other/"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["zone-src-port-other"]["oper"] if info != "NotFound" else info
