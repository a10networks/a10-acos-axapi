...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/fixed-nat/inside/ipv6address/{inside_start_address}+{inside_end_address}+{inside_netmask}+{partition}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/fixed-nat/inside/ipv6address/++"
...
def present(module, result, existing_config):
    payload = utils.build_json("ipv6address", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ipv6address"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["ipv6address-list"] if info != "NotFound" else info
