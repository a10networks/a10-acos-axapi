...
DOCUMENTATION = r'''
module: a10_interface_tunnel_ip_ospf_ospf_ip
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/interface/tunnel/{tunnel_ifnum}/ip/ospf/ospf-ip/{ip_addr}"
    ...
    if '/' in module.params["tunnel_ifnum"]:
        f_dict["tunnel_ifnum"] = module.params["tunnel_ifnum"].replace("/","%2F")
    else:
