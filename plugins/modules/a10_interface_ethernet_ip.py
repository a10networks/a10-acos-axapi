...
AVAILABLE_PROPERTIES = ["address_list", "allow_promiscuous_vip", "cache_spoofing_port", "client", "dhcp", "generate_membership_query", "helper_address_list", "inside", "max_resp_time", "ospf", "outside", "query_interval", "rip", "router", "server", "slb_partition_redirect", "stateful_firewall", "syn_cookie", "ttl_ignore", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'dhcp': {'type': 'bool', },
        ...
        'helper_address_list': {'type': 'list', 'helper_address': {'type': 'str', }},
        'inside': {'type': 'bool', },
        'outside': {'type': 'bool', },
        'ttl_ignore': {'type': 'bool', },
        'syn_cookie': {'type': 'bool', },
        'slb_partition_redirect': {'type': 'bool', },
        ...
        'server': {'type': 'bool', },
        'uuid': {'type': 'str', },
        'stateful_firewall': {'type': 'dict', 'inside': {'type': 'bool', }, 'class_list': {'type': 'str', }, 'outside': {'type': 'bool', }, 'access_list': {'type': 'bool', }, 'acl_id': {'type': 'int', }, 'uuid': {'type': 'str', }},
