...
DOCUMENTATION = r'''
module: a10_ddos_zone_profile_port_range
description:
    - DDOS Port-Range & Protocol profile configuration
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["indicator_list", "port_range_end", "port_range_start", "protocol", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port-range/{port_range_start}+{port_range_end}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port-range/+"
