...
def present(module, result, existing_config):
    payload = utils.build_json("ws-federation", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "ws-federation"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "ws-federation-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["ws-federation"][
