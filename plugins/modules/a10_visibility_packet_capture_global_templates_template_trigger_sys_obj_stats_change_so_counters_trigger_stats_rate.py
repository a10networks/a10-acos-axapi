...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'so_pkts_slb_nat_reserve_fail': {'type': 'bool', },
