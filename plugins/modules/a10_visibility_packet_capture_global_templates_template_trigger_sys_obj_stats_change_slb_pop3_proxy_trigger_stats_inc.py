...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_pop3_proxy_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["bad_sequence", "cl_est_err", "insert_tuple_fail", "invalid_start_line", "line_too_long", "no_route", "rsv_persist_conn_fail", "ser_connecting_err", "server_response_err", "smp_v4_fail", "smp_v6_fail", "snat_fail", "svrsel_fail", "unsupported_command", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-pop3-proxy/trigger-stats-inc"
