...
DOCUMENTATION = r'''
module: a10_ddos_zone_template_http_filter
description:
...
options:
    ...
    http_header_cfg:
        ...
        suboptions:
            ...
            http_filter_header_inverse_match:
                description:
                - "Field http_filter_header_inverse_match"
                type: bool
    http_referer_cfg:
        description:
    ...
    http_uri_cfg:
        ...
        suboptions:
            ...
            uri_contains_cfg:
                description:
                - "Field uri_contains_cfg"
                type: list
            uri_starts_cfg:
                description:
                - "Field uri_starts_cfg"
                type: list
            uri_ends_cfg:
                description:
                - "Field uri_ends_cfg"
...
AVAILABLE_PROPERTIES = ["dst", "http_agent_cfg", "http_filter_action", "http_filter_action_list_name", "http_filter_name", "http_filter_seq", "http_header_cfg", "http_referer_cfg", "http_uri_cfg", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/http/{http_tmpl_name}/filter/{http_filter_name}"

    f_dict = {}
    if '/' in str(module.params["http_filter_name"]):
        f_dict["http_filter_name"] = module.params["http_filter_name"].replace("/", "%2F")
    else:
        f_dict["http_filter_name"] = module.params["http_filter_name"]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/http/{http_tmpl_name}/filter"

    f_dict = {}
    f_dict["http_filter_name"] = ""
    f_dict["http_tmpl_name"] = module.params["http_tmpl_name"]
