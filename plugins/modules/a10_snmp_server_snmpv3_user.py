...
def get_argspec():
    ...
    rv.update({'username': {'type': 'str', 'required': True, },
        'group': {'type': 'str', },
        'v3': {'type': 'str', 'choices': ['auth', 'noauth']},
        'auth_val': {'type': 'str', 'choices': ['md5', 'sha']},
        'passwd': {'type': 'str', },
        'pw_encrypted': {'type': 'str', },
        'priv': {'type': 'str', 'choices': ['des', 'aes']},
        'encpasswd': {'type': 'str', },
        'priv_pw_encrypted': {'type': 'str', },
        'uuid': {'type': 'str', }
    })
    return rv
...
def existing_url(module):
    ...
    f_dict = {}
    if '/' in str(module.params["username"]):
        f_dict["username"] = module.params["username"].replace("/","%2F")
    else:
