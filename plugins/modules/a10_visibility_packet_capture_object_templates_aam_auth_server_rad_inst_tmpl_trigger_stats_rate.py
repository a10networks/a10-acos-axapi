...
AVAILABLE_PROPERTIES = ["accounting_failure", "authen_failure", "authorize_failure", "duration", "other_error", "threshold_exceeded_by", "timeout_error", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-server-rad-inst-tmpl/{aam_auth_server_rad_inst_tmpl_name}/trigger-stats-rate"
