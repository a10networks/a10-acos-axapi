...
AVAILABLE_PROPERTIES = [
    ...
    "request_response_model", "request_to_response_max_time", "response_length_max", "response_request_max_ratio", "response_request_min_ratio", "response_to_request_max_time", "time_window_tracking", "uuid", "violation",
    ]
