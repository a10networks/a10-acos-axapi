...
AVAILABLE_PROPERTIES = ["compress_ctx_alloc_fail", "ctx_alloc_fail", "data_cb_no_tuple", "data_no_stream", "data_no_stream_goaway_close", "data_no_stream_no_goaway", "decompress_fail", "est_cb_no_tuple", "header_compress_fail", "http_conn_alloc_fail", "http_err_stream_closed", "invalid_frame_size", "invalid_version", "request_header_alloc_fail", "session_err", "stream_alloc_fail", "stream_err", "stream_not_found", "tcp_err", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-spdy-proxy/trigger-stats-inc"
