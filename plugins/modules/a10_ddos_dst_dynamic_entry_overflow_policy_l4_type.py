...
DOCUMENTATION = r'''
module: a10_ddos_dst_dynamic_entry_overflow_policy_l4_type
description:
    - DDOS L4 type
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["deny", "drop_frag_pkt", "drop_on_no_port_match", "glid", "max_rexmit_syn_per_flow", "protocol", "stateful", "syn_auth", "syn_cookie", "tcp_reset_client", "tcp_reset_server", "tunnel_decap", "tunnel_rate_limit", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/dynamic-entry-overflow-policy/{dynamic_entry_overflow_policy_default_address_type}/l4-type/{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/dynamic-entry-overflow-policy/{dynamic_entry_overflow_policy_default_address_type}/l4-type"
