...
def present(module, result, existing_config):
    payload = utils.build_json("web-category-license", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "web-category-license"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "web-category-license-list"] if info != "NotFound" else info
