...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_auth_server_ocsp_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "job_start_error", "polling_control_error", "request_dropped", "response_error", "response_failure", "response_timeout", "stapling_request_dropped", "stapling_response_error", "stapling_response_failure", "stapling_response_timeout", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'stapling_request_dropped': {'type': 'bool', },
        'stapling_response_failure': {'type': 'bool', },
        'stapling_response_error': {'type': 'bool', },
        'stapling_response_timeout': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-auth-server-ocsp/trigger-stats-rate"
