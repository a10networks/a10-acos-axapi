...
AVAILABLE_PROPERTIES = [
    "duration", "job_start_error", "polling_control_error", "request_dropped", "response_error", "response_failure", "response_timeout", "stapling_request_dropped", "stapling_response_error", "stapling_response_failure", "stapling_response_timeout", "threshold_exceeded_by", "uuid",
    ]
