...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_src_dst_pair_policy_policy_class_list
description:
...
options:
    ...
    class_list_overflow_policy_list:
        ...
        suboptions:
            dummy_name:
                description:
                - "'configuration'= Configure src dst dynamic entry count overflow policy for
          class-list;"
                type: str
            bypass:
                description:
            ...
            l4_type_src_dst_overflow_list:
                description:
                - "Field l4_type_src_dst_overflow_list"
                type: list
            app_type_src_dst_overflow_list:
                description:
                - "Field app_type_src_dst_overflow_list"
                type: list
    stats:
        description:
        - "Field stats"
...
AVAILABLE_PROPERTIES = ["app_type_src_dst_list", "bypass", "class_list_name", "class_list_overflow_policy_list", "exceed_log_cfg", "glid", "l4_type_src_dst_list", "log_periodic", "max_dynamic_entry_count", "sampling_enable", "stats", "template", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(src_dst_pair_policy_src_based_policy_name=dict(type='str', required=True), entry_dst_entry_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/src-dst-pair-policy/{src_dst_pair_policy_src_based_policy_name}/policy-class-list/{class_list_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/src-dst-pair-policy/{src_dst_pair_policy_src_based_policy_name}/policy-class-list"
