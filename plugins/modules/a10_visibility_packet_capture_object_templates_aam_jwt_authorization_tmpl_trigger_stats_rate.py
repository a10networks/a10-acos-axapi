...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_aam_jwt_authorization_tmpl_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "jwt_authorize_failure", "jwt_missing_claim", "jwt_missing_token", "jwt_other_error", "jwt_signature_failure", "jwt_token_expired", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'jwt_authorize_failure': {'type': 'bool', },
        'jwt_missing_token': {'type': 'bool', },
        'jwt_missing_claim': {'type': 'bool', },
        'jwt_token_expired': {'type': 'bool', },
        'jwt_signature_failure': {'type': 'bool', },
        'jwt_other_error': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-jwt-authorization-tmpl/{aam_jwt_authorization_tmpl_name}/trigger-stats-rate"
