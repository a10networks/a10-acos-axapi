...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_detection_packet_anomaly_detection_indicator
description:
    - Packet Anomaly indicator configuration
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["threshold_num", "ntype", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'ntype': {'type': 'str', 'required': True, 'choices': ['port-zero-pkt-rate']}, 'threshold_num': {'type': 'int', }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/detection/packet-anomaly-detection/indicator/{type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/detection/packet-anomaly-detection/indicator"
