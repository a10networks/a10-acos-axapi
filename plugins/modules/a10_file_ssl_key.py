...
AVAILABLE_PROPERTIES = ["action", "dst_file", "file", "file_handle", "oper", "secured", "uuid", ]
...
def create(module, result, payload={}):
    ...
    result["modified_values"].update(**call_result["request_body"]["ssl-key"])
    result["changed"] = True
    return result
...
def _cert_delete(module):
    params = {"delete": {}}
    params['delete'] = {"private-key": "{}".format(module.params['file'])}
    url = '/axapi/v3/pki/delete'
    call_result = {"endpoint": url, "http_method": "POST", "request_body": params, "response_body": {}, }
    try:
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(module.client, "ssl-key", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ssl-key"]["oper"] if info != "NotFound" else info
    except a10_ex.ACOSException as ex:
