...
AVAILABLE_PROPERTIES = [
    ...
    "threshold_exceeded_by", "udp_bad_csum", "udp_bad_len", "udp_kerb_frg", "udp_port_lb", "udp_srt_hdr", "uuid", "vxlan_err",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/ip-anomaly-drop/trigger-stats-rate"
