...
AVAILABLE_PROPERTIES = ["delete", "file_url", "image", "local", "rollback", "source_ip_address", "upload", "use_mgmt_port", ]
...
def get_argspec():
    ...
    rv.update({'file_content': {'type': 'str', },'image': {'type': 'str', 'choices': ['pri', 'sec']},
        'local': {'type': 'str', },
        'rollback': {'type': 'str', },
        'delete': {'type': 'str', },
...
def get(module):
    ...
    if file_info:
        ...
        file_list = file_info["gui"]["oper"].get("file-list", [])
