...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'ip': {'type': 'int', }, 'mac': {'type': 'int', }, 'hash_list': {'type': 'list', 'hash': {'type': 'int', }, 'node': {'type': 'int', }, 'so_ip': {'type': 'str', }, 'so_mac': {'type': 'str', }, 'real_port': {'type': 'int', }, 'stale': {'type': 'int', }, 'ref_count': {'type': 'int', }}}
    })
    return rv
