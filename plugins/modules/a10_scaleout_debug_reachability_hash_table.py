...
def present(module, result, existing_config):
    payload = utils.build_json("hash-table", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "hash-table"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "hash-table-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["hash-table"][
