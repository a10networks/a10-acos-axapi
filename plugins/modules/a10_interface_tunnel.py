...
AVAILABLE_PROPERTIES = ["action", "ifnum", "ip", "ipv6", "load_interval", "mtu", "name", "oper", "packet_capture_template", "sampling_enable", "security_level", "speed", "stats", "user_tag", "uuid", ]
