...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_rpz_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["parse_error", "set_bw_error", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'set_bw_error': {'type': 'bool', }, 'parse_error': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-rpz/trigger-stats-inc"
