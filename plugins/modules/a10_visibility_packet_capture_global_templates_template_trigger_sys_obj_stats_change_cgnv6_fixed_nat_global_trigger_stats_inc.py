...
AVAILABLE_PROPERTIES = [
    ...
    "nat44_eif_limit_exceeded", "nat44_inbound_filtered", "nat64_eif_limit_exceeded", "nat64_inbound_filtered", "port_overload_failed", "session_user_quota_exceeded", "sixrd_drop", "standby_drop", "uuid",
    ]
