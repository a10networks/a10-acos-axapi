...
AVAILABLE_PROPERTIES = [
    "config_not_found", "dest_rlist_drop", "dest_rlist_pass_through", "dest_rlist_snat_drop", "dslite_eif_limit_exceeded", "dslite_inbound_filtered", "fixed_nat_fullcone_self_hairpinning_dro", "fullcone_failure", "ha_session_user_quota_exceeded", "nat_port_unavailable_icmp",
    "nat_port_unavailable_tcp", "nat_port_unavailable_udp", "nat44_eif_limit_exceeded", "nat44_inbound_filtered", "nat64_eif_limit_exceeded", "nat64_inbound_filtered", "port_overload_failed", "session_user_quota_exceeded", "sixrd_drop", "standby_drop", "uuid",
    ]
