...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_fixed_nat_global_trigger_stats_inc
description:
...
options:
    ...
    nat44_eif_limit_exceeded:
        description:
        - "Enable automatic packet-capture for NAT44 Endpoint-Independent-Filtering Limit
          Exceeded"
        type: bool
        required: False
    nat64_eif_limit_exceeded:
        description:
        - "Enable automatic packet-capture for NAT64 Endpoint-Independent-Filtering Limit
          Exceeded"
        type: bool
        required: False
    dslite_eif_limit_exceeded:
        description:
        - "Enable automatic packet-capture for DS-Lite Endpoint-Independent-Filtering
          Limit Exceeded"
        type: bool
        required: False
    standby_drop:
...
AVAILABLE_PROPERTIES = [
    "config_not_found", "dest_rlist_drop", "dest_rlist_pass_through", "dest_rlist_snat_drop", "dslite_eif_limit_exceeded", "dslite_inbound_filtered", "fixed_nat_fullcone_self_hairpinning_dro", "fullcone_failure", "ha_session_user_quota_exceeded", "nat_port_unavailable_icmp", "nat_port_unavailable_tcp", "nat_port_unavailable_udp",
    "nat44_eif_limit_exceeded", "nat44_inbound_filtered", "nat64_eif_limit_exceeded", "nat64_inbound_filtered", "port_overload_failed", "session_user_quota_exceeded", "sixrd_drop", "standby_drop", "unused_ip_drop", "uuid",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-fixed-nat-global/trigger-stats-inc"
