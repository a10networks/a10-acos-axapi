...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_fixed_nat_alg_rtsp_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "no_session_mem", "port_allocation_failure", "stream_creation_failure", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'stream_creation_failure': {'type': 'bool', }, 'port_allocation_failure': {'type': 'bool', }, 'no_session_mem': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-fixed-nat-alg-rtsp/trigger-stats-rate"
