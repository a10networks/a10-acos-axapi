...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_sip_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["msg_proxy_client_fail", "msg_proxy_fail_start_server_conn", "msg_proxy_server_fail", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'msg_proxy_client_fail': {'type': 'bool', }, 'msg_proxy_server_fail': {'type': 'bool', }, 'msg_proxy_fail_start_server_conn': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-sip/trigger-stats-inc"
