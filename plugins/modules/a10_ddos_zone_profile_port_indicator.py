...
DOCUMENTATION = r'''
module: a10_ddos_zone_profile_port_indicator
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(port_protocol=dict(type='str', required=True), port_num=dict(type='str', required=True), zone_profile_profile_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port/{port_num}+{port_protocol}/indicator/{indicator_name}"
    ...
    if '/' in module.params["port_protocol"]:
        f_dict["port_protocol"] = module.params["port_protocol"].replace("/", "%2F")
    else:
        f_dict["port_protocol"] = module.params["port_protocol"]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port/{port_num}+{port_protocol}/indicator"
