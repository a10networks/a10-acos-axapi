...
DOCUMENTATION = r'''
module: a10_ddos_network_object_template_sport_anomaly_threshold_packet_rate_percentage
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(network_object_template_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object-template/{network_object_template_name}/sport-anomaly-threshold/packet-rate-percentage"

    f_dict = {}
    if '/' in module.params["network_object_template_name"]:
        f_dict["network_object_template_name"] = module.params["network_object_template_name"].replace("/", "%2F")
    else:
        f_dict["network_object_template_name"] = module.params["network_object_template_name"]
