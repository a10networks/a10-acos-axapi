...
DOCUMENTATION = r'''
module: a10_ddos_dst_interface_ipv6_l4_type
description:
...
AVAILABLE_PROPERTIES = ["deny", "drop_frag_pkt", "glid", "protocol", "tunnel_decap", "tunnel_rate_limit", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/interface-ipv6/{interface_ipv6_addr}/l4-type/{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/interface-ipv6/{interface_ipv6_addr}/l4-type"
