...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_rule_set_tmpl_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["deny", "duration", "reset", "threshold_exceeded_by", "unmatched_drops", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'unmatched_drops': {'type': 'bool', }, 'deny': {'type': 'bool', }, 'reset': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/rule-set-tmpl/{rule_set_tmpl_name}/trigger-stats-rate"
