    ...
    sampling_enable:
        ...
        suboptions:
          ...
          Server_rx_handshake_done;"
            ...
            counters2:
                description:
                - "'Pkt_acked_failed'= Pkt_acked_failed; 'Tx_buffer_enq'= Tx buffer enqueued;
          'Tx_buffer_deq'= Tx buffer dequeued; 'App_buffer_enq'= App buffer enqueued;
          'App_buffer_deq'= App buffer dequeued; 'App_buffer_queue_full'= App buffer
          queue full; 'Iov_buffer_bind'= Iov buffer bind; 'Iov_buffer_unbind'= Iov buffer
          unbind; 'Iov_buffer_dup'= Iov buffer dup; 'Iov_alloc_len'= Iov alloc len;
          ...
          'on_ld_timeout'= lost detection timeout; 'idle_alarm'= conn idle timeout;
          'ack_alarm'= ack timeout; 'quic_malloc'= QUIC malloc; 'quic_free'= QUIC free;
          'quic_malloc_failure'= QUIC malloc failure; 'quick_malloc_failure'= quick
          malloc failure; 'quic_lb'= QUIC LB; 'cid_zero'= CID Zero; 'cid_cpu_hash'= CID
          CPU Hash; 'invalid_cid_sig'= Invalid CID Signature; 'key_update_rx'= QUIC TLS
          key update received; 'key_update_tx'= QUIC TLS key update sent;"
                type: str
    oper:
        description:
        - "Field oper"
    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters2': {
                ...
                'str',
                'choices': [
                    'Pkt_acked_failed', 'Tx_buffer_enq', 'Tx_buffer_deq', 'App_buffer_enq', 'App_buffer_deq', 'App_buffer_queue_full', 'Iov_buffer_bind', 'Iov_buffer_unbind', 'Iov_buffer_dup', 'Iov_alloc_len', 'No_tx_queue', 'wsocket_created', 'wsocket_closed', 'a10_socket_created', 'a10_socket_closed', 'No_a10_socket', 'No_other_side_socket',
                    'No_w_engine', 'on_ld_timeout', 'idle_alarm', 'ack_alarm', 'quic_malloc', 'quic_free', 'quic_malloc_failure', 'quick_malloc_failure', 'quic_lb', 'cid_zero', 'cid_cpu_hash', 'invalid_cid_sig', 'key_update_rx', 'key_update_tx'
                    ]
                }
            },
        'oper': {
