...
DOCUMENTATION = r'''
module: a10_fw_session_aging_udp
description:
    - UDP Aging options
author: A10 Networks
options:
...
def get_argspec():
    ...
    rv.update({'udp_idle_timeout': {'type': 'int', }, 'port_cfg': {'type': 'list', 'udp_port': {'type': 'int', }, 'udp_idle_timeout': {'type': 'int', }}, 'uuid': {'type': 'str', }})
    # Parent keys
    rv.update(dict(session_aging_name=dict(type='str', required=True), ))
    return rv
