...
def get_argspec():
    ...
    rv.update({'vlan_num': {'type': 'int', 'required': True, },
        ...
        'oper': {'type': 'dict', 'vlan_name': {'type': 'str', }, 've_num': {'type': 'int', }, 'is_shared_vlan': {'type': 'str', }, 'un_tagg_eth_ports': {'type': 'dict', 'ports': {'type': 'int', }}, 'tagg_eth_ports': {'type': 'dict', 'ports': {'type': 'int', }}, 'un_tagg_logical_ports': {'type': 'dict', 'ports': {'type': 'int', }}, 'tagg_logical_ports': {'type': 'dict', 'ports': {'type': 'int', }}, 'span_tree': {'type': 'str', }, 'vlan_num': {'type': 'int', 'required': True, }},
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/network/vlan/{vlan_num}"

    f_dict = {}
    if '/' in str(module.params["vlan_num"]):
        f_dict["vlan_num"] = module.params["vlan_num"].replace("/","%2F")
    else:
        f_dict["vlan_num"] = module.params["vlan_num"]
