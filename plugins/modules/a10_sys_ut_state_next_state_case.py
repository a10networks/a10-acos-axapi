...
description:
    - Case number
short_description: Configures A10 sys-ut.state.next.state.case
...
options:
    ...
    name:
        ...
        description:
        - Key to identify parent object    action_list:
        description:
        - "Field action_list"
        required: False
        suboptions:
    ...
    if existing_config:
        for k, v in payload["case"].items():
            if isinstance(v, str):
                ...
                if existing_config["case"][k] != v:
                    if result["changed"] is not True:
                        result["changed"] = True
                    existing_config["case"][k] = v
