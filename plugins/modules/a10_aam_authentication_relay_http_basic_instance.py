...
def get_argspec():
    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                'type': 'str',
                'choices': ['all', 'success', 'no-creds', 'bad-req', 'unauth', 'forbidden', 'not-found', 'server-error', 'unavailable']
                }
            },
        'packet_capture_template': {
            'type': 'str',
...
def new_url(module):
    ...
    url_base = "/axapi/v3/aam/authentication/relay/http-basic/instance"
