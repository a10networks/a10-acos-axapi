...
options:
    ...
    sampling_enable:
        ...
        suboptions:
            counters1:
                description:
                - "'all'= all; 'success'= Success; 'no-creds'= No Credential; 'bad-req'= Bad
...
AVAILABLE_PROPERTIES = ["domain", "domain_format", "name", "packet_capture_template", "sampling_enable", "stats", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'domain': {'type': 'str', },
        'domain_format': {'type': 'str', 'choices': ['user-principal-name', 'down-level-logon-name']},
        'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'success', 'no-creds', 'bad-req', 'unauth', 'forbidden', 'not-found', 'server-error', 'unavailable']}},
        'packet_capture_template': {'type': 'str', },
        'stats': {'type': 'dict', 'success': {'type': 'str', }, 'no_creds': {'type': 'str', }, 'bad_req': {'type': 'str', }, 'unauth': {'type': 'str', }, 'forbidden': {'type': 'str', }, 'not_found': {'type': 'str', }, 'server_error': {'type': 'str', }, 'unavailable': {'type': 'str', }, 'name': {'type': 'str', 'required': True, }}
    })
    return rv
