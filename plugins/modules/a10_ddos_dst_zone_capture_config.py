...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_capture_config
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/capture-config/{name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/capture-config"
