...
DOCUMENTATION = r'''
module: a10_sys_ut_state_next_state_case_action_udp
description:
    - UDP header
author: A10 Networks
options:
...
def get_argspec():
    ...
    rv.update({'src_port': {'type': 'int', }, 'dest_port': {'type': 'bool', }, 'dest_port_value': {'type': 'int', }, 'nat_pool': {'type': 'str', }, 'length': {'type': 'int', }, 'checksum': {'type': 'str', 'choices': ['valid', 'invalid']}, 'uuid': {'type': 'str', }})
    # Parent keys
