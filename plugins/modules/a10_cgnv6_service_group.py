...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'shared': {'type': 'bool', },
        'shared_partition': {'type': 'str', },
        'shared_group': {'type': 'str', },
