...
AVAILABLE_PROPERTIES = ["health_check", "member_list", "name", "oper", "packet_capture_template", "protocol", "sampling_enable", "shared", "shared_group", "shared_partition", "stats", "traffic_replication_mirror_ip_repl", "user_tag", "uuid", ]
