...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_detection_outbound_detection_indicator
description:
    - Outbound indicator configuration
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/detection/outbound-detection/indicator/{type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/detection/outbound-detection/indicator"
