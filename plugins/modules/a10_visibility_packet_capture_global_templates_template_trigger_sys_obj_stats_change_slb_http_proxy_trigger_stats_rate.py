...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_http_proxy_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "fwdreq_fail", "fwdreqdata_fail", "parsereq_fail", "req_over_limit", "req_rate_over_limit", "snat_fail", "svrsel_fail", "threshold_exceeded_by", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-http-proxy/trigger-stats-rate"
