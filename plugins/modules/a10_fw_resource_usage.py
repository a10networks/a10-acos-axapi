...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'fw_object_current_count': {'type': 'int', }, 'fw_object_total_count': {'type': 'int', }, 'fw_object_group_current_count': {'type': 'int', }, 'fw_object_group_total_count': {'type': 'int', }, 'fw_rule_set_current_count': {'type': 'int', }, 'fw_rule_set_total_count': {'type': 'int', }, 'fw_rule_current_count': {'type': 'int', }, 'fw_rule_total_count': {'type': 'int', }, 'fw_zone_current_count': {'type': 'int', }, 'fw_zone_total_count': {'type': 'int', }, 'fw_ip_range_current_count': {'type': 'int', }, 'fw_ip_range_total_count': {'type': 'int', }, 'fw_helper_sessions_current_count': {'type': 'int', }, 'fw_helper_sessions_total_count': {'type': 'int', }, 'radius_table_current_count': {'type': 'int', }, 'radius_table_total_count': {'type': 'int', }, 'clause_per_obj_grp_current_count': {'type': 'str', }, 'clause_per_obj_grp_total_count': {'type': 'int', }, 'object': {'type': 'bool', }, 'object_group': {'type': 'bool', }, 'rule_set': {'type': 'bool', }, 'rule': {'type': 'bool', }, 'zone': {'type': 'bool', }, 'ip_range': {'type': 'bool', }, 'helper_sessions': {'type': 'bool', }, 'radius_table_size': {'type': 'bool', }, 'clause_per_obj_grp': {'type': 'bool', }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/fw/resource-usage"
