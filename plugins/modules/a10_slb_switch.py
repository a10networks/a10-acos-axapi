...
options:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          'tls13_drop_req'= TLS13-Request-Per-Sec Limit Drop at ingress;
          'tls13_ignore_req'= TLS13-Request-Per-Sec Limit ignored packets count;
          'tls12_drop_req'= TLS12-Request-Per-Sec Limit Drop at ingress;
          'tls12_ignore_req'= TLS12-Request-Per-Sec Limit ignored packets count;
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'lacp_tx_intf_err_drop', 'service_chain_sent', 'service_chain_rcvd', 'unnumbered_nat_error', 'unnumbered_unsupported_drop', 'ipv6frag_gre_dropped', 'ipv6_ndisc_dad_prefix_mismatch_drop', 'bw_ignore_limit', 'ppsl_drop_egr', 'ppsl_drop_ing', 'ppsl_ignore_limit', 'closed_port_syn_drop', 'tls13_drop_req', 'tls13_ignore_req',
                    'tls12_drop_req', 'tls12_ignore_req', 'tls12_tls13_drop_req', 'tls12_tls13_ignore_req'
                    ]
                }
            },
        'stats': {
