...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_web_gui_protection_port_zone_service
description:
...
AVAILABLE_PROPERTIES = ["pbe", "port_num", "protocol", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'port_num': {'type': 'int', 'required': True, }, 'protocol': {'type': 'str', 'required': True, 'choices': ['dns-tcp', 'dns-udp', 'http', 'tcp', 'udp', 'ssl-l4']}, 'pbe': {'type': 'str', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/port/zone-service/{port_num}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/port/zone-service/"
