...
AVAILABLE_PROPERTIES = ["act_name", "action", "version", ]
...
def get_argspec():
    ...
    rv.update({'file_path': {'type': 'str', }, 'action': {'type': 'str', }, 'act_name': {'type': 'str', }, 'version': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/file/template/app"
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(module.client, "app", file_url, module.params['file'])
