...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_slb_service_tmpl_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["es_resp_300", "es_resp_400", "es_resp_500", "resp_3xx", "resp_4xx", "resp_5xx", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'es_resp_300': {'type': 'bool', }, 'es_resp_400': {'type': 'bool', }, 'es_resp_500': {'type': 'bool', }, 'resp_3xx': {'type': 'bool', }, 'resp_4xx': {'type': 'bool', }, 'resp_5xx': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/slb-service-tmpl/{slb_service_tmpl_name}/trigger-stats-inc"
