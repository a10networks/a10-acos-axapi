...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_tcp_udp_stats_tcp_zone_port
description:
    - Statistics for the object proto-tcp-udp
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["protocol", "stats", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-tcp-udp/{proto_tcp_udp_protocol}/stats?tcp-zone-port=true"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["proto-tcp-udp"]["stats"] if info != "NotFound" else info
