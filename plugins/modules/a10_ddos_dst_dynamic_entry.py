            ...
            'sampling_enable': {
                ...
                'counters3': {
                    ...
                    'choices': [
                        ...
                        'prog_win_exceed_drop', 'prog_win_exceed_bl', 'dst_exceed_action_drop', 'src_hw_drop', 'dst_tcp_auth_rst', 'dst_src_learn_overflow', 'tcp_fwd_sent', 'udp_fwd_sent', 'prog_query_exceed', 'prog_think_exceed'
                        ]
                    }
                }
            },
