...
def get_argspec():
    ...
    rv.update({'auto_size': {'type': 'bool', },
        'editing': {'type': 'bool', },
        'gslb_cfg': {'type': 'dict', 'gslb_prompt': {'type': 'bool', }, 'disable': {'type': 'bool', }, 'group_role': {'type': 'bool', }, 'symbol': {'type': 'bool', }},
        'history_cfg': {'type': 'dict', 'enable': {'type': 'bool', }, 'size': {'type': 'int', }},
        'idle_timeout': {'type': 'int', },
        'length': {'type': 'int', },
        'prompt_cfg': {'type': 'dict', 'prompt': {'type': 'bool', }, 'ha_status': {'type': 'bool', }, 'hostname': {'type': 'bool', }, 'vcs_cfg': {'type': 'dict', 'vcs_status': {'type': 'bool', }}},
        'width': {'type': 'int', },
        'uuid': {'type': 'str', }
    })
    return rv
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["terminal"].items():
        ...
        if config_changes["terminal"].get(k) != v:
            change_results["changed"] = True
            config_changes["terminal"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("terminal", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["terminal"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["terminal-list"] if info != "NotFound" else info
