...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'stapling-certificate-good', 'stapling-certificate-revoked', 'stapling-certificate-unknown', 'stapling-request-normal', 'stapling-request-dropped', 'stapling-response-success', 'stapling-response-failure', 'stapling-response-error', 'stapling-response-timeout', 'stapling-response-other', 'request-normal', 'request-dropped', 'response-success', 'response-failure', 'response-error', 'response-timeout', 'response-other', 'job-start-error', 'polling-control-error']}},
        'instance_list': {'type': 'list', 'name': {'type': 'str', 'required': True, }, 'url': {'type': 'str', }, 'responder_ca': {'type': 'str', }, 'responder_cert': {'type': 'str', }, 'health_check': {'type': 'bool', }, 'health_check_string': {'type': 'str', }, 'health_check_disable': {'type': 'bool', }, 'port_health_check': {'type': 'str', }, 'port_health_check_disable': {'type': 'bool', }, 'http_version': {'type': 'bool', }, 'version_type': {'type': 'str', 'choices': ['1.1']}, 'uuid': {'type': 'str', }, 'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'request', 'certificate-good', 'certificate-revoked', 'certificate-unknown', 'timeout', 'fail', 'stapling-request', 'stapling-certificate-good', 'stapling-certificate-revoked', 'stapling-certificate-unknown', 'stapling-timeout', 'stapling-fail']}}, 'packet_capture_template': {'type': 'str', }},
        'stats': {'type': 'dict', 'stapling_certificate_good': {'type': 'str', }, 'stapling_certificate_revoked': {'type': 'str', }, 'stapling_certificate_unknown': {'type': 'str', }, 'stapling_request_normal': {'type': 'str', }, 'stapling_request_dropped': {'type': 'str', }, 'stapling_response_success': {'type': 'str', }, 'stapling_response_failure': {'type': 'str', }, 'stapling_response_error': {'type': 'str', }, 'stapling_response_timeout': {'type': 'str', }, 'stapling_response_other': {'type': 'str', }, 'request_normal': {'type': 'str', }, 'request_dropped': {'type': 'str', }, 'response_success': {'type': 'str', }, 'response_failure': {'type': 'str', }, 'response_error': {'type': 'str', }, 'response_timeout': {'type': 'str', }, 'response_other': {'type': 'str', }, 'job_start_error': {'type': 'str', }, 'polling_control_error': {'type': 'str', }, 'instance_list': {'type': 'list', 'name': {'type': 'str', 'required': True, }, 'stats': {'type': 'dict', 'request': {'type': 'str', }, 'certificate_good': {'type': 'str', }, 'certificate_revoked': {'type': 'str', }, 'certificate_unknown': {'type': 'str', }, 'timeout': {'type': 'str', }, 'fail': {'type': 'str', }, 'stapling_request': {'type': 'str', }, 'stapling_certificate_good': {'type': 'str', }, 'stapling_certificate_revoked': {'type': 'str', }, 'stapling_certificate_unknown': {'type': 'str', }, 'stapling_timeout': {'type': 'str', }, 'stapling_fail': {'type': 'str', }}}}
    })
    return rv
