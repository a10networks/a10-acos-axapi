...
def present(module, result, existing_config):
    payload = utils.build_json("dns-a-record-srv", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "dns-a-record-srv"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "dns-a-record-srv-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["dns-a-record-srv"][
