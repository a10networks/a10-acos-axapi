...
AVAILABLE_PROPERTIES = ["admin_ip", "as_backup", "as_replace", "disable", "no_resp", "service_name", "static", "stats", "svrname", "ttl", "uuid", "weight", ]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/gslb/zone/{zone_name}/service/{service_port}+{service_name}/dns-a-record/dns-a-record-srv"
