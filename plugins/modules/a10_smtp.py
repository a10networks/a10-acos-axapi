...
def get_argspec():
    ...
    rv.update({'smtp_server': {'type': 'str', },
        'smtp_server_v6': {'type': 'str', },
        'port': {'type': 'int', },
        'needauthentication': {'type': 'bool', },
        'mailfrom': {'type': 'str', },
        'use_mgmt_port': {'type': 'bool', },
        'username_cfg': {'type': 'dict', 'username': {'type': 'str', }, 'password': {'type': 'dict', 'smtp_password': {'type': 'str', }, 'encrypted': {'type': 'str', }}},
        'uuid': {'type': 'str', }
    })
    return rv
