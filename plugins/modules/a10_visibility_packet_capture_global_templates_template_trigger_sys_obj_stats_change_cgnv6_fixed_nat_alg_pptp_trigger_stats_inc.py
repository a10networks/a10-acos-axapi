...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_fixed_nat_alg_pptp_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["call_reply_pns_call_id_mismatch", "call_req_pns_call_id_mismatch", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'call_req_pns_call_id_mismatch': {'type': 'bool', }, 'call_reply_pns_call_id_mismatch': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-fixed-nat-alg-pptp/trigger-stats-inc"
