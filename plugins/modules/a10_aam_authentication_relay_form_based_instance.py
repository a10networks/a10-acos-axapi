...
options:
    ...
    sampling_enable:
        ...
        suboptions:
            counters1:
                description:
                - "'all'= all; 'request'= Request; 'invalid_srv_rsp'= Invalid Server Response;
          'post_fail'= POST Failed; 'invalid_cred'= Invalid Credential; 'bad_req'= Bad
...
AVAILABLE_PROPERTIES = ["name", "packet_capture_template", "request_uri_list", "sampling_enable", "stats", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'request', 'invalid_srv_rsp', 'post_fail', 'invalid_cred', 'bad_req', 'not_fnd', 'error', 'other_error']}},
        'packet_capture_template': {'type': 'str', },
        'request_uri_list': {'type': 'list', 'match_type': {'type': 'str', 'required': True, 'choices': ['equals', 'contains', 'starts-with', 'ends-with']}, 'uri': {'type': 'str', 'required': True, }, 'user_variable': {'type': 'str', }, 'password_variable': {'type': 'str', }, 'domain_variable': {'type': 'str', }, 'other_variables': {'type': 'str', }, 'max_packet_collect_size': {'type': 'int', }, 'cookie': {'type': 'dict', 'cookie_value': {'type': 'dict', 'cookie_value': {'type': 'str', }}}, 'action_uri': {'type': 'str', }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }},
        'stats': {'type': 'dict', 'request': {'type': 'str', }, 'invalid_srv_rsp': {'type': 'str', }, 'post_fail': {'type': 'str', }, 'invalid_cred': {'type': 'str', }, 'bad_req': {'type': 'str', }, 'not_fnd': {'type': 'str', }, 'error': {'type': 'str', }, 'other_error': {'type': 'str', }, 'name': {'type': 'str', 'required': True, }}
    })
    return rv
