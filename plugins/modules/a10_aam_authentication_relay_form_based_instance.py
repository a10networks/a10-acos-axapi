...
def get_argspec():
    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                'type': 'str',
                'choices': ['all', 'request', 'invalid_srv_rsp', 'post_fail', 'invalid_cred', 'bad_req', 'not_fnd', 'error', 'other_error']
                }
            },
        'packet_capture_template': {
            'type': 'str',
...
def new_url(module):
    ...
    url_base = "/axapi/v3/aam/authentication/relay/form-based/instance"
