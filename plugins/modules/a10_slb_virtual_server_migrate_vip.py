...
def present(module, result, existing_config):
    payload = utils.build_json("migrate-vip", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "migrate-vip"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "migrate-vip-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["migrate-vip"][
