...
def present(module, result, existing_config):
    payload = utils.build_json("glm-license", module.params,
                               AVAILABLE_PROPERTIES)
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(
            module.client, "glm-license", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "glm-license"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "glm-license-list"] if info != "NotFound" else info
