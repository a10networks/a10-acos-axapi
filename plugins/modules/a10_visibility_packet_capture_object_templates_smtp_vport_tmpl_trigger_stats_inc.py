...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_smtp_vport_tmpl_trigger_stats_inc
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/smtp-vport-tmpl/{smtp_vport_tmpl_name}/trigger-stats-inc"
