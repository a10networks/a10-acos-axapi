...
def present(module, result, existing_config):
    payload = utils.build_json("dns-ns-record", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "dns-ns-record"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "dns-ns-record-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["dns-ns-record"][
