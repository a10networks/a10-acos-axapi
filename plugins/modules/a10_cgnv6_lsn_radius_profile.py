...
def get_argspec():
    ...
    rv.update({'lid_profile_index': {'type': 'int', 'required': True, },
        'radius': {'type': 'list', 'attribute': {'type': 'str', 'choices': ['custom1', 'custom2', 'custom3', 'imei', 'imsi', 'msisdn', 'default']}, 'starts_with': {'type': 'str', }, 'starts_with_lsn_lid': {'type': 'int', }, 'exact_value': {'type': 'str', }, 'exact_value_lsn_lid': {'type': 'int', }, 'default_lsn_lid': {'type': 'int', }},
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', }
    })
    return rv
