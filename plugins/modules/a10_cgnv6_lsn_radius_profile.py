...
def existing_url(module):
    ...
    if '/' in str(module.params["lid_profile_index"]):
        f_dict["lid_profile_index"] = module.params[
            "lid_profile_index"].replace("/", "%2F")
    else:
...
def present(module, result, existing_config):
    payload = utils.build_json("lsn-radius-profile", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "lsn-radius-profile"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "lsn-radius-profile-list"] if info != "NotFound" else info
