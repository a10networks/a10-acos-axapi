...
def present(module, result, existing_config):
    payload = utils.build_json("basic-mapping-rule", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "basic-mapping-rule"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "basic-mapping-rule-list"] if info != "NotFound" else info
