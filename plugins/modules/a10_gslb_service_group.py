...
def get_argspec():
    ...
    rv.update({'service_group_name': {'type': 'str', 'required': True, },
        'member': {'type': 'list', 'member_name': {'type': 'str', }},
        'disable': {'type': 'bool', },
        'disable_site_list': {'type': 'list', 'disable_site': {'type': 'str', }},
        'dependency_site': {'type': 'bool', },
        'persistent_site': {'type': 'bool', },
        'persistent_mask': {'type': 'str', },
        'persistent_ipv6_mask': {'type': 'int', },
        'persistent_aging_time': {'type': 'int', },
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'oper': {'type': 'dict', 'session_list': {'type': 'list', 'client': {'type': 'str', }, 'best': {'type': 'str', }, 'mode': {'type': 'str', }, 'hits': {'type': 'int', }, 'last_second_hits': {'type': 'int', }, 'ttl': {'type': 'str', }, 'update': {'type': 'int', }, 'aging': {'type': 'int', }}, 'matched': {'type': 'int', }, 'total_sessions': {'type': 'int', }, 'service_group_name': {'type': 'str', 'required': True, }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/gslb/service-group/{service_group_name}"

    f_dict = {}
    if '/' in str(module.params["service_group_name"]):
