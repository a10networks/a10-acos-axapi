...
DOCUMENTATION = r'''
module: a10_ddos_network_object_template_indicators_to_monitor
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object-template/{network_object_template_name}/indicators-to-monitor"
