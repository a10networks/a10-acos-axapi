...
def present(module, result, existing_config):
    payload = utils.build_json("trigger-sys-obj-stats-change", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "trigger-sys-obj-stats-change"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "trigger-sys-obj-stats-change-list"] if info != "NotFound" else info
