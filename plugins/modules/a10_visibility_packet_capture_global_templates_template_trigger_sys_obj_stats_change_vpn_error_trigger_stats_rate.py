...
AVAILABLE_PROPERTIES = [
    ...
    "bad_ipsec_context", "bad_ipsec_context_direction", "bad_ipsec_context_flag_mismatch", "bad_ipsec_padding", "bad_ipsec_protocol", "bad_ipsec_spi", "bad_ipsec_unknown", "bad_len", "bad_min_frag_size_auth_sha384_512", "bad_opcode", "bad_selector_match", "bad_sg_write_len", "bad_srtp_auth_tag", "dsiv_incorrect_param", "dummy_payload", "duration",
    "error_ipv6_decrypt_rh_segs_left_error", "error_IPv6_extension_header_bad", "ipcomp_payload", "ipv6_extension_headers_too_big", "ipv6_hop_by_hop_error", "ipv6_outbound_rh_copy_addr_error", "ipv6_rh_length_error", "tfc_padding_with_prefrag_not_supported", "threshold_exceeded_by", "uuid",
    ]
