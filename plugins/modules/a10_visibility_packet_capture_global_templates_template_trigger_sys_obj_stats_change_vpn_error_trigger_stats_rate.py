...
AVAILABLE_PROPERTIES = [
    ...
    "bad_selector_match", "bad_sg_write_len", "bad_srtp_auth_tag", "dsiv_incorrect_param", "dummy_payload", "duration", "error_ipv6_decrypt_rh_segs_left_error", "error_IPv6_extension_header_bad", "ipcomp_payload", "ipv6_extension_headers_too_big", "ipv6_hop_by_hop_error",
