...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_range_stats_sip_udp_zone_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/stats?sip-udp-zone-port=true"
