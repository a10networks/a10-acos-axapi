...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_name_dynamic_entry_overflow_policy
description:
...
AVAILABLE_PROPERTIES = ["action", "dummy_name", "glid", "user_tag", "uuid", "zone_template", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/dynamic-entry-overflow-policy/{dummy_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/dynamic-entry-overflow-policy"
