...
def get_argspec():
    ...
    rv.update({'ldap': {'type': 'bool', },
        'ldap_port': {'type': 'int', },
        'ldap_security': {'type': 'str', 'choices': ['overssl', 'StartTLS']},
        'ldap_binddn': {'type': 'str', },
        'ldap_password': {'type': 'bool', },
        'ldap_password_string': {'type': 'str', },
        'ldap_encrypted': {'type': 'str', },
        'ldap_run_search': {'type': 'bool', },
        'BaseDN': {'type': 'str', },
        'ldap_query': {'type': 'str', },
        'AcceptResRef': {'type': 'bool', },
        'AcceptNotFound': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ldap"] if info != "NotFound" else info
