...
def get_argspec():
    ...
    rv.update({'neighbor_ipv4': {'type': 'str', 'required': True, },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/router/bgp/{bgp_as_number}/neighbor/ipv4-neighbor/{neighbor_ipv4}"
