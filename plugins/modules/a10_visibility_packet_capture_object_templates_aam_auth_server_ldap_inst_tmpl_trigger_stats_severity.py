...
def get_argspec():
    ...
    # Parent keys
    rv.update(
        dict(aam_auth_server_ldap_inst_tmpl_name=dict(type='str',
                                                      required=True), ))
    return rv
...
def existing_url(module):
    ...
    if '/' in module.params["aam_auth_server_ldap_inst_tmpl_name"]:
        f_dict["aam_auth_server_ldap_inst_tmpl_name"] = module.params[
            "aam_auth_server_ldap_inst_tmpl_name"].replace("/", "%2F")
    else:
        f_dict["aam_auth_server_ldap_inst_tmpl_name"] = module.params[
            "aam_auth_server_ldap_inst_tmpl_name"]
