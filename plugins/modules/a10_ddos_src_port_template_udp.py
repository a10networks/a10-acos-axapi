...
DOCUMENTATION = r'''
module: a10_ddos_src_port_template_udp
description:
...
AVAILABLE_PROPERTIES = ["drop_ntp_monlist", "filter_list", "max_payload_size", "min_payload_size", "name", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/src-port-template/udp/{name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/src-port-template/udp"
