...
DOCUMENTATION = r'''
module: a10_ddos_zone_profile_port_range_indicator
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(protocol=dict(type='str', required=True), port_range_end=dict(type='str', required=True), port_range_port_range_start=dict(type='str', required=True), zone_profile_profile_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/indicator/{indicator_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-profile/{zone_profile_profile_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/indicator"
