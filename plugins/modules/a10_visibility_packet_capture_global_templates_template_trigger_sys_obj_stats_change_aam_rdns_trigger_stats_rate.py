...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_rdns_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "request_dropped", "response_error", "response_failure", "response_timeout", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'request_dropped': {'type': 'bool', }, 'response_failure': {'type': 'bool', }, 'response_error': {'type': 'bool', }, 'response_timeout': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-rdns/trigger-stats-rate"
