...
AVAILABLE_PROPERTIES = ["auth_unsupported", "bad_sequence", "cant_find_epsv", "cant_find_pasv", "cl_est_err", "cl_request_err", "data_send_fail", "data_server_conn_fail", "duration", "insert_tuple_fail", "invalid_start_line", "line_too_long", "no_route", "rsv_persist_conn_fail", "ser_connecting_err", "server_response_err", "smp_create_fail", "smp_v4_fail", "smp_v6_fail", "snat_fail", "svrsel_fail", "threshold_exceeded_by", "unsupported_pbsz_value", "unsupported_prot_value", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-imap-proxy/trigger-stats-rate"
