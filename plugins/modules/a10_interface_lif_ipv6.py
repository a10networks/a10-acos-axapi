...
AVAILABLE_PROPERTIES = ["address_list", "inside", "ipv6_enable", "ospf", "outside", "router", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/interface/lif/{lif_ifname}/ipv6"
