...
def get_argspec():
    ...
    rv.update(dict(
        oper=dict(type='dict', slb_server_statistics=dict(type='list', out_bytes=dict(type='int', ), in_bytes=dict(type='int', ), p_conn=dict(type='int', ), out_pkts=dict(type='int', ), cur_conn=dict(type='int', ), time=dict(type='int', ), in_pkts=dict(type='int', )), start_time=dict(type='int', ), end_time=dict(type='int', ), slb_virtual_server_name=dict(type='str', )),
        uuid=dict(type='str', )
    ))
