...
def present(module, result, existing_config):
    payload = utils.build_json("virtual-server", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "virtual-server"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "virtual-server-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["virtual-server"][
