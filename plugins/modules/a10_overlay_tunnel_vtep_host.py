...
def existing_url(module):
    ...
    if '/' in str(module.params["overlay_mac_addr"]):
        f_dict["overlay_mac_addr"] = module.params["overlay_mac_addr"].replace(
            "/", "%2F")
    else:
    ...
    if '/' in str(module.params["remote_vtep"]):
        f_dict["remote_vtep"] = module.params["remote_vtep"].replace(
            "/", "%2F")
    else:
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result[
                    "acos_info"] = info["host"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "host-list"] if info != "NotFound" else info
