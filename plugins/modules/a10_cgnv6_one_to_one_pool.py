...
AVAILABLE_PROPERTIES = ["end_address", "group", "netmask", "partition", "pool_name", "shared", "start_address", "stats", "uuid", "vrid", ]
...
def get_argspec():
    ...
    rv.update({'pool_name': {'type': 'str', 'required': True, },
        ...
        'partition': {'type': 'str', },
        'uuid': {'type': 'str', },
        'stats': {'type': 'dict', 'total_address': {'type': 'str', }, 'used_address': {'type': 'str', }, 'free_address': {'type': 'str', }, 'pool_name': {'type': 'str', 'required': True, }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/one-to-one/pool/{pool_name}"
