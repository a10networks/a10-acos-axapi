...
def present(module, result, existing_config):
    payload = utils.build_json("hc-pt-mapping", module.params,
                               AVAILABLE_PROPERTIES)
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(
            module.client, "hc-pt-mapping", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "hc-pt-mapping"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "hc-pt-mapping-list"] if info != "NotFound" else info
