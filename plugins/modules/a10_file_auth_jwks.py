...
def get_argspec():
    ...
    rv.update({
        ...
        'action': {
            'type': 'str',
            'choices': ['create', 'import', 'copy', 'rename', 'check', 'replace', 'delete']
            },
        'file_handle': {
            'type': 'str',
            },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/file/auth-jwks"
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(module.client, "auth-jwks", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["auth-jwks"]["oper"] if info != "NotFound" else info
