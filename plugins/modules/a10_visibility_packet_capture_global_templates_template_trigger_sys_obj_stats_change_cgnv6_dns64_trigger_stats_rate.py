...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_dns64_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["drop", "duration", "query_bad_pkt", "resp_bad_pkt", "resp_bad_qr", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'query_bad_pkt': {'type': 'bool', }, 'resp_bad_pkt': {'type': 'bool', }, 'resp_bad_qr': {'type': 'bool', }, 'drop': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-dns64/trigger-stats-rate"
