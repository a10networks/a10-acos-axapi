...
AVAILABLE_PROPERTIES = ["action", "alternate_port", "auth_cfg", "conn_limit", "conn_resume", "extended_stats", "follow_port_protocol", "health_check", "health_check_disable", "health_check_follow_port", "no_logging", "no_ssl", "oper", "packet_capture_template", "port_number", "protocol", "range", "rport_health_check_shared", "sampling_enable", "shared_partition_port_template", "shared_rport_health_check", "stats", "stats_data_action", "support_http2", "template_port", "template_port_shared", "template_server_ssl", "user_tag", "uuid", "weight", ]
...
def get_argspec():
    ...
    rv.update({'port_number': {'type': 'int', 'required': True, },
        ...
        'shared_partition_port_template': {'type': 'bool', },
        'template_port_shared': {'type': 'str', },
        'template_server_ssl': {'type': 'str', },
        'action': {'type': 'str', 'choices': ['enable', 'disable', 'disable-with-health-check']},
        'no_ssl': {'type': 'bool', },
        'health_check': {'type': 'str', },
        'shared_rport_health_check': {'type': 'bool', },
        'rport_health_check_shared': {'type': 'str', },
