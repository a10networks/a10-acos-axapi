...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_auth_relay_kerberos_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["job_start_error", "other_error", "polling_control_error", "request_dropped", "response_error", "response_failure", "response_timeout", "timeout_error", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'timeout_error': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-auth-relay-kerberos/trigger-stats-inc"
