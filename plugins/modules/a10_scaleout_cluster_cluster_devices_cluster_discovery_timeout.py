...
def present(module, result, existing_config):
    payload = utils.build_json("cluster-discovery-timeout", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "cluster-discovery-timeout"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "cluster-discovery-timeout-list"] if info != "NotFound" else info
