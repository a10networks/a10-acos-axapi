...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_name_stats_ipproto_icmp
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/stats?ipproto-icmp=true"
