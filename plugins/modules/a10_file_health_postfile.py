...
def present(module, result, existing_config):
    payload = utils.build_json("health-postfile", module.params,
                               AVAILABLE_PROPERTIES)
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(
            module.client, "health-postfile", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "health-postfile"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "health-postfile-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["health-postfile"][
