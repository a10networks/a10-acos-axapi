...
AVAILABLE_PROPERTIES = [
    ...
    "blade_out_of_session_memory", "duration", "gtp_info_ext_not_found", "gtp_rate_limit_entry_create_failure", "gtp_rate_limit_smp_create_failure", "gtp_rate_limit_t3_ctr_create_failure", "gtp_smp_c_check_failed", "gtp_smp_dec_sess_count_check_failed", "gtp_smp_path_check_failed", "gtp_tunnel_rate_limit_entry_create_fail",
    "gtp_u_smp_check_failed", "gtp_u_tunnel_rate_limit_entry_create_fa", "out_of_session_memory", "threshold_exceeded_by", "uuid",
    ]
