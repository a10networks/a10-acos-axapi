...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'out_of_session_memory': {'type': 'bool', },
        'gtp_smp_path_check_failed': {'type': 'bool', },
        'gtp_smp_check_failed': {'type': 'bool', },
        'gtp_smp_session_count_check_failed': {'type': 'bool', },
        'gtp_c_ref_count_smp_exceeded': {'type': 'bool', },
        'gtp_u_smp_in_rml_with_sess': {'type': 'bool', },
        'gtp_tunnel_rate_limit_entry_create_fail': {'type': 'bool', },
        'gtp_rate_limit_smp_create_failure': {'type': 'bool', },
        'gtp_rate_limit_t3_ctr_create_failure': {'type': 'bool', },
        'gtp_rate_limit_entry_create_failure': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
