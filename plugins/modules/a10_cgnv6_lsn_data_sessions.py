...
def present(module, result, existing_config):
    payload = utils.build_json("data-sessions", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "data-sessions"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "data-sessions-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["data-sessions"][
