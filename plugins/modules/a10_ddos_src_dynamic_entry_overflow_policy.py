...
DOCUMENTATION = r'''
module: a10_ddos_src_dynamic_entry_overflow_policy
description:
    - Configure IP/IPv6 Policy Used When Src Dynamic Entry Count Overflows
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["app_type_list", "default_address_type", "exceed_log_cfg", "glid", "l4_type_list", "log_periodic", "template", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/src/dynamic-entry-overflow-policy/{default_address_type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/src/dynamic-entry-overflow-policy"
