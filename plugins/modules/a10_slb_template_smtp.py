...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'server_domain': {'type': 'str', },
        'service_ready_msg': {'type': 'str', },
        'client_starttls_type': {'type': 'str', 'choices': ['optional', 'enforced']},
        'server_starttls_type': {'type': 'str', 'choices': ['optional', 'enforced']},
        'command_disable': {'type': 'list', 'disable_type': {'type': 'str', 'choices': ['expn', 'turn', 'vrfy']}},
        'LF_to_CRLF': {'type': 'bool', },
        'error_code_to_client': {'type': 'bool', },
        'client_domain_switching': {'type': 'list', 'switching_type': {'type': 'str', 'choices': ['contains', 'ends-with', 'starts-with']}, 'match_string': {'type': 'str', }, 'service_group': {'type': 'str', }},
