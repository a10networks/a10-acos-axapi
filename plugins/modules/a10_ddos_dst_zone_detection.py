...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_detection
description:
    - DDOS Detection
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["notification", "outbound_detection", "packet_anomaly_detection", "service_discovery", "settings", "toggle", "uuid", "victim_ip_detection", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/detection"
