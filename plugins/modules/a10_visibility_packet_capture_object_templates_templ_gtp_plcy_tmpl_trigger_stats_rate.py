...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_templ_gtp_plcy_tmpl_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = [
    ...
    "drop_vld_version_not_supported", "duration", "threshold_exceeded_by", "uuid",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/templ-gtp-plcy-tmpl/{templ_gtp_plcy_tmpl_name}/trigger-stats-rate"
