...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'allow_third_party_from_lan': {'type': 'bool', },
        'allow_third_party_from_wan': {'type': 'bool', },
        'check_client_nonce': {'type': 'bool', },
        'disable_map_filter': {'type': 'bool', },
        'announce': {'type': 'bool', },
        'map': {'type': 'bool', },
        'peer': {'type': 'bool', },
        'maximum': {'type': 'int', },
        'minimum': {'type': 'int', },
        'pcp_server_port': {'type': 'int', },
        'source_ip': {'type': 'str', },
        'source_ipv6': {'type': 'str', },
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', }
    })
    return rv
