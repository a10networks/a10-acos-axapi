...
def get_argspec():
    ...
    rv.update({'id': {'type': 'int', 'required': True, },
        'encap': {'type': 'str', 'choices': ['ip-encap', 'gre', 'nvgre', 'vxlan']},
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        ...
        'local_ip_address': {'type': 'dict', 'ip_address': {'type': 'str', }, 'uuid': {'type': 'str', }, 'vni_list': {'type': 'list', 'segment': {'type': 'int', 'required': True, }, 'partition': {'type': 'str', }, 'gateway': {'type': 'bool', }, 'lif': {'type': 'str', }, 'uuid': {'type': 'str', }}},
        'local_ipv6_address': {'type': 'dict', 'ipv6_address': {'type': 'str', }, 'uuid': {'type': 'str', }},
        'remote_ip_address_list': {'type': 'list', 'ip_address': {'type': 'str', 'required': True, }, 'encap': {'type': 'str', 'choices': ['nvgre', 'vxlan']}, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }, 'use_lif': {'type': 'dict', 'partition': {'type': 'str', }, 'lif': {'type': 'str', }, 'uuid': {'type': 'str', }}, 'gre_keepalive': {'type': 'dict', 'retry_time': {'type': 'int', }, 'retry_count': {'type': 'int', }, 'uuid': {'type': 'str', }}, 'use_gre_key': {'type': 'dict', 'gre_key': {'type': 'int', }, 'uuid': {'type': 'str', }}, 'vni_list': {'type': 'list', 'segment': {'type': 'int', 'required': True, }, 'uuid': {'type': 'str', }}},
        'remote_ipv6_address_list': {'type': 'list', 'ipv6_address': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }, 'use_lif': {'type': 'dict', 'partition': {'type': 'str', }, 'lif': {'type': 'str', }, 'uuid': {'type': 'str', }}},
        'host_list': {'type': 'list', 'ip_addr': {'type': 'str', 'required': True, }, 'overlay_mac_addr': {'type': 'str', 'required': True, }, 'vni': {'type': 'int', 'required': True, }, 'remote_vtep': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }},
        'stats': {'type': 'dict', 'cfg_err_count': {'type': 'str', }, 'flooded_pkt_count': {'type': 'str', }, 'encap_unresolved_count': {'type': 'str', }, 'unknown_encap_rx_pkt': {'type': 'str', }, 'unknown_encap_tx_pkt': {'type': 'str', }, 'arp_req_sent': {'type': 'str', }, 'vtep_host_learned': {'type': 'str', }, 'vtep_host_learn_error': {'type': 'str', }, 'invalid_lif_rx': {'type': 'str', }, 'invalid_lif_tx': {'type': 'str', }, 'unknown_vtep_tx': {'type': 'str', }, 'unknown_vtep_rx': {'type': 'str', }, 'unhandled_pkt_rx': {'type': 'str', }, 'unhandled_pkt_tx': {'type': 'str', }, 'total_pkts_rx': {'type': 'str', }, 'total_bytes_rx': {'type': 'str', }, 'unicast_pkt_rx': {'type': 'str', }, 'bcast_pkt_rx': {'type': 'str', }, 'mcast_pkt_rx': {'type': 'str', }, 'dropped_pkt_rx': {'type': 'str', }, 'encap_miss_pkts_rx': {'type': 'str', }, 'bad_chksum_pks_rx': {'type': 'str', }, 'requeue_pkts_in': {'type': 'str', }, 'pkts_out': {'type': 'str', }, 'total_bytes_tx': {'type': 'str', }, 'unicast_pkt_tx': {'type': 'str', }, 'bcast_pkt_tx': {'type': 'str', }, 'mcast_pkt_tx': {'type': 'str', }, 'dropped_pkts_tx': {'type': 'str', }, 'large_pkts_rx': {'type': 'str', }, 'dot1q_pkts_rx': {'type': 'str', }, 'frag_pkts_tx': {'type': 'str', }, 'reassembled_pkts_rx': {'type': 'str', }, 'bad_inner_ipv4_len_rx': {'type': 'str', }, 'bad_inner_ipv6_len_rx': {'type': 'str', }, 'frag_drop_pkts_tx': {'type': 'str', }, 'lif_un_init_rx': {'type': 'str', }, 'id': {'type': 'int', 'required': True, }}
    })
    return rv
