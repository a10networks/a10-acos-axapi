...
def get_argspec():
    ...
    rv.update({
        ...
        'cpu_process_dir': {
            'type': 'str',
            'choices': ['primary', 'blade', 'hash-dip', 'hash-sip', 'hash-dmac', 'hash-smac']
            },
        'traffic_distribution_mode': {
            'type': 'str',
        ...
        'oper': {
            ...
            'config_speed': {
                'type': 'str',
                'choices': ['10Mbit', '100Mbit', '1Gbit', '10Gbit', '40Gbit', 'auto']
                },
            'actual_speed': {
                'type': 'str',
                'choices': ['10Mbit', '100Mbit', '1Gbit', '10Gbit', '40Gbit', 'unknown']
                },
            'config_duplexity': {
                'type': 'str',
