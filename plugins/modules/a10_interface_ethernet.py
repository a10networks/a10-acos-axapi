...
AVAILABLE_PROPERTIES = ["access_list", "action", "auto_neg_enable", "bfd", "cpu_process", "cpu_process_dir", "ddos", "duplexity", "fec_forced_off", "fec_forced_on", "flow_control", "icmp_rate_limit", "icmpv6_rate_limit", "ifnum", "ip", "ipg_bit_time", "ipv6", "isis", "l3_vlan_fwd_disable", "lldp", "load_interval", "lw_4o6", "mac_learning", "map", "media_type_copper", "monitor_list", "mtu", "name", "nptv6", "oper", "packet_capture_template", "ping_sweep_detection", "port_breakout", "port_scan_detection", "remove_vlan_tag", "sampling_enable", "spanning_tree", "speed", "speed_forced_10g", "speed_forced_1g", "speed_forced_40g", "stats", "traffic_distribution_mode", "trap_source", "trunk_group_list", "update_l2_info", "user_tag", "uuid", "virtual_wire", "vlan_learning", ]
...
def get_argspec():
    ...
    rv.update({'ifnum': {'type': 'str', 'required': True, },
        'name': {'type': 'str', },
        'port_scan_detection': {'type': 'str', 'choices': ['enable', 'disable']},
        'ping_sweep_detection': {'type': 'str', 'choices': ['enable', 'disable']},
        'l3_vlan_fwd_disable': {'type': 'bool', },
        'load_interval': {'type': 'int', },
        'media_type_copper': {'type': 'bool', },
        'auto_neg_enable': {'type': 'bool', },
        'fec_forced_on': {'type': 'bool', },
        'fec_forced_off': {'type': 'bool', },
        'port_breakout': {'type': 'str', 'choices': ['4x10G', '4x25G', '2x50G']},
        'speed_forced_1g': {'type': 'bool', },
        'speed_forced_10g': {'type': 'bool', },
        'speed_forced_40g': {'type': 'bool', },
        'ipg_bit_time': {'type': 'int', },
        'remove_vlan_tag': {'type': 'bool', },
        'mtu': {'type': 'int', },
        'trap_source': {'type': 'bool', },
        ...
        'icmp_rate_limit': {'type': 'dict', 'normal': {'type': 'int', }, 'lockup': {'type': 'int', }, 'lockup_period': {'type': 'int', }},
        'icmpv6_rate_limit': {'type': 'dict', 'normal_v6': {'type': 'int', }, 'lockup_v6': {'type': 'int', }, 'lockup_period_v6': {'type': 'int', }},
        'monitor_list': {'type': 'list', 'monitor': {'type': 'str', 'choices': ['input', 'output', 'both']}, 'mirror_index': {'type': 'int', }, 'monitor_vlan': {'type': 'int', }},
        'cpu_process': {'type': 'bool', },
        'cpu_process_dir': {'type': 'str', 'choices': ['primary', 'blade', 'hash-dip', 'hash-sip', 'hash-dmac', 'hash-smac']},
        'traffic_distribution_mode': {'type': 'str', 'choices': ['sip', 'dip', 'primary', 'blade', 'l4-src-port', 'l4-dst-port']},
        'virtual_wire': {'type': 'bool', },
        'update_l2_info': {'type': 'bool', },
        'vlan_learning': {'type': 'str', 'choices': ['enable', 'disable']},
        'mac_learning': {'type': 'str', 'choices': ['enable', 'disable', 'dmac-only']},
        ...
        'ddos': {'type': 'dict', 'outside': {'type': 'bool', }, 'inside': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        'ip': {'type': 'dict', 'dhcp': {'type': 'bool', }, 'address_list': {'type': 'list', 'ipv4_address': {'type': 'str', }, 'ipv4_netmask': {'type': 'str', }}, 'allow_promiscuous_vip': {'type': 'bool', }, 'cache_spoofing_port': {'type': 'bool', }, 'helper_address_list': {'type': 'list', 'helper_address': {'type': 'str', }}, 'inside': {'type': 'bool', }, 'outside': {'type': 'bool', }, 'ttl_ignore': {'type': 'bool', }, 'syn_cookie': {'type': 'bool', }, 'slb_partition_redirect': {'type': 'bool', }, 'generate_membership_query': {'type': 'bool', }, 'query_interval': {'type': 'int', }, 'max_resp_time': {'type': 'int', }, 'client': {'type': 'bool', }, 'server': {'type': 'bool', }, 'uuid': {'type': 'str', }, 'stateful_firewall': {'type': 'dict', 'inside': {'type': 'bool', }, 'class_list': {'type': 'str', }, 'outside': {'type': 'bool', }, 'access_list': {'type': 'bool', }, 'acl_id': {'type': 'int', }, 'uuid': {'type': 'str', }}, 'router': {'type': 'dict', 'isis': {'type': 'dict', 'tag': {'type': 'str', }, 'uuid': {'type': 'str', }}}, 'rip': {'type': 'dict', 'authentication': {'type': 'dict', 'str': {'type': 'dict', 'string': {'type': 'str', }}, 'mode': {'type': 'dict', 'mode': {'type': 'str', 'choices': ['md5', 'text']}}, 'key_chain': {'type': 'dict', 'key_chain': {'type': 'str', }}}, 'send_packet': {'type': 'bool', }, 'receive_packet': {'type': 'bool', }, 'send_cfg': {'type': 'dict', 'send': {'type': 'bool', }, 'version': {'type': 'str', 'choices': ['1', '2', '1-compatible', '1-2']}}, 'receive_cfg': {'type': 'dict', 'receive': {'type': 'bool', }, 'version': {'type': 'str', 'choices': ['1', '2', '1-2']}}, 'split_horizon_cfg': {'type': 'dict', 'state': {'type': 'str', 'choices': ['poisoned', 'disable', 'enable']}}, 'uuid': {'type': 'str', }}, 'ospf': {'type': 'dict', 'ospf_global': {'type': 'dict', 'authentication_cfg': {'type': 'dict', 'authentication': {'type': 'bool', }, 'value': {'type': 'str', 'choices': ['message-digest', 'null']}}, 'authentication_key': {'type': 'str', }, 'bfd_cfg': {'type': 'dict', 'bfd': {'type': 'bool', }, 'disable': {'type': 'bool', }}, 'cost': {'type': 'int', }, 'database_filter_cfg': {'type': 'dict', 'database_filter': {'type': 'str', 'choices': ['all']}, 'out': {'type': 'bool', }}, 'dead_interval': {'type': 'int', }, 'disable': {'type': 'str', 'choices': ['all']}, 'hello_interval': {'type': 'int', }, 'message_digest_cfg': {'type': 'list', 'message_digest_key': {'type': 'int', }, 'md5': {'type': 'dict', 'md5_value': {'type': 'str', }, 'encrypted': {'type': 'str', }}}, 'mtu': {'type': 'int', }, 'mtu_ignore': {'type': 'bool', }, 'network': {'type': 'dict', 'broadcast': {'type': 'bool', }, 'non_broadcast': {'type': 'bool', }, 'point_to_point': {'type': 'bool', }, 'point_to_multipoint': {'type': 'bool', }, 'p2mp_nbma': {'type': 'bool', }}, 'priority': {'type': 'int', }, 'retransmit_interval': {'type': 'int', }, 'transmit_delay': {'type': 'int', }, 'uuid': {'type': 'str', }}, 'ospf_ip_list': {'type': 'list', 'ip_addr': {'type': 'str', 'required': True, }, 'authentication': {'type': 'bool', }, 'value': {'type': 'str', 'choices': ['message-digest', 'null']}, 'authentication_key': {'type': 'str', }, 'cost': {'type': 'int', }, 'database_filter': {'type': 'str', 'choices': ['all']}, 'out': {'type': 'bool', }, 'dead_interval': {'type': 'int', }, 'hello_interval': {'type': 'int', }, 'message_digest_cfg': {'type': 'list', 'message_digest_key': {'type': 'int', }, 'md5_value': {'type': 'str', }, 'encrypted': {'type': 'str', }}, 'mtu_ignore': {'type': 'bool', }, 'priority': {'type': 'int', }, 'retransmit_interval': {'type': 'int', }, 'transmit_delay': {'type': 'int', }, 'uuid': {'type': 'str', }}}},
        'ipv6': {'type': 'dict', 'address_list': {'type': 'list', 'ipv6_addr': {'type': 'str', }, 'address_type': {'type': 'str', 'choices': ['anycast', 'link-local']}}, 'inside': {'type': 'bool', }, 'outside': {'type': 'bool', }, 'ipv6_enable': {'type': 'bool', }, 'ttl_ignore': {'type': 'bool', }, 'access_list_cfg': {'type': 'dict', 'v6_acl_name': {'type': 'str', }, 'inbound': {'type': 'bool', }}, 'router_adver': {'type': 'dict', 'action': {'type': 'str', 'choices': ['enable', 'disable']}, 'hop_limit': {'type': 'int', }, 'max_interval': {'type': 'int', }, 'min_interval': {'type': 'int', }, 'default_lifetime': {'type': 'int', }, 'rate_limit': {'type': 'int', }, 'reachable_time': {'type': 'int', }, 'retransmit_timer': {'type': 'int', }, 'adver_mtu_disable': {'type': 'bool', }, 'adver_mtu': {'type': 'int', }, 'prefix_list': {'type': 'list', 'prefix': {'type': 'str', }, 'not_autonomous': {'type': 'bool', }, 'not_on_link': {'type': 'bool', }, 'preferred_lifetime': {'type': 'int', }, 'valid_lifetime': {'type': 'int', }}, 'managed_config_action': {'type': 'str', 'choices': ['enable', 'disable']}, 'other_config_action': {'type': 'str', 'choices': ['enable', 'disable']}, 'adver_vrid': {'type': 'int', }, 'use_floating_ip': {'type': 'bool', }, 'floating_ip': {'type': 'str', }, 'adver_vrid_default': {'type': 'bool', }, 'use_floating_ip_default_vrid': {'type': 'bool', }, 'floating_ip_default_vrid': {'type': 'str', }}, 'uuid': {'type': 'str', }, 'stateful_firewall': {'type': 'dict', 'inside': {'type': 'bool', }, 'class_list': {'type': 'str', }, 'outside': {'type': 'bool', }, 'access_list': {'type': 'bool', }, 'acl_name': {'type': 'str', }, 'uuid': {'type': 'str', }}, 'router': {'type': 'dict', 'ripng': {'type': 'dict', 'rip': {'type': 'bool', }, 'uuid': {'type': 'str', }}, 'ospf': {'type': 'dict', 'area_list': {'type': 'list', 'area_id_num': {'type': 'int', }, 'area_id_addr': {'type': 'str', }, 'tag': {'type': 'str', }, 'instance_id': {'type': 'int', }}, 'uuid': {'type': 'str', }}, 'isis': {'type': 'dict', 'tag': {'type': 'str', }, 'uuid': {'type': 'str', }}}, 'rip': {'type': 'dict', 'split_horizon_cfg': {'type': 'dict', 'state': {'type': 'str', 'choices': ['poisoned', 'disable', 'enable']}}, 'uuid': {'type': 'str', }}, 'ospf': {'type': 'dict', 'network_list': {'type': 'list', 'broadcast_type': {'type': 'str', 'choices': ['broadcast', 'non-broadcast', 'point-to-point', 'point-to-multipoint']}, 'p2mp_nbma': {'type': 'bool', }, 'network_instance_id': {'type': 'int', }}, 'bfd': {'type': 'bool', }, 'disable': {'type': 'bool', }, 'cost_cfg': {'type': 'list', 'cost': {'type': 'int', }, 'instance_id': {'type': 'int', }}, 'dead_interval_cfg': {'type': 'list', 'dead_interval': {'type': 'int', }, 'instance_id': {'type': 'int', }}, 'hello_interval_cfg': {'type': 'list', 'hello_interval': {'type': 'int', }, 'instance_id': {'type': 'int', }}, 'mtu_ignore_cfg': {'type': 'list', 'mtu_ignore': {'type': 'bool', }, 'instance_id': {'type': 'int', }}, 'neighbor_cfg': {'type': 'list', 'neighbor': {'type': 'str', }, 'neig_inst': {'type': 'int', }, 'neighbor_cost': {'type': 'int', }, 'neighbor_poll_interval': {'type': 'int', }, 'neighbor_priority': {'type': 'int', }}, 'priority_cfg': {'type': 'list', 'priority': {'type': 'int', }, 'instance_id': {'type': 'int', }}, 'retransmit_interval_cfg': {'type': 'list', 'retransmit_interval': {'type': 'int', }, 'instance_id': {'type': 'int', }}, 'transmit_delay_cfg': {'type': 'list', 'transmit_delay': {'type': 'int', }, 'instance_id': {'type': 'int', }}, 'uuid': {'type': 'str', }}},
        'nptv6': {'type': 'dict', 'domain_list': {'type': 'list', 'domain_name': {'type': 'str', 'required': True, }, 'bind_type': {'type': 'str', 'required': True, 'choices': ['inside', 'outside']}, 'uuid': {'type': 'str', }}},
        'map': {'type': 'dict', 'inside': {'type': 'bool', }, 'outside': {'type': 'bool', }, 'map_t_inside': {'type': 'bool', }, 'map_t_outside': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        'lw_4o6': {'type': 'dict', 'outside': {'type': 'bool', }, 'inside': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        'trunk_group_list': {'type': 'list', 'trunk_number': {'type': 'int', 'required': True, }, 'ntype': {'type': 'str', 'choices': ['static', 'lacp', 'lacp-udld']}, 'admin_key': {'type': 'int', }, 'port_priority': {'type': 'int', }, 'udld_timeout_cfg': {'type': 'dict', 'fast': {'type': 'int', }, 'slow': {'type': 'int', }}, 'mode': {'type': 'str', 'choices': ['active', 'passive']}, 'timeout': {'type': 'str', 'choices': ['long', 'short']}, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }},
        ...
        'spanning_tree': {'type': 'dict', 'auto_edge': {'type': 'bool', }, 'admin_edge': {'type': 'bool', }, 'instance_list': {'type': 'list', 'instance_start': {'type': 'int', }, 'mstp_path_cost': {'type': 'int', }}, 'path_cost': {'type': 'int', }, 'uuid': {'type': 'str', }},
        'oper': {'type': 'dict', 'state': {'type': 'str', 'choices': ['up', 'disabled', 'down']}, 'line_protocol': {'type': 'str', 'choices': ['up', 'down']}, 'link_type': {'type': 'str', 'choices': ['GigabitEthernet', '10Gig', '40Gig']}, 'mac': {'type': 'str', }, 'config_speed': {'type': 'str', 'choices': ['10Mbit', '100Mbit', '1Gbit', '10Gbit', '40Gbit', 'auto']}, 'actual_speed': {'type': 'str', 'choices': ['10Mbit', '100Mbit', '1Gbit', '10Gbit', '40Gbit', 'unknown']}, 'config_duplexity': {'type': 'str', 'choices': ['Full', 'fdx', 'Half', 'hdx', 'auto']}, 'actual_duplexity': {'type': 'str', 'choices': ['Full', 'fdx', 'Half', 'hdx', 'auto']}, 'media_type': {'type': 'str', 'choices': ['Copper', 'Fiber']}, 'ipv4_address': {'type': 'str', }, 'ipv4_netmask': {'type': 'str', }, 'ipv4_addr_count': {'type': 'int', }, 'ipv4_list': {'type': 'list', 'addr': {'type': 'str', }, 'mask': {'type': 'str', }}, 'ipv6_addr_count': {'type': 'int', }, 'ipv6_list': {'type': 'list', 'addr': {'type': 'str', }, 'prefix': {'type': 'str', }, 'is_anycast': {'type': 'int', }}, 'ipv6_link_local': {'type': 'str', }, 'ipv6_link_local_prefix': {'type': 'str', }, 'ipv6_link_local_type': {'type': 'str', }, 'ipv6_link_local_scope': {'type': 'str', }, 'igmp_query_sent': {'type': 'int', }, 'icmp_rate_limit_current': {'type': 'int', }, 'icmp_rate_over_limit_drop': {'type': 'int', }, 'icmp6_rate_limit_current': {'type': 'int', }, 'icmp6_rate_over_limit_drop': {'type': 'int', }, 'is_tagged': {'type': 'int', }, 'vlan_id': {'type': 'int', }, 'tagged_vlan_list': {'type': 'str', }, 'span_mode': {'type': 'str', }, 'span_port_state': {'type': 'str', }, 'is_lead_member': {'type': 'int', }, 'is_blocked': {'type': 'int', }, 'current_vnp_id': {'type': 'int', }, 'port_vnp_id': {'type': 'int', }, 'is_pristine': {'type': 'int', }, 'rate_byte_rcvd': {'type': 'int', }, 'rate_byte_sent': {'type': 'int', }, 'rate_pkt_rcvd': {'type': 'int', }, 'rate_pkt_sent': {'type': 'int', }, 'input_utilization': {'type': 'int', }, 'output_utilization': {'type': 'int', }, 'is_device_transparent': {'type': 'int', }, 'incoming_pkts_mirrored': {'type': 'int', }, 'outgoing_pkts_mirrored': {'type': 'int', }, 'incoming_pkts_monitored': {'type': 'int', }, 'outgoing_pkts_monitored': {'type': 'int', }, 'ip_unnumbered_oper': {'type': 'int', }, 'ip_unnumbered_enabled': {'type': 'int', }, 'ip_unnumbered_mac_learned': {'type': 'int', }, 'ip_unnumbered_peer_lla': {'type': 'str', }, 'last_count_clear_at': {'type': 'str', }, 'last_up_event_at': {'type': 'str', }, 'last_down_event_at': {'type': 'str', }, 'ifnum': {'type': 'str', 'required': True, }},
        'stats': {'type': 'dict', 'packets_input': {'type': 'str', }, 'bytes_input': {'type': 'str', }, 'received_broadcasts': {'type': 'str', }, 'received_multicasts': {'type': 'str', }, 'received_unicasts': {'type': 'str', }, 'input_errors': {'type': 'str', }, 'crc': {'type': 'str', }, 'frame': {'type': 'str', }, 'runts': {'type': 'str', }, 'giants': {'type': 'str', }, 'packets_output': {'type': 'str', }, 'bytes_output': {'type': 'str', }, 'transmitted_broadcasts': {'type': 'str', }, 'transmitted_multicasts': {'type': 'str', }, 'transmitted_unicasts': {'type': 'str', }, 'output_errors': {'type': 'str', }, 'collisions': {'type': 'str', }, 'giants_output': {'type': 'str', }, 'rate_pkt_sent': {'type': 'str', }, 'rate_byte_sent': {'type': 'str', }, 'rate_pkt_rcvd': {'type': 'str', }, 'rate_byte_rcvd': {'type': 'str', }, 'load_interval': {'type': 'str', }, 'ifnum': {'type': 'str', 'required': True, }}
    })
    return rv
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ethernet"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["ethernet-list"] if info != "NotFound" else info
            elif module.params.get("get_type") == "oper":
                get_oper_result = api_client.get_oper(module.client, existing_url(module),
                                                      params=module.params)
                result["axapi_calls"].append(get_oper_result)
                info = get_oper_result["response_body"]
                result["acos_info"] = info["ethernet"]["oper"] if info != "NotFound" else info
            elif module.params.get("get_type") == "stats":
                get_type_result = api_client.get_stats(module.client, existing_url(module),
                                                       params=module.params)
                result["axapi_calls"].append(get_type_result)
                info = get_type_result["response_body"]
                result["acos_info"] = info["ethernet"]["stats"] if info != "NotFound" else info
