...
AVAILABLE_PROPERTIES = ["answer_only_disable", "auth_data", "cache", "change_query", "compress_disable", "deep_check_qr", "deep_check_rr_disable", "drop_cname_disable", "edns_append", "enable", "fast_append", "ignore_rcode3_disable", "max_qr_length", "parallel_query", "passive_query_disable", "retry", "single_response_disable", "timeout", "trans_ptr", "trans_ptr_query", "ttl", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'enable': {'type': 'bool', },
        'answer_only_disable': {'type': 'bool', },
        'auth_data': {'type': 'bool', },
        'cache': {'type': 'bool', },
        'change_query': {'type': 'bool', },
        'compress_disable': {'type': 'bool', },
        'deep_check_qr': {'type': 'bool', },
        'deep_check_rr_disable': {'type': 'bool', },
        'drop_cname_disable': {'type': 'bool', },
        'edns_append': {'type': 'bool', },
        'fast_append': {'type': 'bool', },
        'ignore_rcode3_disable': {'type': 'bool', },
        'max_qr_length': {'type': 'int', },
        'parallel_query': {'type': 'bool', },
        'passive_query_disable': {'type': 'bool', },
        'retry': {'type': 'int', },
        'single_response_disable': {'type': 'bool', },
        'timeout': {'type': 'int', },
        'trans_ptr': {'type': 'bool', },
        'trans_ptr_query': {'type': 'bool', },
        'ttl': {'type': 'int', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
