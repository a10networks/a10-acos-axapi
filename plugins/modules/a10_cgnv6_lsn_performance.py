...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'data-sessions-current-epoch', 'fullcone-created-current-epoch', 'user-quote-created-current-epoch', 'data-sessions-previous-epoch-first', 'fullcone-created-previous-epoch-first', 'user-quote-created-previous-epoch-first', 'data-sessions-previous-epoch-last', 'fullcone-created-previous-epoch-last', 'user-quote-created-previous-epoch-last']}},
        'oper': {'type': 'dict', 'data_sessions': {'type': 'int', }, 'full_cone_sessions': {'type': 'int', }, 'user_quotas': {'type': 'int', }},
        'stats': {'type': 'dict', 'data_sessions_current_epoch': {'type': 'str', }, 'fullcone_created_current_epoch': {'type': 'str', }, 'user_quote_created_current_epoch': {'type': 'str', }, 'data_sessions_previous_epoch_first': {'type': 'str', }, 'fullcone_created_previous_epoch_first': {'type': 'str', }, 'user_quote_created_previous_epoch_first': {'type': 'str', }, 'data_sessions_previous_epoch_last': {'type': 'str', }, 'fullcone_created_previous_epoch_last': {'type': 'str', }, 'user_quote_created_previous_epoch_last': {'type': 'str', }}
    })
    return rv
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["performance"].items():
        ...
        if config_changes["performance"].get(k) != v:
            change_results["changed"] = True
            config_changes["performance"][k] = v
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["performance"]["stats"] if info != "NotFound" else info
