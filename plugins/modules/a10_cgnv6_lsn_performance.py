    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'data-sessions-current-epoch',
                    'fullcone-created-current-epoch',
                    'user-quote-created-current-epoch',
                    'data-sessions-previous-epoch-first',
                    'fullcone-created-previous-epoch-first',
                    'user-quote-created-previous-epoch-first',
                    'data-sessions-previous-epoch-last',
                    'fullcone-created-previous-epoch-last',
...
def present(module, result, existing_config):
    payload = utils.build_json("performance", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "performance"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "performance-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["performance"][
