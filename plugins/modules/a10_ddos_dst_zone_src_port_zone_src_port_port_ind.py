...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_zone_src_port_port_ind
description:
    - zone src port indicators
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port/{zone_src_port_port_num}+{protocol}/port-ind"
