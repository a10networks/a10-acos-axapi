...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_auth_server_radius_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["accounting_failure", "authen_failure", "authorize_failure", "job_start_error", "other_error", "polling_control_error", "request_dropped", "response_error", "response_failure", "response_timeout", "timeout_error", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-auth-server-radius/trigger-stats-inc"
