...
def present(module, result, existing_config):
    payload = utils.build_json("fw-ddos-protection", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "fw-ddos-protection"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "fw-ddos-protection-list"] if info != "NotFound" else info
