        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'so_fw_internal_rule_count', 'so_hc_registration_done', 'so_hc_deregistration_done', 'so_pkts_l2redirect_vlan_retrieval_error', 'so_pkts_l2redirect_port_retrieval_error'
                    ]
                }
            },
        'stats': {
