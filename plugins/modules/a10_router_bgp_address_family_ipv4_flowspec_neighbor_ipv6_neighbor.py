...
DOCUMENTATION = r'''
module: a10_router_bgp_address_family_ipv4_flowspec_neighbor_ipv6_neighbor
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/router/bgp/{bgp_as_number}/address-family/ipv4-flowspec/neighbor/ipv6-neighbor/{neighbor_ipv6}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/router/bgp/{bgp_as_number}/address-family/ipv4-flowspec/neighbor/ipv6-neighbor"
