...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', }, 'stats': {'type': 'dict', 'log_msg_quota_exceed': {'type': 'str', }, 'log_msg_oom': {'type': 'str', }, 'log_queue_full': {'type': 'str', }, 'log_msg_sent': {'type': 'str', }, 'log_msg_send_err': {'type': 'str', }}})
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/logging"
