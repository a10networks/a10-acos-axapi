...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_authentication_global_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["aflex_authz_fail", "authn_failure", "authz_failure", "connect_failed", "create_timer_failed", "dns_resolve_failed", "get_socket_option_failed", "misses", "open_socket_failed", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-authentication-global/trigger-stats-inc"
