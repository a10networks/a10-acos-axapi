...
AVAILABLE_PROPERTIES = ["duration", "no_session_mem", "port_allocation_failure", "stream_creation_failure", "threshold_exceeded_by", "unknown_client_port_from_server", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-lsn-alg-rtsp/trigger-stats-rate"
