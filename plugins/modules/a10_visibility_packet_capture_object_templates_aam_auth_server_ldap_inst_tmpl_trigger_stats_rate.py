...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_aam_auth_server_ldap_inst_tmpl_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["admin_bind_failure", "authorize_failure", "bind_failure", "duration", "other_error", "pw_change_failure", "search_failure", "ssl_session_failure", "threshold_exceeded_by", "timeout_error", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'admin_bind_failure': {'type': 'bool', },
        'bind_failure': {'type': 'bool', },
        'search_failure': {'type': 'bool', },
        'authorize_failure': {'type': 'bool', },
        'timeout_error': {'type': 'bool', },
        'other_error': {'type': 'bool', },
        'ssl_session_failure': {'type': 'bool', },
        'pw_change_failure': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-server-ldap-inst-tmpl/{aam_auth_server_ldap_inst_tmpl_name}/trigger-stats-rate"
