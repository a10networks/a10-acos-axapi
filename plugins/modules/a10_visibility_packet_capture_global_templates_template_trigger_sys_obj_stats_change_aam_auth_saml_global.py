...
def present(module, result, existing_config):
    payload = utils.build_json("aam-auth-saml-global", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "aam-auth-saml-global"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "aam-auth-saml-global-list"] if info != "NotFound" else info
