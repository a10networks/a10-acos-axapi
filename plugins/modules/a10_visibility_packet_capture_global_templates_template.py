...
options:
    ...
    trigger_sys_obj_stats_severity:
        description:
        - "Field trigger_sys_obj_stats_severity"
        type: dict
        required: False
        suboptions:
            error:
    ...
    trigger_sys_obj_stats_change:
        description:
        - "Field trigger_sys_obj_stats_change"
        type: dict
        required: False
        suboptions:
            dummy:
...
AVAILABLE_PROPERTIES = ["capture_config", "name", "trigger_sys_obj_stats_change", "trigger_sys_obj_stats_severity", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{name}"
