...
def present(module, result, existing_config):
    payload = utils.build_json("network-element", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "network-element"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "network-element-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["network-element"][
