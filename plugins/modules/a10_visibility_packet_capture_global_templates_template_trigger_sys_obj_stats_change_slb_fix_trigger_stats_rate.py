...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_fix_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["client_err", "duration", "noroute", "server_err", "snat_fail", "svrsel_fail", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'svrsel_fail': {'type': 'bool', }, 'noroute': {'type': 'bool', }, 'snat_fail': {'type': 'bool', }, 'client_err': {'type': 'bool', }, 'server_err': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-fix/trigger-stats-rate"
