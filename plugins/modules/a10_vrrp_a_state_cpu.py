...
def present(module, result, existing_config):
    payload = utils.build_json("state-cpu", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "state-cpu"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "state-cpu-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["state-cpu"][
