...
def get_argspec():
    ...
    rv.update({'area_ipv4': {'type': 'str', 'required': True, },
        ...
        'range_list': {'type': 'list', 'value': {'type': 'str', }, 'option': {'type': 'str', 'choices': ['advertise', 'not-advertise']}},
        'stub': {'type': 'bool', },
        'no_summary': {'type': 'bool', },
        'virtual_link_list': {'type': 'list', 'value': {'type': 'str', }, 'dead_interval': {'type': 'int', }, 'bfd': {'type': 'bool', }, 'hello_interval': {'type': 'int', }, 'retransmit_interval': {'type': 'int', }, 'transmit_delay': {'type': 'int', }, 'instance_id': {'type': 'int', }},
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
