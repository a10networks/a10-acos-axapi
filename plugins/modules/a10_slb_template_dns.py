...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'response_rate_limiting': {'type': 'dict', 'response_rate': {'type': 'int', }, 'filter_response_rate': {'type': 'int', }, 'slip_rate': {'type': 'int', }, 'window': {'type': 'int', }, 'enable_log': {'type': 'bool', }, 'action': {'type': 'str', 'choices': ['log-only', 'rate-limit', 'whitelist']}, 'uuid': {'type': 'str', }}
    })
    return rv
