...
AVAILABLE_PROPERTIES = [
    "age", "apply_policy_on_overflow", "default_address_type", "deny", "disable", "drop_disable", "drop_disable_fwd_immediate", "drop_frag_pkt", "exceed_log_cfg", "exceed_log_dep_cfg", "glid", "inbound_forward_dscp", "ip_proto_list", "l4_type_list", "log_periodic", "max_dynamic_entry_count", "outbound_forward_dscp", "port_list", "src_port_list",
    "template", "user_tag", "uuid",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/default/{default_address_type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/default"
