...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["detail"].items():
        ...
        if config_changes["detail"].get(k) != v:
            change_results["changed"] = True
            config_changes["detail"][k] = v
