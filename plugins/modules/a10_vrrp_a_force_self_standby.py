...
def present(module, result, existing_config):
    payload = utils.build_json("force-self-standby", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "force-self-standby"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "force-self-standby-list"] if info != "NotFound" else info
