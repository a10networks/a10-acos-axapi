...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_fw_tcp_syn_cookie_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["uuid", "verification_failed", ]
...
def get_argspec():
    ...
    rv.update({'verification_failed': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/fw-tcp-syn-cookie/trigger-stats-inc"
