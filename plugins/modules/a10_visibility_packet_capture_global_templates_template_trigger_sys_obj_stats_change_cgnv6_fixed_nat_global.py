...
def present(module, result, existing_config):
    payload = utils.build_json("cgnv6-fixed-nat-global", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "cgnv6-fixed-nat-global"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "cgnv6-fixed-nat-global-list"] if info != "NotFound" else info
