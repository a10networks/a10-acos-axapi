...
def present(module, result, existing_config):
    payload = utils.build_json("disable-log-by-destination", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "disable-log-by-destination"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "disable-log-by-destination-list"] if info != "NotFound" else info
