...
def get_argspec():
    ...
    rv.update({'ipv6_address': {'type': 'str', 'required': True, },
        'ipv6_nexthop_ipv6': {'type': 'list', 'ipv6_nexthop': {'type': 'str', }, 'ethernet': {'type': 'str', }, 've': {'type': 'str', }, 'trunk': {'type': 'str', }, 'distance': {'type': 'int', }, 'description': {'type': 'str', }},
        'ipv6_nexthop_tunnel': {'type': 'list', 'tunnel': {'type': 'int', }, 'ipv6_nexthop_tunnel_addr': {'type': 'str', }, 'distance_nexthop_tunnel': {'type': 'int', }, 'description': {'type': 'str', }},
        'uuid': {'type': 'str', }
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ipv6/route/rib/{ipv6_address}"
