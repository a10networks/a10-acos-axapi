...
def present(module, result, existing_config):
    payload = utils.build_json("destination-ip-address", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "destination-ip-address"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "destination-ip-address-list"] if info != "NotFound" else info
