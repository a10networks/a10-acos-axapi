...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_range_level
description:
...
options:
    ...
    indicator_list:
        ...
        suboptions:
          ...
          utilization'= outside interface utilization;"
                type: str
            tcp_window_size:
                description:
...
AVAILABLE_PROPERTIES = ["apply_extracted_filters", "close_sessions_for_unauth_sources", "glid_action", "indicator_list", "level_num", "src_default_glid", "src_escalation_score", "src_violation_actions", "start_pattern_recognition", "user_tag", "uuid", "zone_escalation_score", "zone_template", "zone_violation_actions", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/level/{level_num}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/level"
