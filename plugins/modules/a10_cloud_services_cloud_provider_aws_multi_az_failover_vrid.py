...
DOCUMENTATION = r'''
module: a10_cloud_services_cloud_provider_aws_multi_az_failover_vrid
description:
    - VRID list
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["fip_dest", "fip_interface_id", "route_table_id", "user_tag", "uuid", "vip_dest", "vip_interface_id", "vip_list", "vrid_number", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cloud-services/cloud-provider/aws/multi-az-failover/vrid/{vrid_number}"

    f_dict = {}
    if '/' in str(module.params["vrid_number"]):
...
def new_url(module):
    ...
    url_base = "/axapi/v3/cloud-services/cloud-provider/aws/multi-az-failover/vrid"
