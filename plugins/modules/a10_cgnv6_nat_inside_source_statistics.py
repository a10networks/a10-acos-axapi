...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'static_list': {'type': 'list', 'src_address': {'type': 'str', }, 'port_usage': {'type': 'int', }, 'total_used': {'type': 'int', }, 'total_freed': {'type': 'int', }, 'nat_address': {'type': 'str', }}, 'total': {'type': 'int', }}
    })
    return rv
