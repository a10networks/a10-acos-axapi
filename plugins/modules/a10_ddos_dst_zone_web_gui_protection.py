...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_web_gui_protection
description:
    - Configure TPS Wizard Protection
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["ip_proto", "port", "port_range_list", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection"
