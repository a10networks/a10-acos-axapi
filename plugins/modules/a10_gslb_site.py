...
def get_argspec():
    ...
    rv.update({'site_name': {'type': 'str', 'required': True, },
        ...
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'ip_server_list': {'type': 'list', 'ip_server_name': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }},
        'active_rdt': {'type': 'dict', 'aging_time': {'type': 'int', }, 'smooth_factor': {'type': 'int', }, 'range_factor': {'type': 'int', }, 'limit': {'type': 'int', }, 'mask': {'type': 'str', }, 'ipv6_mask': {'type': 'int', }, 'ignore_count': {'type': 'int', }, 'bind_geoloc': {'type': 'bool', }, 'overlap': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        'easy_rdt': {'type': 'dict', 'aging_time': {'type': 'int', }, 'smooth_factor': {'type': 'int', }, 'range_factor': {'type': 'int', }, 'limit': {'type': 'int', }, 'mask': {'type': 'str', }, 'ipv6_mask': {'type': 'int', }, 'ignore_count': {'type': 'int', }, 'bind_geoloc': {'type': 'bool', }, 'overlap': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        'slb_dev_list': {'type': 'list', 'device_name': {'type': 'str', 'required': True, }, 'ip_address': {'type': 'str', }, 'ipv6_address': {'type': 'str', }, 'admin_preference': {'type': 'int', }, 'session_number': {'type': 'int', }, 'session_utilization': {'type': 'int', }, 'rdt_type': {'type': 'str', 'choices': ['rdt', 'site-rdt']}, 'client_ip': {'type': 'str', }, 'rdt_value': {'type': 'int', }, 'probe_timer': {'type': 'int', }, 'auto_detect': {'type': 'str', 'choices': ['ip', 'port', 'ip-and-port', 'disabled']}, 'auto_map': {'type': 'bool', }, 'max_client': {'type': 'int', }, 'proto_aging_time': {'type': 'int', }, 'proto_aging_fast': {'type': 'bool', }, 'health_check_action': {'type': 'str', 'choices': ['health-check', 'health-check-disable']}, 'gateway_ip_addr': {'type': 'str', }, 'proto_compatible': {'type': 'bool', }, 'msg_format_acos_2x': {'type': 'bool', }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }, 'vip_server': {'type': 'dict', 'vip_server_v4_list': {'type': 'list', 'ipv4': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }, 'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'dev_vip_hits']}}}, 'vip_server_v6_list': {'type': 'list', 'ipv6': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }, 'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'dev_vip_hits']}}}, 'vip_server_name_list': {'type': 'list', 'vip_name': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }, 'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'dev_vip_hits']}}}}},
