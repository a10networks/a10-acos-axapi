...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }})
    # Parent keys
...
def new_url(module):
    ...
    url_base = "/axapi/v3/acos-events/template/{template_name}/message-selector//collector-group"
