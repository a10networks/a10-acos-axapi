...
DOCUMENTATION = r'''
module: a10_aam_authentication_oauth_global
description:
...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'auth-req', 'auth-succ', 'auth-fail', 'auth-error', 'relay-req', 'relay-succ', 'relay-fail', 'other-error']}},
        'stats': {'type': 'dict', 'auth_req': {'type': 'str', }, 'auth_succ': {'type': 'str', }, 'auth_fail': {'type': 'str', }, 'auth_error': {'type': 'str', }, 'relay_req': {'type': 'str', }, 'relay_succ': {'type': 'str', }, 'relay_fail': {'type': 'str', }, 'other_error': {'type': 'str', }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/aam/authentication/oauth/global"
