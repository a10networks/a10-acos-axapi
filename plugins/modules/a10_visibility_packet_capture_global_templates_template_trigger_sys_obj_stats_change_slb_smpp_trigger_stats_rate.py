...
AVAILABLE_PROPERTIES = ["duration", "msg_proxy_client_fail", "msg_proxy_fail_start_server_conn", "msg_proxy_server_fail", "select_client_fail", "select_server_fail", "threshold_exceeded_by", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-smpp/trigger-stats-rate"
