...
AVAILABLE_PROPERTIES = ["duration", "extended_quota_exceeded", "fullcone_failure", "nat_port_unavailable_icmp", "nat_port_unavailable_tcp", "nat_port_unavailable_udp", "threshold_exceeded_by", "uuid", ]
