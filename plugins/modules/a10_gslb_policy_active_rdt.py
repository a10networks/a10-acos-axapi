...
AVAILABLE_PROPERTIES = ["controller", "difference", "enable", "fail_break", "ignore_id", "keep_tracking", "limit", "prefer_dns_sticky", "proto_rdt_enable", "samples", "single_shot", "skip", "sticky_difference", "timeout", "tolerance", "uuid", ]
