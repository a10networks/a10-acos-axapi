...
AVAILABLE_PROPERTIES = ["health_check", "health_check_disable", "health_check_string", "http_version", "name", "packet_capture_template", "port_health_check", "port_health_check_disable", "responder_ca", "responder_cert", "sampling_enable", "stats", "url", "uuid", "version_type", ]
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'url': {'type': 'str', },
        'responder_ca': {'type': 'str', },
        'responder_cert': {'type': 'str', },
        'health_check': {'type': 'bool', },
        'health_check_string': {'type': 'str', },
        'health_check_disable': {'type': 'bool', },
        'port_health_check': {'type': 'str', },
        'port_health_check_disable': {'type': 'bool', },
        'http_version': {'type': 'bool', },
        'version_type': {'type': 'str', 'choices': ['1.1']},
        'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'request', 'certificate-good', 'certificate-revoked', 'certificate-unknown', 'timeout', 'fail', 'stapling-request', 'stapling-certificate-good', 'stapling-certificate-revoked', 'stapling-certificate-unknown', 'stapling-timeout', 'stapling-fail']}},
        'packet_capture_template': {'type': 'str', },
        'stats': {'type': 'dict', 'request': {'type': 'str', }, 'certificate_good': {'type': 'str', }, 'certificate_revoked': {'type': 'str', }, 'certificate_unknown': {'type': 'str', }, 'timeout': {'type': 'str', }, 'fail': {'type': 'str', }, 'stapling_request': {'type': 'str', }, 'stapling_certificate_good': {'type': 'str', }, 'stapling_certificate_revoked': {'type': 'str', }, 'stapling_certificate_unknown': {'type': 'str', }, 'stapling_timeout': {'type': 'str', }, 'stapling_fail': {'type': 'str', }, 'name': {'type': 'str', 'required': True, }}
    })
    return rv
