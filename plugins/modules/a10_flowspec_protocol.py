...
AVAILABLE_PROPERTIES = ["proto_attribute", "proto_num", "proto_num_end", "uuid", ]
...
def existing_url(module):
    ...
    if '/' in str(module.params["proto_attribute"]):
        f_dict["proto_attribute"] = module.params["proto_attribute"].replace("/", "%2F")
    else:
        f_dict["proto_attribute"] = module.params["proto_attribute"]
    if '/' in str(module.params["proto_num"]):
