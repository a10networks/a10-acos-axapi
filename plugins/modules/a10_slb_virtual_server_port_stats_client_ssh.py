...
DOCUMENTATION = r'''
module: a10_slb_virtual_server_port_stats_client_ssh
description:
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, }, 'stats': {'type': 'dict', 'client_ssh': {'type': 'dict', 'successful_handshakes': {'type': 'str', }, 'failed_handshakes': {'type': 'str', }, 'forwarding_errors': {'type': 'str', }}}})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/slb/virtual-server/{virtual_server_name}/port/{port_number}+{protocol}/stats?client-ssh=true"
