...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_dhcpv6_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "packets_dropped", "pkts_dropped_during_clear", "rcv_not_supported_msg", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'packets_dropped': {'type': 'bool', }, 'pkts_dropped_during_clear': {'type': 'bool', }, 'rcv_not_supported_msg': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-dhcpv6/trigger-stats-rate"
