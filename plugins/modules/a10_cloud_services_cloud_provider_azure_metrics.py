...
DOCUMENTATION = r'''
module: a10_cloud_services_cloud_provider_azure_metrics
description:
...
options:
    ...
    action:
        description:
        - "'enable'= Enable Azure Application Insights; 'disable'= Disable Azure
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cloud-services/cloud-provider/azure/metrics"
