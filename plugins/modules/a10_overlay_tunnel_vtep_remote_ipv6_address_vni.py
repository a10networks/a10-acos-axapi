...
DOCUMENTATION = r'''
module: a10_overlay_tunnel_vtep_remote_ipv6_address_vni
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/overlay-tunnel/vtep/{vtep_id}/remote-ipv6-address/{remote_ipv6_address_ipv6_address}/vni/{segment}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/overlay-tunnel/vtep/{vtep_id}/remote-ipv6-address/{remote_ipv6_address_ipv6_address}/vni"
