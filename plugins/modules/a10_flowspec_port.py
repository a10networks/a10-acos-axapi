...
def existing_url(module):
    ...
    url_base = "/axapi/v3/flowspec/{flowspec_name}/port/{port_attribute}+{port_num}+{port_num_end}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/flowspec/{flowspec_name}/port/+"
