...
AVAILABLE_PROPERTIES = ["bad_req", "duration", "forbidden", "no_creds", "not_found", "server_error", "threshold_exceeded_by", "unauth", "unavailable", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-relay-hbase-inst-tmpl/{aam_auth_relay_hbase_inst_tmpl_name}/trigger-stats-rate"
