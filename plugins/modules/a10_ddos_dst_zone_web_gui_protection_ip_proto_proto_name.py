...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_web_gui_protection_ip_proto_proto_name
description:
...
AVAILABLE_PROPERTIES = ["pbe", "protocol", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'protocol': {'type': 'str', 'required': True, 'choices': ['icmp-v4', 'icmp-v6']}, 'pbe': {'type': 'str', }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/ip-proto/proto-name/{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/ip-proto/proto-name"
