...
def get_argspec():
    ...
    rv.update({'count': {'type': 'int', },
        ...
        'capture': {'type': 'dict', 'brief': {'type': 'bool', }, 'detail': {'type': 'bool', }, 'save': {'type': 'str', }, 'current_slot': {'type': 'bool', }, 'no_stop': {'type': 'bool', }},
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["axdebug"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["axdebug-list"] if info != "NotFound" else info
