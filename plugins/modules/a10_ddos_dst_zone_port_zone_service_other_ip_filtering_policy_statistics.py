...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_other_ip_filtering_policy_statistics
description:
    - IP Filter
author: A10 Networks
options:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/ip-filtering-policy-statistics"
