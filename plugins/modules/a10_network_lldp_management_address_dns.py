...
def get_argspec():
    ...
    rv.update({'dns': {'type': 'str', 'required': True, }, 'interface': {'type': 'dict', 'ethernet': {'type': 'str', }, 've': {'type': 'int', }, 'management': {'type': 'bool', }}, 'uuid': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    f_dict = {}
    if '/' in str(module.params["dns"]):
        f_dict["dns"] = module.params["dns"].replace("/", "%2F")
    else:
...
def new_url(module):
    ...
    url_base = "/axapi/v3/network/lldp/management-address/dns"
