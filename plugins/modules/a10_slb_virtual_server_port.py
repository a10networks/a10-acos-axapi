...
options:
    ...
    showtech_print_extended_stats:
        description:
        - "Enable print extended stats in showtech for vports"
        type: bool
        required: False
    attack_detection:
        description:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          'http2_client_idle_timeout'= HTTP2 Client Idle Timeout; 'dnsrrl_total_tc'= DNS
          Response-Rate-Limiting Total Responses Replied With Truncated;"
                type: str
