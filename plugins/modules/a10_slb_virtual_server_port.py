...
AVAILABLE_PROPERTIES = ["acl_list", "action", "aflex_scripts", "aflex_table_entry_syn_disable", "aflex_table_entry_syn_enable", "alt_protocol1", "alt_protocol2", "alternate_port", "alternate_port_number", "attack_detection", "auth_cfg", "auto", "clientip_sticky_nat", "conn_limit", "cpu_compute", "def_selection_if_pref_failed", "enable_playerid_check", "enable_scaleout", "eth_fwd", "eth_rev", "expand", "extended_stats", "force_routing_mode", "gslb_enable", "gtp_session_lb", "ha_conn_mirror", "ignore_global", "ip_map_list", "ip_only_lb", "ip_smart_rr", "ipinip", "l7_hardware_assist", "l7_service_chain", "memory_compute", "message_switching", "name", "no_auto_up_on_aflex", "no_dest_nat", "no_logging", "on_syn", "one_server_conn", "oper", "optimization_level", "p_template_sip_shared", "packet_capture_template", "persist_type", "pool", "pool_shared", "port_number", "port_translation", "precedence", "protocol", "proxy_layer", "range", "rate", "redirect_to_https", "reply_acme_challenge", "req_fail", "reselection", "reset", "reset_on_server_selection_fail", "resolve_web_cat_list", "rtp_sip_call_id_match", "sampling_enable", "scaleout_bucket_count", "scaleout_device_group", "secs", "serv_sel_fail", "server_group", "service_group", "shared_partition_cache_template", "shared_partition_client_ssl_template", "shared_partition_connection_reuse_template", "shared_partition_dblb_template", "shared_partition_diameter_template", "shared_partition_dns_template", "shared_partition_doh_template", "shared_partition_dynamic_service_template", "shared_partition_external_service_template", "shared_partition_fix_template", "shared_partition_http_policy_template", "shared_partition_http_template", "shared_partition_imap_pop3_template", "shared_partition_persist_cookie_template", "shared_partition_persist_destination_ip_template", "shared_partition_persist_source_ip_template", "shared_partition_persist_ssl_sid_template", "shared_partition_policy_template", "shared_partition_pool", "shared_partition_server_ssl_template", "shared_partition_smpp_template", "shared_partition_smtp_template", "shared_partition_tcp", "shared_partition_tcp_proxy_template", "shared_partition_udp", "shared_partition_virtual_port_template", "showtech_print_extended_stats", "skip_rev_hash", "snat_on_vip", "stats", "stats_data_action", "substitute_source_mac", "support_http2", "syn_cookie", "template_cache", "template_cache_shared", "template_client_ssh", "template_client_ssl", "template_client_ssl_shared", "template_connection_reuse", "template_connection_reuse_shared", "template_dblb", "template_dblb_shared", "template_diameter", "template_diameter_shared", "template_dns", "template_dns_shared", "template_doh", "template_doh_shared", "template_dynamic_service", "template_dynamic_service_shared", "template_external_service", "template_external_service_shared", "template_fix", "template_fix_shared", "template_ftp", "template_http", "template_http_policy", "template_http_policy_shared", "template_http_shared", "template_imap_pop3", "template_imap_pop3_shared", "template_mqtt", "template_persist_cookie", "template_persist_cookie_shared", "template_persist_destination_ip", "template_persist_destination_ip_shared", "template_persist_source_ip", "template_persist_source_ip_shared", "template_persist_ssl_sid", "template_persist_ssl_sid_shared", "template_policy", "template_policy_shared", "template_ram_cache", "template_reqmod_icap", "template_respmod_icap", "template_scaleout", "template_server_ssh", "template_server_ssl", "template_server_ssl_shared", "template_sip", "template_sip_shared", "template_smpp", "template_smpp_shared", "template_smtp", "template_smtp_shared", "template_ssli", "template_tcp", "template_tcp_proxy", "template_tcp_proxy_client", "template_tcp_proxy_server", "template_tcp_proxy_shared", "template_tcp_shared", "template_udp", "template_udp_shared", "template_virtual_port", "template_virtual_port_shared", "trunk_fwd", "trunk_rev", "use_alternate_port", "use_cgnv6", "use_default_if_no_server", "use_rcv_hop_for_resp", "use_rcv_hop_group", "user_tag", "uuid", "view", "waf_template", "when_down", "when_down_protocol2", ]
...
def get_argspec():
    ...
    rv.update({'port_number': {'type': 'int', 'required': True, },
        'protocol': {'type': 'str', 'required': True, 'choices': ['tcp', 'udp', 'others', 'diameter', 'dns-tcp', 'dns-udp', 'fast-http', 'fix', 'ftp', 'ftp-proxy', 'http', 'https', 'imap', 'mlb', 'mms', 'mysql', 'mssql', 'pop3', 'radius', 'rtsp', 'sip', 'sip-tcp', 'sips', 'smpp-tcp', 'spdy', 'spdys', 'smtp', 'mqtt', 'mqtts', 'ssl-proxy', 'ssli', 'ssh', 'tcp-proxy', 'tftp', 'fast-fix']},
        'range': {'type': 'int', },
        'alternate_port': {'type': 'bool', },
        'proxy_layer': {'type': 'str', 'choices': ['v1', 'v2']},
        ...
        'reselection': {'type': 'str', 'choices': ['disable']},
        'eth_fwd': {'type': 'str', },
        'trunk_fwd': {'type': 'str', },
        'eth_rev': {'type': 'str', },
        'trunk_rev': {'type': 'str', },
        'template_sip': {'type': 'str', },
        'p_template_sip_shared': {'type': 'bool', },
        'template_sip_shared': {'type': 'str', },
        'template_smpp': {'type': 'str', },
        'shared_partition_smpp_template': {'type': 'bool', },
        'template_smpp_shared': {'type': 'str', },
        'template_dblb': {'type': 'str', },
        'shared_partition_dblb_template': {'type': 'bool', },
        'template_dblb_shared': {'type': 'str', },
        ...
        'shared_partition_imap_pop3_template': {'type': 'bool', },
        'template_imap_pop3_shared': {'type': 'str', },
        'template_smtp': {'type': 'str', },
        'shared_partition_smtp_template': {'type': 'bool', },
        'template_smtp_shared': {'type': 'str', },
        'template_mqtt': {'type': 'str', },
        ...
        'template_doh': {'type': 'str', },
        'shared_partition_doh_template': {'type': 'bool', },
        'template_doh_shared': {'type': 'str', },
        ...
        'template_ram_cache': {'type': 'str', },
        'template_fix': {'type': 'str', },
        'shared_partition_fix_template': {'type': 'bool', },
        'template_fix_shared': {'type': 'str', },
        ...
        'substitute_source_mac': {'type': 'bool', },
        'ignore_global': {'type': 'bool', },
        'aflex_table_entry_syn_disable': {'type': 'bool', },
        'aflex_table_entry_syn_enable': {'type': 'bool', },
        'gtp_session_lb': {'type': 'bool', },
        'reply_acme_challenge': {'type': 'bool', },
