...
AVAILABLE_PROPERTIES = [
    "app_serv_conn_err", "app_serv_conn_no_pcb_err", "chunk1_hdr_err", "chunk2_hdr_err", "chunk_bad_trail_err", "duration", "encap_hdr_incomplete_err", "http_resp_hdr_err", "http_resp_line_parse_err", "http_resp_line_read_err", "icap_line_err", "icap_ver_err", "no_icap_resp_err",
    "no_payload_buff_err", "no_payload_next_buff_err", "no_status_code_err", "prep_req_fail_err", "req_hdr_incomplete_err", "resp_hdr_err", "resp_hdr_incomplete_err", "resp_line_parse_err", "resp_line_read_err", "serv_sel_fail_err", "start_icap_conn_fail_err", "threshold_exceeded_by", "uuid",
    ]
