...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_icap_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["app_serv_conn_err", "app_serv_conn_no_pcb_err", "chunk1_hdr_err", "chunk2_hdr_err", "chunk_bad_trail_err", "duration", "encap_hdr_incomplete_err", "http_resp_hdr_err", "http_resp_line_parse_err", "http_resp_line_read_err", "icap_line_err", "icap_ver_err", "no_icap_resp_err", "no_payload_buff_err", "no_payload_next_buff_err", "no_status_code_err", "prep_req_fail_err", "req_hdr_incomplete_err", "resp_hdr_err", "resp_hdr_incomplete_err", "resp_line_parse_err", "resp_line_read_err", "serv_sel_fail_err", "start_icap_conn_fail_err", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'app_serv_conn_no_pcb_err': {'type': 'bool', },
        'app_serv_conn_err': {'type': 'bool', },
        'chunk1_hdr_err': {'type': 'bool', },
        'chunk2_hdr_err': {'type': 'bool', },
        'chunk_bad_trail_err': {'type': 'bool', },
        'no_payload_next_buff_err': {'type': 'bool', },
        'no_payload_buff_err': {'type': 'bool', },
        'resp_hdr_incomplete_err': {'type': 'bool', },
        'serv_sel_fail_err': {'type': 'bool', },
        'start_icap_conn_fail_err': {'type': 'bool', },
        'prep_req_fail_err': {'type': 'bool', },
        'icap_ver_err': {'type': 'bool', },
        'icap_line_err': {'type': 'bool', },
        'encap_hdr_incomplete_err': {'type': 'bool', },
        'no_icap_resp_err': {'type': 'bool', },
        'resp_line_read_err': {'type': 'bool', },
        'resp_line_parse_err': {'type': 'bool', },
        'resp_hdr_err': {'type': 'bool', },
        'req_hdr_incomplete_err': {'type': 'bool', },
        'no_status_code_err': {'type': 'bool', },
        'http_resp_line_read_err': {'type': 'bool', },
        'http_resp_line_parse_err': {'type': 'bool', },
        'http_resp_hdr_err': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-icap/trigger-stats-rate"
