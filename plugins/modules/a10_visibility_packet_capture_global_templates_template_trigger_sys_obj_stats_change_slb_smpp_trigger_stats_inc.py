...
def get_argspec():
    ...
    rv.update({'msg_proxy_client_fail': {'type': 'bool', },
        'msg_proxy_server_fail': {'type': 'bool', },
        'msg_proxy_fail_start_server_conn': {'type': 'bool', },
        'select_client_fail': {'type': 'bool', },
        'select_server_fail': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
