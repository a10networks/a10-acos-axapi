...
def get_argspec():
    ...
    rv.update({'strictly_sticky_nat': {'type': 'bool', },
        'enhanced_user_tracking': {'type': 'bool', },
        'attempt_port_preservation': {'type': 'str', 'choices': ['disable']},
        'hairpinning': {'type': 'str', 'choices': ['filter-none', 'filter-self-ip', 'filter-self-ip-port']},
        'inbound_refresh': {'type': 'str', 'choices': ['disable']},
        'ip_selection': {'type': 'str', 'choices': ['random', 'round-robin', 'least-used-strict', 'least-udp-used-strict', 'least-tcp-used-strict', 'least-reserved-strict', 'least-udp-reserved-strict', 'least-tcp-reserved-strict', 'least-users-strict']},
        'syn_timeout': {'type': 'int', },
        'half_close_timeout': {'type': 'int', },
