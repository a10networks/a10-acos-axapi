...
def get_argspec():
    ...
    rv.update({
        ...
        'ip_selection': {
            ...
            'str',
            'choices': [
                'random', 'round-robin', 'least-used-strict',
                'least-udp-used-strict', 'least-tcp-used-strict',
                'least-reserved-strict', 'least-udp-reserved-strict',
                'least-tcp-reserved-strict', 'least-users-strict'
            ]
        },
        'syn_timeout': {
            'type': 'int',
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'no_radius_profile_match',
                    'nat_ip_max_tcp_ports_allocated',
                    'nat_ip_max_udp_ports_allocated', 'no_class_list_match',
                    'lid_drop', 'lid_pass_through', 'fullcone_in_del_q',
                    'fullcone_retry_lookup', 'fullcone_not_found',
                    'nat_port_double_free', 'nat_port_chunk_freed_from_cpu',
                    'nat_port_freed_from_diff_cpu', 'nat_pool_deleted',
                    'nat_esp_ip_conflicts', 'nat_esp_no_control_sesn',
                    'esp_user_quota_exceeded', 'udp_alg_user_quota_exceeded',
                    'gre_user_quota_exceeded', 'ha_classlist_mismatch',
                    'ha_user_quota_mismatch', 'ha_fullcone_mismatch',
                    'ha_port_mismatch', 'ha_dnat_mismatch',
                    'ha_nat_port_unavailable', 'ha_unknown_nat_ip',
                    'ha_fullcone_failure', 'ha_fullcone_create_race_failure',
                    'ha_endpoint_indep_map_match', 'standby_class_list_drop',
                    'bad_tuple_nat_ip', 'bad_smp_tuple_nat_ip',
                    'fullcone_inbound_nat_pool_mismatch',
                    'fullcone_overflow_eim', 'fullcone_overflow_eif',
                    'cross_cpu_helper_created', 'cross_cpu_sent',
                    'cross_cpu_rcv', 'cross_cpu_bad_l3', 'cross_cpu_bad_l4',
                    'cross_cpu_no_session', 'cross_cpu_helper_free',
                    'cross_cpu_helper_free_retry_lookup',
                    'cross_cpu_helper_free_not_found',
                    'cross_cpu_helper_deleted',
                    'cross_cpu_helper_cpu_mismatch',
                    'cross_cpu_helper_nat_pool_standby',
                    'cross_cpu_helper_double_add', 'mtu_exceeded', 'frag',
                    'dslite_tunnel_frag', 'sixrd_tunnel_frag', 'frag_icmp',
                    'frag_tunnel_icmp', 'quota_ext_mem_allocated',
                    'quota_ext_mem_alloc_failure', 'quota_ext_mem_freed',
                    'quota_ext_put_in_del_q', 'port_batch_num_mismatch',
                    'port_batch_interval_mismatch', 'port_pair_alloc_bad_math',
                    'free_port_from_quota_no_container',
                    'free_port_from_quota_no_port_info',
                    'static_nat_cross_cpu_helper_created',
                    'static_nat_cross_cpu_helper_deleted',
                    'static_nat_cross_cpu_helper_standby',
                    'static_nat_cross_cpu_helper_cpu_mismatch',
                    'static_nat_cross_cpu_sent', 'static_nat_cross_cpu_rcv',
                    'static_nat_cross_cpu_bad_l3',
                    'static_nat_cross_cpu_bad_l4',
                    'static_nat_cross_cpu_no_session',
                    'static_nat_cross_cpu_helper_free',
                    'static_nat_cross_cpu_helper_free_retry_lookup',
                    'static_nat_cross_cpu_helper_free_not_found',
                    'static_nat_ha_map_mismatch', 'ip_slb_cross_cpu_sent',
                    'fullcone_force_deleted', 'user_quota_mem_allocated',
                    'user_quota_mem_freed', 'user_quota_created_shadow',
                    'quota_marked_deleted', 'quota_delete_not_in_bucket',
                    'user_quota_put_in_del_q_shadow',
                    'tcp_out_of_state_rst_sent',
            ...
            'counters2': {
                ...
                'str',
                'choices': [
                    'user_quota_not_found', 'tcp_fullcone_created_shadow',
                    'tcp_fullcone_freed_shadow', 'udp_fullcone_created_shadow',
                    'udp_fullcone_freed_shadow', 'udp_alg_fullcone_created',
                    'udp_alg_fullcone_freed', 'fullcone_created',
                    'fullcone_freed', 'data_session_created_shadow',
            ...
            'counters3': {
                ...
                'choices': [
                    ...
                    'cross_cpu_helper_created_eim',
                    'cross_cpu_helper_created_eif',
                    'cross_cpu_helper_created_udp',
                    'cross_cpu_helper_created_tcp',
                    'cross_cpu_helper_created_icmp',
                    'cross_cpu_helper_created_ip',
                    'cross_cpu_helper_free_not_found_ip',
                    'cross_cpu_helper_free_not_found_icmp',
                    'cross_cpu_helper_free_not_found_tcp',
