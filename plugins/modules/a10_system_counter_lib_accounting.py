...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'stats': {'type': 'dict', 'total_ctr_alloc': {'type': 'str', }, 'total_ctr_in_rml': {'type': 'str', }, 'total_ctr_freed': {'type': 'str', }, 'total_ctr_in_system': {'type': 'str', }, 'total_oper_alloc': {'type': 'str', }, 'total_oper_free': {'type': 'str', }, 'total_blocks_in_hash': {'type': 'str', }, 'total_blocks_in_rml_hash': {'type': 'str', }, 'total_nodes_alloc': {'type': 'str', }, 'total_nodes_in_rml': {'type': 'str', }, 'total_nodes_free': {'type': 'str', }, 'total_nodes_free_failed': {'type': 'str', }, 'total_nodes_unlink_failed': {'type': 'str', }, 'total_nodes_in_system': {'type': 'str', }, 'total_memblocks_alloc_avro': {'type': 'str', }, 'total_memblocks_free_avro': {'type': 'str', }, 'total_memblocks_realloc_avro': {'type': 'str', }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/system/counter-lib-accounting"
...
def present(module, result, existing_config):
    payload = utils.build_json("counter-lib-accounting", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["counter-lib-accounting"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["counter-lib-accounting-list"] if info != "NotFound" else info
            elif module.params.get("get_type") == "stats":
                get_type_result = api_client.get_stats(module.client, existing_url(module),
                                                       params=module.params)
                result["axapi_calls"].append(get_type_result)
                info = get_type_result["response_body"]
                result["acos_info"] = info["counter-lib-accounting"]["stats"] if info != "NotFound" else info
