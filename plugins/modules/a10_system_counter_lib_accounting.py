...
def present(module, result, existing_config):
    payload = utils.build_json("counter-lib-accounting", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "counter-lib-accounting"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "counter-lib-accounting-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["counter-lib-accounting"][
