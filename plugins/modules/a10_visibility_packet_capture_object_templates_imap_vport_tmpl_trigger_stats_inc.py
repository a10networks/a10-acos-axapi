...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_imap_vport_tmpl_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = [
    "auth_unsupported", "bad_sequence", "cant_find_epsv", "cant_find_pasv", "cl_est_err", "cl_request_err", "data_send_fail", "data_server_conn_fail", "insert_tuple_fail", "invalid_start_line", "line_too_long", "no_route", "rsv_persist_conn_fail", "ser_connecting_err", "server_response_err", "smp_create_fail", "smp_v4_fail", "smp_v6_fail",
    "snat_fail", "svrsel_fail", "unsupported_pbsz_value", "unsupported_prot_value", "uuid",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/imap-vport-tmpl/{imap_vport_tmpl_name}/trigger-stats-inc"
