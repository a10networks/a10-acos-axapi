...
AVAILABLE_PROPERTIES = ["bad_ip_chksum_drop", "bad_ip_flags_drop", "bad_ip_frag_offset", "bad_ip_hdr_len", "bad_ip_payload_len", "bad_ip_ttl_drop", "empty_frag_drop", "icmp_pod_drop", "ipv4_frag", "ipv4_opt_drop", "land_drop", "mic_frag_drop", "no_ip_payload_drop", "oversize_ip_payload", "runt_ip_hdr", "runt_tcpudp_hdr", "tcp_bad_chksum", "tcp_bad_ip_len", "tcp_bad_urg_offet", "tcp_fin_sin", "tcp_frag_hdr", "tcp_null_flags", "tcp_null_scan", "tcp_short_hdr", "tcp_syn_frag", "tcp_xmas_flags", "tcp_xmas_scan", "tun_mismatch", "udp_bad_chksum", "udp_bad_ip_len", "udp_kb_frags", "udp_port_lb", "udp_short_hdr", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/system-fpga-drop/trigger-stats-inc"
