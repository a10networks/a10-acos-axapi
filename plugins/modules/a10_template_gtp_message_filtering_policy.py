...
def present(module, result, existing_config):
    payload = utils.build_json("message-filtering-policy", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "message-filtering-policy"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "message-filtering-policy-list"] if info != "NotFound" else info
