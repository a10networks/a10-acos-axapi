...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_aam_auth_relay_hbase_inst_tmpl_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["bad_req", "forbidden", "no_creds", "not_found", "server_error", "unauth", "unavailable", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'no_creds': {'type': 'bool', }, 'bad_req': {'type': 'bool', }, 'unauth': {'type': 'bool', }, 'forbidden': {'type': 'bool', }, 'not_found': {'type': 'bool', }, 'server_error': {'type': 'bool', }, 'unavailable': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-relay-hbase-inst-tmpl/{aam_auth_relay_hbase_inst_tmpl_name}/trigger-stats-inc"
