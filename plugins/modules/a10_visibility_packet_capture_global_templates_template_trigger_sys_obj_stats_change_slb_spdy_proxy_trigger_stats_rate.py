...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_spdy_proxy_trigger_stats_rate
description:
...
options:
    ...
    data_no_stream_goaway_close:
        description:
        - "Enable automatic packet-capture for Data no stream and no goaway and close
          session"
        type: bool
        required: False
    est_cb_no_tuple:
...
AVAILABLE_PROPERTIES = ["compress_ctx_alloc_fail", "ctx_alloc_fail", "data_cb_no_tuple", "data_no_stream", "data_no_stream_goaway_close", "data_no_stream_no_goaway", "decompress_fail", "duration", "est_cb_no_tuple", "header_compress_fail", "http_conn_alloc_fail", "http_err_stream_closed", "invalid_frame_size", "invalid_version", "request_header_alloc_fail", "session_err", "stream_alloc_fail", "stream_err", "stream_not_found", "tcp_err", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'tcp_err': {'type': 'bool', },
        'stream_not_found': {'type': 'bool', },
        'stream_err': {'type': 'bool', },
        'session_err': {'type': 'bool', },
        'data_no_stream': {'type': 'bool', },
        'data_no_stream_no_goaway': {'type': 'bool', },
        'data_no_stream_goaway_close': {'type': 'bool', },
        'est_cb_no_tuple': {'type': 'bool', },
        'data_cb_no_tuple': {'type': 'bool', },
        'ctx_alloc_fail': {'type': 'bool', },
        'stream_alloc_fail': {'type': 'bool', },
        'http_conn_alloc_fail': {'type': 'bool', },
        'request_header_alloc_fail': {'type': 'bool', },
        'decompress_fail': {'type': 'bool', },
        'invalid_frame_size': {'type': 'bool', },
        'invalid_version': {'type': 'bool', },
        'compress_ctx_alloc_fail': {'type': 'bool', },
        'header_compress_fail': {'type': 'bool', },
        'http_err_stream_closed': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-spdy-proxy/trigger-stats-rate"
