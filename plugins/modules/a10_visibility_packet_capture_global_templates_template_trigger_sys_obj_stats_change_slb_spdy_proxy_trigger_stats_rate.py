...
AVAILABLE_PROPERTIES = [
    "compress_ctx_alloc_fail", "ctx_alloc_fail", "data_cb_no_tuple", "data_no_stream", "data_no_stream_goaway_close", "data_no_stream_no_goaway", "decompress_fail", "duration", "est_cb_no_tuple", "header_compress_fail", "http_conn_alloc_fail", "http_err_stream_closed", "invalid_frame_size",
    "invalid_version", "request_header_alloc_fail", "session_err", "stream_alloc_fail", "stream_err", "stream_not_found", "tcp_err", "threshold_exceeded_by", "uuid",
    ]
