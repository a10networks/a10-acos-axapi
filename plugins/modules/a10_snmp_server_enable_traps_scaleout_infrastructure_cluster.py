...
DOCUMENTATION = r'''
module: a10_snmp_server_enable_traps_scaleout_infrastructure_cluster
description:
    - Enable cluster group traps
...
def get_argspec():
    ...
    rv.update({'single_node_mode': {'type': 'bool', },
        'election': {'type': 'bool', },
        'master_calling_re_election': {'type': 'bool', },
        'node_status': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/snmp-server/enable/traps/scaleout/infrastructure/cluster"
