    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'total-throughput-bits-per-sec', 'l4-conns-per-sec',
                    'l7-conns-per-sec', 'l7-trans-per-sec',
                    'ssl-conns-per-sec', 'ip-nat-conns-per-sec',
                    'total-new-conns-per-sec', 'total-curr-conns',
                    'l4-bandwidth', 'l7-bandwidth', 'serv-ssl-conns-per-sec',
                    'fw-conns-per-sec', 'gifw-conns-per-sec'
                ]
            }
        },
        'stats': {
...
def present(module, result, existing_config):
    payload = utils.build_json("app-performance", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "app-performance"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "app-performance-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["app-performance"][
