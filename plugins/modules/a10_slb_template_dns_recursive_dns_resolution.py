...
AVAILABLE_PROPERTIES = ["default_recursive", "force_cname_resolution", "full_response", "host_list_cfg", "ipv4_nat_pool", "ipv6_nat_pool", "max_trials", "ns_cache_lookup", "ns_longest_match", "request_for_pending_resolution", "retries_per_level", "udp_initial_interval", "udp_retry_interval", "use_client_qid", "use_service_group_response", "uuid", ]
