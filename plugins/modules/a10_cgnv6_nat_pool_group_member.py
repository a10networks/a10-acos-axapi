...
DOCUMENTATION = r'''
module: a10_cgnv6_nat_pool_group_member
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/nat/pool-group/{pool_group_pool_group_name}/member/{pool_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/nat/pool-group/{pool_group_pool_group_name}/member"
