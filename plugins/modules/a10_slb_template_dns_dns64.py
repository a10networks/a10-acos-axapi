...
DOCUMENTATION = r'''
module: a10_slb_template_dns_dns64
description:
    - Enable DNS64
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["cache", "change_query", "enable", "parallel_query", "retry", "single_response_disable", "timeout", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'enable': {'type': 'bool', }, 'cache': {'type': 'bool', }, 'change_query': {'type': 'bool', }, 'parallel_query': {'type': 'bool', }, 'retry': {'type': 'int', }, 'single_response_disable': {'type': 'bool', }, 'timeout': {'type': 'int', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/slb/template/dns/{dns_name}/dns64"
