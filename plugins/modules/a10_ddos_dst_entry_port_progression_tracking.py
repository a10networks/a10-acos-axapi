...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_port_progression_tracking
description:
    - DDos dst port progression-tracking
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/port/{port_num}+{protocol}/progression-tracking"
