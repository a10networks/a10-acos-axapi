...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_number_level_indicator
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(level_num=dict(type='str', required=True), proto_number_protocol_num=dict(type='str', required=True), zone_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/level/{level_num}/indicator/{type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/level/{level_num}/indicator"
