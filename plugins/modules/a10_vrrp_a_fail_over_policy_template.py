...
def present(module, result, existing_config):
    payload = utils.build_json("fail-over-policy-template", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "fail-over-policy-template"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "fail-over-policy-template-list"] if info != "NotFound" else info
