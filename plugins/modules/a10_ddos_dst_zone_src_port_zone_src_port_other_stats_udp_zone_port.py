...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_zone_src_port_other_stats_udp_zone_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port-other/{zone_src_port_other_port_other}+{protocol}/stats?udp-zone-port=true"
