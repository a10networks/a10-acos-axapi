...
AVAILABLE_PROPERTIES = [
    "bad_ip_chksum_drop", "bad_ip_flags_drop", "bad_ip_frag_offset", "bad_ip_hdr_len", "bad_ip_payload_len", "bad_ip_ttl_drop", "duration", "empty_frag_drop", "fcs_drop", "hrx_drop", "icmp_pod_drop", "ipv4_frag", "ipv4_opt_drop", "land_drop", "mic_frag_drop", "mrx_drop", "no_ip_payload_drop", "oversize_ip_payload", "runt_ip_hdr", "runt_tcpudp_hdr",
    "siz_drop", "tcp_bad_chksum", "tcp_bad_ip_len", "tcp_bad_urg_offet", "tcp_fin_sin", "tcp_frag_hdr", "tcp_null_flags", "tcp_null_scan", "tcp_short_hdr", "tcp_syn_frag", "tcp_xmas_flags", "tcp_xmas_scan", "threshold_exceeded_by", "tun_mismatch", "udp_bad_chksum", "udp_bad_ip_len", "udp_kb_frags", "udp_port_lb", "udp_short_hdr", "uuid",
    ]
