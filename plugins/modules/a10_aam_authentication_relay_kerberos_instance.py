...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'kerberos_realm': {'type': 'str', },
        'kerberos_kdc': {'type': 'str', },
        'kerberos_kdc_service_group': {'type': 'str', },
        'kerberos_account': {'type': 'str', },
        'password': {'type': 'bool', },
        ...
        'timeout': {'type': 'int', },
        'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'request-send', 'response-receive', 'current-requests-of-user', 'tickets']}},
        'oper': {'type': 'dict', 'ticket_cache': {'type': 'str', }, 'default_principal': {'type': 'str', }, 'item_list': {'type': 'list', 'service_principal': {'type': 'str', }, 'client_principal': {'type': 'str', }, 'start_time': {'type': 'str', }, 'end_time': {'type': 'str', }, 'renew_time': {'type': 'str', }, 'flags': {'type': 'str', }}, 'name': {'type': 'str', 'required': True, }},
        'stats': {'type': 'dict', 'request_send': {'type': 'str', }, 'response_receive': {'type': 'str', }, 'current_requests_of_user': {'type': 'str', }, 'tickets': {'type': 'str', }, 'name': {'type': 'str', 'required': True, }}
    })
    return rv
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["instance"]["oper"] if info != "NotFound" else info
