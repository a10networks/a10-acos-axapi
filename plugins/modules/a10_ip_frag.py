...
def get_argspec():
    ...
    rv.update({'buff': {'type': 'int', },
        'max_reassembly_sessions': {'type': 'int', },
        'max_packets_per_reassembly': {'type': 'int', },
        'timeout': {'type': 'int', },
        'cpu_threshold': {'type': 'dict', 'high': {'type': 'int', }, 'low': {'type': 'int', }},
        'uuid': {'type': 'str', },
