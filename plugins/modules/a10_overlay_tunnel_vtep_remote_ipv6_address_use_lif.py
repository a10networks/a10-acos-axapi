...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(
        remote_ipv6_address_ipv6_address=dict(type='str', required=True),
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/overlay-tunnel/vtep/{vtep_id}/remote-ipv6-address/{remote_ipv6_address_ipv6_address}/use-lif"
