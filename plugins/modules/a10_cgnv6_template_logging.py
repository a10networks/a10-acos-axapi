    ...
    rv.update({
        ...
        'log': {
            ...
            'map_dhcpv6': {
                ...
                'map_dhcpv6_msg_type': {
                    ...
                    'map_dhcpv6_msg_type': {
                        'type': 'str',
                        'choices': ['prefix-assignment', 'prefix-renewal', 'prefix-release']
                        }
                    }
                },
            'http_requests': {
        ...
        'include_radius_attribute': {
            ...
            'attr_cfg': {
                ...
                'attr_event': {
                    'type': 'str',
                    'choices': ['http-requests', 'port-mappings', 'sessions', 'user-data']
                    }
                },
            'no_quote': {
                'type': 'bool',
        ...
        'include_http': {
            ...
            'header_cfg': {
                ...
                'http_header': {
                    'type': 'str',
                    'choices': ['cookie', 'referer', 'user-agent', 'header1', 'header2', 'header3']
                    },
                'max_length': {
                    'type': 'int',
                    },
        ...
        'facility': {
            'type': 'str',
            'choices': ['kernel', 'user', 'mail', 'daemon', 'security-authorization', 'syslog', 'line-printer', 'news', 'uucp', 'cron', 'security-authorization-private', 'ftp', 'ntp', 'audit', 'alert', 'clock', 'local0', 'local1', 'local2', 'local3', 'local4', 'local5', 'local6', 'local7']
            },
        'severity': {
            'type': 'dict',
            'severity_string': {
        ...
        'format': {
            'type': 'str',
            'choices': ['binary', 'compact', 'custom', 'default', 'rfc5424', 'cef']
            },
        'batched_logging_disable': {
            'type': 'bool',
            },
