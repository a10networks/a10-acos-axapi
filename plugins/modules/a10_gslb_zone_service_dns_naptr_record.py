...
def new_url(module):
    ...
    url_base = "/axapi/v3/gslb/zone/{zone_name}/service/{service_port}+{service_name}/dns-naptr-record/+"
...
def present(module, result, existing_config):
    payload = utils.build_json("dns-naptr-record", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["dns-naptr-record"] if info != "NotFound" else info
