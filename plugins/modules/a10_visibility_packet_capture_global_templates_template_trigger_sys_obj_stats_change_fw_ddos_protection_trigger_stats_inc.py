...
def get_argspec():
    ...
    rv.update({'ddos_entries_too_many': {'type': 'bool', },
        'ddos_entry_add_to_bgp_failure': {'type': 'bool', },
        'ddos_entry_remove_from_bgp_failure': {'type': 'bool', },
        'ddos_packet_dropped': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
