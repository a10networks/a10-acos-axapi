...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_fw_ddos_protection_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["ddos_entries_too_many", "ddos_entry_add_to_bgp_failure", "ddos_entry_remove_from_bgp_failure", "ddos_packet_dropped", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'ddos_entries_too_many': {'type': 'bool', }, 'ddos_entry_add_to_bgp_failure': {'type': 'bool', }, 'ddos_entry_remove_from_bgp_failure': {'type': 'bool', }, 'ddos_packet_dropped': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/fw-ddos-protection/trigger-stats-inc"
