...
AVAILABLE_PROPERTIES = ["days", "dn", "encrypted", "end_date", "enroll", "interval", "key_length", "log_level", "max_polltime", "method", "minute", "name", "password", "renew_before", "renew_before_type", "renew_before_value", "renew_every", "renew_every_type", "renew_every_value", "secret_string", "start_date", "subject_alternate_name", "url", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'key_length': {'type': 'str', 'choices': ['1024', '2048', '4096', '8192']},
        'days': {'type': 'int', },
        'start_date': {'type': 'str', },
        'end_date': {'type': 'str', },
        'method': {'type': 'str', 'choices': ['GET', 'POST']},
        'interval': {'type': 'int', },
...
def present(module, result, existing_config):
    payload = utils.build_json("scep-cert", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["scep-cert"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["scep-cert-list"] if info != "NotFound" else info
