...
DOCUMENTATION = r'''
module: a10_ddos_zone_template_tcp_progression_tracking_mitigation_connection_tracking
description:
    - Configure and enable TCP Progression Tracking Mitigation per Connection
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/tcp/{tcp_name}/progression-tracking/mitigation/connection-tracking"
