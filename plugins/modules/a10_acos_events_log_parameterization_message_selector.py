...
DOCUMENTATION = r'''
module: a10_acos_events_log_parameterization_message_selector
description:
...
options:
    ...
    rule_list:
        ...
        suboptions:
            ...
            action:
                description:
                - "'send'= log messages selected by this rule will be sent (Default); 'drop'= log
          messages selected by this rule will be dropped;"
                type: str
            message_id:
                description:
...
AVAILABLE_PROPERTIES = ["dummy_config", "rule_list", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/acos-events/log-parameterization/message-selector"
