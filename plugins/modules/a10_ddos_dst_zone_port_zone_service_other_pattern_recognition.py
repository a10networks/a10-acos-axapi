...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_other_pattern_recognition
description:
...
AVAILABLE_PROPERTIES = ["algorithm", "capture_traffic", "filter_inactive_threshold", "filter_threshold", "mode", "oper", "sensitivity", "triggered_by", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/pattern-recognition"
