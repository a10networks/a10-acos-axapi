...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_port_range_stats_http_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/stats?http-port=true"
