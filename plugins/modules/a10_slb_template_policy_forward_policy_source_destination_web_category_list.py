...
def existing_url(module):
    ...
    if '/' in str(module.params["web_category_list"]):
        f_dict["web_category_list"] = module.params[
            "web_category_list"].replace("/", "%2F")
    else:
...
def present(module, result, existing_config):
    payload = utils.build_json("web-category-list", module.params,
                               AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "web-category-list-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["web-category-list"][
