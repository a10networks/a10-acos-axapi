...
DOCUMENTATION = r'''
module: a10_ddos_network_object_ip
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object/{network_object_object_name}/ip/{subnet_ip_addr}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object/{network_object_object_name}/ip"
