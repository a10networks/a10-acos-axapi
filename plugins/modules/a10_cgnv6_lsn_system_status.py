...
def present(module, result, existing_config):
    payload = utils.build_json("system-status", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "system-status"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "system-status-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["system-status"][
