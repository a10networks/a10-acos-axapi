...
options:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          Served; 'total_req'= Total Requests; 'caching_req'= Cacheable Requests;
          'nc_req_header'= No-cache Request; 'nc_res_header'= Not cacheable;
          'rv_success'= Revalidation Successes; 'rv_failure'= Revalidation Failures;
          'ims_request'= IMS Requests; 'nm_response'= Responses from cache 304 Not
          Modified; 'rsp_type_CL'= Responses from server 200 OK - Cont Len;
          'rsp_type_CE'= Responses from server 200 OK - Chnk Enc; 'rsp_type_304'=
          Responses from server 304 Not Modified; 'rsp_type_other'= Responses from server
          200 OK - Other; 'rsp_no_compress'= Responses from cache 200 OK - No Comp;
          'rsp_gzip'= Responses from cache 200 OK - Gzip; 'rsp_deflate'= Responses from
          cache 200 OK - Deflate; 'rsp_other'= Responses from cache Other;
          'nocache_match'= Policy URI nocache; 'match'= Policy URI cache;
          'invalidate_match'= Policy URI invalidate; 'content_toobig'= Policy Content Too
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["rc-cache-global"].items():
        ...
        if config_changes["rc-cache-global"].get(k) != v:
            change_results["changed"] = True
            config_changes["rc-cache-global"][k] = v
