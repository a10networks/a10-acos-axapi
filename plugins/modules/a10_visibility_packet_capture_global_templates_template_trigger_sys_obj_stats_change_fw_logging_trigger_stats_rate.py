...
AVAILABLE_PROPERTIES = ["duration", "http_logging_invalid_format", "log_dropped", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'log_dropped': {'type': 'bool', },
        'http_logging_invalid_format': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
