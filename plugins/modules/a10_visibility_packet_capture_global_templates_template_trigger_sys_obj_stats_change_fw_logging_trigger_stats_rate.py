...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_fw_logging_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "http_logging_invalid_format", "log_dropped", "session_limit_exceeded", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'log_dropped': {'type': 'bool', }, 'http_logging_invalid_format': {'type': 'bool', }, 'session_limit_exceeded': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/fw-logging/trigger-stats-rate"
