...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_tcp_udp_stats_udp_zone_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-tcp-udp/{proto_tcp_udp_protocol}/stats?udp-zone-port=true"
