...
DOCUMENTATION = r'''
module: a10_slb_virtual_server_port_stats_pop3_vport
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/slb/virtual-server/{virtual_server_name}/port/{port_number}+{protocol}/stats?pop3_vport=true"
