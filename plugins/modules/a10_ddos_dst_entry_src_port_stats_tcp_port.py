...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_src_port_stats_tcp_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/src-port/{src_port_port_num}+{protocol}/stats?tcp-port=true"
