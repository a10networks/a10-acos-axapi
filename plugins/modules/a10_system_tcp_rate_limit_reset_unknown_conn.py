...
def present(module, result, existing_config):
    payload = utils.build_json("rate-limit-reset-unknown-conn", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "rate-limit-reset-unknown-conn"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "rate-limit-reset-unknown-conn-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["rate-limit-reset-unknown-conn"][
