...
def get_argspec():
    ...
    rv.update({'file_content': {'type': 'str', },'max_file_size': {'type': 'int', },
        'max_buffer_size': {'type': 'int', },
        'classification': {'type': 'dict', 'classification_disable': {'type': 'bool', }, 'min_classification_len': {'type': 'int', }, 'max_classification_len': {'type': 'int', }},
        'max_concurrent_files': {'type': 'int', },
        'max_concurrent_files_action': {'type': 'str', 'choices': ['bypass']},
        'logging': {'type': 'dict', 'bypass': {'type': 'dict', 'all_bypass_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'no_content_disposition_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'old_http_version_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'aflex_disabled_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'service_disabled_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'service_down_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'max_concurrent_files_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'filesize_overlimit_log': {'type': 'str', 'choices': ['log', 'no-log']}, 'internal_buffered_overlimit_log': {'type': 'str', 'choices': ['log', 'no-log']}}, 'failed_transactions': {'type': 'str', 'choices': ['log', 'no-log']}, 'local_logging_disable': {'type': 'bool', }},
        'uuid': {'type': 'str', }
    })
    return rv
...
def get(module):
    ...
    if file_info:
        ...
        file_list = file_info["global"]["oper"].get("file-list", [])
