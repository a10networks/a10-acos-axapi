...
AVAILABLE_PROPERTIES = [
    "crl_cache_status_revoked", "crl_connection_error", "crl_other_error", "crl_response_status_revoked", "crl_response_status_unknown", "crl_uri_https", "crl_uri_not_found", "crl_uri_unsupported", "ocsp_cache_miss", "ocsp_cache_status_revoked", "ocsp_chain_status_revoked",
    "ocsp_chain_status_unknown", "ocsp_connection_error", "ocsp_other_error", "ocsp_response_no_nonce", "ocsp_response_nonce_error", "ocsp_response_status_revoked", "ocsp_response_status_unknown", "ocsp_uri_https", "ocsp_uri_not_found", "ocsp_uri_unsupported", "uuid",
    ]
