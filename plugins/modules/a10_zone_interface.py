...
def get_argspec():
    ...
    rv.update({'ethernet_list': {'type': 'list', 'interface_ethernet_start': {'type': 'str', }, 'interface_ethernet_end': {'type': 'str', }},
        ...
        'lif_list': {'type': 'list', 'interface_lif_start': {'type': 'int', }, 'interface_lif_end': {'type': 'int', }},
        'tunnel_list': {'type': 'list', 'interface_tunnel_start': {'type': 'int', }, 'interface_tunnel_end': {'type': 'int', }},
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def present(module, result, existing_config):
    payload = build_json("interface", module)
