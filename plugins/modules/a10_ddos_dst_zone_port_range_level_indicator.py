...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_range_level_indicator
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(level_num=dict(type='str', required=True), protocol=dict(type='str', required=True), port_range_end=dict(type='str', required=True), port_range_port_range_start=dict(type='str', required=True), zone_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/level/{level_num}/indicator/{type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port-range/{port_range_port_range_start}+{port_range_end}+{protocol}/level/{level_num}/indicator"
