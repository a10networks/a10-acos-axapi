...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_auth_captcha_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["attr_fail", "job_start_error", "json_fail", "other_error", "polling_control_error", "request_dropped", "response_error", "response_failure", "response_timeout", "timeout_error", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'request_dropped': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-auth-captcha/trigger-stats-inc"
