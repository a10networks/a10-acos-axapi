...
DOCUMENTATION = r'''
module: a10_router_bgp_address_family_ipv6_flowspec_neighbor_ipv4_neighbor
description:
...
AVAILABLE_PROPERTIES = ["activate", "neighbor_ipv4", "neighbor_route_map_lists", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'neighbor_ipv4': {'type': 'str', 'required': True, }, 'activate': {'type': 'bool', }, 'neighbor_route_map_lists': {'type': 'list', 'nbr_route_map': {'type': 'str', }, 'nbr_rmap_direction': {'type': 'str', 'choices': ['in', 'out']}}, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/router/bgp/{bgp_as_number}/address-family/ipv6-flowspec/neighbor/ipv4-neighbor/{neighbor_ipv4}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/router/bgp/{bgp_as_number}/address-family/ipv6-flowspec/neighbor/ipv4-neighbor"
