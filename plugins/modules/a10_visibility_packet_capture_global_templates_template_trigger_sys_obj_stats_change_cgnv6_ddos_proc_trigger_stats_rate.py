...
AVAILABLE_PROPERTIES = ["duration", "ip_node_alloc_failure", "ip_other_block_alloc_failure", "ip_port_block_alloc_failure", "l3_entry_add_to_bgp_failure", "l3_entry_add_to_hw_failure", "l3_entry_remove_from_bgp_failure", "l4_entry_list_alloc_failure", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'l4_entry_list_alloc_failure': {'type': 'bool', },
