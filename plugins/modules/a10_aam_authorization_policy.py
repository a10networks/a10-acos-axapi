...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'attribute_list': {'type': 'list', 'attr_num': {'type': 'int', 'required': True, }, 'attribute_name': {'type': 'str', }, 'any': {'type': 'bool', }, 'attr_type': {'type': 'bool', }, 'string_type': {'type': 'bool', }, 'integer_type': {'type': 'bool', }, 'ip_type': {'type': 'bool', }, 'number_type': {'type': 'bool', }, 'attr_str': {'type': 'str', 'choices': ['match', 'sub-string']}, 'attr_str_val': {'type': 'str', }, 'attr_int': {'type': 'str', 'choices': ['equal', 'not-equal', 'less-than', 'more-than', 'less-than-equal-to', 'more-than-equal-to']}, 'attr_int_val': {'type': 'int', }, 'attr_ip': {'type': 'str', 'choices': ['equal', 'not-equal']}, 'attr_ipv4': {'type': 'str', }, 'attr_number': {'type': 'str', 'choices': ['equal', 'not-equal', 'less-than', 'more-than', 'less-than-equal-to', 'more-than-equal-to']}, 'attr_number_val': {'type': 'str', }, 'A10_AX_AUTH_URI': {'type': 'bool', }, 'custom_attr_type': {'type': 'bool', }, 'custom_attr_str': {'type': 'str', 'choices': ['match', 'sub-string']}, 'a10_dynamic_defined': {'type': 'bool', }, 'uuid': {'type': 'str', }},
