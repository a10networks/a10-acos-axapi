...
AVAILABLE_PROPERTIES = ["icmpv6_redirect_disable", "icmpv6_unreachable_disable", "rpf_check_enable", "source_route_pkt_drop_enable", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'icmpv6_unreachable_disable': {'type': 'bool', }, 'icmpv6_redirect_disable': {'type': 'bool', }, 'rpf_check_enable': {'type': 'bool', }, 'source_route_pkt_drop_enable': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    return rv
