...
DOCUMENTATION = r'''
module: a10_ddos_src_default_l4_type
description:
    - DDOS L4 type
author: A10 Networks
options:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/src/default/{default_address_type}/l4-type/{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/src/default/{default_address_type}/l4-type"
