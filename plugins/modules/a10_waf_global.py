    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'total_req', 'req_allowed', 'req_denied', 'resp_denied', 'brute_force_success', 'brute_force_violation', 'brute_force_challenge_cookie_sent', 'brute_force_challenge_cookie_success', 'brute_force_challenge_cookie_violation', 'brute_force_challenge_javascript_sent', 'brute_force_challenge_javascript_success',
                    'brute_force_challenge_javascript_violation', 'brute_force_challenge_captcha_sent', 'brute_force_challenge_captcha_success', 'brute_force_challenge_captcha_violation', 'brute_force_lockout_limit_success', 'brute_force_lockout_limit_violation', 'brute_force_challenge_limit_success', 'brute_force_challenge_limit_violation',
                    'brute_force_response_codes_triggered', 'brute_force_response_headers_triggered', 'brute_force_response_string_triggered', 'cookie_security_encrypt_success', 'cookie_security_encrypt_violation', 'cookie_security_encrypt_limit_exceeded', 'cookie_security_encrypt_skip_rcache', 'cookie_security_decrypt_success',
                    'cookie_security_decrypt_violation', 'cookie_security_sign_success', 'cookie_security_sign_violation', 'cookie_security_sign_limit_exceeded', 'cookie_security_sign_skip_rcache', 'cookie_security_signature_check_success', 'cookie_security_signature_check_violation', 'cookie_security_add_http_only_success',
                    'cookie_security_add_http_only_violation', 'cookie_security_add_secure_success', 'cookie_security_add_secure_violation', 'cookie_security_missing_cookie_success', 'cookie_security_missing_cookie_violation', 'cookie_security_unrecognized_cookie_success', 'cookie_security_unrecognized_cookie_violation',
                    'cookie_security_cookie_policy_success', 'cookie_security_cookie_policy_violation', 'cookie_security_persistent_cookies', 'cookie_security_persistent_cookies_encrypted', 'cookie_security_persistent_cookies_signed', 'cookie_security_session_cookies', 'cookie_security_session_cookies_encrypted',
                    'cookie_security_session_cookies_signed', 'cookie_security_allowed_session_cookies', 'cookie_security_allowed_persistent_cookies', 'cookie_security_disallowed_session_cookies', 'cookie_security_disallowed_persistent_cookies', 'cookie_security_allowed_session_set_cookies', 'cookie_security_allowed_persistent_set_cookies',
                    'cookie_security_disallowed_session_set_cookies', 'cookie_security_disallowed_persistent_set_cookies', 'csp_header_violation', 'csp_header_success', 'csp_header_inserted', 'form_csrf_tag_success', 'form_csrf_tag_violation', 'form_consistency_success', 'form_consistency_violation', 'form_tag_inserted', 'form_non_ssl_success',
                    'form_non_ssl_violation', 'form_request_non_post_success', 'form_request_non_post_violation', 'form_check_success', 'form_check_violation', 'form_check_sanitize', 'form_non_masked_password_success', 'form_non_masked_password_violation', 'form_non_ssl_password_success', 'form_non_ssl_password_violation',
                    'form_password_autocomplete_success', 'form_password_autocomplete_violation', 'form_set_no_cache_success', 'form_set_no_cache', 'dlp_ccn_success', 'dlp_ccn_amex_violation', 'dlp_ccn_amex_masked', 'dlp_ccn_diners_violation', 'dlp_ccn_diners_masked', 'dlp_ccn_visa_violation', 'dlp_ccn_visa_masked', 'dlp_ccn_mastercard_violation',
                    'dlp_ccn_mastercard_masked', 'dlp_ccn_discover_violation', 'dlp_ccn_discover_masked', 'dlp_ccn_jcb_violation', 'dlp_ccn_jcb_masked', 'dlp_ssn_success', 'dlp_ssn_violation', 'dlp_pcre_success', 'dlp_pcre_violation', 'dlp_pcre_masked', 'evasion_check_apache_whitespace_success', 'evasion_check_apache_whitespace_violation',
                    'evasion_check_decode_entities_success', 'evasion_check_decode_entities_violation', 'evasion_check_decode_escaped_chars_success', 'evasion_check_decode_escaped_chars_violation', 'evasion_check_decode_unicode_chars_success', 'evasion_check_decode_unicode_chars_violation', 'evasion_check_dir_traversal_success',
                    'evasion_check_dir_traversal_violation'
                    ]
                },
            'counters2': {
                ...
                'str',
                'choices': [
                    'evasion_check_high_ascii_bytes_success', 'evasion_check_high_ascii_bytes_violation', 'evasion_check_invalid_hex_encoding_success', 'evasion_check_invalid_hex_encoding_violation', 'evasion_check_multiple_encoding_levels_success', 'evasion_check_multiple_encoding_levels_violation', 'evasion_check_multiple_slashes_success',
                    'evasion_check_multiple_slashes_violation', 'evasion_check_max_levels_success', 'evasion_check_max_levels_violation', 'evasion_check_remove_comments_success', 'evasion_check_remove_comments_violation', 'evasion_check_remove_spaces_success', 'evasion_check_remove_spaces_violation', 'http_limit_max_content_length_success',
                    'http_limit_max_content_length_violation', 'http_limit_max_cookie_header_length_success', 'http_limit_max_cookie_header_length_violation', 'http_limit_max_cookie_name_length_success', 'http_limit_max_cookie_name_length_violation', 'http_limit_max_cookie_value_length_success', 'http_limit_max_cookie_value_length_violation',
                    'http_limit_max_cookies_success', 'http_limit_max_cookies_violation', 'http_limit_max_cookies_length_success', 'http_limit_max_cookies_length_violation', 'http_limit_max_data_parse_success', 'http_limit_max_data_parse_violation', 'http_limit_max_entities_success', 'http_limit_max_entities_violation',
                    'http_limit_max_header_length_success', 'http_limit_max_header_length_violation', 'http_limit_max_header_name_length_success', 'http_limit_max_header_name_length_violation', 'http_limit_max_header_value_length_success', 'http_limit_max_header_value_length_violation', 'http_limit_max_headers_success',
                    'http_limit_max_headers_violation', 'http_limit_max_headers_length_success', 'http_limit_max_headers_length_violation', 'http_limit_max_param_name_length_success', 'http_limit_max_param_name_length_violation', 'http_limit_max_param_value_length_success', 'http_limit_max_param_value_length_violation',
                    'http_limit_max_params_success', 'http_limit_max_params_violation', 'http_limit_max_params_length_success', 'http_limit_max_params_length_violation', 'http_limit_max_post_length_success', 'http_limit_max_post_length_violation', 'http_limit_max_query_length_success', 'http_limit_max_query_length_violation',
                    'http_limit_max_request_length_success', 'http_limit_max_request_length_violation', 'http_limit_max_request_line_length_success', 'http_limit_max_request_line_length_violation', 'max_url_length_success', 'max_url_length_violation', 'http_protocol_allowed_headers_success', 'http_protocol_allowed_headers_violation',
                    'http_protocol_allowed_versions_success', 'http_protocol_allowed_versions_violation', 'http_protocol_allowed_method_check_success', 'http_protocol_allowed_method_check_violation', 'http_protocol_bad_multipart_request_success', 'http_protocol_bad_multipart_request_violation', 'http_protocol_get_with_content_success',
                    'http_protocol_get_with_content_violation', 'http_protocol_head_with_content_success', 'http_protocol_head_with_content_violation', 'http_protocol_host_header_with_ip_success', 'http_protocol_host_header_with_ip_violation', 'http_protocol_invalid_url_encoding_success', 'http_protocol_invalid_url_encoding_violation',
                    'http_protocol_malformed_content_length_success', 'http_protocol_malformed_content_length_violation', 'http_protocol_malformed_header_success', 'http_protocol_malformed_header_violation', 'http_protocol_malformed_parameter_success', 'http_protocol_malformed_parameter_violation', 'http_protocol_malformed_request_success',
                    'http_protocol_malformed_request_violation', 'http_protocol_malformed_request_line_success', 'http_protocol_malformed_request_line_violation', 'http_protocol_missing_header_value_success', 'http_protocol_missing_header_value_violation', 'http_protocol_missing_host_header_success', 'http_protocol_missing_host_header_violation',
                    'http_protocol_multiple_content_length_success', 'http_protocol_multiple_content_length_violation', 'http_protocol_post_with_0_content_success', 'http_protocol_post_with_0_content_violation', 'http_protocol_post_without_content_success', 'http_protocol_post_without_content_violation', 'http_protocol_success',
                    'http_protocol_violation', 'json_check_format_success'
                    ]
                },
            'counters3': {
                'type':
                'str',
                'choices': [
                    'json_check_format_violation', 'json_check_max_array_value_count_success', 'json_check_max_array_value_count_violation', 'json_check_max_depth_success', 'json_check_max_depth_violation', 'json_check_max_object_member_count_success', 'json_check_max_object_member_count_violation', 'json_check_max_string_success',
                    'json_check_max_string_violation', 'request_check_bot_success', 'request_check_bot_violation', 'request_check_redirect_wlist_success', 'request_check_redirect_wlist_violation', 'request_check_redirect_wlist_learn', 'request_check_referer_success', 'request_check_referer_violation', 'request_check_referer_redirect',
                    'request_check_session_check_none', 'request_check_session_check_success', 'request_check_session_check_violation', 'request_check_sqlia_url_success', 'request_check_sqlia_url_violation', 'request_check_sqlia_url_sanitize', 'request_check_sqlia_post_body_success', 'request_check_sqlia_post_body_violation',
                    'request_check_sqlia_post_body_sanitize', 'request_check_url_list_success', 'request_check_url_list_violation', 'request_check_url_list_learn', 'request_check_url_whitelist_success', 'request_check_url_whitelist_violation', 'request_check_url_blacklist_success', 'request_check_url_blacklist_violation',
                    'request_check_xss_cookie_success', 'request_check_xss_cookie_violation', 'request_check_xss_cookie_sanitize', 'request_check_xss_url_success', 'request_check_xss_url_violation', 'request_check_xss_url_sanitize', 'request_check_xss_post_body_success', 'request_check_xss_post_body_violation',
                    'request_check_xss_post_body_sanitize', 'response_cloaking_hide_status_code_success', 'response_cloaking_hide_status_code_violation', 'response_cloaking_filter_headers_success', 'response_cloaking_filter_headers_violation', 'soap_check_success', 'soap_check_violation', 'xml_check_format_success', 'xml_check_format_violation',
                    'xml_check_max_attr_success', 'xml_check_max_attr_violation', 'xml_check_max_attr_name_len_success', 'xml_check_max_attr_name_len_violation', 'xml_check_max_attr_value_len_success', 'xml_check_max_attr_value_len_violation', 'xml_check_max_cdata_len_success', 'xml_check_max_cdata_len_violation', 'xml_check_max_elem_success',
                    'xml_check_max_elem_violation', 'xml_check_max_elem_child_success', 'xml_check_max_elem_child_violation', 'xml_check_max_elem_depth_success', 'xml_check_max_elem_depth_violation', 'xml_check_max_elem_name_len_success', 'xml_check_max_elem_name_len_violation', 'xml_check_max_entity_exp_success',
                    'xml_check_max_entity_exp_violation', 'xml_check_max_entity_exp_depth_success', 'xml_check_max_entity_exp_depth_violation', 'xml_check_max_namespace_success', 'xml_check_max_namespace_violation', 'xml_check_namespace_uri_len_success', 'xml_check_namespace_uri_len_violation', 'xml_check_sqlia_success',
                    'xml_check_sqlia_violation', 'xml_check_xss_success', 'xml_check_xss_violation', 'xml_content_check_schema_success', 'xml_content_check_schema_violation', 'xml_content_check_wsdl_success', 'xml_content_check_wsdl_violation', 'learning_list_full', 'action_allow', 'action_deny_200', 'action_deny_403', 'action_deny_redirect',
                    'action_deny_reset', 'action_drop', 'action_deny_custom_response', 'action_learn', 'action_log', 'policy_limit_exceeded', 'sessions_alloc', 'sessions_freed', 'out_of_sessions', 'too_many_sessions', 'regex_violation', 'request_check_command_injection_cookies_success', 'request_check_command_injection_cookies_violation',
                    ...
                    'cookie_security_decrypt_in_grace_period_violation', 'form_response_non_post_success', 'form_response_non_post_violation', 'form_response_non_post_sanitize', 'xml_check_max_entity_decl_success', 'xml_check_max_entity_decl_violation', 'xml_check_max_entity_depth_success', 'xml_check_max_entity_depth_violation',
            ...
            'counters4': {
                ...
                'str',
                'choices': [
                    'action_response_deny_403', 'action_response_deny_redirect', 'action_response_deny_reset', 'action_response_drop', 'action_response_deny_custom_response', 'action_response_learn', 'action_response_log', 'http_protocol_post_without_content_type_success', 'http_protocol_post_without_content_type_violation',
                    'http_protocol_body_without_content_type_success', 'http_protocol_body_without_content_type_violation', 'http_protocol_non_ssl_cookie_prefix_success', 'http_protocol_non_ssl_cookie_prefix_violation', 'cookie_security_add_samesite_success', 'cookie_security_add_samesite_violation', 'rule_set_request', 'rule_set_response',
                    'phase1_pass', 'phase1_allow', 'phase1_deny', 'phase1_drop', 'phase1_redirect', 'phase1_other', 'phase2_pass', 'phase2_allow', 'phase2_deny', 'phase2_drop', 'phase2_redirect', 'phase2_other', 'phase3_pass', 'phase3_allow', 'phase3_deny', 'phase3_drop', 'phase3_redirect', 'phase3_other', 'phase4_pass', 'phase4_allow',
                    'phase4_deny', 'phase4_drop', 'phase4_redirect', 'phase4_other'
                    ]
                }
            },
        'stats': {
