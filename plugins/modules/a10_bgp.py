...
options:
    ...
    nexthop_trigger:
        ...
        suboptions:
            ...
            delay:
                description:
                - "Configure nexthop trigger delay time interval (Nexthop Trigger Delay time
...
def get_argspec():
    ...
    rv.update({'extended_asn_cap': {'type': 'bool', },
        'nexthop_trigger': {'type': 'dict', 'enable': {'type': 'bool', }, 'delay': {'type': 'int', }},
        'uuid': {'type': 'str', }
    })
    return rv
