...
def present(module, result, existing_config):
    payload = utils.build_json("aam-aaa-policy-tmpl", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "aam-aaa-policy-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "aam-aaa-policy-tmpl-list"] if info != "NotFound" else info
