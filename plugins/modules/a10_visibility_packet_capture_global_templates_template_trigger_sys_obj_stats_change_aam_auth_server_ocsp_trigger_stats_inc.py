...
AVAILABLE_PROPERTIES = ["job_start_error", "polling_control_error", "request_dropped", "response_error", "response_failure", "response_timeout", "stapling_request_dropped", "stapling_response_error", "stapling_response_failure", "stapling_response_timeout", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'stapling_request_dropped': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-auth-server-ocsp/trigger-stats-inc"
