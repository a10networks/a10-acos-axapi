...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_number_manual_mode
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/manual-mode/{config}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/manual-mode"
