...
options:
    ...
    sampling_enable:
        ...
        suboptions:
            counters1:
                description:
                - "'all'= all; 'pause_conn'= Pause connection; 'pause_conn_fail'= Pause connection
          fail; 'resume_conn'= Resume connection; 'event_resume_conn'= Resume conn by
          event; 'timer_resume_conn'= Resume conn by timer; 'try_to_resume_conn'= Resume
          conn by trying; 'retry_resume_conn'= Resume conn by retry; 'error_resume_conn'=
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["aflow"].items():
        ...
        if config_changes["aflow"].get(k) != v:
            change_results["changed"] = True
            config_changes["aflow"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("aflow", module.params, AVAILABLE_PROPERTIES)
