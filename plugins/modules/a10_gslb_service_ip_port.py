...
def get_argspec():
    ...
    rv.update({'port_num': {'type': 'int', 'required': True, },
        'port_proto': {'type': 'str', 'required': True, 'choices': ['tcp', 'udp']},
        ...
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'active', 'current']}},
        'oper': {'type': 'dict', 'service_port': {'type': 'int', }, 'state': {'type': 'str', }, 'disabled': {'type': 'int', }, 'gslb_protocol': {'type': 'int', }, 'local_protocol': {'type': 'int', }, 'tcp': {'type': 'int', }, 'manually_health_check': {'type': 'int', }, 'use_gslb_state': {'type': 'int', }, 'dynamic': {'type': 'int', }, 'port_num': {'type': 'int', 'required': True, }, 'port_proto': {'type': 'str', 'required': True, 'choices': ['tcp', 'udp']}},
        'stats': {'type': 'dict', 'active': {'type': 'str', }, 'current': {'type': 'str', }, 'port_num': {'type': 'int', 'required': True, }, 'port_proto': {'type': 'str', 'required': True, 'choices': ['tcp', 'udp']}}
    })
    # Parent keys
    rv.update(dict(
