...
DOCUMENTATION = r'''
module: a10_acos_events_template
description:
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'message_selector_list': {'type': 'list', 'name': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }, 'collector_group_list': {'type': 'list', 'name': {'type': 'str', 'required': True, }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }}}
    })
    return rv
