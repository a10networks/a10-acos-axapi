...
def get_argspec():
    ...
    rv.update({'radius': {'type': 'bool', },
        'radius_username': {'type': 'str', },
        'radius_password_string': {'type': 'str', },
        'radius_encrypted': {'type': 'str', },
        'radius_secret': {'type': 'str', },
        'radius_secret_encrypted': {'type': 'str', },
        'radius_port': {'type': 'int', },
        'radius_expect': {'type': 'bool', },
        'radius_response_code': {'type': 'str', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
