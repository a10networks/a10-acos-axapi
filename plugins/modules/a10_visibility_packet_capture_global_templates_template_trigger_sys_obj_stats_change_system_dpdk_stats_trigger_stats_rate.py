...
AVAILABLE_PROPERTIES = [
    "duration", "err_pkt_drop", "io_ring_drop", "io_rx_que_drop", "io_tx_que_drop", "pkt_drop", "pkt_lnk_down_drop", "rx_align_err", "rx_crc_err", "rx_csum_offload_err", "rx_err", "rx_frame_err", "rx_len_err", "rx_long_len_err", "rx_miss_err", "rx_no_buff_err", "rx_over_err", "rx_short_len_err", "threshold_exceeded_by", "tx_abort_err",
