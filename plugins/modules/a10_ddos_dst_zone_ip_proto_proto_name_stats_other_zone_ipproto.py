...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_name_stats_other_zone_ipproto
description:
    - Statistics for the object proto-name
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/stats?other-zone-ipproto=true"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["proto-name"]["stats"] if info != "NotFound" else info
