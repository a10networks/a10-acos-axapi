...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_other_dynamic_entry_overflow_policy
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/dynamic-entry-overflow-policy/{dummy_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/dynamic-entry-overflow-policy"
