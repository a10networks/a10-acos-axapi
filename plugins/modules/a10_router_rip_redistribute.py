...
def get_argspec():
    ...
    rv.update({'redist_list': {'type': 'list', 'ntype': {'type': 'str', 'choices': ['bgp', 'connected', 'floating-ip', 'ip-nat-list', 'ip-nat', 'isis', 'lw4o6', 'nat-map', 'static-nat', 'ospf', 'static']}, 'metric': {'type': 'int', }, 'route_map': {'type': 'str', }},
