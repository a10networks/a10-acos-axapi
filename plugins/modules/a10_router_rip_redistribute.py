...
options:
    ...
    redist_list:
        ...
        suboptions:
          ...
          'public-ip'= Public IPv4 Prefixes; 'ospf'= Open Shortest Path First (OSPF);
...
def get_argspec():
    ...
    rv.update({
        'redist_list': {
            ...
            'ntype': {
                'type': 'str',
                'choices': ['bgp', 'connected', 'floating-ip', 'ip-nat-list', 'ip-nat', 'isis', 'lw4o6', 'nat-map', 'static-nat', 'public-ip', 'ospf', 'static']
                },
            'metric': {
                'type': 'int',
                },
