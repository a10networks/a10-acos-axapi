...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_mysql_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["session_err", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'session_err': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-mysql/trigger-stats-inc"
