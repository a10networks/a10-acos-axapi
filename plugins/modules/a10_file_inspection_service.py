...
DOCUMENTATION = r'''
module: a10_file_inspection_service
description:
...
def get_argspec():
    ...
    rv.update({'file_content': {'type': 'str', },'enable': {'type': 'bool', },
        'service_down_action': {'type': 'str', 'choices': ['reset', 'allow']},
...
def get(module):
    ...
    if file_info:
        ...
        file_list = file_info["service"]["oper"].get("file-list", [])
