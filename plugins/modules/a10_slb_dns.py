...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'slb_req', 'slb_resp', 'slb_no_resp', 'slb_req_rexmit', 'slb_resp_no_match', 'slb_no_resource', 'nat_req', 'nat_resp', 'nat_no_resp', 'nat_req_rexmit', 'nat_resp_no_match', 'nat_no_resource', 'nat_xid_reused']}},
        'stats': {'type': 'dict', 'slb_req': {'type': 'str', }, 'slb_resp': {'type': 'str', }, 'slb_no_resp': {'type': 'str', }, 'slb_req_rexmit': {'type': 'str', }, 'slb_resp_no_match': {'type': 'str', }, 'slb_no_resource': {'type': 'str', }, 'nat_req': {'type': 'str', }, 'nat_resp': {'type': 'str', }, 'nat_no_resp': {'type': 'str', }, 'nat_req_rexmit': {'type': 'str', }, 'nat_resp_no_match': {'type': 'str', }, 'nat_no_resource': {'type': 'str', }, 'nat_xid_reused': {'type': 'str', }}
    })
    return rv
