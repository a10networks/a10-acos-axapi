...
options:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          'sched_conn_with_wrong_next_idx_to_rml'= Attempt to Put a Conn to RML Whose
          next_idx is NOT Invalid; 'free_conn_not_in_sp'= Attempt to Free a Conn Whoes
          Address Not in Session Pool; 'total_system_sessions'= Total system-wide
          sessions;"
                type: str
    oper:
        description:
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'gtp_u_echo_counter', 'gtp_curr_free_conn', 'gtp_cum_conn_counter', 'gtp_cum_conn_freed_counter', 'fw_blacklist_sess', 'fw_blacklist_sess_created', 'fw_blacklist_sess_freed', 'server_tcp_est_counter', 'server_tcp_half_open_counter', 'sched_conn_with_wrong_next_idx_to_rml', 'free_conn_not_in_sp', 'total_system_sessions'
                    ]
                }
            },
        'oper': {
