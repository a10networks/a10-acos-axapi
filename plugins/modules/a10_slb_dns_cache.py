...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'total_q', 'total_r', 'hit', 'bad_q', 'encode_q', 'multiple_q', 'oversize_q', 'bad_r', 'oversize_r', 'encode_r', 'multiple_r', 'answer_r', 'ttl_r', 'ageout', 'bad_answer', 'ageout_weight', 'total_log', 'total_alloc', 'total_freed', 'current_allocate', 'current_data_allocate', 'resolver_queue_full', 'truncated_r']}},
        'oper': {'type': 'dict', 'cache_client': {'type': 'list', 'domain': {'type': 'str', }, 'address': {'type': 'str', }, 'unit_type': {'type': 'str', }, 'curr_rate': {'type': 'int', }, 'over_rate_limit_times': {'type': 'int', }, 'lockup': {'type': 'int', }, 'lockup_time': {'type': 'int', }}, 'cache_entry': {'type': 'list', 'name': {'type': 'str', }, 'domain': {'type': 'str', }, 'dnssec': {'type': 'int', }, 'cache_type': {'type': 'int', }, 'cache_class': {'type': 'int', }, 'q_length': {'type': 'int', }, 'r_length': {'type': 'int', }, 'ttl': {'type': 'int', }, 'age': {'type': 'int', }, 'weight': {'type': 'int', }, 'hits': {'type': 'int', }}, 'total': {'type': 'int', }, 'client': {'type': 'bool', }, 'entry': {'type': 'bool', }, 'global': {'type': 'bool', }, 'vport': {'type': 'bool', }, 'vs_name': {'type': 'str', }, 'port_type': {'type': 'str', }, 'port_num': {'type': 'int', }, 'type_value': {'type': 'int', }, 'fqdn_domain': {'type': 'str', }, 'class_string': {'type': 'str', 'choices': ['IN', 'CH', 'HS', 'NONE', 'ANY']}, 'class_value': {'type': 'int', }, 'type_string': {'type': 'str', 'choices': ['A', 'AAAA', 'CNAE', 'MX', 'NS', 'SRV']}, 'domain_name': {'type': 'str', }},
        'stats': {'type': 'dict', 'total_q': {'type': 'str', }, 'total_r': {'type': 'str', }, 'hit': {'type': 'str', }, 'bad_q': {'type': 'str', }, 'encode_q': {'type': 'str', }, 'multiple_q': {'type': 'str', }, 'oversize_q': {'type': 'str', }, 'bad_r': {'type': 'str', }, 'oversize_r': {'type': 'str', }, 'encode_r': {'type': 'str', }, 'multiple_r': {'type': 'str', }, 'answer_r': {'type': 'str', }, 'ttl_r': {'type': 'str', }, 'ageout': {'type': 'str', }, 'bad_answer': {'type': 'str', }, 'ageout_weight': {'type': 'str', }, 'total_log': {'type': 'str', }, 'total_alloc': {'type': 'str', }, 'total_freed': {'type': 'str', }, 'current_allocate': {'type': 'str', }, 'current_data_allocate': {'type': 'str', }, 'resolver_queue_full': {'type': 'str', }, 'truncated_r': {'type': 'str', }}
    })
    return rv
