...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_range
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port-range/{src_port_range_start}+{src_port_range_end}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port-range/+"
