...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'interfaces': {'type': 'list', 'port_num': {'type': 'str', }, 'speed': {'type': 'str', }, 'duplexity': {'type': 'str', }, 'trunk_group': {'type': 'str', }, 'vlan_info': {'type': 'str', }, 'state': {'type': 'str', }, 'mac': {'type': 'str', }, 'ipv4_addr_count': {'type': 'int', }, 'ipv4_addr': {'type': 'str', }, 'ipv4_mask': {'type': 'str', }, 'ipv6_addr_count': {'type': 'int', }, 'ipv6_addr': {'type': 'str', }, 'ipv6_prefix': {'type': 'str', }, 'intf_name': {'type': 'str', }}}
    })
    return rv
