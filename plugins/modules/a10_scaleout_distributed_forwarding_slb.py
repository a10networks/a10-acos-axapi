...
DOCUMENTATION = r'''
module: a10_scaleout_distributed_forwarding_slb
description:
...
AVAILABLE_PROPERTIES = ["slb_value", "tcp_threshold", "udp_threshold", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'slb_value': {'type': 'str', 'choices': ['enable', 'disable']}, 'tcp_threshold': {'type': 'int', }, 'udp_threshold': {'type': 'int', }, 'uuid': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/scaleout/distributed-forwarding/slb"
