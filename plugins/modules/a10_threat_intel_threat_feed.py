...
def get_argspec():
    ...
    rv.update({
        ...
        'log_level': {
            'type': 'str',
            'choices': ['disable', 'error', 'warning', 'info', 'debug', 'trace']
            },
        'proxy_host': {
            'type': 'str',
            },
...
def new_url(module):
    ...
    url_base = "/axapi/v3/threat-intel/threat-feed"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["threat-feed"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["threat-feed-list"] if info != "NotFound" else info
