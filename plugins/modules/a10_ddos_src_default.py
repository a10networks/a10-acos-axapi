...
AVAILABLE_PROPERTIES = ["age", "app_type_list", "apply_policy_on_overflow", "default_address_type", "disable", "exceed_log_cfg", "glid", "l4_type_list", "log_periodic", "max_dynamic_entry_count", "template", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/src/default/{default_address_type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/src/default"
