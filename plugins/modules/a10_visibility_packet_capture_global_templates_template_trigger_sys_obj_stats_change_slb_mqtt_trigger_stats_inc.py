...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_mqtt_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["client_id_null", "conn_null", "insertion_failed", "parse_connect_fail", "parse_publish_fail", "parse_subscribe_fail", "parse_unsubscribe_fail", "session_exist", "tuple_already_linked", "tuple_not_linked", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'parse_connect_fail': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-mqtt/trigger-stats-inc"
