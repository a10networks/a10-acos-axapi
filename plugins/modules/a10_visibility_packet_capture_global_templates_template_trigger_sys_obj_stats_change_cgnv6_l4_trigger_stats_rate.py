...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_l4_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "icmp_host_unreachable_sent", "out_of_session_memory", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'out_of_session_memory': {'type': 'bool', }, 'icmp_host_unreachable_sent': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-l4/trigger-stats-rate"
