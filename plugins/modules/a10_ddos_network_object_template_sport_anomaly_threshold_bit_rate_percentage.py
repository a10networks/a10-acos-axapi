...
DOCUMENTATION = r'''
module: a10_ddos_network_object_template_sport_anomaly_threshold_bit_rate_percentage
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object-template/{network_object_template_name}/sport-anomaly-threshold/bit-rate-percentage"
