...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_name_src_based_policy_policy_class_list
description:
...
AVAILABLE_PROPERTIES = ["action", "class_list_name", "class_list_overflow_policy_list", "glid", "glid_action", "log_enable", "log_periodic", "max_dynamic_entry_count", "sampling_enable", "stats", "user_tag", "uuid", "zone_template", ]
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(src_based_policy_src_based_policy_name=dict(type='str', required=True), proto_name_protocol=dict(type='str', required=True), zone_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/src-based-policy/{src_based_policy_src_based_policy_name}/policy-class-list/{class_list_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/src-based-policy/{src_based_policy_src_based_policy_name}/policy-class-list"
