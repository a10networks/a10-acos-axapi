...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_virtualhosts_virtualhost_stats_l4_ssl_zone_port
description:
    - Statistics for the object virtualhost
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["stats", "vhost", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service/{zone_service_port_num}+{protocol}/virtualhosts/virtualhost/{virtualhost_vhost}/stats?l4-ssl-zone-port=true"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single" or module.params.get("get_type") is None:
                ...
                result["acos_info"] = info["virtualhost"]["stats"] if info != "NotFound" else info
