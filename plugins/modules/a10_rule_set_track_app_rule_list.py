...
def present(module, result, existing_config):
    payload = utils.build_json("track-app-rule-list", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "track-app-rule-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "track-app-rule-list-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["track-app-rule-list"][
