...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_number_src_based_policy
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/src-based-policy/{src_based_policy_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-number/{proto_number_protocol_num}/src-based-policy"
