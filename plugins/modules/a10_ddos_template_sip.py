...
options:
    ...
    action:
        description:
        - "'drop'= Drop packets for sip connection; 'reset'= Send RST for sip-tcp
          connection;"
        type: str
        required: False
...
AVAILABLE_PROPERTIES = ["action", "dst", "filter_header_list", "idle_timeout", "ignore_zero_payload", "malformed_sip", "multi_pu_threshold_distribution", "sip_tmpl_name", "src", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/template/sip/{sip_tmpl_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/template/sip"
