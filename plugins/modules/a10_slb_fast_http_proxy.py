        ...
        'sampling_enable': {
            ...
            'counters2': {
                ...
                'choices': [
                    ...
                    'req_1s', 'req_2s', 'req_5s', 'req_over_5s', 'insert_client_port', 'req_track', 'full_proxy_put', 'non_http_bypass', 'skip_insert_client_ip', 'skip_insert_client_port', 'decompression_before', 'decompression_after', 'http_pkts_in_seq', 'http_pkts_retx', 'http_client_retx',
