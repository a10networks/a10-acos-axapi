...
def get_argspec():
    ...
    rv.update({'snmp_name': {'type': 'str', 'required': True, },
        'version': {'type': 'str', 'choices': ['v1', 'v2c', 'v3']},
        'community': {'type': 'str', },
        'security_level': {'type': 'str', 'choices': ['no-auth', 'auth-no-priv', 'auth-priv']},
        'oid': {'type': 'str', },
        'interface': {'type': 'int', },
        'username': {'type': 'str', },
        'auth_key': {'type': 'str', },
        ...
        'port': {'type': 'int', },
        'interval': {'type': 'int', },
        'auth_proto': {'type': 'str', 'choices': ['sha', 'md5']},
        'priv_proto': {'type': 'str', 'choices': ['aes', 'des']},
        'context_name': {'type': 'str', },
        'context_engine_id': {'type': 'str', },
        'security_engine_id': {'type': 'str', },
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', }
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/gslb/template/snmp/{snmp_name}"

    f_dict = {}
    if '/' in str(module.params["snmp_name"]):
        f_dict["snmp_name"] = module.params["snmp_name"].replace("/","%2F")
    else:
        f_dict["snmp_name"] = module.params["snmp_name"]
