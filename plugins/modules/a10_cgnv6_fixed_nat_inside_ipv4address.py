...
def present(module, result, existing_config):
    payload = utils.build_json("ipv4address", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "ipv4address"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "ipv4address-list"] if info != "NotFound" else info
