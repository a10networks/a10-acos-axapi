...
AVAILABLE_PROPERTIES = ["duration", "l4_process_error", "threshold_exceeded_by", "unsol_ance_sent_fail", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-pcp/trigger-stats-rate"
