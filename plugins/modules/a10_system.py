...
def get_argspec():
    ...
    rv.update({'anomaly_log': {'type': 'bool', },
        ...
        'table_integrity_check': {'type': 'dict', 'action': {'type': 'bool', }, 'uuid': {'type': 'str', }},
        ...
        'cpu_load_sharing': {'type': 'dict', 'disable': {'type': 'bool', }, 'packets_per_second': {'type': 'dict', 'min': {'type': 'int', }}, 'cpu_usage': {'type': 'dict', 'low': {'type': 'int', }, 'high': {'type': 'int', }}, 'uuid': {'type': 'str', }},
        ...
        'apps_global': {'type': 'dict', 'log_session_on_established': {'type': 'bool', }, 'msl_time': {'type': 'int', }, 'uuid': {'type': 'str', }},
        'shell_privileges': {'type': 'dict', 'uuid': {'type': 'str', }},
        ...
        'dns': {'type': 'dict', 'uuid': {'type': 'str', }, 'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'slb_req', 'slb_resp', 'slb_no_resp', 'slb_req_rexmit', 'slb_resp_no_match', 'slb_no_resource', 'nat_req', 'nat_resp', 'nat_no_resp', 'nat_req_rexmit', 'nat_resp_no_match', 'nat_no_resource', 'nat_xid_reused']}}},
        'dns_cache': {'type': 'dict', 'uuid': {'type': 'str', }, 'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'total_q', 'total_r', 'hit', 'bad_q', 'encode_q', 'multiple_q', 'oversize_q', 'bad_r', 'oversize_r', 'encode_r', 'multiple_r', 'answer_r', 'ttl_r', 'ageout', 'bad_answer', 'ageout_weight', 'total_log', 'total_alloc', 'total_freed', 'current_allocate', 'current_data_allocate']}}},
        ...
        'telemetry_log': {'type': 'dict', 'top_k_source_list': {'type': 'dict', 'uuid': {'type': 'str', }}, 'top_k_app_svc_list': {'type': 'dict', 'uuid': {'type': 'str', }}, 'device_status': {'type': 'dict', 'uuid': {'type': 'str', }}, 'partition_metrics': {'type': 'dict', 'uuid': {'type': 'str', }}}
    })
    return rv
