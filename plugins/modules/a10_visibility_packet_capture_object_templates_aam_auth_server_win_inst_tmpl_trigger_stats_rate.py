...
AVAILABLE_PROPERTIES = ["duration", "krb_other_error", "krb_pw_change_failure", "krb_pw_expiry", "krb_timeout_error", "krb_validate_kdc_failure", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'krb_timeout_error': {'type': 'bool', }, 'krb_other_error': {'type': 'bool', }, 'krb_pw_expiry': {'type': 'bool', }, 'krb_pw_change_failure': {'type': 'bool', }, 'krb_validate_kdc_failure': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
