...
def present(module, result, existing_config):
    payload = utils.build_json("ike-stats-by-gw", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "ike-stats-by-gw"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "ike-stats-by-gw-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["ike-stats-by-gw"][
