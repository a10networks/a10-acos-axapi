...
AVAILABLE_PROPERTIES = ["fwdreq_fail", "fwdreqdata_fail", "parsereq_fail", "req_over_limit", "req_rate_over_limit", "snat_fail", "svrsel_fail", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-http-proxy/trigger-stats-inc"
