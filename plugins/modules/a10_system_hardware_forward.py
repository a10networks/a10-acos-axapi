...
def get_argspec():
    ...
    rv.update(dict(
        ...
        stats=dict(type='dict', hw_fwd_flow_unalign_count=dict(type='str', ), hw_fwd_flow_error_count=dict(type='str', ), hw_fwd_vmid_drop=dict(type='str', ), hw_fwd_protocol_mismatch_drop=dict(type='str', ), hw_fwd_flow_seq_mismatch=dict(type='str', ), hw_fwd_flow_drop_count=dict(type='str', ), ipv4_forward_counts=dict(type='str', ), hw_fwd_phyport_mismatch_drop=dict(type='str', ), hw_fwd_invalidation_drop=dict(type='str', ), ipv6_forward_counts=dict(type='str', ), hw_fwd_flow_hit_index=dict(type='str', ), hw_fwd_flow_tag_mismatch=dict(type='str', ), hw_fwd_ageout_drop_count=dict(type='str', ), hw_fwd_flow_tx_full_drop=dict(type='str', ), hw_fwd_flow_singlebit_errors=dict(type='str', ), hw_fwd_avail_ipv4_entry=dict(type='str', ), hw_fwd_flow_qdr_full_drop=dict(type='str', ), hw_fwd_vlanid_mismatch_drop=dict(type='str', ), hw_fwd_prog_errors=dict(type='str', ), hit_index=dict(type='str', ), hw_fwd_prog_reqs=dict(type='str', ), hw_fwd_avail_ipv6_entry=dict(type='str', ), hw_fwd_flow_reason_flags=dict(type='str', ), hw_fwd_flow_underflow_count=dict(type='str', ), hw_fwd_module_status=dict(type='str', ), hit_counts=dict(type='str', )),
        uuid=dict(type='str', )
    ))
