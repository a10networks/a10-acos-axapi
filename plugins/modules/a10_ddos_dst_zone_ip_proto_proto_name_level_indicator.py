...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_name_level_indicator
description:
...
AVAILABLE_PROPERTIES = ["data_packet_size", "score", "src_threshold_large_num", "src_threshold_num", "src_threshold_str", "src_violation_actions", "ntype", "user_tag", "uuid", "zone_threshold_large_num", "zone_threshold_num", "zone_threshold_str", "zone_violation_actions", ]
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(level_num=dict(type='str', required=True), proto_name_protocol=dict(type='str', required=True), zone_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/level/{level_num}/indicator/{type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/level/{level_num}/indicator"
