...
AVAILABLE_PROPERTIES = ["data_packet_size", "score", "src_threshold_num", "src_threshold_str", "src_violation_actions", "ntype", "user_tag", "uuid", "zone_threshold_num", "zone_threshold_str", "zone_violation_actions", ]
