...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_range_stats_tcp_zone_port
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(protocol=dict(type='str', required=True), src_port_range_end=dict(type='str', required=True), src_port_range_src_port_range_start=dict(type='str', required=True), zone_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port-range/{src_port_range_src_port_range_start}+{src_port_range_end}+{protocol}/stats?tcp-zone-port=true"
