...
short_description: Configures A10 system.all-vlan-limit
        ...
        for k, v in payload["all-vlan-limit"].items():
            if isinstance(v, str):
               ...
               break
                ...
                if existing_config["all-vlan-limit"][k] != v:
                    if result["changed"] != True:
                        result["changed"] = True
                    existing_config["all-vlan-limit"][k] = v
...
def present(module, result, existing_config):
    payload = build_json("all-vlan-limit", module)
