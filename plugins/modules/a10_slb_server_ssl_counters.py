...
def present(module, result, existing_config):
    payload = utils.build_json("server-ssl-counters", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "server-ssl-counters"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "server-ssl-counters-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["server-ssl-counters"][
