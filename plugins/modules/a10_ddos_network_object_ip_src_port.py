...
DOCUMENTATION = r'''
module: a10_ddos_network_object_ip_src_port
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(ip_subnet_ip_addr=dict(type='str', required=True), network_object_object_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object/{network_object_object_name}/ip/{ip_subnet_ip_addr}/src-port/{port_num}+{protocol}"
    ...
    if '/' in module.params["ip_subnet_ip_addr"]:
        f_dict["ip_subnet_ip_addr"] = module.params["ip_subnet_ip_addr"].replace("/", "%2F")
    else:
        f_dict["ip_subnet_ip_addr"] = module.params["ip_subnet_ip_addr"]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/network-object/{network_object_object_name}/ip/{ip_subnet_ip_addr}/src-port/"
