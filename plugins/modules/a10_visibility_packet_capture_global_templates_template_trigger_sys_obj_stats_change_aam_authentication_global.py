...
def present(module, result, existing_config):
    payload = utils.build_json("aam-authentication-global", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "aam-authentication-global"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "aam-authentication-global-list"] if info != "NotFound" else info
