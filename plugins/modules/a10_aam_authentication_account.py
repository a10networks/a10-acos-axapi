    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'request-normal', 'request-dropped',
                    'response-success', 'response-failure', 'response-error',
                    'response-timeout', 'response-other'
                ]
            }
        },
        'kerberos_spn_list': {
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "account"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "account-list"] if info != "NotFound" else info
