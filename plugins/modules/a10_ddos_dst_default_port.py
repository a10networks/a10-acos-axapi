...
DOCUMENTATION = r'''
module: a10_ddos_dst_default_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/default/{default_address_type}/port/{port_num}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/default/{default_address_type}/port/"
