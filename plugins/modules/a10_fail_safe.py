...
options:
    ...
    fpga_monitor_threshold:
        ...
        - "FPGA monitor packet missed for error condition (Numbers of missed monitor
          packets before setting error condition (default 30))"
        type: int
        required: False
    hw_error_monitor:
        description:
...
def get_argspec():
    ...
    rv.update({
        ...
        'hw_ssl_timeout_monitor': {
            'type': 'str',
            'choices': ['hw-ssl-timeout-monitor-disable', 'hw-ssl-timeout-monitor-enable']
            },
        'hw_error_recovery_timeout': {
            'type': 'int',
            },
        ...
        'disable_failsafe': {
            ...
            'action': {
                'type': 'str',
                'choices': ['all', 'io-buffer', 'session-memory', 'system-memory']
                },
            'uuid': {
                'type': 'str',
                }
