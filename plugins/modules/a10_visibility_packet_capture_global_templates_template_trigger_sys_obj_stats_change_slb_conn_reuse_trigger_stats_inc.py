...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_conn_reuse_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["ntermi_err", "pause_conn_fail", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'ntermi_err': {'type': 'bool', }, 'pause_conn_fail': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-conn-reuse/trigger-stats-inc"
