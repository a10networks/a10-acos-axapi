        ...
        'sampling_enable': {
            ...
            'counters2': {
                ...
                'choices': [
                    ...
                    'h2up_with_host_and_auth', 'header_filter_rule_hit'
                ]
            }
        },
        'oper': {
...
def present(module, result, existing_config):
    payload = utils.build_json("http-proxy", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "http-proxy"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "http-proxy-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["http-proxy"][
