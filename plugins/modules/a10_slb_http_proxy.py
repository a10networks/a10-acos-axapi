...
options:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          upgrade; 'del_h2c_header'= H2C header deletion; 'transaction_limited'=
          Transaction limited;"
                type: str
    oper:
        description:
        ...
        'sampling_enable': {
            ...
            'counters2': {
                ...
                'choices': [
                    ...
                    'header_filter_rule_hit', 'http1_client_idle_timeout', 'http2_client_idle_timeout', 'http_disallowed_methods', 'upgrade_to_new_proxy', 'del_h2c_header', 'transaction_limited'
                    ]
                }
            },
        'oper': {
