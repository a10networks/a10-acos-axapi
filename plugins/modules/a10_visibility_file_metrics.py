...
def get_argspec():
    ...
    rv.update({'action': {'type': 'str', 'choices': ['enable', 'disable']},
        'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'monitor_type': {'type': 'str', }, 'pri_type': {'type': 'str', }, 'pri_ipv4_addr': {'type': 'str', }, 'pri_ipv6_addr': {'type': 'str', }, 'pri_l4_proto': {'type': 'int', }, 'pri_l4_port': {'type': 'int', }, 'sec_type': {'type': 'str', }, 'sec_ipv4_addr': {'type': 'str', }, 'sec_ipv6_addr': {'type': 'str', }, 'sec_l4_proto': {'type': 'int', }, 'sec_l4_port': {'type': 'int', }, 'file_name': {'type': 'str', }, 'proc_metric_list': {'type': 'list', 'metric_name': {'type': 'str', }, 'metric_attr_list': {'type': 'list', 'metric_attr_name': {'type': 'str', }, 'metric_attr_value': {'type': 'str', }}}}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/file/metrics"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["metrics"]["oper"] if info != "NotFound" else info
