...
AVAILABLE_PROPERTIES = ["cpu_id", "dumy", "entry_ip", "life_cycle_log", "metric", "per_pkt_log", "raw_log", "tpl_id", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'raw_log': {'type': 'bool', }, 'per_pkt_log': {'type': 'bool', }, 'life_cycle_log': {'type': 'bool', }, 'tpl_id': {'type': 'int', }, 'entry_ip': {'type': 'str', }, 'metric': {'type': 'int', }, 'cpu_id': {'type': 'int', }, 'dumy': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/debug/rate-limit"
