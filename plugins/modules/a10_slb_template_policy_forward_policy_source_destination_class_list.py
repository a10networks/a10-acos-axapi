...
AVAILABLE_PROPERTIES = ["action", "dest_class_list", "dual_stack_action", "priority", "stats", "ntype", "uuid", ]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/slb/template/policy/{policy_name}/forward-policy/source/{name}/destination/class-list"
