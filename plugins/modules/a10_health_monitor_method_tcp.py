...
AVAILABLE_PROPERTIES = ["maintenance", "maintenance_text", "method_tcp", "port_halfopen", "port_resp", "port_send", "tcp_port", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'method_tcp': {'type': 'bool', },
        'tcp_port': {'type': 'int', },
        'port_halfopen': {'type': 'bool', },
        'port_send': {'type': 'str', },
        'port_resp': {'type': 'dict', 'port_contains': {'type': 'str', }},
