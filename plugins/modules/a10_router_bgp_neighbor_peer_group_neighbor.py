...
def present(module, result, existing_config):
    payload = utils.build_json("peer-group-neighbor", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "peer-group-neighbor"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "peer-group-neighbor-list"] if info != "NotFound" else info
