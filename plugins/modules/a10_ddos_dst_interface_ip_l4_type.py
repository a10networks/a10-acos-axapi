...
DOCUMENTATION = r'''
module: a10_ddos_dst_interface_ip_l4_type
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/interface-ip/{interface_ip_addr}/l4-type/{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/interface-ip/{interface_ip_addr}/l4-type"
