...
def get_argspec():
    ...
    rv.update({'https': {'type': 'bool', },
        ...
        'maintenance_text': {'type': 'str', },
        'maintenance_text_regex': {'type': 'str', },
        'https_username': {'type': 'str', },
        'https_server_cert_name': {'type': 'str', },
