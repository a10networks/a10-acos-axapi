        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'l7-proxy-conns-per-sec', 'l7-proxy-trans-per-sec'
                ]
            }
        },
        'stats': {
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result[
                    "acos_info"] = info["perf"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "perf-list"] if info != "NotFound" else info
