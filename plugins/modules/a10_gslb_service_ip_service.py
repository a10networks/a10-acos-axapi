...
DOCUMENTATION = r'''
module: a10_gslb_service_ip_service
description:
    - Service Port
author: A10 Networks
options:
...
AVAILABLE_PROPERTIES = ["action", "health_check", "health_check_disable", "health_check_protocol_disable", "label", "oper", "port_num", "port_proto", "sampling_enable", "stats", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/gslb/service-ip/{service_ip_node_name}/service/{port_num}+{port_proto}+{label}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/gslb/service-ip/{service_ip_node_name}/service/+"
