...
def present(module, result, existing_config):
    payload = utils.build_json("slot-summary", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "slot-summary"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "slot-summary-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["slot-summary"][
