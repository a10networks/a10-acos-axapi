...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_netflow_monitor_tmpl_trigger_stats_severity
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/netflow-monitor-tmpl/{netflow_monitor_tmpl_name}/trigger-stats-severity"
