...
def existing_url(module):
    ...
    url_base = "/axapi/v3/template/limit-policy/{policy-number}"

    f_dict = {}
    f_dict["policy-number"] = module.params["policy_number"]
...
def present(module, result, existing_config):
    payload = utils.build_json("limit-policy", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "limit-policy"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "limit-policy-list"] if info != "NotFound" else info
