...
AVAILABLE_PROPERTIES = ["gtp_u_downlink_byte_rate", "gtp_u_downlink_packet_rate", "gtp_u_max_concurrent_tunnels", "gtp_u_total_byte_rate", "gtp_u_total_packet_rate", "gtp_u_tunnel_create_rate", "gtp_u_uplink_byte_rate", "gtp_u_uplink_packet_rate", "lockout", "name", "rate_limit_action", "user_tag", "uuid", "v0_agg_message_type_rate", "v1_agg_message_type_rate", "v1_create_pdp_request_rate", "v1_update_pdp_request_rate", "v2_agg_message_type_rate", "v2_create_session_request_rate", "v2_modify_bearer_request_rate", ]
...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        'rate_limit_action': {'type': 'str', 'choices': ['monitor', 'drop']},
        'v0_agg_message_type_rate': {'type': 'int', },
        'v1_agg_message_type_rate': {'type': 'int', },
        'v2_agg_message_type_rate': {'type': 'int', },
        'v1_create_pdp_request_rate': {'type': 'int', },
        'v2_create_session_request_rate': {'type': 'int', },
        'v1_update_pdp_request_rate': {'type': 'int', },
        'v2_modify_bearer_request_rate': {'type': 'int', },
        'gtp_u_tunnel_create_rate': {'type': 'int', },
        'gtp_u_uplink_byte_rate': {'type': 'int', },
        'gtp_u_uplink_packet_rate': {'type': 'int', },
        'gtp_u_downlink_byte_rate': {'type': 'int', },
        'gtp_u_downlink_packet_rate': {'type': 'int', },
        'gtp_u_total_byte_rate': {'type': 'int', },
        'gtp_u_total_packet_rate': {'type': 'int', },
        'lockout': {'type': 'int', },
        'gtp_u_max_concurrent_tunnels': {'type': 'int', },
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', }
    })
    return rv
...
def present(module, result, existing_config):
    payload = utils.build_json("rate-limit-policy", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["rate-limit-policy"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["rate-limit-policy-list"] if info != "NotFound" else info
