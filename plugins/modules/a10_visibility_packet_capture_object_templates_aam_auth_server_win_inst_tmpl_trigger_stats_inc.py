...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_aam_auth_server_win_inst_tmpl_trigger_stats_inc
description:
...
def get_argspec():
    ...
    rv.update({'krb_timeout_error': {'type': 'bool', },
        'krb_other_error': {'type': 'bool', },
        'krb_pw_expiry': {'type': 'bool', },
        'krb_pw_change_failure': {'type': 'bool', },
        'ntlm_proto_nego_failure': {'type': 'bool', },
        'ntlm_session_setup_failure': {'type': 'bool', },
        'ntlm_prepare_req_error': {'type': 'bool', },
        'ntlm_auth_failure': {'type': 'bool', },
        'ntlm_timeout_error': {'type': 'bool', },
        'ntlm_other_error': {'type': 'bool', },
        'krb_validate_kdc_failure': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-server-win-inst-tmpl/{aam_auth_server_win_inst_tmpl_name}/trigger-stats-inc"
