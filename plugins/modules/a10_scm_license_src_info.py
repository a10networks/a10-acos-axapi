...
def present(module, result, existing_config):
    payload = utils.build_json("license-src-info", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "license-src-info"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "license-src-info-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["license-src-info"][
