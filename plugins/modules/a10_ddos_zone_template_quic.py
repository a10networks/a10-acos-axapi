...
DOCUMENTATION = r'''
module: a10_ddos_zone_template_quic
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/quic/{quic_tmpl_name}"

    f_dict = {}
    if '/' in str(module.params["quic_tmpl_name"]):
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/quic"

    f_dict = {}
    f_dict["quic_tmpl_name"] = ""
