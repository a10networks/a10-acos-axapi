...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_stats_dns_udp_zone_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service/{zone_service_port_num}+{protocol}/stats?dns-udp-zone-port=true"
