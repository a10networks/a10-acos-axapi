...
def get_argspec():
    ...
    rv.update({'ip_dscp_preserve': {'type': 'bool', },
        'nvgre_disable_flow_id': {'type': 'bool', },
        'nvgre_key_mode_lower24': {'type': 'bool', },
        'tcp_mss_adjust_disable': {'type': 'bool', },
        'gateway_mac': {'type': 'str', },
        'fragmentation_mode_inner': {'type': 'bool', },
        'vxlan_dest_port': {'type': 'int', },
        'uuid': {'type': 'str', }
    })
    return rv
