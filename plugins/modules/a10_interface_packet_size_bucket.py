...
def present(module, result, existing_config):
    payload = utils.build_json("packet-size-bucket", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "packet-size-bucket"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "packet-size-bucket-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["packet-size-bucket"][
