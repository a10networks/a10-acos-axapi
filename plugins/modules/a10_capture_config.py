...
AVAILABLE_PROPERTIES = ["count", "enable", "file_history_size", "file_size", "filter", "length", "name", "oper", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/capture-config/{name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/capture-config"
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["capture-config"]["oper"] if info != "NotFound" else info
