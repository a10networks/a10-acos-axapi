...
def get_argspec():
    ...
    rv.update({'lsn_nat_addr_count': {'type': 'int', },
        'fixed_nat_ip_addr_count': {'type': 'int', },
        'fixed_nat_inside_user_count': {'type': 'int', },
        'radius_table_size': {'type': 'int', },
        'uuid': {'type': 'str', },
        'stateless_entries': {'type': 'dict', 'l4_session_count': {'type': 'int', }, 'uuid': {'type': 'str', }},
        'oper': {'type': 'dict', 'lsn_nat_addr_count_min': {'type': 'int', }, 'lsn_nat_addr_count_max': {'type': 'int', }, 'lsn_nat_addr_count_default': {'type': 'int', }, 'fixed_nat_ip_addr_count_min': {'type': 'int', }, 'fixed_nat_ip_addr_count_max': {'type': 'int', }, 'fixed_nat_ip_addr_count_default': {'type': 'int', }, 'fixed_nat_inside_user_count_min': {'type': 'int', }, 'fixed_nat_inside_user_count_max': {'type': 'int', }, 'fixed_nat_inside_user_count_default': {'type': 'int', }, 'radius_table_size_min': {'type': 'int', }, 'radius_table_size_max': {'type': 'int', }, 'radius_table_size_default': {'type': 'int', }}
    })
    return rv
