    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'sessions_alloc', 'sessions_freed',
                    'out_of_sessions', 'too_many_sessions', 'called',
                    'permitted', 'threshold_exceed', 'lockout_drop',
                    'log_msg_sent'
                ]
            }
        },
...
def present(module, result, existing_config):
    payload = utils.build_json("crl-srcip", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "crl-srcip"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "crl-srcip-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["crl-srcip"][
