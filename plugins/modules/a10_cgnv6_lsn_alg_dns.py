...
DOCUMENTATION = r'''
module: a10_cgnv6_lsn_alg_dns
description:
    - Change LSN DNS ALG Settings
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["dns_value", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'dns_value': {'type': 'str', 'choices': ['disable']}, 'uuid': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/lsn/alg/dns"
