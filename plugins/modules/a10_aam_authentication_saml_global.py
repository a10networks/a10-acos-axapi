...
options:
    ...
    sampling_enable:
        ...
        suboptions:
            counters1:
                description:
                - "'all'= all; 'requests-to-a10saml'= Total Request to A10 SAML Service;
          'responses-from-a10saml'= Total Response from A10 SAML Service; 'sp-metadata-
          export-req'= Total Metadata Export Request; 'sp-metadata-export-success'= Toal
          Metadata Export Success; 'login-auth-req'= Total Login Authentication Request;
          'login-auth-resp'= Total Login Authentication Response; 'acs-req'= Total SAML
          Single-Sign-On Request; 'acs-success'= Total SAML Single-Sign-On Success; 'acs-
...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'requests-to-a10saml', 'responses-from-a10saml', 'sp-metadata-export-req', 'sp-metadata-export-success', 'login-auth-req', 'login-auth-resp', 'acs-req', 'acs-success', 'acs-authz-fail', 'acs-error', 'slo-req', 'slo-success', 'slo-error', 'sp-slo-req', 'glo-slo-success', 'loc-slo-success', 'par-slo-success', 'relay-req', 'relay-success', 'relay-fail', 'relay-error', 'other-error']}},
        'stats': {'type': 'dict', 'requests_to_a10saml': {'type': 'str', }, 'responses_from_a10saml': {'type': 'str', }, 'sp_metadata_export_req': {'type': 'str', }, 'sp_metadata_export_success': {'type': 'str', }, 'login_auth_req': {'type': 'str', }, 'login_auth_resp': {'type': 'str', }, 'acs_req': {'type': 'str', }, 'acs_success': {'type': 'str', }, 'acs_authz_fail': {'type': 'str', }, 'acs_error': {'type': 'str', }, 'slo_req': {'type': 'str', }, 'slo_success': {'type': 'str', }, 'slo_error': {'type': 'str', }, 'sp_slo_req': {'type': 'str', }, 'glo_slo_success': {'type': 'str', }, 'loc_slo_success': {'type': 'str', }, 'par_slo_success': {'type': 'str', }, 'relay_req': {'type': 'str', }, 'relay_success': {'type': 'str', }, 'relay_fail': {'type': 'str', }, 'relay_error': {'type': 'str', }, 'other_error': {'type': 'str', }}
    })
    return rv
