...
DOCUMENTATION = r'''
module: a10_cgnv6_lsn_endpoint_independent_filtering_tcp
description:
...
def get_argspec():
    ...
    rv.update({'port_list': {'type': 'list', 'port': {'type': 'int', }, 'port_end': {'type': 'int', }}, 'session_limit': {'type': 'int', }, 'uuid': {'type': 'str', }})
    return rv
