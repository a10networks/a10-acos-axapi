...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_port
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/port/{port_num}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/port/"
