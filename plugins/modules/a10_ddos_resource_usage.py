...
DOCUMENTATION = r'''
module: a10_ddos_resource_usage
description:
    - DDoS Resource Usage
author: A10 Networks
options:
    ...
    oper:
        ...
        suboptions:
            ...
            per_resource_limit:
                description:
                - "Field per_resource_limit"
                type: list
            hw_resource_limit:
                description:
                - "Field hw_resource_limit"
                type: list
            enabled:
                description:
                - "Field enabled"
            ...
            system_capacity_remaining:
                description:
                - "Field system_capacity_remaining"
                type: int
            system_capacity_total:
                description:
                - "Field system_capacity_total"
                type: int
            system_capacity_percentage:
                description:
                - "Field system_capacity_percentage"
                type: int
            system_capacity:
                description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/resource-usage"
