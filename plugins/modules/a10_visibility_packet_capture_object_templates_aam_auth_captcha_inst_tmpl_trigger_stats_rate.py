...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_aam_auth_captcha_inst_tmpl_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["attr_fail", "duration", "json_fail", "other_error", "parse_fail", "threshold_exceeded_by", "timeout_error", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'parse_fail': {'type': 'bool', }, 'json_fail': {'type': 'bool', }, 'attr_fail': {'type': 'bool', }, 'timeout_error': {'type': 'bool', }, 'other_error': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-captcha-inst-tmpl/{aam_auth_captcha_inst_tmpl_name}/trigger-stats-rate"
