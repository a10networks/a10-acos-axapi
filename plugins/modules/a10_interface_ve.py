...
def get_argspec():
    ...
    rv.update({'ifnum': {'type': 'int', 'required': True, },
        ...
        'oper': {'type': 'dict', 'state': {'type': 'str', 'choices': ['up', 'disabled', 'down']}, 'line_protocol': {'type': 'str', 'choices': ['up', 'down']}, 'link_type': {'type': 'str', }, 'mac': {'type': 'str', }, 'ipv4_address': {'type': 'str', }, 'ipv4_netmask': {'type': 'str', }, 'ipv6_link_local': {'type': 'str', }, 'ipv6_link_local_prefix': {'type': 'str', }, 'ipv6_link_local_type': {'type': 'str', }, 'ipv6_link_local_scope': {'type': 'str', }, 'ipv4_addr_count': {'type': 'int', }, 'ipv4_list': {'type': 'list', 'addr': {'type': 'str', }, 'mask': {'type': 'str', }}, 'ipv6_addr_count': {'type': 'int', }, 'ipv6_list': {'type': 'list', 'addr': {'type': 'str', }, 'prefix': {'type': 'str', }, 'is_anycast': {'type': 'int', }}, 'igmp_query_sent': {'type': 'int', }, 'icmp_rate_limit_current': {'type': 'int', }, 'icmp_rate_over_limit_drop': {'type': 'int', }, 'icmp6_rate_limit_current': {'type': 'int', }, 'icmp6_rate_over_limit_drop': {'type': 'int', }, 'user_trunk_id': {'type': 'int', }, 'ip_unnumbered_oper': {'type': 'int', }, 'ip_unnumbered_enabled': {'type': 'int', }, 'ip_unnumbered_mac_learned': {'type': 'int', }, 'ip_unnumbered_peer_lla': {'type': 'str', }, 'ifnum': {'type': 'int', 'required': True, }},
        'stats': {'type': 'dict', 'num_pkts': {'type': 'str', }, 'num_total_bytes': {'type': 'str', }, 'num_unicast_pkts': {'type': 'str', }, 'num_broadcast_pkts': {'type': 'str', }, 'num_multicast_pkts': {'type': 'str', }, 'num_tx_pkts': {'type': 'str', }, 'num_total_tx_bytes': {'type': 'str', }, 'num_unicast_tx_pkts': {'type': 'str', }, 'num_broadcast_tx_pkts': {'type': 'str', }, 'num_multicast_tx_pkts': {'type': 'str', }, 'rate_pkt_sent': {'type': 'str', }, 'rate_byte_sent': {'type': 'str', }, 'rate_pkt_rcvd': {'type': 'str', }, 'rate_byte_rcvd': {'type': 'str', }, 'load_interval': {'type': 'str', }, 'ifnum': {'type': 'int', 'required': True, }}
    })
    return rv
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["ve"].items():
        ...
        if config_changes["ve"].get(k) != v:
            change_results["changed"] = True
            config_changes["ve"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("ve", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ve"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["ve-list"] if info != "NotFound" else info
            elif module.params.get("get_type") == "oper":
                get_oper_result = api_client.get_oper(module.client, existing_url(module),
                                                      params=module.params)
                result["axapi_calls"].append(get_oper_result)
                info = get_oper_result["response_body"]
                result["acos_info"] = info["ve"]["oper"] if info != "NotFound" else info
            elif module.params.get("get_type") == "stats":
                get_type_result = api_client.get_stats(module.client, existing_url(module),
                                                       params=module.params)
                result["axapi_calls"].append(get_type_result)
                info = get_type_result["response_body"]
                result["acos_info"] = info["ve"]["stats"] if info != "NotFound" else info
