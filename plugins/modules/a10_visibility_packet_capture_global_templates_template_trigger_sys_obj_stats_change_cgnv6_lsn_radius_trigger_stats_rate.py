...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_lsn_radius_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "ha_standby_dropped", "invalid_key", "radius_request_dropped", "radius_table_full", "request_bad_secret_dropped", "request_ignored", "request_malformed_dropped", "request_no_key_vap_dropped", "secret_not_configured_dropped", "threshold_exceeded_by", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-lsn-radius/trigger-stats-rate"
