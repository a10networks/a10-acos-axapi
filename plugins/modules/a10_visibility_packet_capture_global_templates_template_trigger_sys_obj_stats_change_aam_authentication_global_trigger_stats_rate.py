...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_aam_authentication_global_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["aflex_authz_fail", "authn_failure", "authz_failure", "connect_failed", "create_timer_failed", "dns_resolve_failed", "duration", "get_socket_option_failed", "misses", "open_socket_failed", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'misses': {'type': 'bool', },
        'open_socket_failed': {'type': 'bool', },
        'connect_failed': {'type': 'bool', },
        'create_timer_failed': {'type': 'bool', },
        'get_socket_option_failed': {'type': 'bool', },
        'aflex_authz_fail': {'type': 'bool', },
        'authn_failure': {'type': 'bool', },
        'authz_failure': {'type': 'bool', },
        'dns_resolve_failed': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/aam-authentication-global/trigger-stats-rate"
