...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(user_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/rba/user/{user_name}/partition/{partition_name}"
    ...
    if '/' in module.params["user_name"]:
        f_dict["user_name"] = module.params["user_name"].replace("/", "%2F")
    else:
...
def new_url(module):
    ...
    url_base = "/axapi/v3/rba/user/{user_name}/partition"
