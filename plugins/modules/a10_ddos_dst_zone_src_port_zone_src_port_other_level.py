...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_src_port_zone_src_port_other_level
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port-other/{zone_src_port_other_port_other}+{protocol}/level/{level_num}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/src-port/zone-src-port-other/{zone_src_port_other_port_other}+{protocol}/level"
