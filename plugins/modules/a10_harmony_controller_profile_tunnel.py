...
DOCUMENTATION = r'''
module: a10_harmony_controller_profile_tunnel
description:
    - tunnel status
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/harmony-controller/profile/tunnel"
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "tunnel"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "tunnel-list"] if info != "NotFound" else info
