...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(
            module.client, "csr", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result[
                    "acos_info"] = info["csr"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "csr-list"] if info != "NotFound" else info
