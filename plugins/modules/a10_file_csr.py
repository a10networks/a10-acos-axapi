...
def create(module, result, payload={}):
    ...
    result["modified_values"].update(**call_result["request_body"]["csr"])
    result["changed"] = True
    return result
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(module.client, "csr", file_url, module.params['file'])
