...
def present(module, result, existing_config):
    payload = utils.build_json("system-radius-server", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "system-radius-server"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "system-radius-server-list"] if info != "NotFound" else info
