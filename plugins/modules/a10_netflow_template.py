        ...
        'information_element_blk': {
            ...
            'information_element': {
                ...
                'choices': [
                    ...
                    'source-ipv4-address', 'source-ipv4-prefix-len',
                    'dest-ipv4-address', 'dest-ipv4-prefix-len',
                    'source-ipv6-address', 'source-ipv6-prefix-len',
                    'dest-ipv6-address', 'dest-ipv6-prefix-len',
                    ...
                    'fw-dest-zone', 'application-id', 'application-name',
                    'imsi', 'msisdn', 'imei', 'radius-custom1',
                    'radius-custom2', 'radius-custom3', 'radius-custom4',
                    'radius-custom5', 'radius-custom6', 'flow-start-msec',
                    'flow-duration-msec', 'flow-duration-msec-64',
                    'flow-end-msec', 'nat-event', 'fw-event',
                    'fw-deny-reset-event', 'cgn-flow-direction',
                    'fw-dest-fqdn', 'flow-end-reason', 'gtp-deny-reason',
                    'gtp-apn', 'gtp-steid', 'gtp-dteid', 'gtp-selection-mode',
                    'gtp-mcc', 'gtp-mnc', 'gtp-rat-type', 'gtp-pdn-pdp-type',
                    'gtp-uli', 'gtp-enduser-v4-addr', 'gtp-enduser-v6-addr',
                    'gtp-bearer-id-or-nsapi', 'gtp-qci', 'gtp-info-event-ind',
                    'gtp-restarted-node-ipv4', 'gtp-restarted-node-ipv6',
                    'gtp-c-tunnels-removed-with-node-restart', 'radius-imsi',
                    'radius-msisdn', 'radius-imei', 'event-time-msec',
                    'security-event-type', 'limit-exceeded-count',
                    'rate-limit-key', 'rate-limit-type',
