...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_crl_srcip_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["out_of_sessions", "threshold_exceed", "too_many_sessions", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'out_of_sessions': {'type': 'bool', }, 'too_many_sessions': {'type': 'bool', }, 'threshold_exceed': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-crl-srcip/trigger-stats-inc"
