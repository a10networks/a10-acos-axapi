...
DOCUMENTATION = r'''
module: a10_ddos_detection_agent
description:
...
options:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          Length; 'netflow-v9-sample-flowset-bad-padding'= Netflow v9 Sample Flowset Bad
          Padding; 'netflow-v9-max-records-exceed'= Netflow v9 Sample Max Records Error;
          'netflow-v9-template-not-found'= Netflow v9 Template Not Found;
          ...
          Fail, Local MEM size error; 'netflow-record-rse-invalid'= Netflow Data Record
    ...
    sflow:
        ...
        suboptions:
            sflow_pkt_samples_collection:
                description:
                - "'enable'= Enable sflow packet samples collection(default); 'disable'= Disable
          sflow packet samples collection;"
                type: str
            uuid:
                description:
                - "uuid of the object"
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/detection/agent/{agent_name}"

    f_dict = {}
    if '/' in str(module.params["agent_name"]):
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/detection/agent"
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["agent"].items():
        ...
        if config_changes["agent"].get(k) != v:
            change_results["changed"] = True
            config_changes["agent"][k] = v
...
def present(module, result, existing_config):
    payload = utils.build_json("agent", module.params, AVAILABLE_PROPERTIES)
