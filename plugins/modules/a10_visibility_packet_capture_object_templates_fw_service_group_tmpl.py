...
def present(module, result, existing_config):
    payload = utils.build_json("fw-service-group-tmpl", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "fw-service-group-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "fw-service-group-tmpl-list"] if info != "NotFound" else info
