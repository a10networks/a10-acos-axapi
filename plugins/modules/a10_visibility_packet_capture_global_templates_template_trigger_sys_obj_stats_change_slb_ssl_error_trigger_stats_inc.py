...
AVAILABLE_PROPERTIES = [
    ...
    "digest_check_failed", "encrypted_length_too_long", "error_generating_tmp_rsa_key", "error_in_received_cipher_list", "excessive_message_size", "extra_data_in_message", "got_a_fin_before_a_ccs", "http_request", "https_proxy_request", "illegal_padding", "inappropriate_fallback", "invalid_challenge_length", "invalid_command", "invalid_purpose",
    "invalid_status_response", "invalid_trust", "key_arg_too_long", "krb5", "krb5_client_cc_principal", "krb5_client_get_cred", "krb5_client_init", "krb5_client_mk_req", "krb5_server_bad_ticket", "krb5_server_init", "krb5_server_rd_req", "krb5_server_tkt_expired", "krb5_server_tkt_not_yet_valid", "krb5_server_tkt_skew", "length_mismatch",
    "length_too_short", "library_bug", "library_has_no_ciphers", "mast_key_too_long", "message_too_long", "missing_dh_dsa_cert", "missing_dh_key", "missing_dh_rsa_cert", "missing_dsa_signing_cert", "missing_export_tmp_dh_key", "missing_export_tmp_rsa_key", "missing_rsa_certificate", "missing_rsa_encrypting_cert", "missing_rsa_signing_cert",
    "missing_tmp_dh_key", "missing_tmp_rsa_key", "missing_tmp_rsa_pkey", "missing_verify_message", "multiple_sgc_restarts", "no_certificate_assigned", "no_certificate_returned", "no_certificate_set", "no_certificate_specified", "no_certificates_returned", "no_cipher_list", "no_cipher_match", "no_ciphers_available", "no_ciphers_passed",
    "no_ciphers_specified", "no_client_cert_received", "no_compression_specified", "no_method_specified", "no_private_key_assigned", "no_privatekey", "no_protocols_available", "no_publickey", "no_required_digest", "no_shared_cipher", "no_verify_callback", "non_sslv2_initial_packet", "null_ssl_ctx", "null_ssl_method_passed",
    ...
    "sslv3_alert_unexpected_msg", "sslv3_alert_unknown_remote_err_type", "sslv3_alert_unspported_cert", "tls_client_cert_req_with_anon_cipher", "tls_invalid_ecpointformat_list", "tls_peer_did_not_respond_with_cert_list", "tls_rsa_encrypted_value_length_is_wrong", "tlsv1_alert_access_denied", "tlsv1_alert_decode_error", "tlsv1_alert_decrypt_error",
    "tlsv1_alert_decryption_failed", "tlsv1_alert_export_restriction", "tlsv1_alert_insufficient_security", "tlsv1_alert_internal_error", "tlsv1_alert_no_renegotiation", "tlsv1_alert_protocol_version", "tlsv1_alert_record_overflow", "tlsv1_alert_unknown_ca", "tlsv1_alert_user_cancelled", "tried_to_use_unsupported_cipher",
    "unable_to_decode_dh_certs", "unable_to_extract_public_key", "unable_to_find_dh_parameters", "unable_to_find_public_key_parameters", "unable_to_find_ssl_method", "unable_to_load_ssl2_md5_routines", "unable_to_load_ssl3_md5_routines", "unable_to_load_ssl3_sha1_routines", "unexpected_message", "unexpected_record", "uninitialized",
    "unknown_alert_type", "unknown_certificate_type", "unknown_cipher_returned", "unknown_cipher_type", "unknown_key_exchange_type", "unknown_pkey_type", "unknown_protocol", "unknown_remote_error_type", "unknown_ssl_version", "unknown_state", "unsupported_cipher", "unsupported_compression_algorithm", "unsupported_digest_type",
    "unsupported_elliptic_curve", "unsupported_option", "unsupported_protocol", "unsupported_ssl_version", "unsupported_status_type", "uuid", "write_bio_not_set", "wrong_cipher_returned", "wrong_counter_of_key_bits", "wrong_message_type", "wrong_signature_length", "wrong_signature_size", "wrong_ssl_version", "wrong_version_counter", "x509_lib",
    "x509_verification_setup_problems",
    ]
