...
AVAILABLE_PROPERTIES = [
    "cookie_invalid", "cookie_not_found", "cookie_persist_fail", "cssl_sid_not_found", "cssl_sid_not_match", "dst_ip_fail", "dst_ip_hash_fail", "dst_ip_new_sess_cache_fail", "dst_ip_new_sess_sel_fail", "hash_tbl_create_fail", "hash_tbl_rst_adddel", "hash_tbl_rst_updown", "hash_tbl_trylock_fail", "header_hash_fail", "src_ip_fail",
    "src_ip_hash_fail", "src_ip_new_sess_cache_fail", "src_ip_new_sess_sel_fail", "ssl_sid_persist_fail", "ssl_sid_session_fail", "sssl_sid_not_found", "sssl_sid_not_match", "url_hash_fail", "uuid",
    ]
