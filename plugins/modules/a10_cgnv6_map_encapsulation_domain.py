...
AVAILABLE_PROPERTIES = ["basic_mapping_rule", "description", "format", "health_check_gateway", "name", "packet_capture_template", "sampling_enable", "stats", "tunnel_endpoint_address", "user_tag", "uuid", ]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/map/encapsulation/domain"
