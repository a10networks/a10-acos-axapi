...
AVAILABLE_PROPERTIES = [
    "age", "apply_policy_on_overflow", "default_action_list", "deny", "dynamic_entry_count_warn_threshold", "dynamic_entry_overflow_policy_list", "enable_class_list_overflow", "enable_top_k", "enable_top_k_destination", "faster_de_escalation", "glid_cfg", "ip_filtering_policy", "ip_filtering_policy_statistics", "level_list", "manual_mode_enable",
    "manual_mode_list", "max_dynamic_entry_count", "oper", "outbound_only", "pattern_recognition", "pattern_recognition_pu_details", "port_ind", "port_other", "progression_tracking", "protocol", "same_source_dest_port_drop", "set_counter_base_val", "sflow_common", "sflow_ip_filtering_policy", "sflow_packets", "sflow_tcp", "src_based_policy_list",
    "stateful", "topk_destinations", "topk_dst_num_records", "topk_dst_sort_key", "topk_num_records", "topk_sort_key", "topk_sources", "unlimited_dynamic_entry_count", "uuid",
    ]
