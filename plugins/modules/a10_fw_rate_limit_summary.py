...
options:
    ...
    oper:
        ...
        suboptions:
            ...
            alloc_failures:
                description:
                - "Field alloc_failures"
                type: int
            total_num_entries:
                description:
                - "Field total_num_entries"
                type: int
            total_num_entries_allocated:
                description:
                - "Field total_num_entries_allocated"
                type: int
            total_num_entries_freed:
                description:
                - "Field total_num_entries_freed"
                type: int
            total_entries_scope_aggregate:
                description:
                - "Field total_entries_scope_aggregate"
                type: int
            total_entries_scope_subscriber_ip:
                description:
                - "Field total_entries_scope_subscriber_ip"
                type: int
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/fw/rate-limit/summary"
