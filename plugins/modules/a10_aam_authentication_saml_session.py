...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'oper': {'type': 'dict', 'sp_list': {'type': 'list', 'sp_id': {'type': 'str', }, 'session_count': {'type': 'int', }, 'session_list': {'type': 'list', 'nameid': {'type': 'str', }, 'client_addr': {'type': 'str', }, 'id_provider': {'type': 'str', }, 'auth_instant': {'type': 'str', }, 'expire_time': {'type': 'str', }}}, 'name': {'type': 'str', }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/aam/authentication/saml/session"
