...
AVAILABLE_PROPERTIES = [
    ...
    "manual_mode_enable", "manual_mode_list", "max_dynamic_entry_count", "oper", "port_ind", "progression_tracking", "protocol", "set_counter_base_val", "src_based_policy_list", "topk_destinations", "topk_dst_num_records", "topk_dst_sort_key", "topk_num_records", "topk_sort_key", "topk_sources", "tunnel_decap", "tunnel_rate_limit",
