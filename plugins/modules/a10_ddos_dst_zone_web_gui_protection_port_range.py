...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_web_gui_protection_port_range
description:
...
options:
    ...
    protocol:
        ...
        - "'dns-tcp'= DNS-TCP Port; 'dns-udp'= DNS-UDP Port; 'http'= HTTP Port; 'tcp'= TCP
          Port; 'udp'= UDP Port; 'ssl-l4'= SSL-L4 Port;"
        type: str
        required: True
    pbe:
        description:
...
AVAILABLE_PROPERTIES = ["pbe", "port_range_end", "port_range_start", "protocol", "user_tag", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'port_range_start': {'type': 'int', 'required': True, }, 'port_range_end': {'type': 'int', 'required': True, }, 'protocol': {'type': 'str', 'required': True, 'choices': ['dns-tcp', 'dns-udp', 'http', 'tcp', 'udp', 'ssl-l4']}, 'pbe': {'type': 'str', }, 'uuid': {'type': 'str', }, 'user_tag': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/port-range/{port_range_start}+{port_range_end}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/port-range/+"
