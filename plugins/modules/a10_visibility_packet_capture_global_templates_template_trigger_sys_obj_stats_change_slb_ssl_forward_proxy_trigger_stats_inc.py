...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_ssl_forward_proxy_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["connections_failed", "failed_in_certificate_signing", "failed_in_certificate_verification", "failed_in_crypto_operations", "failed_in_ssl_handshakes", "failed_in_tcp", "invalid_ocsp_stapling_response", "revoked_ocsp_response", "unsupported_ssl_version", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'failed_in_ssl_handshakes': {'type': 'bool', },
        'failed_in_crypto_operations': {'type': 'bool', },
        'failed_in_tcp': {'type': 'bool', },
        'failed_in_certificate_verification': {'type': 'bool', },
        'failed_in_certificate_signing': {'type': 'bool', },
        'invalid_ocsp_stapling_response': {'type': 'bool', },
        'revoked_ocsp_response': {'type': 'bool', },
        'unsupported_ssl_version': {'type': 'bool', },
        'connections_failed': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-ssl-forward-proxy/trigger-stats-inc"
