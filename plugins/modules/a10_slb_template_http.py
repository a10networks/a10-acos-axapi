...
def get_argspec():
    ...
    rv.update({'name': {'type': 'str', 'required': True, },
        ...
        'default_charset': {'type': 'str', 'choices': ['iso-8859-1', 'utf-8', 'us-ascii']},
        ...
        'uuid': {'type': 'str', },
        'user_tag': {'type': 'str', },
        'http_protocol_check': {'type': 'dict', 'h2up_content_length_alias': {'type': 'str', 'choices': ['drop']}, 'malformed_h2up_header_value': {'type': 'str', 'choices': ['drop']}, 'malformed_h2up_scheme_value': {'type': 'str', 'choices': ['drop']}, 'h2up_with_transfer_encoding': {'type': 'str', 'choices': ['drop']}, 'multiple_content_length': {'type': 'str', 'choices': ['drop']}, 'multiple_transfer_encoding': {'type': 'str', 'choices': ['drop']}, 'transfer_encoding_and_content_length': {'type': 'str', 'choices': ['drop']}, 'get_and_payload': {'type': 'str', 'choices': ['drop']}, 'h2up_with_host_and_auth': {'type': 'str', 'choices': ['drop']}, 'uuid': {'type': 'str', }}
    })
    return rv
