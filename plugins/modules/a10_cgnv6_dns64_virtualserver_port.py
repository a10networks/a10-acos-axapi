...
AVAILABLE_PROPERTIES = ["acl_id_list", "acl_name_list", "action", "auto", "oper", "packet_capture_template", "pool", "port_number", "precedence", "protocol", "sampling_enable", "service_group", "stats", "template_dns", "template_policy", "user_tag", "uuid", ]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/dns64-virtualserver/{dns64_virtualserver_name}/port/"
