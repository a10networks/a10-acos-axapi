...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_fw_logging_gtp_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "log_type_gtp_out_of_order_ie", "log_type_gtp_out_of_state_ie", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'log_type_gtp_out_of_order_ie': {'type': 'bool', },
        'log_type_gtp_out_of_state_ie': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/fw-logging-gtp/trigger-stats-rate"
