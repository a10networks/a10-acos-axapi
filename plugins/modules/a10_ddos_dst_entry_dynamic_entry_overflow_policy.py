...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_dynamic_entry_overflow_policy
description:
    - Configure src dst dynamic entry count overflow policy
author: A10 Networks
options:
    state:
        description:
...
AVAILABLE_PROPERTIES = ["app_type_src_dst_list", "bypass", "dummy_name", "exceed_log_cfg", "glid", "l4_type_src_dst_list", "log_periodic", "template", "user_tag", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/dynamic-entry-overflow-policy/{dummy_name}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/dynamic-entry-overflow-policy"
