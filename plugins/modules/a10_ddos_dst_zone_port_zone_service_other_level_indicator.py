...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_port_zone_service_other_level_indicator
description:
...
def get_argspec():
    ...
    # Parent keys
    rv.update(dict(level_num=dict(type='str', required=True), protocol=dict(type='str', required=True), zone_service_other_port_other=dict(type='str', required=True), zone_name=dict(type='str', required=True), ))
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/level/{level_num}/indicator/{type}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/port/zone-service-other/{zone_service_other_port_other}+{protocol}/level/{level_num}/indicator"
