...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_slb_vport_tmpl_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["compression_miss_no_client", "compression_miss_template_exclusion", "dnsrrl_bad_fqdn", "dnsrrl_total_dropped", "es_total_failure_actions", "loc_deny", "total_mf_dns_pkts", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'total_mf_dns_pkts': {'type': 'bool', },
        'es_total_failure_actions': {'type': 'bool', },
        'compression_miss_no_client': {'type': 'bool', },
        'compression_miss_template_exclusion': {'type': 'bool', },
        'loc_deny': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/slb-vport-tmpl/{slb_vport_tmpl_name}/trigger-stats-inc"
