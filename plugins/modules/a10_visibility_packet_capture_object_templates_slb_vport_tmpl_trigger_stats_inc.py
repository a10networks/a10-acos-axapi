...
AVAILABLE_PROPERTIES = ["compression_miss_no_client", "compression_miss_template_exclusion", "dnsrrl_bad_fqdn", "dnsrrl_nx_exceed", "dnsrrl_total_dropped", "es_total_failure_actions", "loc_deny", "total_mf_dns_pkts", "uuid", ]
