...
def create(module, result, payload={}):
    ...
    result["modified_values"].update(**call_result["request_body"]["ssl-cert-key"])
    result["changed"] = True
    return result
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(module.client, "ssl-cert-key", file_url, module.params['file'])
