...
DOCUMENTATION = r'''
module: a10_cgnv6_nat_exclude_port_tcp
description:
...
def get_argspec():
    ...
    rv.update({'port_list': {'type': 'list', 'port': {'type': 'int', }, 'port_end': {'type': 'int', }}, 'uuid': {'type': 'str', }})
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cgnv6/nat/exclude-port/tcp"
