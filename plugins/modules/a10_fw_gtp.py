...
options:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          unlinked from HT while creating U-conn; 'gtp-u-stateless-forward'= GTP-U
          Stateless Forward; 'gtp-u-smp-not-found-conn-creation'= GTP-U smp not found
          during conn creation; 'gtp-u-match-c-smp-with-del-flag'= GTP-U match C-smp with
          deletion flag; 'gtp-u-match-c-smp-with-ho-flag'= GTP-U match C-smp with HO
          flag; 'gtp-u-match-dbr-u-smp-conn-create'= GTP-U match U-smp with dbr during
          conn creation; 'gtp-c-info-extract-failed'= unable to extract GTP-C extension
          during pkt processing; 'gtp-c-smp-extract-failed'= unable to extract GTP-C smp
          during pkt processing; 'gtp-u-info-extract-failed'= unable to extract GTP-U
          extension during pkt processing; 'gtp-u-match-c-smp-in-rml'= GTP-U match C-smp
          in rml; 'gtp-echo-stateless-forward'= GTP-echo Stateless Forward; 'gtp-u-smp-
          not-found-c-processing'= unable to extract GTP-U smp not found in C-processing;
          'gtp-u-pkt-u-smp-validation-failed'= gtp-u smp ip validation failed; 'gtp-u-
          frag-pkt-processed'= GTP-U Fragmented packet processed; 'gtp-c-frag-pkt-
          received'= GTP-C Fragmented packet received; 'gtp-u-frag-pkt-received'= GTP-U
          Fragmented packet received; 'gtp-u-attempt-for-double-free'= GTP-U smp double
          free attempted; 'gtp-c-attempt-for-double-free'= GTP-C smp double free
          attempted; 'gtp-c-smp-access-after-reuse'= GTP-C smp access after reuse; 'gtp-
          u-smp-access-after-reuse'= GTP-U smp access after reuse; 'gtp-c-smp-cleared-by-
          standalone'= GTP-C smp cleared by standalone conn; 'gtp-c-smp-cleared-
          by-l3-with-l5'= GTP-C smp cleared by l3-conn with l5; 'gtp-v0-c-uplink-ingress-
          packets'= GTPv0-C Uplink Ingress Packets; 'gtp-v0-c-uplink-egress-packets'=
          GTPv0-C Uplink Egress Packets; 'gtp-v0-c-downlink-ingress-packets'= GTPv0-C
          Downlink Ingress Packets; 'gtp-v0-c-downlink-egress-packets'= GTPv0-C Downlink
          Egress Packets; 'gtp-v0-c-uplink-ingress-bytes'= GTPv0-C Uplink Ingress Bytes;
          ...
          mismatch'= GTP-Path Message Length Mismatch Across Layers;"
                type: str
            counters3:
                description:
                - "'drop-gtp-missing-cond-ie-bearer-ctx'= Missing conditional IE in bearer context
          Drop; 'drop-gtp-bearer-not-found-in-resp'= GTP Bearer not found in response;
          'gtp-stateless-forward'= GTP Stateless Forward; 'gtp-l3-conn-deleted'= GTP L3
          conn deleted; 'gtp-l5-conn-created'= GTP L5 conn created; 'gtp-monitor-
          forward'= GTP messages forwarded via monitor mode; 'gtp-u_inner-ip-not-
          present'= GTP-U inner IP not present; 'gtp-ext_hdr-incorrect-length'= GTP
        ...
        'sampling_enable': {
            ...
            'counters2': {
                ...
                'choices': [
                    ...
                    'gtp-u-smp-unlinked-u-conn-creation', 'gtp-u-stateless-forward', 'gtp-u-smp-not-found-conn-creation', 'gtp-u-match-c-smp-with-del-flag', 'gtp-u-match-c-smp-with-ho-flag', 'gtp-u-match-dbr-u-smp-conn-create', 'gtp-c-info-extract-failed', 'gtp-c-smp-extract-failed', 'gtp-u-info-extract-failed', 'gtp-u-match-c-smp-in-rml',
                    'gtp-echo-stateless-forward', 'gtp-u-smp-not-found-c-processing', 'gtp-u-pkt-u-smp-validation-failed', 'gtp-u-frag-pkt-processed', 'gtp-c-frag-pkt-received', 'gtp-u-frag-pkt-received', 'gtp-u-attempt-for-double-free', 'gtp-c-attempt-for-double-free', 'gtp-c-smp-access-after-reuse', 'gtp-u-smp-access-after-reuse',
                    'gtp-c-smp-cleared-by-standalone', 'gtp-c-smp-cleared-by-l3-with-l5', 'gtp-v0-c-uplink-ingress-packets', 'gtp-v0-c-uplink-egress-packets', 'gtp-v0-c-downlink-ingress-packets', 'gtp-v0-c-downlink-egress-packets', 'gtp-v0-c-uplink-ingress-bytes', 'gtp-v0-c-uplink-egress-bytes', 'gtp-v0-c-downlink-ingress-bytes',
                    'gtp-v0-c-downlink-egress-bytes', 'gtp-v1-c-uplink-ingress-packets', 'gtp-v1-c-uplink-egress-packets', 'gtp-v1-c-downlink-ingress-packets', 'gtp-v1-c-downlink-egress-packets', 'gtp-v1-c-uplink-ingress-bytes', 'gtp-v1-c-uplink-egress-bytes', 'gtp-v1-c-downlink-ingress-bytes', 'gtp-v1-c-downlink-egress-bytes',
                    'gtp-v2-c-uplink-ingress-packets', 'gtp-v2-c-uplink-egress-packets', 'gtp-v2-c-downlink-ingress-packets', 'gtp-v2-c-downlink-egress-packets', 'gtp-v2-c-uplink-ingress-bytes', 'gtp-v2-c-uplink-egress-bytes', 'gtp-v2-c-downlink-ingress-bytes', 'gtp-v2-c-downlink-egress-bytes', 'gtp-u-uplink-ingress-packets',
                    'gtp-u-uplink-egress-packets', 'gtp-u-downlink-ingress-packets', 'gtp-u-downlink-egress-packets', 'gtp-u-uplink-ingress-bytes', 'gtp-u-uplink-egress-bytes', 'gtp-u-downlink-ingress-bytes', 'gtp-u-downlink-egress-bytes', 'gtp-v0-c-create-synced', 'gtp-v1-c-create-synced', 'gtp-v2-c-create-synced', 'gtp-v0-c-delete-synced',
            ...
            'counters3': {
                'type': 'str',
                'choices': ['drop-gtp-missing-cond-ie-bearer-ctx', 'drop-gtp-bearer-not-found-in-resp', 'gtp-stateless-forward', 'gtp-l3-conn-deleted', 'gtp-l5-conn-created', 'gtp-monitor-forward', 'gtp-u_inner-ip-not-present', 'gtp-ext_hdr-incorrect-length']
                }
            },
        'apn_prefix': {
            'type': 'dict',
