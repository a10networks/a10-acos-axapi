...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_icmp_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "icmp_to_icmp_err", "icmp_to_icmpv6_err", "icmpv6_to_icmp_err", "icmpv6_to_icmpv6_err", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'icmp_to_icmp_err': {'type': 'bool', }, 'icmp_to_icmpv6_err': {'type': 'bool', }, 'icmpv6_to_icmp_err': {'type': 'bool', }, 'icmpv6_to_icmpv6_err': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-icmp/trigger-stats-rate"
