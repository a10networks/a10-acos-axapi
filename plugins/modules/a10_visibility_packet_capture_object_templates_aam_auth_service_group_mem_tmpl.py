...
def present(module, result, existing_config):
    payload = utils.build_json("aam-auth-service-group-mem-tmpl",
                               module.params, AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "aam-auth-service-group-mem-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "aam-auth-service-group-mem-tmpl-list"] if info != "NotFound" else info
