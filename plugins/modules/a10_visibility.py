        ...
        'topn': {
            ...
            'sampling_enable': {
                ...
                'counters1': {
                    ...
                    'str',
                    'choices': [
                        'all', 'heap-alloc-success', 'heap-alloc-failed',
                        'heap-alloc-oom', 'obj-reg-success', 'obj-reg-failed',
                        'obj-reg-oom', 'heap-deleted', 'obj-deleted',
                        'heap-metric-alloc-success', 'heap-metric-alloc-oom',
                        'heap-move-to-delq', 'heap-metric-deleted',
                        'obj-metric-reg-success', 'obj-metric-reg-oom',
                        'obj-move-to-delq', 'obj-metric-deleted',
                        'hc-obj-alloc-failed'
                    ]
                }
            },
...
def present(module, result, existing_config):
    payload = utils.build_json("visibility", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "visibility"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "visibility-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["visibility"][
