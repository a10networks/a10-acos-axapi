...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_web_gui_protection_port_zone_service_other
description:
...
AVAILABLE_PROPERTIES = ["pbe", "port_other", "protocol", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'port_other': {'type': 'str', 'required': True, 'choices': ['other']}, 'protocol': {'type': 'str', 'required': True, 'choices': ['tcp', 'udp']}, 'pbe': {'type': 'str', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/port/zone-service-other/{port_other}+{protocol}"
...
def new_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/web-gui/protection/port/zone-service-other/"
