...
AVAILABLE_PROPERTIES = ["ddos_entries_too_many", "ddos_entry_add_to_bgp_failure", "ddos_entry_remove_from_bgp_failure", "ddos_packet_dropped", "duration", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'ddos_entries_too_many': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/fw-ddos-protection/trigger-stats-rate"
