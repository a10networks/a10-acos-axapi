...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_fw_alg_rtsp_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "threshold_exceeded_by", "transport_alloc_failure", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', }, 'duration': {'type': 'int', }, 'transport_alloc_failure': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/fw-alg-rtsp/trigger-stats-rate"
