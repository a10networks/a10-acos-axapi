...
def get_argspec():
    ...
    rv.update({'failure': {'type': 'bool', }, 'buffer_alloc_fail': {'type': 'bool', }, 'encoding_fail': {'type': 'bool', }, 'insert_header_fail': {'type': 'bool', }, 'parse_header_fail': {'type': 'bool', }, 'internal_error': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
