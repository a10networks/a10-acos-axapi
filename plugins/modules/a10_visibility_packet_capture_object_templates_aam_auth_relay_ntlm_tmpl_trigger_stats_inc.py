...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_object_templates_aam_auth_relay_ntlm_tmpl_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["buffer_alloc_fail", "encoding_fail", "failure", "insert_header_fail", "internal_error", "parse_header_fail", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'failure': {'type': 'bool', },
        'buffer_alloc_fail': {'type': 'bool', },
        'encoding_fail': {'type': 'bool', },
        'insert_header_fail': {'type': 'bool', },
        'parse_header_fail': {'type': 'bool', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/object-templates/aam-auth-relay-ntlm-tmpl/{aam_auth_relay_ntlm_tmpl_name}/trigger-stats-inc"
