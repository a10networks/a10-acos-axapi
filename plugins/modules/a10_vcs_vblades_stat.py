...
def existing_url(module):
    ...
    url_base = "/axapi/v3/vcs-vblades/stat/{vblade_id}"

    f_dict = {}
    if '/' in str(module.params["vblade_id"]):
        f_dict["vblade_id"] = module.params["vblade_id"].replace("/", "%2F")
    else:
        f_dict["vblade_id"] = module.params["vblade_id"]
...
def new_url(module):
    ...
    url_base = "/axapi/v3/vcs-vblades/stat"
