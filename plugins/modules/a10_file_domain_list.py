...
DOCUMENTATION = r'''
module: a10_file_domain_list
description:
    - domain list file information and management commands
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/file/domain-list"
...
def run_command(module):
    ...
    try:
        ...
        if state == 'present' or state == 'absent':
            ...
            existing_config, file_exists = api_client.get_file(module.client, "domain-list", file_url, module.params['file'])
