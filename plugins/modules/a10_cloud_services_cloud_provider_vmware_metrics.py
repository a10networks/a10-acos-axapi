...
DOCUMENTATION = r'''
module: a10_cloud_services_cloud_provider_vmware_metrics
description:
    - VMware metrics configuration
author: A10 Networks
options:
    state:
        description:
    ...
    action:
        description:
        - "'enable'= Enable VMware vRealize Operations Manager; 'disable'= Disable VMware
          vRealize Operations Manager (default);"
        type: str
        required: False
    vrops_host:
        description:
...
AVAILABLE_PROPERTIES = ["action", "active_partitions", "cps", "cpu", "disk", "interfaces", "memory", "packet_drop", "packet_rate", "resource_id", "server_down_count", "server_down_percentage", "server_error", "sessions", "ssl_cert", "throughput", "tps", "uuid", "vrops_host", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/cloud-services/cloud-provider/vmware/metrics"
