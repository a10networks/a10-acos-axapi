...
def get_argspec():
    ...
    rv.update({'port_scan_detection': {'type': 'str', 'choices': ['enable', 'disable']},
        ...
        'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'tcp-total-ports-allocated', 'udp-total-ports-allocated', 'icmp-total-ports-allocated']}},
        'stats': {'type': 'dict', 'tcp_total_ports_allocated': {'type': 'str', }, 'udp_total_ports_allocated': {'type': 'str', }, 'icmp_total_ports_allocated': {'type': 'str', }}
    })
    return rv
