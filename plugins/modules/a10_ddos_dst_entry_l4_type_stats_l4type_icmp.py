...
DOCUMENTATION = r'''
module: a10_ddos_dst_entry_l4_type_stats_l4type_icmp
description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/entry/{entry_dst_entry_name}/l4-type/{l4_type_protocol}/stats?l4type-icmp=true"
