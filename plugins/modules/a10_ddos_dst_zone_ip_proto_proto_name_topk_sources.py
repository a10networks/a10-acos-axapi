...
DOCUMENTATION = r'''
module: a10_ddos_dst_zone_ip_proto_proto_name_topk_sources
description:
    - DDos dst zone-service indicators top sources
author: A10 Networks
options:
    state:
        description:
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/dst/zone/{zone_name}/ip-proto/proto-name/{proto_name_protocol}/topk-sources"
