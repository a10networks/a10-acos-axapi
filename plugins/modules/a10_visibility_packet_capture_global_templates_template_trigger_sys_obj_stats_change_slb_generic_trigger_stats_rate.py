...
AVAILABLE_PROPERTIES = ["client_fail", "client_select_fail", "dcmsg_error", "duration", "invalid_avp", "mismatch_fwd_id", "mismatch_rev_id", "no_fwd_tuple", "no_rev_tuple", "no_route", "no_session_id", "reply_error_info_fail", "reply_unknown_session_id", "retry_client_request_fail", "server_fail", "snat_fail", "svrsel_fail", "threshold_exceeded_by", "unkwn_cmd_code", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        ...
        'no_route': {'type': 'bool', },
        'snat_fail': {'type': 'bool', },
        'client_fail': {'type': 'bool', },
        'server_fail': {'type': 'bool', },
        'mismatch_fwd_id': {'type': 'bool', },
        'mismatch_rev_id': {'type': 'bool', },
        'unkwn_cmd_code': {'type': 'bool', },
        'no_session_id': {'type': 'bool', },
        'no_fwd_tuple': {'type': 'bool', },
        'no_rev_tuple': {'type': 'bool', },
        'dcmsg_error': {'type': 'bool', },
        'retry_client_request_fail': {'type': 'bool', },
        'reply_unknown_session_id': {'type': 'bool', },
        'client_select_fail': {'type': 'bool', },
        'invalid_avp': {'type': 'bool', },
        'reply_error_info_fail': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-generic/trigger-stats-rate"
