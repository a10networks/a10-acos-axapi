...
AVAILABLE_PROPERTIES = [
    "address_mismatch", "cannot_provide_suggest", "excessive_remote_peers", "internal_error_drop", "l4_process_error", "malform_option", "malform_request", "no_resources", "noroute_drop", "not_authorized", "pkt_not_from_nat_inside", "pkt_not_request_drop", "pkt_too_short_drop", "unsol_ance_sent_fail", "unsupp_opcode", "unsupp_option",
    "unsupp_protocol", "unsupported_version", "uuid",
    ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-pcp/trigger-stats-inc"
