...
DOCUMENTATION = r'''
module: a10_ddos_zone_template_dns_malformed_query_check
description:
...
AVAILABLE_PROPERTIES = ["dns_malformed_query_action", "dns_malformed_query_action_list_name", "non_query_opcode_check", "skip_multi_packet_check", "uuid", "validation_type", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/ddos/zone-template/dns/{dns_name}/malformed-query-check"
