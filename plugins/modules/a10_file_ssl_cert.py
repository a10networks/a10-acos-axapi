...
def create(module, result, payload={}):
    ...
    result["modified_values"].update(**call_result["request_body"]["ssl-cert"])
    result["changed"] = True
    return result
...
def _cert_delete(module):
    params = {"delete": {}}
    params['delete'] = {"cert-name": "{}".format(module.params['file'])}
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(module.client, "ssl-cert", file_url, module.params['file'])
