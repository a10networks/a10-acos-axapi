...
AVAILABLE_PROPERTIES = ["all_slots", "cpuid", "filename", "filesize", "no_stop", "timeout", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'filename': {'type': 'str', }, 'all_slots': {'type': 'bool', }, 'cpuid': {'type': 'int', }, 'timeout': {'type': 'int', }, 'filesize': {'type': 'int', }, 'no_stop': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    return rv
