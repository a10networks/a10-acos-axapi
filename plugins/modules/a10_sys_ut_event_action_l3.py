...
def get_argspec():
    ...
    rv.update({'protocol': {'type': 'bool', },
        ...
        'ttl': {'type': 'int', },
        'uuid': {'type': 'str', },
        'ip_list': {'type': 'list', 'src_dst': {'type': 'str', 'required': True, 'choices': ['dest', 'src']}, 'ipv4_address': {'type': 'str', }, 'ipv6_address': {'type': 'str', }, 'nat_pool': {'type': 'str', }, 'virtual_server': {'type': 'str', }, 'ethernet': {'type': 'str', }, 've': {'type': 'str', }, 'trunk': {'type': 'str', }, 'uuid': {'type': 'str', }}
    })
    # Parent keys
    rv.update(dict(
