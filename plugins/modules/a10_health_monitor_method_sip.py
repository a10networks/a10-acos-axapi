...
AVAILABLE_PROPERTIES = ["expect_response_code", "register", "sip", "sip_hostname", "sip_port", "sip_tcp", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'sip': {'type': 'bool', }, 'register': {'type': 'bool', }, 'sip_port': {'type': 'int', }, 'expect_response_code': {'type': 'str', }, 'sip_tcp': {'type': 'bool', }, 'sip_hostname': {'type': 'str', }, 'uuid': {'type': 'str', }})
    # Parent keys
