...
AVAILABLE_PROPERTIES = ["allow_non_tls", "auth_handshake", "disable", "dst", "multi_pu_threshold_distribution", "renegotiation", "src", "ssl_l4_tmpl_name", "ssl_traffic_check", "user_tag", "uuid", ]
