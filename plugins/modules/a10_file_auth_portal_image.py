...
def present(module, result, existing_config):
    payload = utils.build_json("auth-portal-image", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "auth-portal-image"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "auth-portal-image-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["auth-portal-image"][
