...
AVAILABLE_PROPERTIES = ["acos_application_only", "activate", "advertisement_interval", "allowas_in", "allowas_in_count", "as_origination_interval", "bfd", "bfd_encrypted", "bfd_value", "collide_established", "connect", "default_originate", "description", "disallow_infinite_holdtime", "distribute_lists", "dont_capability_negotiate", "dynamic", "ebgp_multihop", "ebgp_multihop_hop_count", "enforce_multihop", "ethernet", "extended_nexthop", "graceful_restart", "inbound", "key_id", "key_type", "lif", "loopback", "maximum_prefix", "maximum_prefix_thres", "multihop", "nbr_remote_as", "neighbor_filter_lists", "neighbor_ipv6", "neighbor_prefix_lists", "neighbor_route_map_lists", "next_hop_self", "override_capability", "pass_encrypted", "pass_value", "passive", "peer_group_name", "prefix_list_direction", "remove_private_as", "restart_min", "route_map", "route_refresh", "send_community_val", "shutdown", "strict_capability_match", "timers_holdtime", "timers_keepalive", "trunk", "tunnel", "unsuppress_map", "update_source_ip", "update_source_ipv6", "uuid", "ve", "weight", ]
...
def get_argspec():
    ...
    rv.update({'neighbor_ipv6': {'type': 'str', 'required': True, },
        'nbr_remote_as': {'type': 'int', },
        ...
        'acos_application_only': {'type': 'bool', },
        ...
        'multihop': {'type': 'bool', },
        'key_id': {'type': 'int', },
        'key_type': {'type': 'str', 'choices': ['md5', 'meticulous-md5', 'meticulous-sha1', 'sha1', 'simple']},
        'bfd_value': {'type': 'str', },
        'bfd_encrypted': {'type': 'str', },
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/router/bgp/{bgp_as_number}/neighbor/ipv6-neighbor/{neighbor_ipv6}"

    f_dict = {}
    if '/' in str(module.params["neighbor_ipv6"]):
        f_dict["neighbor_ipv6"] = module.params["neighbor_ipv6"].replace("/","%2F")
    else:
        f_dict["neighbor_ipv6"] = module.params["neighbor_ipv6"]
...
def present(module, result, existing_config):
    payload = utils.build_json("ipv6-neighbor", module.params, AVAILABLE_PROPERTIES)
    ...
    try:
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ipv6-neighbor"] if info != "NotFound" else info
            elif module.params.get("get_type") == "list":
                get_list_result = api_client.get_list(module.client, existing_url(module))
                result["axapi_calls"].append(get_list_result)

                info = get_list_result["response_body"]
                result["acos_info"] = info["ipv6-neighbor-list"] if info != "NotFound" else info
