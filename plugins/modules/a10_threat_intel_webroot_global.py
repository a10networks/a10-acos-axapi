        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'rtu-lookup', 'database-lookup', 'non-malicious-ips'
                ]
            }
        },
        'stats': {
...
def present(module, result, existing_config):
    payload = utils.build_json("webroot-global", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "webroot-global"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "webroot-global-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["webroot-global"][
