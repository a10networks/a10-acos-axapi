...
def get_argspec():
    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                'type': 'str',
                'choices': ['all', 'spam-sources', 'windows-exploits', 'web-attacks', 'botnets', 'scanners', 'dos-attacks', 'reputation', 'phishing', 'proxy', 'mobile-threats', 'tor-proxy', 'rtu-lookup', 'database-lookup', 'non-malicious-ips']
                }
            },
        'stats': {
            'type': 'dict',
