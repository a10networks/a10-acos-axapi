...
def present(module, result, existing_config):
    payload = utils.build_json("per-instance", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "per-instance"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "per-instance-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["per-instance"][
