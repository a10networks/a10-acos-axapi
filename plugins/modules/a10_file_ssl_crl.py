...
def create(module, result, payload={}):
    ...
    result["modified_values"].update(**call_result["request_body"]["ssl-crl"])
    result["changed"] = True
    return result
...
def _cert_delete(module):
    params = {"delete": {}}
    params['delete'] = {"crl": "{}".format(module.params['file'])}
...
def run_command(module):
    ...
    try:
        ...
        existing_config, file_exists = api_client.get_file(module.client, "ssl-crl", file_url, module.params['file'])
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info["ssl-crl"]["oper"] if info != "NotFound" else info
    except a10_ex.ACOSException as ex:
