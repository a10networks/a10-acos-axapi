...
def present(module, result, existing_config):
    payload = utils.build_json("aam-jwt-authorization-tmpl", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "aam-jwt-authorization-tmpl"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "aam-jwt-authorization-tmpl-list"] if info != "NotFound" else info
