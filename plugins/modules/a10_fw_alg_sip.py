...
def get_argspec():
    ...
    rv.update({'default_port_disable': {'type': 'str', 'choices': ['default-port-disable']},
        ...
        'stats': {'type': 'dict', 'stat_request': {'type': 'str', }, 'stat_response': {'type': 'str', }, 'method_register': {'type': 'str', }, 'method_invite': {'type': 'str', }, 'method_ack': {'type': 'str', }, 'method_cancel': {'type': 'str', }, 'method_bye': {'type': 'str', }, 'method_options': {'type': 'str', }, 'method_prack': {'type': 'str', }, 'method_subscribe': {'type': 'str', }, 'method_notify': {'type': 'str', }, 'method_publish': {'type': 'str', }, 'method_info': {'type': 'str', }, 'method_refer': {'type': 'str', }, 'method_message': {'type': 'str', }, 'method_update': {'type': 'str', }, 'method_unknown': {'type': 'str', }}
    })
    return rv
