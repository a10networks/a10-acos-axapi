...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_slb_hw_compress_trigger_stats_inc
description:
...
AVAILABLE_PROPERTIES = ["failure_code", "failure_count", "max_outstanding_request_count", "max_outstanding_submit_count", "ring_full_count", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'failure_count': {'type': 'bool', }, 'failure_code': {'type': 'bool', }, 'ring_full_count': {'type': 'bool', }, 'max_outstanding_request_count': {'type': 'bool', }, 'max_outstanding_submit_count': {'type': 'bool', }, 'uuid': {'type': 'str', }})
    # Parent keys
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/slb-hw-compress/trigger-stats-inc"
