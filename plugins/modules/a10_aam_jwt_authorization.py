...
options:
    ...
    sampling_enable:
        ...
        suboptions:
            counters1:
                description:
                - "'all'= all; 'jwt-request'= JWT Request; 'jwt-authorize-success'= JWT Authorize
          Success; 'jwt-authorize-failure'= JWT Authorize Failure; 'jwt-missing-token'=
    ...
    rv.update({
        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'str',
                'choices': [
                    'all', 'jwt-request', 'jwt-authorize-success',
                    'jwt-authorize-failure', 'jwt-missing-token',
                    'jwt-missing-claim', 'jwt-token-expired',
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/aam/jwt-authorization/{name}"
...
def report_changes(module, result, existing_config, payload):
    ...
    for k, v in payload["jwt-authorization"].items():
        ...
        if config_changes["jwt-authorization"].get(k) != v:
            change_results["changed"] = True
            config_changes["jwt-authorization"][k] = v
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "jwt-authorization"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "jwt-authorization-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["jwt-authorization"][
