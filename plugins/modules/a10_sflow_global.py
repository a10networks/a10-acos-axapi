...
def get_argspec():
    ...
    rv.update({'uuid': {'type': 'str', },
        'sampling_enable': {'type': 'list', 'counters1': {'type': 'str', 'choices': ['all', 'total-packet-sample-records', 'total-counter-sample-records', 'total-sflow-packets-sent']}},
        'oper': {'type': 'dict', 'if_stats_list': {'type': 'list', 'if_type': {'type': 'str', 'choices': ['Ethernet', 'VE']}, 'if_num': {'type': 'int', }, 'packet_sample_records': {'type': 'int', }, 'counter_sample_records': {'type': 'int', }}},
        'stats': {'type': 'dict', 'total_packet_sample_records': {'type': 'str', }, 'total_counter_sample_records': {'type': 'str', }, 'total_sflow_packets_sent': {'type': 'str', }}
    })
    return rv
