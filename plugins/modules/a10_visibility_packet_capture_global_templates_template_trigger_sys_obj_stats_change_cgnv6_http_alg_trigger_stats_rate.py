...
DOCUMENTATION = r'''
module: a10_visibility_packet_capture_global_templates_template_trigger_sys_obj_stats_change_cgnv6_http_alg_trigger_stats_rate
description:
...
AVAILABLE_PROPERTIES = ["duration", "header_insertion_failed", "header_removal_failed", "out_of_memory_dropped", "out_of_order_dropped", "queue_len_exceed_dropped", "radius_requst_dropped", "radius_response_dropped", "threshold_exceeded_by", "uuid", ]
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/visibility/packet-capture/global-templates/template/{template_name}/trigger-sys-obj-stats-change/cgnv6-http-alg/trigger-stats-rate"
