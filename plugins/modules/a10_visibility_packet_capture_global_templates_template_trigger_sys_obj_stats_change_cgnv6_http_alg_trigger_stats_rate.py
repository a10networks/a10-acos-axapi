...
AVAILABLE_PROPERTIES = ["duration", "header_insertion_failed", "header_removal_failed", "threshold_exceeded_by", "uuid", ]
...
def get_argspec():
    ...
    rv.update({'threshold_exceeded_by': {'type': 'int', },
        'duration': {'type': 'int', },
        'header_insertion_failed': {'type': 'bool', },
        'header_removal_failed': {'type': 'bool', },
        'uuid': {'type': 'str', }
    })
    # Parent keys
    rv.update(dict(
