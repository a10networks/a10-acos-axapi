...
def present(module, result, existing_config):
    payload = utils.build_json("template-name", module.params,
                               AVAILABLE_PROPERTIES)
        ...
        if state == 'noop':
            if module.params.get("get_type") == "single":
                ...
                result["acos_info"] = info[
                    "template-name"] if info != "NotFound" else info
                ...
                result["acos_info"] = info[
                    "template-name-list"] if info != "NotFound" else info
                ...
                result["acos_info"] = info["template-name"][
