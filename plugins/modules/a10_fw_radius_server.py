        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'smp-mem-allocated', 'smp-mem-alloc-failed',
                    'smp-mem-freed', 'smp-created', 'smp-in-rml',
                    'smp-deleted', 'mem-allocated', 'mem-alloc-failed',
                    'mem-freed', 'ha-sync-create-sent', 'ha-sync-delete-sent',
