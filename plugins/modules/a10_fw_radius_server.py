...
options:
    ...
    sampling_enable:
        ...
        suboptions:
          ...
          Dropped; 'request-ignored'= RADIUS Request Table Full Dropped; 'radius-table-
          full'= RADIUS Request Dropped (Table Full); 'secret-not-configured-dropped'=
          RADIUS Secret Not Configured Dropped; 'ha-standby-dropped'= HA Standby Dropped;
          'ipv6-prefix-length-mismatch'= Framed IPV6 Prefix Length Mismatch; 'invalid-
          key'= Radius Request has Invalid Key Field; 'smp-mem-allocated'= RADIUS SMP
          Memory Allocated; 'smp-mem-alloc-failed'= RADIUS SMP Memory Allocation Failed;
          'smp-mem-freed'= RADIUS SMP Memory Freed; 'smp-created'= RADIUS SMP Created;
          'smp-in-rml'= RADIUS SMP in RML; 'smp-deleted'= RADIUS SMP Deleted; 'mem-
          allocated'= RADIUS Memory Allocated; 'mem-alloc-failed'= RADIUS Memory
          Allocation Failed; 'mem-freed'= RADIUS Memory Freed; 'ha-sync-create-sent'= HA
          Record Sync Create Sent; 'ha-sync-delete-sent'= HA Record Sync Delete Sent;
          'ha-sync-create-recv'= HA Record Sync Create Received; 'ha-sync-delete-recv'=
          HA Record Sync Delete Received; 'acct-on-filters-full'= RADIUS Acct On Request
          Ignored(Filters Full); 'acct-on-dup-request'= Duplicate RADIUS Acct On Request;
          'ip-mismatch-delete'= Radius Entry IP Mismatch Delete; 'ip-add-race-drop'=
          Radius Entry IP Add Race Drop; 'ha-sync-no-key-vap-dropped'= HA Record Sync No
          key dropped; 'inter-card-msg-fail-drop'= Inter-Card Message Fail Drop; 'radius-
          packets-redirected'= RADIUS packets redirected (SO); 'radius-packets-redirect-
...
def get_argspec():
    ...
    rv.update({'listen_port': {'type': 'int', },
        ...
        'encrypted': {'type': 'str', },
        'vrid': {'type': 'int', },
        'attribute': {'type': 'list', 'attribute_value': {'type': 'str', 'choices': ['inside-ipv6-prefix', 'inside-ip', 'inside-ipv6', 'imei', 'imsi', 'msisdn', 'custom1', 'custom2', 'custom3']}, 'prefix_length': {'type': 'str', 'choices': ['32', '48', '64', '80', '96', '112']}, 'prefix_vendor': {'type': 'int', }, 'prefix_number': {'type': 'int', }, 'name': {'type': 'str', }, 'value': {'type': 'str', 'choices': ['hexadecimal']}, 'custom_vendor': {'type': 'int', }, 'custom_number': {'type': 'int', }, 'vendor': {'type': 'int', }, 'number': {'type': 'int', }},
        'accounting_start': {'type': 'str', 'choices': ['ignore', 'append-entry', 'replace-entry']},
        'accounting_stop': {'type': 'str', 'choices': ['ignore', 'delete-entry']},
        ...
        'attribute_name': {'type': 'str', 'choices': ['msisdn', 'imei', 'imsi']},
        ...
        'oper': {'type': 'dict', 'radius_table_entries_list': {'type': 'list', 'inside_ip': {'type': 'str', }, 'inside_ipv6': {'type': 'str', }, 'prefix_len': {'type': 'int', }, 'msisdn': {'type': 'str', }, 'imei': {'type': 'str', }, 'imsi': {'type': 'str', }, 'custom1_attr_value': {'type': 'str', }, 'custom2_attr_value': {'type': 'str', }, 'custom3_attr_value': {'type': 'str', }, 'is_obsolete': {'type': 'bool', }}, 'total_entries': {'type': 'int', }, 'custom_attr_name': {'type': 'str', }, 'custom_attr_value': {'type': 'str', }, 'starts_with': {'type': 'bool', }, 'case_insensitive': {'type': 'bool', }},
        'stats': {'type': 'dict', 'msisdn_received': {'type': 'str', }, 'imei_received': {'type': 'str', }, 'imsi_received': {'type': 'str', }, 'custom_received': {'type': 'str', }, 'radius_request_received': {'type': 'str', }, 'radius_request_dropped': {'type': 'str', }, 'request_bad_secret_dropped': {'type': 'str', }, 'request_no_key_vap_dropped': {'type': 'str', }, 'request_malformed_dropped': {'type': 'str', }, 'request_ignored': {'type': 'str', }, 'radius_table_full': {'type': 'str', }, 'secret_not_configured_dropped': {'type': 'str', }, 'ha_standby_dropped': {'type': 'str', }, 'ipv6_prefix_length_mismatch': {'type': 'str', }, 'invalid_key': {'type': 'str', }, 'smp_created': {'type': 'str', }, 'smp_deleted': {'type': 'str', }}
    })
    return rv
