        ...
        'sampling_enable': {
            ...
            'counters1': {
                ...
                'choices': [
                    ...
                    'secret-not-configured-dropped', 'ha-standby-dropped', 'ipv6-prefix-length-mismatch', 'invalid-key', 'smp-mem-allocated', 'smp-mem-alloc-failed', 'smp-mem-freed', 'smp-created', 'smp-in-rml', 'smp-deleted', 'mem-allocated', 'mem-alloc-failed', 'mem-freed', 'ha-sync-create-sent',
                    'ha-sync-delete-sent', 'ha-sync-create-recv', 'ha-sync-delete-recv', 'acct-on-filters-full', 'acct-on-dup-request', 'ip-mismatch-delete', 'ip-add-race-drop', 'ha-sync-no-key-vap-dropped', 'inter-card-msg-fail-drop', 'radius-packets-redirected',
