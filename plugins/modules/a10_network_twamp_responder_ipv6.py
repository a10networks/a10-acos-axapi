...
def get_argspec():
    ...
    rv.update({'v6_acl_name': {'type': 'str', },
        'uuid': {'type': 'str', },
        'stats': {'type': 'dict', 'rx_pkts_v6': {'type': 'str', }, 'tx_pkts_v6': {'type': 'str', }, 'rx_drop_not_enabled_v6': {'type': 'str', }, 'rx_acl_drop_v6': {'type': 'str', }, 'twamp_hdr_len_err_v6': {'type': 'str', }, 'no_route_err_v6': {'type': 'str', }, 'other_err_v6': {'type': 'str', }}
    })
    return rv
...
def existing_url(module):
    ...
    url_base = "/axapi/v3/network/twamp/responder/ipv6"
